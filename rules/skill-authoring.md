...
2. `Read` [`skills/faion/knowledge/llm-integration/semantic-xml-content/templates/tag-glossary.xml`](../skills/faion/knowledge/llm-integration/semantic-xml-content/templates/tag-glossary.xml) — closed tag vocabulary for `content/*.xml`.
