#!/usr/bin/env python3
"""validate-success-metrics-definition.py

Validate a Success Metrics Definition artefact against the JSON Schema (draft-07) defined in
...
OK = {
    "artefact_id": "success-metrics-definition-2026-05-23",
