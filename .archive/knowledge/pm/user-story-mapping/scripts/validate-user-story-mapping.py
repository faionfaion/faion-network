#!/usr/bin/env python3
"""validate-user-story-mapping.py — validate a user-story-mapping output JSON against the methodology schema.
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"user-story-mapping-example\", \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"persona\": \"persona value\", \"backbone\": [\"item-1\", \"item-2\", \"item-3\"], \"tasks\": [\"item-1\", \"item-2\", \"item-3\"], \"walking_skeleton\": [\"item-1\", \"item-2\", \"item-3\"], \"release_slices\": [\"item-1\", \"item-2\", \"item-3\"], \"owner\": \"@solo-founder\"}")
