#!/usr/bin/env python3
"""validate-websocket-design.py

Validate an artefact produced by the websocket-design methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/websocket-design.json", "type": "object", "required": ["envelope", "heartbeat", "reconnect_policy", "send_queue", "auth"], "properties": {"envelope": {"type": "object", "required": ["fields"]}, "heartbeat": {"type": "object", "required": ["interval_seconds", "timeout_seconds"]}, "reconnect_policy": {"type": "object", "required": ["base_ms", "max_ms", "jitter"]}, "send_queue": {"type": "object", "required": ["max_size", "shed_policy"]}, "auth": {"type": "object", "required": ["method", "ttl_seconds"]}, "message_schemas": {"type": "object"}}}')
