#!/usr/bin/env python3
"""validate-django-base-model.py — Validate the django-base-model output record against 02-output-contract.xml.
...
def validate(rec: dict) -> list[str]:
    out: list[str] = []
    if rec.get("produced_by") != "django-base-model":
        out.append("produced_by must equal 'django-base-model'")
