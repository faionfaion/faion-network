...
## [Unreleased]
- migrate: 3/3 pro/research/market-researcher methodologies → methodology.xml (continuous-discovery, distribution-channel-research, market-analysis; feature-045 batch CG)
...
- migrate: 3/3 pro/infra/infrastructure-engineer methodologies → methodology.xml (docker, gcp-networking, terraform-basics; feature-045 batch BD)
...
- migrate: 3/3 pro/infra/devops-engineer methodologies → methodology.xml (secrets-management, security-as-code, ssl-tls-setup; feature-045 batch AW-retry)
