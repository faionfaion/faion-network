#!/usr/bin/env python3
"""validate-anti-slop-rubric.py — validate output artefacts against the anti-slop-rubric output contract.
...
SMOKE = {
    "artefact_id": "anti-slop-rubric-2026-05-22-001",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate anti-slop-rubric output JSON.")
