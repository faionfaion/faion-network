#!/usr/bin/env python3
"""validate-technical-seo-for-ai.py — validate output artefacts against the technical-seo-for-ai output contract.
...
SMOKE = {
    "artefact_id": "technical-seo-for-ai-2026-05-22-001",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate technical-seo-for-ai output JSON.")
