#!/usr/bin/env python3
"""validate-seo-audit-runbook.py — validate output artefacts against the seo-audit-runbook output contract.
...
SMOKE = {
    "artefact_id": "seo-audit-runbook-2026-05-22-001",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate seo-audit-runbook output JSON.")
