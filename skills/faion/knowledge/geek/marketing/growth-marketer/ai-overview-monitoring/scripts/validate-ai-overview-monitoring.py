#!/usr/bin/env python3
"""validate-ai-overview-monitoring.py — validate output artefacts against the ai-overview-monitoring output contract.
...
SMOKE = {
    "artefact_id": "ai-overview-monitoring-2026-05-22-001",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate ai-overview-monitoring output JSON.")
