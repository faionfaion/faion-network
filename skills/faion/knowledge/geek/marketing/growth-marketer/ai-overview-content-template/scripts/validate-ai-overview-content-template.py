#!/usr/bin/env python3
"""validate-ai-overview-content-template.py — validate output artefacts against the ai-overview-content-template output contract.
...
SMOKE = {
    "artefact_id": "ai-overview-content-template-2026-05-22-001",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate ai-overview-content-template output JSON.")
