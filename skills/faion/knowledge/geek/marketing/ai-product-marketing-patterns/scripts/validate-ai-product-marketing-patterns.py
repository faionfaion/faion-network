#!/usr/bin/env python3
"""validate-ai-product-marketing-patterns.py — validate output artefacts against the ai-product-marketing-patterns output contract.
...
REQUIRED = ["product", "patterns_used", "claims", "evidence_links", "trust_safety_messaging"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate ai-product-marketing-patterns output JSON.")
