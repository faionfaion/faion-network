#!/usr/bin/env python3
"""validate-agent-postmortem-template.py — validate output artefacts against the agent-postmortem-template output contract.
...
REQUIRED = ['trace_id', 'model_id', 'incident_summary', 'layer_attribution', 'prompt_diff', 'eval_delta', 'replay_artefacts', 'forbidden_seen']
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate agent-postmortem-template output JSON.")
