#!/usr/bin/env python3
"""validate-multi-agent-design-patterns.py — validate an output artefact against the multi-agent-design-patterns contract.
...
PAYLOAD_REQUIRED = ['criteria', 'scores', 'recommendation']
...
SMOKE = {'slug': 'multi-agent-design-patterns', 'version': '1.0.0', 'date': '2026-05-22', 'produces': 'decision-record', 'signature': 'b677c7cc1c524cc0', 'payload': {'criteria': ['accuracy', 'latency', 'cost'], 'scores': {'a': 3, 'b': 5}, 'recommendation': 'Pick option B.'}, 'forbidden_seen': []}
