#!/usr/bin/env python3
# purpose: validate video-generation-provider-selection JSON artefact against 02-output-contract schema
...
"""validate-video-generation-provider-selection.py — validate a video-generation-provider-selection JSON artefact.
...
REQUIRED = ['decision_id', 'selected_provider', 'budget_usd_month', 'fallback_provider', 'expected_volume']
