<!-- purpose: Filled-in provider-selection decision record -->
<!-- consumes: inputs declared in video-generation-provider-selection/AGENTS.md Prerequisites -->
...
# Filled-in provider-selection decision record
