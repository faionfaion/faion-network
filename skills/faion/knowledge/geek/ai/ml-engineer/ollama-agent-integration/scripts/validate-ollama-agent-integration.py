#!/usr/bin/env python3
"""validate-ollama-agent-integration.py — validate an output artefact against the ollama-agent-integration contract.
...
SMOKE = {'slug': 'ollama-agent-integration', 'version': '1.0.0', 'date': '2026-05-22', 'produces': 'code', 'signature': '2cdfcb953ba576d5', 'payload': {'language': 'python', 'entry_point': 'skeleton.py', 'files': [{'path': 'skeleton.py', 'purpose': 'main module'}]}, 'forbidden_seen': []}
