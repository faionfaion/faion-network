#!/usr/bin/env python3
"""validate-prompt-engineering-production.py — validate an output artefact against the prompt-engineering-production contract.
...
PAYLOAD_REQUIRED = ['title', 'sections']
...
SMOKE = {'slug': 'prompt-engineering-production', 'version': '1.0.0', 'date': '2026-05-22', 'produces': 'spec', 'signature': 'b7ffecef9f44cecb', 'payload': {'title': 'Worked spec', 'sections': ['Intro', 'Requirements', 'Acceptance']}, 'forbidden_seen': []}
