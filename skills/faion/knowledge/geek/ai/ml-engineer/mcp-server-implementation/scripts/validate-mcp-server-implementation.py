#!/usr/bin/env python3
"""validate-mcp-server-implementation.py — validate an output artefact against the mcp-server-implementation contract.
...
PAYLOAD_REQUIRED = ['language', 'entry_point', 'files']
...
SMOKE = {'slug': 'mcp-server-implementation', 'version': '1.0.0', 'date': '2026-05-22', 'produces': 'code', 'signature': '2eb6770033796ca4', 'payload': {'language': 'python', 'entry_point': 'skeleton.py', 'files': [{'path': 'skeleton.py', 'purpose': 'main module'}]}, 'forbidden_seen': []}
