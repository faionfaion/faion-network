#!/usr/bin/env python3
"""validate-ollama-tool-calling.py — validate an output artefact against the ollama-tool-calling contract.
...
SMOKE = {'slug': 'ollama-tool-calling', 'version': '1.0.0', 'date': '2026-05-22', 'produces': 'code', 'signature': '99b04b8f605a4172', 'payload': {'language': 'python', 'entry_point': 'skeleton.py', 'files': [{'path': 'skeleton.py', 'purpose': 'main module'}]}, 'forbidden_seen': []}
