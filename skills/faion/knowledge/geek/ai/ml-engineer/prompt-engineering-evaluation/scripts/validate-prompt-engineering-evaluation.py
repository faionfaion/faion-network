#!/usr/bin/env python3
"""validate-prompt-engineering-evaluation.py — validate an output artefact against the prompt-engineering-evaluation contract.
...
PAYLOAD_REQUIRED = ['metrics', 'narrative', 'caveats']
...
SMOKE = {'slug': 'prompt-engineering-evaluation', 'version': '1.0.0', 'date': '2026-05-22', 'produces': 'report', 'signature': '8e16fc9cd0496509', 'payload': {'metrics': {'accuracy': 0.91}, 'narrative': 'Accuracy improved 3.6 pp on the frozen eval suite.', 'caveats': ['LLM-as-judge variance ±3%.']}, 'forbidden_seen': []}
