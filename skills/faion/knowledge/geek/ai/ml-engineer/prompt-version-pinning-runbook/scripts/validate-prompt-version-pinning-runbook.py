#!/usr/bin/env python3
"""validate-prompt-version-pinning-runbook.py — validate an output artefact against the prompt-version-pinning-runbook contract.
...
SMOKE = {'slug': 'prompt-version-pinning-runbook', 'version': '1.0.0', 'date': '2026-05-22', 'produces': 'playbook-step', 'signature': '2fd213e797732483', 'payload': {'trigger': 'deploy event', 'action': 'rollout 5% canary', 'verification': 'eval delta within ±2 pp', 'rollback': 'gateway rollback to prev hash'}, 'forbidden_seen': []}
