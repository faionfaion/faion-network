#!/usr/bin/env python3
"""validate-ollama-python-client.py — validate an output artefact against the ollama-python-client contract.
...
SMOKE = {'slug': 'ollama-python-client', 'version': '1.0.0', 'date': '2026-05-22', 'produces': 'code', 'signature': '46f2d7aa252cec9c', 'payload': {'language': 'python', 'entry_point': 'skeleton.py', 'files': [{'path': 'skeleton.py', 'purpose': 'main module'}]}, 'forbidden_seen': []}
