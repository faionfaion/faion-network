#!/usr/bin/env python3
"""validate-ollama-setup-models.py — validate an output artefact against the ollama-setup-models contract.
...
SMOKE = {'slug': 'ollama-setup-models', 'version': '1.0.0', 'date': '2026-05-22', 'produces': 'config', 'signature': 'af1d49fe3a740293', 'payload': {'env': 'prod', 'keys': {'timeout': 30}}, 'forbidden_seen': []}
