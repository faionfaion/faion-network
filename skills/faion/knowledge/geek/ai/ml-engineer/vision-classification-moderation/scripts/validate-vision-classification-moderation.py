#!/usr/bin/env python3
# purpose: validate vision-classification-moderation JSON artefact against 02-output-contract schema
...
"""validate-vision-classification-moderation.py — validate a vision-classification-moderation JSON artefact.
...
REQUIRED = ['image_hash', 'category', 'severity', 'confidence', 'model_used', 'audit_id']
