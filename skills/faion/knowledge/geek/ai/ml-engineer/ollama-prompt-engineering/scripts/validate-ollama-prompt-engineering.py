#!/usr/bin/env python3
"""validate-ollama-prompt-engineering.py — validate an output artefact against the ollama-prompt-engineering contract.
...
SMOKE = {'slug': 'ollama-prompt-engineering', 'version': '1.0.0', 'date': '2026-05-22', 'produces': 'playbook-step', 'signature': '0ee04b5cd3d3e08a', 'payload': {'trigger': 'deploy event', 'action': 'rollout 5% canary', 'verification': 'eval delta within ±2 pp', 'rollback': 'gateway rollback to prev hash'}, 'forbidden_seen': []}
