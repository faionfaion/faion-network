#!/usr/bin/env python3
"""validate-prompt-changelog-discipline.py — validate an output artefact against the prompt-changelog-discipline contract.
...
SMOKE = {'slug': 'prompt-changelog-discipline', 'version': '1.0.0', 'date': '2026-05-22', 'produces': 'spec', 'signature': 'acb4704b34bc6f0b', 'payload': {'title': 'Worked spec', 'sections': ['Intro', 'Requirements', 'Acceptance']}, 'forbidden_seen': []}
