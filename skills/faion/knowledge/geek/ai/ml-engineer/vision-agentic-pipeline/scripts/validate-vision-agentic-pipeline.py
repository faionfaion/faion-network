#!/usr/bin/env python3
# purpose: validate vision-agentic-pipeline JSON artefact against 02-output-contract schema
...
"""validate-vision-agentic-pipeline.py — validate a vision-agentic-pipeline JSON artefact.
...
REQUIRED = ['pipeline_id', 'image_hash', 'doc_type', 'validation_status']
