# purpose: skeleton implementation of openai-api
# consumes: task brief + constraints
# produces: python module implementing the contract
# depends-on: content/02-output-contract.xml
# token-budget-impact: medium

"""openai-api skeleton — fill the TODO blocks and wire to your pipeline.

Implements the output contract in content/02-output-contract.xml.
Run scripts/validate-openai-api.py against the emitted payload before handing off.
"""
...
def build_payload(brief: dict[str, Any]) -> Payload:
    ...
    # TODO: replace with the real business logic for openai-api.
    return Payload(
