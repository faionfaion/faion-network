#!/usr/bin/env python3
"""validate-openai-api.py — validate an output artefact against the openai-api contract.
...
SMOKE = {'slug': 'openai-api', 'version': '1.0.0', 'date': '2026-05-22', 'produces': 'code', 'signature': '029d2b9e21afffa9', 'payload': {'language': 'python', 'entry_point': 'skeleton.py', 'files': [{'path': 'skeleton.py', 'purpose': 'main module'}]}, 'forbidden_seen': []}
