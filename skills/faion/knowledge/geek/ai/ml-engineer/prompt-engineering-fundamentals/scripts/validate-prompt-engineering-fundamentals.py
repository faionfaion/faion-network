#!/usr/bin/env python3
"""validate-prompt-engineering-fundamentals.py — validate an output artefact against the prompt-engineering-fundamentals contract.
...
PAYLOAD_REQUIRED = ['trigger', 'action', 'verification', 'rollback']
...
SMOKE = {'slug': 'prompt-engineering-fundamentals', 'version': '1.0.0', 'date': '2026-05-22', 'produces': 'playbook-step', 'signature': '374c45ac16101e21', 'payload': {'trigger': 'deploy event', 'action': 'rollout 5% canary', 'verification': 'eval delta within ±2 pp', 'rollback': 'gateway rollback to prev hash'}, 'forbidden_seen': []}
