...
summary: Produces a design-partner session spec: agenda, named partner, problem hypothesis, prototype-under-test, decision questions, capture format, owner.
content_id: "cd605342e5d1b283"
complexity: medium
produces: spec
est_tokens: 4000
tags: [design-partner, discovery, product-research, ai-core, geek]
---
...
| `templates/design-partner-session-template.md` | Markdown skeleton with required fields |
