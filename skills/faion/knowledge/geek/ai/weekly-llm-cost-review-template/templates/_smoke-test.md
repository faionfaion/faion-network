<!--
purpose: Filled-in minimum viable example of a Weekly LLM Cost Review Template artefact.
consumes: nothing — fixture.
produces: a worked Markdown example for tests / docs.
depends-on: content/02-output-contract.xml + templates/weekly-llm-cost-review-template.md.
token-budget-impact: ~150 tokens.
-->

# Weekly LLM Cost Review Template — wlcr-smoke-001

- **artefact_id**: wlcr-smoke-001
...
Apply the weekly-llm-cost-review-template procedure to the pilot engagement; emit artefact bound to the scope doc.
