#!/usr/bin/env python3
"""validate-reranking-pipeline-integration.

Validates a reranking-pipeline-integration output JSON against the 02-output-contract schema.
...
REQUIRED = {"query", "results", "latency", "degraded"}
