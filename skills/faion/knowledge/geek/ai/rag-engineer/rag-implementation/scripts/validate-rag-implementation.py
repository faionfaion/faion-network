...
Validates a rag-implementation output JSON against the 02-output-contract schema.
...
REQUIRED = {"loaders", "chunker", "embedding", "store", "retrieval", "generation", "incremental"}
