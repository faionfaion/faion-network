...
### Design Pattern
```
Prompt: Design a agentic-rag system that:
1. Handles {use_case}
...
### Code Generation
```
Prompt: Generate Python code for {specific_task} using agentic-rag.
...
Using agentic-rag, what's the issue and how to fix it?
```
...
### Test Generation
```
Prompt: Generate comprehensive tests for {function_name} that handles agentic-rag.
...
### Tutorial Generation
```
Prompt: Create a tutorial for implementing agentic-rag from scratch.
...
### Performance
```
Prompt: How can I improve the performance of {metric} in {language} for agentic-rag?
...
### Cost Optimization
```
Prompt: How to reduce API costs while maintaining quality for agentic-rag?
