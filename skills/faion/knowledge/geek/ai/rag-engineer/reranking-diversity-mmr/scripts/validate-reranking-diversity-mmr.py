#!/usr/bin/env python3
"""validate-reranking-diversity-mmr.

Validates a reranking-diversity-mmr output JSON against the 02-output-contract schema.
...
REQUIRED = {"lambda", "pool_n", "top_k", "results"}
