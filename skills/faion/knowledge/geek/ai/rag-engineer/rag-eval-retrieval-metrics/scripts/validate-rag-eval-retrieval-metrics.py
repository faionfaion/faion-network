#!/usr/bin/env python3
"""validate-rag-eval-retrieval-metrics.

Validates a rag-eval-retrieval-metrics output JSON against the 02-output-contract schema.
...
REQUIRED = {"k", "snapshot", "per_query", "aggregate"}
