#!/usr/bin/env python3
"""validate-rag-eval-pipeline.

Validates a rag-eval-pipeline output JSON against the 02-output-contract schema.
...
REQUIRED = {"snapshot", "n_questions", "retrieval", "generation", "per_query"}
