...
summary: Produces an eval-contract spec: golden set, scorer list (deterministic + judge), threshold, sampling policy, regression gate, named owner.
content_id: "8faf2046ab2ed5e4"
complexity: medium
produces: spec
est_tokens: 4000
tags: [eval, contract, judge, golden-set, ai-core, sdlc-ai, geek]
---
...
| `templates/eval-contract-template.md` | Markdown skeleton with required fields |
