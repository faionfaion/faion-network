#!/usr/bin/env python3
# purpose: validate lora-qlora JSON artefact against 02-output-contract schema
...
"""validate-lora-qlora.py — validate a lora-qlora JSON artefact.
...
REQUIRED = ['run_id', 'technique', 'rank', 'alpha', 'compute_dtype', 'base_dtype']
