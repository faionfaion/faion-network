#!/usr/bin/env python3
# purpose: validate evaluation-metrics JSON artefact against 02-output-contract schema
...
"""validate-evaluation-metrics.py — validate a evaluation-metrics JSON artefact.
...
REQUIRED = ['task_id', 'metric_card_version', 'safety_floor', 'reliability_floor']

TYPE_MAP = {
    'task_id': 'string',
    'dimensions': 'object',
    'metric_card_version': 'string',
    'thresholds': 'object',
    'safety_floor': 'number',
