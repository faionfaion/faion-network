#!/usr/bin/env python3
# purpose: validate finetuning-datasets JSON artefact against 02-output-contract schema
...
"""validate-finetuning-datasets.py — validate a finetuning-datasets JSON artefact.
...
REQUIRED = ['dataset_id', 'raw_count', 'clean_count', 'duplicate_rate', 'format', 'test_split_hash']
