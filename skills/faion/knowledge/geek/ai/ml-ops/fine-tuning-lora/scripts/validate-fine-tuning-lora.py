#!/usr/bin/env python3
# purpose: validate fine-tuning-lora JSON artefact against 02-output-contract schema
...
"""validate-fine-tuning-lora.py — validate a fine-tuning-lora JSON artefact.
...
REQUIRED = ['run_id', 'base_model', 'rank', 'alpha', 'lr', 'epochs']
