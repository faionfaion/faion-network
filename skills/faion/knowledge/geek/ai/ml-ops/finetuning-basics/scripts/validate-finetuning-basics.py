#!/usr/bin/env python3
# purpose: validate finetuning-basics JSON artefact against 02-output-contract schema
...
"""validate-finetuning-basics.py — validate a finetuning-basics JSON artefact.
...
REQUIRED = ['decision_id', 'base_model', 'technique', 'framework', 'dataset_size', 'gpu_floor_gb']
