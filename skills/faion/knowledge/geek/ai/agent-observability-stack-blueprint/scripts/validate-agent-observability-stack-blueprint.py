#!/usr/bin/env python3
"""validate-agent-observability-stack-blueprint.py — validate output artefacts against the agent-observability-stack-blueprint output contract.
...
REQUIRED = ['vendor', 'otel_spans_enabled', 'cost_ledger_schema', 'judge_sample_pct', 'drift_alert_threshold', 'forbidden_seen']
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate agent-observability-stack-blueprint output JSON.")
