#!/usr/bin/env python3
"""validate-agent-eval-harness-bootstrap-recipe.py — validate output artefacts against the agent-eval-harness-bootstrap-recipe output contract.
...
REQUIRED = ['harness_path', 'trajectory_count', 'criteria_count', 'ci_gate_threshold_pct', 'replay_dir', 'otel_trace_correlation', 'forbidden_seen']
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate agent-eval-harness-bootstrap-recipe output JSON.")
