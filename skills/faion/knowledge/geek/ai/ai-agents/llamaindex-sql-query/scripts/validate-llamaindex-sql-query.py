#!/usr/bin/env python3
"""Validate a llamaindex-sql-query decision-record against the embedded schema.

Usage:
    validate-llamaindex-sql-query.py <file.json>
    validate-llamaindex-sql-query.py --self-test
    validate-llamaindex-sql-query.py --help
...
DECISION_REQUIRED = ['dsn', 'include_tables', 'use_object_index', 'max_returned_rows', 'read_only']
DRIVERS_REQUIRED = ['table_count', 'schema_size_chars', 'read_only_required']
