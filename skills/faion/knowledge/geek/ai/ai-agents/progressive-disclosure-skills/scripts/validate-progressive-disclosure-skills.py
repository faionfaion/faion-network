#!/usr/bin/env python3
"""Validate a progressive-disclosure-skills spec JSON.

Usage: validate-progressive-disclosure-skills.py <file.json> | --self-test | --help
...
DEC = ["frontmatter_token_budget", "body_token_budget", "references_layout", "trigger_set"]
DRV = ["body_tokens", "ref_count", "trigger_precision", "session_token_cap"]
...
def _self_test() -> int:
    good = {
        ...
        "audit": {"rule_refs": ["r1-frontmatter-bounded"]},
    }
