#!/usr/bin/env python3
"""Validate a rerank-before-reasoning spec JSON.

Usage: validate-rerank-before-reasoning.py <file.json> | --self-test | --help
...
DEC = ["reranker_model", "k_retrieved", "k_final", "timeout_ms", "fallback_mode"]
DRV = ["top_1_miss_rate", "latency_budget_ms", "context_budget_tokens"]
...
def _self_test() -> int:
    good = {
        ...
        "audit": {"rule_refs": ["r1-rerank-required"]},
    }
