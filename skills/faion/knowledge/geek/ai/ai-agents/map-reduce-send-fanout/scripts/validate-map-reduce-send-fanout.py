#!/usr/bin/env python3
"""Validate a map-reduce-send-fanout decision-record against the embedded schema.

Usage:
    validate-map-reduce-send-fanout.py <file.json>
    validate-map-reduce-send-fanout.py --self-test
    validate-map-reduce-send-fanout.py --help
...
DECISION_REQUIRED = ['framework', 'concurrency_cap', 'reducer', 'idempotency_guarantee', 'max_attempts']
DRIVERS_REQUIRED = ['item_count', 'mutates_shared_state', 'idempotent', 'framework']
