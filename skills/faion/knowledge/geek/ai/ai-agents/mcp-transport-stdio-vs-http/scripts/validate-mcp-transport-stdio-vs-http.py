#!/usr/bin/env python3
"""Validate a mcp-transport-stdio-vs-http decision-record against the embedded schema.

Usage:
    validate-mcp-transport-stdio-vs-http.py <file.json>
    validate-mcp-transport-stdio-vs-http.py --self-test
    validate-mcp-transport-stdio-vs-http.py --help
...
DECISION_REQUIRED = ['transport', 'auth_scheme', 'resumable_streams', 'base_url']
DRIVERS_REQUIRED = ['multi_tenant', 'auth_required', 'client_targets']
