#!/usr/bin/env python3
"""validate-agent-eval-cost-budget-policy.py — validate output artefacts against the agent-eval-cost-budget-policy output contract.
...
REQUIRED = ['nightly_full_suite_size', 'per_pr_subset_size', 'weekly_adversarial_size', 'cost_ceiling_daily_usd', 'fallback_judge_model', 'forbidden_seen']
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate agent-eval-cost-budget-policy output JSON.")
