#!/usr/bin/env python3
"""validate-agent-architectures.py — validate output artefacts against the agent-architectures output contract.
...
REQUIRED = ['memory_size_limit', 'memory_summarization', 'tool_count', 'fsm_states', 'planning_enabled', 'reflection_enabled', 'idle_evict_iterations', 'forbidden_seen']
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate agent-architectures output JSON.")
