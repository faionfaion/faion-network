#!/usr/bin/env python3
"""Validate a llamaindex-hybrid-retrieval decision-record against the embedded schema.

Usage:
    validate-llamaindex-hybrid-retrieval.py <file.json>
    validate-llamaindex-hybrid-retrieval.py --self-test
    validate-llamaindex-hybrid-retrieval.py --help
...
DECISION_REQUIRED = ['retrievers', 'fusion_top_k', 'rerank_model', 'rerank_top_n', 'similarity_cutoff']
DRIVERS_REQUIRED = ['corpus_heterogeneity', 'latency_target_ms', 'rerank_budget_usd']
