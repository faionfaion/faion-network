#!/usr/bin/env python3
"""Validate a schema-field-order spec JSON.

Usage: validate-schema-field-order.py <file.json> | --self-test | --help
...
DEC = ["field_order", "reasoning_field_name", "schema_strict"]
DRV = ["answer_quality_floor", "latency_budget_ms", "schema_modifiable"]
...
def _self_test() -> int:
    good = {
        ...
        "audit": {"rule_refs": ["r1-reasoning-first"]},
    }
