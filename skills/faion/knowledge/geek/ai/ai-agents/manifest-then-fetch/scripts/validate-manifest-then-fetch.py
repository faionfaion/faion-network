#!/usr/bin/env python3
"""Validate a manifest-then-fetch decision-record against the embedded schema.

Usage:
    validate-manifest-then-fetch.py <file.json>
    validate-manifest-then-fetch.py --self-test
    validate-manifest-then-fetch.py --help
...
DECISION_REQUIRED = ['wrapped_tools', 'manifest_max_tokens', 'store_backend', 'retention_ttl_seconds', 'preview_strategy']
DRIVERS_REQUIRED = ['tool_outputs_avg_bytes', 'store_backend', 'sensitivity']
