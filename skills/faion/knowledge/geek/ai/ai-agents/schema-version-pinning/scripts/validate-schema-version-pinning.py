#!/usr/bin/env python3
"""Validate a schema-version-pinning spec JSON.

Usage: validate-schema-version-pinning.py <file.json> | --self-test | --help
...
DEC = ["pin_range", "migration_script_path", "deprecation_window_days"]
DRV = ["schema_change_rate_per_quarter", "agent_deploys", "recorded_calls_count"]
...
def _self_test() -> int:
    good = {
        ...
        "audit": {"rule_refs": ["r1-semver-in-schema"]},
    }
