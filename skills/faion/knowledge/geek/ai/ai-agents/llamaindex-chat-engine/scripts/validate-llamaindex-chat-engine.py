#!/usr/bin/env python3
"""Validate a llamaindex-chat-engine decision-record against the embedded schema.

Usage:
    validate-llamaindex-chat-engine.py <file.json>
    validate-llamaindex-chat-engine.py --self-test
    validate-llamaindex-chat-engine.py --help
...
DECISION_REQUIRED = ['chat_mode', 'token_limit', 'streaming', 'context_prompt']
DRIVERS_REQUIRED = ['follow_up_complexity', 'tool_use', 'latency_target_ms']
