#!/usr/bin/env python3
"""Validate a mcp-resource-vs-tool-vs-prompt decision-record against the embedded schema.

Usage:
    validate-mcp-resource-vs-tool-vs-prompt.py <file.json>
    validate-mcp-resource-vs-tool-vs-prompt.py --self-test
    validate-mcp-resource-vs-tool-vs-prompt.py --help
...
DECISION_REQUIRED = ['classifications']
DRIVERS_REQUIRED = ['side_effect', 'user_facing', 'llm_reasons_on_result']
