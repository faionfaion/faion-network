#!/usr/bin/env python3
"""Validate a langchain-workflows decision-record against the embedded schema.

Usage:
    validate-langchain-workflows.py <file.json>
    validate-langchain-workflows.py --self-test
    validate-langchain-workflows.py --help
...
DECISION_REQUIRED = ['state_schema', 'nodes', 'edges', 'interrupt_before', 'checkpointer', 'subgraphs']
DRIVERS_REQUIRED = ['steps', 'branches', 'hitl_points', 'parallel_branches', 'persistence_target']
