#!/usr/bin/env python3
"""validate-agent-kill-switch-design.py — validate output artefacts against the agent-kill-switch-design output contract.
...
REQUIRED = ['scopes', 'e2e_kill_latency_p95_sec', 'tested_at', 'recovery_path', 'structured_log_emitted', 'forbidden_seen']
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate agent-kill-switch-design output JSON.")
