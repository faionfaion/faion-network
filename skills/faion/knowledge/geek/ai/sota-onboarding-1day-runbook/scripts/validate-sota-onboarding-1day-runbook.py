#!/usr/bin/env python3
"""validate-sota-onboarding-1day-runbook.

Validates a sota-onboarding-1day-runbook output JSON against the 02-output-contract schema.
...
REQUIRED = {"model_id", "version", "eval_scores", "cost_delta", "latency_delta", "decision", "owner", "revisit_date"}
