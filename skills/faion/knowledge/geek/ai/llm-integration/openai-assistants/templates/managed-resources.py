# purpose: Context-managed assistant + thread + vector-store lifecycle
# consumes: Inputs declared in `AGENTS.md` Prerequisites.
# produces: Filled artefact for `openai-assistants` matching `content/02-output-contract.xml`.
# depends-on: `content/01-core-rules.xml`, `scripts/validate-openai-assistants.py`.
