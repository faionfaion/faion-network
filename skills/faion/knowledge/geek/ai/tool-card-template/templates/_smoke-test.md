<!--
purpose: Filled-in minimum viable example of a Tool Card Template artefact.
consumes: nothing — fixture.
produces: a worked Markdown example for tests / docs.
depends-on: content/02-output-contract.xml + templates/tool-card-template.md.
token-budget-impact: ~150 tokens.
-->

# Tool Card Template — toolc-smoke-001

- **artefact_id**: toolc-smoke-001
...
Apply the tool-card-template procedure to the pilot engagement; emit artefact bound to the scope doc.
