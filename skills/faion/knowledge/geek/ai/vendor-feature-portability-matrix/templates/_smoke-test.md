<!--
purpose: Filled-in minimum viable example of a Vendor Feature Portability Matrix artefact.
consumes: nothing — fixture.
produces: a worked Markdown example for tests / docs.
depends-on: content/02-output-contract.xml + templates/vendor-feature-portability-matrix.md.
token-budget-impact: ~150 tokens.
-->

# Vendor Feature Portability Matrix — vfpm-smoke-001

- **artefact_id**: vfpm-smoke-001
...
Apply the vendor-feature-portability-matrix procedure to the pilot engagement; emit artefact bound to the scope doc.
