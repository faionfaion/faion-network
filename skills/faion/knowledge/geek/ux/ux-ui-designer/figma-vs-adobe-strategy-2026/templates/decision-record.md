<!-- purpose: ADR-style decision record skeleton -->
...
_Skeleton for the `figma-vs-adobe-strategy-2026` methodology output. Fill each section; do not leave headings empty._
...
- Timestamp
- Validator run: `python scripts/validate-figma-vs-adobe-strategy-2026.py --file out.json`
