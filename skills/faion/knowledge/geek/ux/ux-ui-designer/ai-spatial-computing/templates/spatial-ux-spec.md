<!-- purpose: Spec document skeleton for spatial-AI experience -->
...
_Skeleton for the `ai-spatial-computing` methodology output. Fill each section; do not leave headings empty._
...
- Timestamp
- Validator run: `python scripts/validate-ai-spatial-computing.py --file out.json`
