<!-- purpose: Spec document skeleton -->
...
_Skeleton for the `generative-ui-design` methodology output. Fill each section; do not leave headings empty._
...
- Timestamp
- Validator run: `python scripts/validate-generative-ui-design.py --file out.json`
