#!/usr/bin/env python3
"""validate-feature-flag-rollout-runbook.py — validate output artefacts against the feature-flag-rollout-runbook output contract.
...
REQUIRED = ["flag_key", "stages", "kill_switch", "rollback_criteria", "cleanup_due_date"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate feature-flag-rollout-runbook output JSON.")
