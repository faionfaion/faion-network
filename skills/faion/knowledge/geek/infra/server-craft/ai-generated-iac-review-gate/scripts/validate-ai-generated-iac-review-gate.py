#!/usr/bin/env python3
"""validate-ai-generated-iac-review-gate.py — validate output artefacts against the ai-generated-iac-review-gate output contract.
...
REQUIRED = ["change_id", "ai_assisted", "blast_radius", "automated_checks", "human_signoff"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate ai-generated-iac-review-gate output JSON.")
