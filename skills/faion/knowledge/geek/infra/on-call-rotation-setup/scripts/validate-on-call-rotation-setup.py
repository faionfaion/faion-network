#!/usr/bin/env python3
"""validate-on-call-rotation-setup.py — validate output artefacts against the on-call-rotation-setup output contract.
...
REQUIRED = ["rotation_id", "shifts", "engineers", "compensation_model", "fairness_audit_cadence"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate on-call-rotation-setup output JSON.")
