#!/usr/bin/env python3
"""validate-ai-workload-cost-attribution.py — validate output artefacts against the ai-workload-cost-attribution output contract.
...
REQUIRED = ["period", "tenants", "total_cost", "by_feature", "reconciled_to_invoice"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate ai-workload-cost-attribution output JSON.")
