#!/usr/bin/env python3
"""validate-eu-sovereign-llm-deployment-bundle.py — validate output artefacts against the eu-sovereign-llm-deployment-bundle output contract.
...
REQUIRED = ["risk_class", "regions", "providers", "audit_events", "egress_policy"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate eu-sovereign-llm-deployment-bundle output JSON.")
