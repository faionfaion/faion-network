#!/usr/bin/env python3
"""validate-service-ownership-map-template.py — validate output artefacts against the service-ownership-map-template output contract.
...
REQUIRED = ["services", "team", "on_call", "slo_url", "runbook_url", "dependencies"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate service-ownership-map-template output JSON.")
