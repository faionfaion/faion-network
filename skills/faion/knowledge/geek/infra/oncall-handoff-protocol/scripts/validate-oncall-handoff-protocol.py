#!/usr/bin/env python3
"""validate-oncall-handoff-protocol.py — validate output artefacts against the oncall-handoff-protocol output contract.
...
REQUIRED = ["shift_id", "outgoing", "incoming", "open_incidents", "followups", "fatigue_signal"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate oncall-handoff-protocol output JSON.")
