#!/usr/bin/env python3
"""validate-chaos-engineering-practice-for-infra.py — validate output artefacts against the chaos-engineering-practice-for-infra output contract.
...
REQUIRED = ["experiment_id", "hypothesis", "blast_radius", "abort_criteria", "outcome", "learnings"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate chaos-engineering-practice-for-infra output JSON.")
