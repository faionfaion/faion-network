#!/usr/bin/env python3
"""validate-agent-on-call-runbook-template.py

Validate the artefact produced by the `agent-on-call-runbook-template` methodology against the schema
...
EXPECTED_SLUG = "agent-on-call-runbook-template"
