#!/usr/bin/env python3
"""validate-tracker-github-copilot-workspace.py

Validate the playbook-step artefact for the tracker-github-copilot-workspace methodology against the schema
...
REQUIRED = ['issue_url', 'spec_snapshot_url', 'plan_snapshot_url', 'diff_url', 'pr_url', 'gates_passed', 'human_edited_at']
SCHEMA_PROPS = {'gates_passed': {'minItems': 4}, 'human_edited_at': {'minItems': 1}}
...
OK = {'issue_url': 'https://github.com/org/repo/issues/4521', 'spec_snapshot_url': 'https://github.com/copilot/workspaces/abc#spec', 'plan_snapshot_url': 'https://github.com/copilot/workspaces/abc#plan', 'diff_url': 'https://github.com/copilot/workspaces/abc#diff', 'pr_url': 'https://github.com/org/repo/pull/4530', 'gates_passed': ['spec', 'plan', 'diff', 'pr'], 'human_edited_at': ['spec', 'plan']}
BAD = {'issue_url': 'https://github.com/org/repo/issues/4521', 'pr_url': 'https://github.com/org/repo/pull/4530', 'gates_passed': ['diff'], 'human_edited_at': []}
