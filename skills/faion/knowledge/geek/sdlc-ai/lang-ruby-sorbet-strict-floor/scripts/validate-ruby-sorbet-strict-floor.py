#!/usr/bin/env python3
"""validate-ruby-sorbet-strict-floor.py — validate the config artefact for the lang-ruby-sorbet-strict-floor methodology.
...
SCHEMA = json.loads(r"""{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/lang-ruby-sorbet-strict-floor.json", "type": "object", "required": ["sorbet_config", "tapioca_rbis_committed", "ci_runs_srb_tc", "ci_runs_check_shims", "min_sigil_level"], "properties": {"sorbet_config": {"type": "string"}, "tapioca_rbis_committed": {"const": true}, "ci_runs_srb_tc": {"const": true}, "ci_runs_check_shims": {"const": true}, "min_sigil_level": {"enum": ["true", "strict", "strong"]}, "untyped_justification_required": {"const": true}}}""")
VALID_FIXTURE = json.loads(r"""{"sorbet_config": "sorbet/config", "tapioca_rbis_committed": true, "ci_runs_srb_tc": true, "ci_runs_check_shims": true, "min_sigil_level": "true", "untyped_justification_required": true}""")
INVALID_FIXTURE = json.loads(r"""{"sorbet_config": "sorbet/config", "tapioca_rbis_committed": false, "ci_runs_srb_tc": false, "min_sigil_level": "false"}""")
