#!/usr/bin/env python3
"""validate-adr-ai-drafted-with-review.py

Validate the artefact produced by the `adr-ai-drafted-with-review` methodology against the schema
...
EXPECTED_SLUG = "adr-ai-drafted-with-review"
