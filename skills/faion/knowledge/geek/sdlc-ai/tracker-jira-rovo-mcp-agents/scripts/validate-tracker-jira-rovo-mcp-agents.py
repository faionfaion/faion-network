#!/usr/bin/env python3
"""validate-tracker-jira-rovo-mcp-agents.py

Validate the config artefact for the tracker-jira-rovo-mcp-agents methodology against the schema
...
REQUIRED = ['rovo_mcp_url', 'ai_clients', 'permission_inheritance', 'native_audit_log', 'single_installation', 'scope_projects']
SCHEMA_PROPS = {'ai_clients': {'minItems': 1}, 'permission_inheritance': {'const': True}, 'native_audit_log': {'const': True}, 'single_installation': {'const': True}, 'scope_projects': {'minItems': 1}}
...
OK = {'rovo_mcp_url': 'https://acme.atlassian.net/rovo/mcp', 'ai_clients': ['claude-code', 'cursor'], 'permission_inheritance': True, 'native_audit_log': True, 'single_installation': True, 'scope_projects': ['PROJ', 'DEVOPS']}
BAD = {'rovo_mcp_url': 'https://acme.atlassian.net/rovo/mcp', 'ai_clients': [], 'permission_inheritance': False, 'native_audit_log': False, 'single_installation': False, 'scope_projects': []}
