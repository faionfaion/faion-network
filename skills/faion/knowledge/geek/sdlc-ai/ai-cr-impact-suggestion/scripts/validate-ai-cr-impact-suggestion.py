#!/usr/bin/env python3
"""validate-ai-cr-impact-suggestion.py

Validate the artefact produced by the `ai-cr-impact-suggestion` methodology against the schema
...
EXPECTED_SLUG = "ai-cr-impact-suggestion"
