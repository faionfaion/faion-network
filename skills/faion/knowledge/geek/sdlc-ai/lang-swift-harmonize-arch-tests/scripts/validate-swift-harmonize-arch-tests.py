#!/usr/bin/env python3
"""validate-swift-harmonize-arch-tests.py — validate the config artefact for the lang-swift-harmonize-arch-tests methodology.
...
SCHEMA = json.loads(r"""{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/lang-swift-harmonize-arch-tests.json", "type": "object", "required": ["harmonize_dep_pinned", "ci_runs_swift_test", "arch_test_files", "swiftlint_present"], "properties": {"harmonize_dep_pinned": {"const": true}, "ci_runs_swift_test": {"const": true}, "arch_test_files": {"type": "array", "minItems": 1, "items": {"type": "string"}}, "swiftlint_present": {"const": true}, "swift_version": {"type": "string", "pattern": "^[5-9]\\."}}}""")
VALID_FIXTURE = json.loads(r"""{"harmonize_dep_pinned": true, "ci_runs_swift_test": true, "arch_test_files": ["Tests/ArchTests/LayerBoundariesTests.swift", "Tests/ArchTests/NamingTests.swift"], "swiftlint_present": true, "swift_version": "5.9"}""")
INVALID_FIXTURE = json.loads(r"""{"harmonize_dep_pinned": false, "ci_runs_swift_test": false, "arch_test_files": []}""")
