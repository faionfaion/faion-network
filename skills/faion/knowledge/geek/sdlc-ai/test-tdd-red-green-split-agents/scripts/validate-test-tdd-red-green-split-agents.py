#!/usr/bin/env python3
"""validate-test-tdd-red-green-split-agents.py

Validate the config artefact for the test-tdd-red-green-split-agents methodology against the schema
...
REQUIRED = ['red_skill_path', 'green_skill_path', 'red_tools_allowed', 'green_tools_allowed', 'tools_disjoint', 'orchestrator_records_transition']
SCHEMA_PROPS = {'red_skill_path': {'pattern': '\\.skill\\.md$'}, 'green_skill_path': {'pattern': '\\.skill\\.md$'}, 'red_tools_allowed': {'minItems': 1}, 'green_tools_allowed': {'minItems': 1}, 'tools_disjoint': {'const': True}, 'orchestrator_records_transition': {'const': True}}
...
OK = {'red_skill_path': '.claude/skills/tdd-red.skill.md', 'green_skill_path': '.claude/skills/tdd-green.skill.md', 'red_tools_allowed': ['Read(src/)', 'Write(tests/)', 'Bash(pytest -q)'], 'green_tools_allowed': ['Read(tests/)', 'Edit(src/)', 'Bash(pytest -q)'], 'tools_disjoint': True, 'orchestrator_records_transition': True}
BAD = {'red_skill_path': 'red.md', 'green_skill_path': 'green.md', 'red_tools_allowed': ['Edit(src/)', 'Write(tests/)'], 'green_tools_allowed': ['Edit(src/)', 'Write(tests/)'], 'tools_disjoint': False, 'orchestrator_records_transition': False}
