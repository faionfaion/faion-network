<!--
purpose: Canonical skeleton for the `ai-assisted-dev` artefact.
consumes: A trigger URL + named owner + typed inputs from upstream methodologies.
produces: A committed artefact file at .product/ai-assisted-dev/<instance>.md.
depends-on: templates/header.yaml, scripts/validate-ai-assisted-dev.py.
