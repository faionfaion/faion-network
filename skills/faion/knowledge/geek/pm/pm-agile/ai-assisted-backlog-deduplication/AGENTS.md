...
maintainers: [faion]
summary: End-to-end playbook for ai assisted backlog deduplication that walks an operator from trigger to closed outcome with named artefacts at each step.
content_id: "cae0d0a6f3a525d7"
tags: [ai, playbook, pm]
---
...
**One-sentence:** End-to-end playbook for ai assisted backlog deduplication that walks an operator from trigger to closed outcome with named artefacts at each step.

**One-paragraph:** End-to-end playbook for ai assisted backlog deduplication that walks an operator from trigger to closed outcome with named artefacts at each step. geek/pm has ai-powered-pm-tools at overview level — needs a concrete recipe (embed backlog → cluster → propose merges) usable in 60 minutes.

## Applies If (ALL must hold)

- You are executing the cross-cutting workflow addressed by ai assisted backlog deduplication end to end.
