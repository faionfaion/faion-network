#!/usr/bin/env python3
"""validate-cross-team-estimation-normalisation.py — validate output artefacts against the cross-team-estimation-normalisation output contract.
...
SMOKE = {
    "artefact_id": "cross-team-estimation-normalisation-2026-05-22-001",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate cross-team-estimation-normalisation output JSON.")
