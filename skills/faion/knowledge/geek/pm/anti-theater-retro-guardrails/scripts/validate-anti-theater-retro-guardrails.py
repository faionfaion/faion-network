#!/usr/bin/env python3
"""validate-anti-theater-retro-guardrails.py — validate output artefacts against the anti-theater-retro-guardrails output contract.
...
SMOKE = {
    "artefact_id": "anti-theater-retro-guardrails-2026-05-22-001",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate anti-theater-retro-guardrails output JSON.")
