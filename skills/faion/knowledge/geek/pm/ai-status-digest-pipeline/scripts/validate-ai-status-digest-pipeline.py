#!/usr/bin/env python3
"""validate-ai-status-digest-pipeline.py — validate output artefacts against the ai-status-digest-pipeline output contract.
...
SMOKE = {
    "artefact_id": "ai-status-digest-pipeline-2026-05-22-001",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate ai-status-digest-pipeline output JSON.")
