#!/usr/bin/env python3
"""validate-ai-sprint-planning-agent.py — validate output artefacts against the ai-sprint-planning-agent output contract.
...
SMOKE = {
    "artefact_id": "ai-sprint-planning-agent-2026-05-22-001",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate ai-sprint-planning-agent output JSON.")
