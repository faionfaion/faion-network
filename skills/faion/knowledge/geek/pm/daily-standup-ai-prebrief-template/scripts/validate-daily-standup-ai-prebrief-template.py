#!/usr/bin/env python3
"""validate-daily-standup-ai-prebrief-template.py — validate output artefacts against the daily-standup-ai-prebrief-template output contract.
...
SMOKE = {
    "artefact_id": "daily-standup-ai-prebrief-template-2026-05-22-001",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate daily-standup-ai-prebrief-template output JSON.")
