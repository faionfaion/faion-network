<!--
purpose: Filled-in minimum viable example of a Compliance Traceability Pack artefact.
consumes: nothing — fixture.
produces: a worked Markdown example for tests / docs.
depends-on: content/02-output-contract.xml + templates/compliance-traceability-pack.md.
token-budget-impact: ~150 tokens.
-->

# Compliance Traceability Pack — ctp-smoke-001

- **artefact_id**: ctp-smoke-001
...
Apply the compliance-traceability-pack procedure to the pilot engagement; emit artefact bound to the scope doc.
