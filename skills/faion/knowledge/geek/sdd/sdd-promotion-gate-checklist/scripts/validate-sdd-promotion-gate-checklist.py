#!/usr/bin/env python3
"""validate-sdd-promotion-gate-checklist.py

Validate the artefact produced by the `sdd-promotion-gate-checklist` methodology against the schema
...
EXPECTED_SLUG = "sdd-promotion-gate-checklist"
