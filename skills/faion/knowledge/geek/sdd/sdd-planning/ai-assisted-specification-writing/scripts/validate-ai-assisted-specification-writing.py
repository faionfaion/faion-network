#!/usr/bin/env python3
"""validate-ai-assisted-specification-writing.py

Validate the artefact produced by the `ai-assisted-specification-writing` methodology against the schema
...
EXPECTED_SLUG = "ai-assisted-specification-writing"
