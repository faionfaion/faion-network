#!/usr/bin/env python3
"""validate-sprint-capacity-from-complexity-tags.py

Validate the artefact produced by the `sprint-capacity-from-complexity-tags` methodology against the schema
...
EXPECTED_SLUG = "sprint-capacity-from-complexity-tags"
