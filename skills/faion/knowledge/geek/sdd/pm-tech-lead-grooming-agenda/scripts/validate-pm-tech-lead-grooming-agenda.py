#!/usr/bin/env python3
"""validate-pm-tech-lead-grooming-agenda.py

Validate the artefact produced by the `pm-tech-lead-grooming-agenda` methodology against the schema
...
EXPECTED_SLUG = "pm-tech-lead-grooming-agenda"
