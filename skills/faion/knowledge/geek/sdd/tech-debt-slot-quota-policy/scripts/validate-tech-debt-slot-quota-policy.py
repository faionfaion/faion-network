#!/usr/bin/env python3
"""validate-tech-debt-slot-quota-policy.py

Validate the artefact produced by the `tech-debt-slot-quota-policy` methodology against the schema
...
EXPECTED_SLUG = "tech-debt-slot-quota-policy"
