#!/usr/bin/env python3
"""validate-architecture-repo-scaffolding-template.py

Validate the artefact produced by the `architecture-repo-scaffolding-template` methodology against the schema
...
EXPECTED_SLUG = "architecture-repo-scaffolding-template"
