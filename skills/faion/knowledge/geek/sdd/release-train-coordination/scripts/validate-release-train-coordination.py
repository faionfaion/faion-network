#!/usr/bin/env python3
"""validate-release-train-coordination.py

Validate the artefact produced by the `release-train-coordination` methodology against the schema
...
EXPECTED_SLUG = "release-train-coordination"
