#!/usr/bin/env python3
"""validate-aws-cfn-terraform-templates.py — validate artefact produced by the aws-cfn-terraform-templates methodology.
...
OK_FIXTURE = {
    "artefact_id": "aws-cfn-terraform-templates-2026-05-23-001",
...
BAD_FIXTURE = {
    "artefact_id": "aws-cfn-terraform-templates-bad",
    "owner": "team",
    "decision": "apply",
    "rationale": "obvious",
    "inputs_used": [],
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Validate AWS Infrastructure-as-Code Templates (CloudFormation and Terraform) artefact",
