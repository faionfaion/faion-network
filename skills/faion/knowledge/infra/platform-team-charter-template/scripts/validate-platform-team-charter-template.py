#!/usr/bin/env python3
"""validate-platform-team-charter-template.py — validate output artefacts against the platform-team-charter-template output contract.
...
REQUIRED = ["team_id", "mission", "customers", "scope", "anti_scope", "services", "slas", "metrics"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate platform-team-charter-template output JSON.")
