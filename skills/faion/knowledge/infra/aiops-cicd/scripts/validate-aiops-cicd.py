...
Validate the output artefact for the `aiops` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/aiops.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'aiops',
    'title': 'AIOps Anomaly + Auto-remediation Playbook',
...
BAD = {"slug": "BAD_aiops", "owner": "someone"}
