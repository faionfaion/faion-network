#!/usr/bin/env python3
"""validate-terraform-state.py — enforce the output contract for Terraform State.
...
CLI:
  ...
  python validate-terraform-state.py <artefact.json>      validate an artefact file
  python validate-terraform-state.py --help               print help
  python validate-terraform-state.py --self-test          run built-in fixture
"""
