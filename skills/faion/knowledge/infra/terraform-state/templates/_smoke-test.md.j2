<!--
purpose: smoke-test fixture for terraform-state
consumes: nothing; self-contained fixture
produces: minimum-viable filled instance; passes `scripts/validate-terraform-state.py`
depends-on: templates/spec.md
token-budget-impact: ~250 tokens
-->

# Terraform State — terraform-state-smoke-test

| Field | Value |
|-------|-------|
| artefact_id | terraform-state-smoke-test |
| produces | spec |
