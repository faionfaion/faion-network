#!/usr/bin/env python3
"""validate-cloud-run-traffic-management.py — F-066 output-contract validator for `cloud-run-traffic-management`.
...
REQUIRED = ["service", "splits", "tags", "rollout_strategy"]
...
OK_FIXTURE = {"service": "example-service", "splits": [], "tags": [], "rollout_strategy": "example-rollout_strategy"}
