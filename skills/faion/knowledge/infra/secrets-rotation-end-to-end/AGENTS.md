...
| File | Purpose |
|------|---------|
| `templates/secrets-rotation-end-to-end.md.j2` | Working skeleton for the `secrets-rotation-end-to-end` artefact with required fields and `not_applicable: <reason>` markers per row. |
| `templates/secrets-rotation-end-to-end.md` | Working skeleton for the `secrets-rotation-end-to-end` artefact with required fields and `not_applicable: <reason>` markers per row. Generated from `templates/secrets-rotation-end-to-end.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
