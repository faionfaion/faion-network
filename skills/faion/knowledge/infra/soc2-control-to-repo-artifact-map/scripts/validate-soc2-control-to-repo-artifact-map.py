#!/usr/bin/env python3
"""validate-soc2-control-to-repo-artifact-map.py — validate output artefacts against the soc2-control-to-repo-artifact-map output contract.
...
REQUIRED = ["controls", "artifact_paths", "owner", "evidence_retention", "last_verified"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate soc2-control-to-repo-artifact-map output JSON.")
