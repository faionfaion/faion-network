#!/usr/bin/env python3
"""validate-gcp-billing-cost.py — F-066 output-contract validator for `gcp-billing-cost`.

Validates a report artefact (JSON / YAML / Markdown front-matter) against the
...
REQUIRED = ["period", "projects", "top_cost_drivers", "savings_opportunities", "recommendations"]
...
OK_FIXTURE = {"period": "example-period", "projects": [], "top_cost_drivers": [], "savings_opportunities": [], "recommendations": []}
