#!/usr/bin/env python3
"""validate-aws-networking.py

Validate the output artefact for the `aws-networking` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/aws-networking.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
BAD = {"slug": "BAD_aws-networking", "owner": "someone"}
