#!/usr/bin/env python3
"""validate-backup-kubernetes-velero.py

Validate the artefact for the backup-kubernetes-velero methodology against the JSON Schema in
...
REQUIRED = ['velero_version', 'uploader_type', 'csi_enabled', 'backup_storage_location', 'schedules', 'hooks_for_stateful']

ENUMS = {  }
CONSTS = { 'uploader_type': 'kopia', 'csi_enabled': True, 'hooks_for_stateful': True }
INT_BOUNDS = {  }
ARRAY_MIN = { 'schedules': 1 }
OBJECT_REQUIRED = { 'backup_storage_location': ['kind', 'uri', 'region'] }
...
OK = {'velero_version': 'ok', 'uploader_type': 'kopia', 'csi_enabled': True, 'backup_storage_location': {'kind': 's3', 'uri': 'x', 'region': 'x'}, 'schedules': ['x'], 'hooks_for_stateful': True}
BAD = {'velero_version': None}
