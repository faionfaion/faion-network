#!/usr/bin/env python3
"""validate-gcp-storage-cdn.py

Validate a `config` artefact for the gcp-storage-cdn methodology against the
...
OK = {'slug': 'gcp-storage-cdn', 'version': '1.0.0', 'settings': {'key1': 'value1', 'key2': 'value2', 'key3': 'value3'}, 'applied_to': ['prod'], 'notes': 'Generated by gcp-storage-cdn methodology.'}
BAD = {'slug': 'gcp-storage-cdn'}
