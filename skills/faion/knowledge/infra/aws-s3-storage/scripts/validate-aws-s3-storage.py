#!/usr/bin/env python3
"""validate-aws-s3-storage.py

Validate the output artefact for the `aws-s3-storage` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/aws-s3-storage.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
BAD = {"slug": "BAD_aws-s3-storage", "owner": "someone"}
