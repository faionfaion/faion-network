#!/usr/bin/env python3
"""validate-rotation-evidence-template.py

Validate the output artefact for the `rotation-evidence-template` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#',
 '$id': 'https://faion.net/schemas/rotation-evidence-template.json',
 'type': 'object',
 'required': ['slug',
              'title',
              'owner',
...
OK = {'slug': 'rotation-evidence-template',
 'title': 'Rotation Evidence Template',
