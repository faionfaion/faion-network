#!/usr/bin/env python3
"""validate-aws-multi-account-landing-zone.py

Validate the output artefact for the `aws-multi-account-landing-zone` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/aws-multi-account-landing-zone.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'aws-multi-account-landing-zone',
...
BAD = {"slug": "BAD_aws-multi-account-landing-zone", "owner": "someone"}
