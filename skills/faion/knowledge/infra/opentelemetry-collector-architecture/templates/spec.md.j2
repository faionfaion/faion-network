<!--
purpose: OpenTelemetry Collector Architecture - spec skeleton matching `produces=spec`
consumes: typed inputs from AGENTS.md Prerequisites table
produces: filled spec artefact validated by scripts/validate-opentelemetry-collector-architecture.py
