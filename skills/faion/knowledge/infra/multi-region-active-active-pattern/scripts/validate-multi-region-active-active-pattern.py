#!/usr/bin/env python3
"""validate-multi-region-active-active-pattern.py — validate output artefacts against the multi-region-active-active-pattern output contract.
...
REQUIRED = ["regions", "data_classes", "consistency_model", "conflict_policy", "drill_cadence"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate multi-region-active-active-pattern output JSON.")
