#!/usr/bin/env python3
"""validate-per-client-credential-isolation-pattern.py

Validate the output artefact for the `per-client-credential-isolation-pattern` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#',
 '$id': 'https://faion.net/schemas/per-client-credential-isolation-pattern.json',
 'type': 'object',
 'required': ['slug',
              'title',
              'owner',
...
OK = {'slug': 'per-client-credential-isolation-pattern',
 'title': 'Per-Client Credential Isolation Pattern',
