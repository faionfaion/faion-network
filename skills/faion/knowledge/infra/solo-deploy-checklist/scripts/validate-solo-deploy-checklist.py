#!/usr/bin/env python3
"""validate-solo-deploy-checklist.py — validate a solo-deploy-checklist output JSON against the methodology schema.
...
REQUIRED = ["artefact_id", "version", "last_reviewed", "commit_sha", "rollback_plan", "tests_green", "backup_taken", "deploy_window", "owner"]
ENUMS = {}
...
ARRAY_FIELDS = []
OBJECT_FIELDS = []
BOOL_FIELDS = ["tests_green", "backup_taken", "migration"]
STRING_FIELDS = ["artefact_id", "commit_sha", "rollback_plan", "deploy_window", "owner"]
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"deploy-faion-net-2026-05-23\", \"version\": \"1.1.0\", \"last_reviewed\": \"2026-05-23\", \"commit_sha\": \"9f1c2a4\", \"rollback_plan\": \"git revert + ./deploy-be.sh prev_tag\", \"tests_green\": true, \"backup_taken\": true, \"deploy_window\": \"tuesday-morning\", \"migration\": true, \"owner\": \"@ruslan\"}")
INVALID_FIXTURE = json.loads("{\"commit_sha\": \"9f1c2a4\", \"rollback_plan\": \"\", \"tests_green\": false, \"deploy_window\": \"friday-evening\", \"owner\": \"team\"}")
