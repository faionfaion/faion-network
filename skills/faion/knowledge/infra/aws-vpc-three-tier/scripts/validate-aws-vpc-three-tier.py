#!/usr/bin/env python3
"""validate-aws-vpc-three-tier.py

Validate the output artefact for the `aws-vpc-three-tier` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/aws-vpc-three-tier.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'aws-vpc-three-tier',
    'title': 'AWS VPC Three-Tier',
...
BAD = {"slug": "BAD_aws-vpc-three-tier", "owner": "someone"}
