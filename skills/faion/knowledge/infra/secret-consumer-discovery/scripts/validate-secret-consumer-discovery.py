#!/usr/bin/env python3
"""validate-secret-consumer-discovery.py

Validate the output artefact for the `secret-consumer-discovery` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#',
 '$id': 'https://faion.net/schemas/secret-consumer-discovery.json',
 'type': 'object',
 'required': ['slug',
              'title',
              'owner',
...
OK = {'slug': 'secret-consumer-discovery',
 'title': 'Secret Consumer Discovery',
