...
| File | Purpose |
|------|---------|
| `templates/secret-consumer-discovery.md.j2` | Working skeleton for the `secret-consumer-discovery` artefact with required fields and `not_applicable: <reason>` markers per row. |
| `templates/secret-consumer-discovery.md` | Working skeleton for the `secret-consumer-discovery` artefact with required fields and `not_applicable: <reason>` markers per row. Generated from `templates/secret-consumer-discovery.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
