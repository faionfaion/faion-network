...
| File | Purpose |
|------|---------|
| `templates/vendor-lock-in-audit-checklist.md.j2` | Working skeleton for the `vendor-lock-in-audit-checklist` artefact with required fields and `not_applicable: <reason>` markers per row. |
| `templates/vendor-lock-in-audit-checklist.md` | Working skeleton for the `vendor-lock-in-audit-checklist` artefact with required fields and `not_applicable: <reason>` markers per row. Generated from `templates/vendor-lock-in-audit-checklist.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
