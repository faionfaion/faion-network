...
| File | Purpose |
|------|---------|
| `templates/gcp-arch-patterns.md.j2` | Skeleton for the spec artefact this methodology produces. |
| `templates/gcp-arch-patterns.md` | Skeleton for the spec artefact this methodology produces. Generated from `templates/gcp-arch-patterns.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
