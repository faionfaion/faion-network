#!/usr/bin/env python3
"""validate-gcp-arch-patterns.py — F-066 output-contract validator for `gcp-arch-patterns`.
...
REQUIRED = ["pattern", "components", "rationale", "ha_strategy", "security_controls"]
...
OK_FIXTURE = {"pattern": "example-pattern", "components": [], "rationale": "example-rationale", "ha_strategy": "example-ha_strategy", "security_controls": "example-security_controls"}
