#!/usr/bin/env python3
"""validate-cronjob-overrun-monitoring.py — validate artefact produced by the cronjob-overrun-monitoring methodology.
...
OK_FIXTURE = {
    "artefact_id": "cronjob-overrun-monitoring-2026-05-23-001",
...
BAD_FIXTURE = {
    "artefact_id": "cronjob-overrun-monitoring-bad",
    "owner": "team",
    "decision": "apply",
    "rationale": "obvious",
    "inputs_used": [],
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Validate Cronjob Overrun Monitoring artefact",
