#!/usr/bin/env python3
"""validate-action-item-stale-aging.py — validate artefact produced by the action-item-stale-aging methodology.
...
OK_FIXTURE = {
    "artefact_id": "action-item-stale-aging-2026-05-23-001",
...
BAD_FIXTURE = {
    "artefact_id": "action-item-stale-aging-bad",
    "owner": "team",
    "decision": "apply",
    "rationale": "obvious",
    "inputs_used": [],
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Validate Action Item Stale Aging artefact",
