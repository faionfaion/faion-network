#!/usr/bin/env python3
"""validate-gcp-compute-gke.py — F-066 output-contract validator for `gcp-compute-gke`.
...
REQUIRED = ["name", "mode", "region", "node_pools", "workload_identity", "private_nodes"]
...
OK_FIXTURE = {"name": "example-name", "mode": "example-mode", "region": "example-region", "node_pools": [], "workload_identity": True, "private_nodes": True}
