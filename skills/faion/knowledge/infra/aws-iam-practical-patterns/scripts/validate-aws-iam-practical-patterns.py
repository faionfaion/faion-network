#!/usr/bin/env python3
"""validate-aws-iam-practical-patterns.py

Validate the output artefact for the `aws-iam-practical-patterns` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/aws-iam-practical-patterns.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'aws-iam-practical-patterns',
    'title': 'AWS IAM Practical Patterns',
...
BAD = {"slug": "BAD_aws-iam-practical-patterns", "owner": "someone"}
