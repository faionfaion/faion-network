#!/usr/bin/env python3
"""validate-azure-private-link.py

Validate the output artefact for the `azure-private-link` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/azure-private-link.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
BAD = {"slug": "BAD_azure-private-link", "owner": "someone"}
