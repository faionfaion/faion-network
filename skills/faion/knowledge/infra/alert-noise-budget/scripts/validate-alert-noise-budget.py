#!/usr/bin/env python3
"""validate-alert-noise-budget.py — validate artefact produced by the alert-noise-budget methodology.
...
OK_FIXTURE = {
    "artefact_id": "alert-noise-budget-2026-05-23-001",
...
BAD_FIXTURE = {
    "artefact_id": "alert-noise-budget-bad",
    "owner": "team",
    "decision": "apply",
    "rationale": "obvious",
    "inputs_used": [],
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Validate Alert Noise Budget artefact",
