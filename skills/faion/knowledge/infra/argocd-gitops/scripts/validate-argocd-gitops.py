#!/usr/bin/env python3
"""validate-argocd-gitops.py — validate artefact produced by the argocd-gitops methodology.
...
OK_FIXTURE = {
    "artefact_id": "argocd-gitops-2026-05-23-001",
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Validate ArgoCD GitOps for Kubernetes Deployments artefact",
