#!/usr/bin/env python3
"""validate-rto-rpo-tracking-board.py

Validate the output artefact for the `rto-rpo-tracking-board` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#',
 '$id': 'https://faion.net/schemas/rto-rpo-tracking-board.json',
 'type': 'object',
 'required': ['slug',
              'title',
              'owner',
...
OK = {'slug': 'rto-rpo-tracking-board',
 'title': 'RTO/RPO Tracking Board',
