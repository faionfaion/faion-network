...
| File | Purpose |
|------|---------|
| `templates/rto-rpo-tracking-board.md.j2` | Working skeleton for the `rto-rpo-tracking-board` artefact with required fields and `not_applicable: <reason>` markers per row. |
| `templates/rto-rpo-tracking-board.md` | Working skeleton for the `rto-rpo-tracking-board` artefact with required fields and `not_applicable: <reason>` markers per row. Generated from `templates/rto-rpo-tracking-board.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
