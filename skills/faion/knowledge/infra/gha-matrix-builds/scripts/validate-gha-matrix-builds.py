#!/usr/bin/env python3
"""validate-gha-matrix-builds.py

Validate the artefact produced by the `gha-matrix-builds` methodology against the
...
REQUIRED = ['axes', 'include', 'exclude', 'fail_fast', 'max_parallel', 'artifact_naming_pattern', 'owner', 'last_reviewed']
...
OK = json.loads("{\"axes\": {\"os\": [\"ubuntu-latest\", \"macos-latest\", \"windows-latest\"], \"python-version\": [\"3.10\", \"3.11\", \"3.12\"]}, \"include\": [{\"os\": \"ubuntu-latest\", \"python-version\": \"3.12\", \"experimental\": true}], \"exclude\": [{\"os\": \"macos-latest\", \"python-version\": \"3.10\"}], \"fail_fast\": false, \"max_parallel\": 6, \"artifact_naming_pattern\": \"coverage-${{ matrix.os }}-${{ matrix.python-version }}\", \"owner\": \"ci-lead@team.io\", \"last_reviewed\": \"2026-05-23\"}")
BAD = json.loads("{\"axes\": null, \"owner\": \"team\"}")
