<!--
purpose: On-Call Handoff Template - report skeleton matching `produces=report`
consumes: typed inputs from AGENTS.md Prerequisites table
produces: filled report artefact validated by scripts/validate-on-call-handoff-template.py
