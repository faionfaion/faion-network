#!/usr/bin/env python3
"""validate-finops-devops-cost-commitments.py

Validate a `decision-record` artefact for the finops-devops-cost-commitments methodology against the
...
OK = {'slug': 'finops-devops-cost-commitments', 'title': 'Finops Devops Cost Commitments', 'context': 'Selecting commitment strategy for the next 12 months of compute baseline.', 'options': [{'id': 'o1', 'name': 'Standard RI'}, {'id': 'o2', 'name': 'Compute Savings Plan'}], 'decision': 'Choose Compute Savings Plan at 55% of 5th percentile floor.', 'consequences': ['Locks $X/yr discount', 'Re-evaluate quarterly']}
BAD = {'slug': 'finops-devops-cost-commitments'}
