#!/usr/bin/env python3
"""validate-gcp-networking.py — F-066 output-contract validator for `gcp-networking`.
...
REQUIRED = ["vpc_topology", "lb_strategy", "egress", "private_services", "firewall_strategy"]
...
OK_FIXTURE = {"vpc_topology": "example-vpc_topology", "lb_strategy": "example-lb_strategy", "egress": "example-egress", "private_services": "example-private_services", "firewall_strategy": "example-firewall_strategy"}
