#!/usr/bin/env python3
"""validate-cost-model-spreadsheet-template.py — validate artefact produced by the cost-model-spreadsheet-template methodology.
...
OK_FIXTURE = {
    "artefact_id": "cost-model-spreadsheet-template-2026-05-23-001",
...
BAD_FIXTURE = {
    "artefact_id": "cost-model-spreadsheet-template-bad",
    "owner": "team",
    "decision": "apply",
    "rationale": "obvious",
    "inputs_used": [],
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Validate Cost-Model Spreadsheet Template artefact",
