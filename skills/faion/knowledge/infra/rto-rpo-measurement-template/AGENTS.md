...
| File | Purpose |
|------|---------|
| `templates/rto-rpo-measurement-template.md.j2` | Working skeleton for the `rto-rpo-measurement-template` artefact with required fields and `not_applicable: <reason>` markers per row. |
| `templates/rto-rpo-measurement-template.md` | Working skeleton for the `rto-rpo-measurement-template` artefact with required fields and `not_applicable: <reason>` markers per row. Generated from `templates/rto-rpo-measurement-template.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
