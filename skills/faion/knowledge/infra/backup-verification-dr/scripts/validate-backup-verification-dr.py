#!/usr/bin/env python3
"""validate-backup-verification-dr.py

Validate the artefact for the backup-verification-dr methodology against the JSON Schema in
...
REQUIRED = ['drill_schedule', 'metrics', 'alerts', 'runbook_path', 'last_drill_pass']

ENUMS = {  }
CONSTS = {  }
INT_BOUNDS = {  }
ARRAY_MIN = { 'metrics': 3, 'alerts': 3 }
OBJECT_REQUIRED = { 'drill_schedule': ['cron', 'rpo_seconds_target', 'rto_seconds_target'] }
...
OK = {'drill_schedule': {'cron': 'x', 'rpo_seconds_target': 'x', 'rto_seconds_target': 'x'}, 'metrics': ['x', 'x', 'x'], 'alerts': ['x', 'x', 'x'], 'runbook_path': 'ok', 'last_drill_pass': 'ok'}
BAD = {'drill_schedule': None}
