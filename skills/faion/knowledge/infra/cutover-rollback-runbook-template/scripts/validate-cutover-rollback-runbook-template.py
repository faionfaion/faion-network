#!/usr/bin/env python3
"""validate-cutover-rollback-runbook-template.py — validate artefact produced by the cutover-rollback-runbook-template methodology.
...
OK_FIXTURE = {
    "artefact_id": "cutover-rollback-runbook-template-2026-05-23-001",
...
BAD_FIXTURE = {
    "artefact_id": "cutover-rollback-runbook-template-bad",
    "owner": "team",
    "decision": "apply",
    "rationale": "obvious",
    "inputs_used": [],
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Validate Cutover Rollback Runbook Template artefact",
