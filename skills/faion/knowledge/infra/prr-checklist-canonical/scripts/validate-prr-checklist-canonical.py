#!/usr/bin/env python3
"""validate-prr-checklist-canonical.py

Validate the output artefact for the `prr-checklist-canonical` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#',
 '$id': 'https://faion.net/schemas/prr-checklist-canonical.json',
 'type': 'object',
 'required': ['slug',
              'title',
              'owner',
...
OK = {'slug': 'prr-checklist-canonical',
 'title': 'PRR Checklist Canonical',
