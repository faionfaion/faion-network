<!--
purpose: PCI-DSS Vendor Evidence Pack - report skeleton matching `produces=report`
consumes: typed inputs from AGENTS.md Prerequisites table
produces: filled report artefact validated by scripts/validate-pci-dss-vendor-evidence-pack.py
depends-on: content/01-core-rules.xml, content/02-output-contract.xml
token-budget-impact: ~600 tokens for a typical instance
-->
# PCI-DSS Vendor Evidence Pack — {artefact_id}
