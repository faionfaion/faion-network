#!/usr/bin/env python3
"""validate-azure-vnet-hub-spoke.py

Validate the output artefact for the `azure-vnet-hub-spoke` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/azure-vnet-hub-spoke.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'azure-vnet-hub-spoke',
    'title': 'Azure VNet Hub-Spoke Topology',
...
BAD = {"slug": "BAD_azure-vnet-hub-spoke", "owner": "someone"}
