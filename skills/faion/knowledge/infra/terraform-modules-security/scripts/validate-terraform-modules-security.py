#!/usr/bin/env python3
"""validate-terraform-modules-security.py — enforce the output contract for Terraform Modules — Security.
...
CLI:
  ...
  python validate-terraform-modules-security.py <artefact.json>      validate an artefact file
  python validate-terraform-modules-security.py --help               print help
  python validate-terraform-modules-security.py --self-test          run built-in fixture
"""
