...
| File | Purpose |
|------|---------|
| `templates/report.md.j2` | working skeleton matching the `produces=report` shape |
| `templates/report.md` | working skeleton matching the `produces=report` shape Generated from `templates/report.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
