...
|----------|------|-------------|--------------|--------|
| <instance_id> | EC2 | 2% CPU | [$XXX] | Schedule stop or terminate |
| <db_id> | RDS | 5% CPU | [$XXX] | Downsize to t3.small |
...
- [ ] Engineering: implement S3 lifecycle policy for <bucket_names>
