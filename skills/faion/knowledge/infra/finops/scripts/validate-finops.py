...
Validate the artefact produced by the `finops` methodology against the
...
REQUIRED = ['phases', 'tagging_coverage_pct', 'anomaly_alerts', 'commitments', 'per_team_accountability', 'owner', 'last_reviewed']
...
OK = json.loads('{"phases": ["inform", "optimize", "operate"], "tagging_coverage_pct": 92, "anomaly_alerts": {"enabled": true, "ack_sla_hours": 24}, "commitments": {"strategy": "savings_plans_70pct_coverage", "baseline_days": 90}, "per_team_accountability": true, "owner": "finops@acme.io", "last_reviewed": "2026-05-23"}')
BAD = json.loads('{"phases": ["optimize"], "owner": "team"}')
