#!/usr/bin/env python3
"""validate-capacity-safety-floor-policy.py

Validate the output artefact for the `capacity-safety-floor-policy` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/capacity-safety-floor-policy.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'capacity-safety-floor-policy',
    'title': 'Capacity Safety-Floor Policy',
...
BAD = {"slug": "BAD_capacity-safety-floor-policy", "owner": "someone"}
