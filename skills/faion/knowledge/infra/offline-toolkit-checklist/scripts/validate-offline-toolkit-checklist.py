#!/usr/bin/env python3
"""validate-offline-toolkit-checklist.py

Validate the output artefact for the `offline-toolkit-checklist` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/offline-toolkit-checklist.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'offline-toolkit-checklist',
    'title': 'Offline Toolkit Checklist',
