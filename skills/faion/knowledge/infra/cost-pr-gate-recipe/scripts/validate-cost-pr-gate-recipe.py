#!/usr/bin/env python3
"""validate-cost-pr-gate-recipe.py — validate artefact produced by the cost-pr-gate-recipe methodology.
...
OK_FIXTURE = {
    "artefact_id": "cost-pr-gate-recipe-2026-05-23-001",
...
BAD_FIXTURE = {
    "artefact_id": "cost-pr-gate-recipe-bad",
    "owner": "team",
    "decision": "apply",
    "rationale": "obvious",
    "inputs_used": [],
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Validate Cost PR Gate Recipe artefact",
