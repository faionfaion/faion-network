#!/usr/bin/env python3
"""validate-aiops.py — validate artefact produced by the aiops methodology.
...
OK_FIXTURE = {
    "artefact_id": "aiops-2026-05-23-001",
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Validate AIOps: ML-Powered Incident Detection and Auto-Remediation artefact",
