...
| File | Purpose |
|------|---------|
| `templates/scheduled-job-decommission-checklist.md.j2` | Working skeleton for the `scheduled-job-decommission-checklist` artefact with required fields and `not_applicable: <reason>` markers per row. |
| `templates/scheduled-job-decommission-checklist.md` | Working skeleton for the `scheduled-job-decommission-checklist` artefact with required fields and `not_applicable: <reason>` markers per row. Generated from `templates/scheduled-job-decommission-checklist.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
