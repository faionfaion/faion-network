#!/usr/bin/env python3
"""validate-regulated-incident-response-protocol.py

Validate the output artefact for the `regulated-incident-response-protocol` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#',
 '$id': 'https://faion.net/schemas/regulated-incident-response-protocol.json',
 'type': 'object',
 'required': ['slug',
              'title',
              'owner',
...
OK = {'slug': 'regulated-incident-response-protocol',
 'title': 'Regulated Incident Response Protocol',
 ...
 'steps': [{'n': 1,
            'name': 'scope-check',
            'action': 'Verify Applies-If preconditions.',
            'owner': 'lead-engineer'},
           {'n': 2,
            'name': 'execute',
            'action': 'Run the playbook body.',
            'owner': 'lead-engineer'}]}
