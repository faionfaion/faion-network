#!/usr/bin/env python3
"""validate-opentelemetry-instrumentation-playbook.py — enforce the output contract for OpenTelemetry Instrumentation Playbook.
...
CLI:
  ...
  python validate-opentelemetry-instrumentation-playbook.py <artefact.json>      validate an artefact file
  python validate-opentelemetry-instrumentation-playbook.py --help               print help
  python validate-opentelemetry-instrumentation-playbook.py --self-test          run built-in fixture
"""
...
EXPECTED_PRODUCES = "playbook-step"
