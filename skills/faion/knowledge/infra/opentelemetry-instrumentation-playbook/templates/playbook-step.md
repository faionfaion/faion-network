<!--
purpose: OpenTelemetry Instrumentation Playbook - playbook-step skeleton matching `produces=playbook-step`
consumes: typed inputs from AGENTS.md Prerequisites table
produces: filled playbook-step artefact validated by scripts/validate-opentelemetry-instrumentation-playbook.py
