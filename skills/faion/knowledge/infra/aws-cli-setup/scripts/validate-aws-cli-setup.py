#!/usr/bin/env python3
"""validate-aws-cli-setup.py

Validate the output artefact for the `aws-cli-setup` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/aws-cli-setup.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
BAD = {"slug": "BAD_aws-cli-setup", "owner": "someone"}
