#!/usr/bin/env python3
"""validate-gce-managed-instance-groups.py — F-066 output-contract validator for `gce-managed-instance-groups`.
...
REQUIRED = ["name", "template", "placement", "target_size", "rolling_update", "health_check"]
...
OK_FIXTURE = {"name": "example-name", "template": "example-template", "placement": "example-placement", "target_size": 1, "rolling_update": "example-rolling_update", "health_check": "example-health_check"}
