#!/usr/bin/env python3
"""validate-backup-basics.py

Validate the output artefact for the `backup-basics` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/backup-basics.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'backup-basics',
    'title': 'Backup Strategy Basics (3-2-1-1-0 + RPO/RTO)',
...
BAD = {"slug": "BAD_backup-basics", "owner": "someone"}
