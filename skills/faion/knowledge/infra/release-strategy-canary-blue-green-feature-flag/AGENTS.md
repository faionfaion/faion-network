...
| File | Purpose |
|------|---------|
| `templates/release-strategy-canary-blue-green-feature-flag.md.j2` | Working skeleton for the `release-strategy-canary-blue-green-feature-flag` artefact with required fields and `not_applicable: <reason>` markers per row. |
| `templates/release-strategy-canary-blue-green-feature-flag.md` | Working skeleton for the `release-strategy-canary-blue-green-feature-flag` artefact with required fields and `not_applicable: <reason>` markers per row. Generated from `templates/release-strategy-canary-blue-green-feature-flag.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
