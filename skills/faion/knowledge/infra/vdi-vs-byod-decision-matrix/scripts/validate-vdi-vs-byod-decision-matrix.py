#!/usr/bin/env python3
"""validate-vdi-vs-byod-decision-matrix.py

Validate the output artefact for the `vdi-vs-byod-decision-matrix` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#',
 '$id': 'https://faion.net/schemas/vdi-vs-byod-decision-matrix.json',
 'type': 'object',
 'required': ['slug',
              'title',
              'owner',
...
OK = {'slug': 'vdi-vs-byod-decision-matrix',
 'title': 'VDI vs BYOD Decision Matrix',
