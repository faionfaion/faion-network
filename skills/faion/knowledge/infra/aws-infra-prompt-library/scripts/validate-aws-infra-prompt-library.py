#!/usr/bin/env python3
"""validate-aws-infra-prompt-library.py

Validate the output artefact for the `aws-infra-prompt-library` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/aws-infra-prompt-library.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'aws-infra-prompt-library',
    'title': 'AWS Infra Prompt Library',
...
BAD = {"slug": "BAD_aws-infra-prompt-library", "owner": "someone"}
