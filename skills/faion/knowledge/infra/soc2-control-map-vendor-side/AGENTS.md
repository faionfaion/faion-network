...
| File | Purpose |
|------|---------|
| `templates/soc2-control-map-vendor-side.md.j2` | Working skeleton for the `soc2-control-map-vendor-side` artefact with required fields and `not_applicable: <reason>` markers per row. |
| `templates/soc2-control-map-vendor-side.md` | Working skeleton for the `soc2-control-map-vendor-side` artefact with required fields and `not_applicable: <reason>` markers per row. Generated from `templates/soc2-control-map-vendor-side.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
