#!/usr/bin/env python3
"""validate-devops-lb-health-checks.py

Validate the artefact produced by the `devops-lb-health-checks` methodology against the
...
REQUIRED = ['liveness', 'readiness', 'tuning', 'language_impl', 'owner', 'last_reviewed']
...
OK = json.loads('{"liveness": {"path": "/healthz", "method": "GET", "expect_status": 200}, "readiness": {"path": "/ready", "method": "GET", "expect_status": 200, "deps_checked": ["postgres", "redis"]}, "tuning": {"interval_s": 10, "timeout_ms": 500, "fall": 3, "rise": 2}, "language_impl": "python_fastapi", "owner": "sre@acme.io", "last_reviewed": "2026-05-23"}')
BAD = json.loads('{"liveness": {"path": "/healthz"}, "owner": "team"}')
