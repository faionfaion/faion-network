...
Validate a `code` artefact for the helm-charts methodology against the
...
OK = {'slug': 'helm-charts', 'language': 'yaml', 'entrypoint': 'Chart.yaml', 'files': ['Chart.yaml', 'values.yaml', 'templates/deployment.yaml'], 'build_command': 'helm lint .', 'test_command': 'helm template . | kubeconform -'}
BAD = {'slug': 'helm-charts'}
