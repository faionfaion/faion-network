...
| File | Purpose |
|------|---------|
| `templates/secret-rotation-drill-runbook.md.j2` | Working skeleton for the `secret-rotation-drill-runbook` artefact with required fields and `not_applicable: <reason>` markers per row. |
| `templates/secret-rotation-drill-runbook.md` | Working skeleton for the `secret-rotation-drill-runbook` artefact with required fields and `not_applicable: <reason>` markers per row. Generated from `templates/secret-rotation-drill-runbook.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
