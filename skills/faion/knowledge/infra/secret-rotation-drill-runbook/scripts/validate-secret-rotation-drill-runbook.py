#!/usr/bin/env python3
"""validate-secret-rotation-drill-runbook.py

Validate the output artefact for the `secret-rotation-drill-runbook` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#',
 '$id': 'https://faion.net/schemas/secret-rotation-drill-runbook.json',
 'type': 'object',
 'required': ['slug',
              'title',
              'owner',
...
OK = {'slug': 'secret-rotation-drill-runbook',
 'title': 'Secret Rotation Drill Runbook',
