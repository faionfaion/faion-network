#!/usr/bin/env python3
"""validate-slo-design-from-user-journeys.py

Validate the output artefact for the `slo-design-from-user-journeys` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#',
 '$id': 'https://faion.net/schemas/slo-design-from-user-journeys.json',
 'type': 'object',
 'required': ['slug',
              'title',
              'owner',
...
OK = {'slug': 'slo-design-from-user-journeys',
 'title': 'SLO Design From User Journeys',
 ...
 'sections': [{'title': 'Scope',
               'body': 'What this artefact covers and what it explicitly excludes.'},
              {'title': 'Findings',
               'body': 'Observed values, evidence anchors, and named decisions.'}]}
