#!/usr/bin/env python3
"""validate-k8s-vpa-rightsizing-runbook.py — enforce the output contract for K8s VPA Rightsizing Runbook.
...
CLI:
  ...
  python validate-k8s-vpa-rightsizing-runbook.py <artefact.json>      validate an artefact file
  python validate-k8s-vpa-rightsizing-runbook.py --help               print help
  python validate-k8s-vpa-rightsizing-runbook.py --self-test          run built-in fixture
"""
