<!--
purpose: K8s VPA Rightsizing Runbook - report skeleton matching `produces=report`
consumes: typed inputs from AGENTS.md Prerequisites table
produces: filled report artefact validated by scripts/validate-k8s-vpa-rightsizing-runbook.py
depends-on: content/01-core-rules.xml, content/02-output-contract.xml
token-budget-impact: ~600 tokens for a typical instance
-->
# K8s VPA Rightsizing Runbook — {artefact_id}
