#!/usr/bin/env python3
"""validate-claude-code-hooks.py — validate output artefacts against the claude-code-hooks output contract.
...
REQUIRED = ["hooks", "scope", "events", "commands"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate claude-code-hooks output JSON.")
