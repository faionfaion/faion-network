#!/usr/bin/env python3
"""validate-multi-burn-rate-slo-recipe.py — validate output artefacts against the multi-burn-rate-slo-recipe output contract.
...
REQUIRED = ["slo_name", "windows", "burn_rates", "alert_routes", "runbook_url"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate multi-burn-rate-slo-recipe output JSON.")
