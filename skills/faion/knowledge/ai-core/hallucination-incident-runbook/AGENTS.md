...
| `templates/hallucination-incident-runbook.md.j2` | Markdown skeleton with required fields |
| `templates/hallucination-incident-runbook.md` | Markdown skeleton with required fields Generated from `templates/hallucination-incident-runbook.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/hallucination-incident-runbook.json`

```json
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://faion.network/schema/hallucination-incident-runbook.json",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
