...
| `templates/hallucination-detection-online.md.j2` | Markdown skeleton with required fields |
| `templates/hallucination-detection-online.md` | Markdown skeleton with required fields Generated from `templates/hallucination-detection-online.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/hallucination-detection-online.json`

```json
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://faion.network/schema/hallucination-detection-online.json",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
