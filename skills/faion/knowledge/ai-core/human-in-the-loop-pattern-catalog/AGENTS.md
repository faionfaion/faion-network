...
| `templates/human-in-the-loop-pattern-catalog.md.j2` | Markdown skeleton with required fields |
| `templates/human-in-the-loop-pattern-catalog.md` | Markdown skeleton with required fields Generated from `templates/human-in-the-loop-pattern-catalog.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/human-in-the-loop-pattern-catalog.json`

```json
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://faion.network/schema/human-in-the-loop-pattern-catalog.json",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
