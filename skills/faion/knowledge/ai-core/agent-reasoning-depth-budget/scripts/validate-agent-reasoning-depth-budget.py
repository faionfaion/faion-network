#!/usr/bin/env python3
"""validate-agent-reasoning-depth-budget.py — validate output artefacts against the agent-reasoning-depth-budget output contract.
...
REQUIRED = ['task_budgets', 'pareto_pick_budget', 'under_thinking_pct', 'over_thinking_pct', 'inter_turn_compression_tokens', 'forbidden_seen']
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate agent-reasoning-depth-budget output JSON.")
