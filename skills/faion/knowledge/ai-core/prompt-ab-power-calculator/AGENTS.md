...
| `templates/power-calc-spec.md.j2` | Narrative review draft. |
| `templates/power-calc-spec.md` | Narrative review draft. Generated from `templates/power-calc-spec.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
