<!-- purpose: Spec skeleton for corpus policy -->
...
_Skeleton for the `agent-context-engineering-corpus-standard` methodology output. Fill each section; do not leave headings empty._
...
- Timestamp
- Validator run: `python scripts/validate-agent-context-engineering-corpus-standard.py --file out.json`
