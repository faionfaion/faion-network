#!/usr/bin/env python3
"""validate-agent-eval-test-set-curation.py — validate output artefacts against the agent-eval-test-set-curation output contract.
...
REQUIRED = ['trajectory_count', 'real_trace_fraction', 'tag_schema', 'partition', 'version_control_path', 'forbidden_seen']
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate agent-eval-test-set-curation output JSON.")
