#!/usr/bin/env python3
"""Validate a refusal-field-strict-schema spec JSON.

Usage: validate-refusal-field-strict-schema.py <file.json> | --self-test | --help
...
DEC = ["schema_path", "strict_mode", "refusal_branch_code"]
DRV = ["api_flavor", "production_refusal_rate", "downstream_consumer_count"]
...
def _self_test() -> int:
    good = {
        ...
        "audit": {"rule_refs": ["r1-top-level-refusal"]},
    }
