#!/usr/bin/env python3
"""Validate a llamaindex-production-gotchas decision-record against the embedded schema.

Usage:
    validate-llamaindex-production-gotchas.py <file.json>
    validate-llamaindex-production-gotchas.py --self-test
    validate-llamaindex-production-gotchas.py --help
...
DECISION_REQUIRED = ['async_fixes', 'concurrency_caps', 'agent_wraps', 'eval_sampling', 'callback_handlers']
DRIVERS_REQUIRED = ['async', 'components_used', 'cost_cap_per_turn_usd']
