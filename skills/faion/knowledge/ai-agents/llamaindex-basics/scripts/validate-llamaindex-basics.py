#!/usr/bin/env python3
"""Validate a llamaindex-basics decision-record against the embedded schema.

Usage:
    validate-llamaindex-basics.py <file.json>
    validate-llamaindex-basics.py --self-test
    validate-llamaindex-basics.py --help
...
DECISION_REQUIRED = ['loader', 'node_parser', 'chunk_size', 'embedding_model', 'vectorstore', 'persistence_path']
DRIVERS_REQUIRED = ['doc_count', 'avg_doc_chars', 'query_pattern', 'persistence_target']
