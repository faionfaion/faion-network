#!/usr/bin/env python3
"""validate-agent-ga-readiness-checklist.py — validate output artefacts against the agent-ga-readiness-checklist output contract.
...
REQUIRED = ['items', 'eval_bar_passed', 'rollback_tested', 'kill_switch_tested', 'date', 'signer', 'forbidden_seen']
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate agent-ga-readiness-checklist output JSON.")
