#!/usr/bin/env python3
"""Validate a max-turns-circuit-breaker decision-record against the embedded schema.

Usage:
    validate-max-turns-circuit-breaker.py <file.json>
    validate-max-turns-circuit-breaker.py --self-test
    validate-max-turns-circuit-breaker.py --help
...
DECISION_REQUIRED = ['max_turns', 'recovery_model', 'fallback_message_template', 'log_partial_trajectory']
DRIVERS_REQUIRED = ['agent_kind', 'per_turn_cost_usd']
