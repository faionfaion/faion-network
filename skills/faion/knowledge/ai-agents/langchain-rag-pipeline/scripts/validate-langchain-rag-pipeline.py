#!/usr/bin/env python3
"""Validate a langchain-rag-pipeline decision-record against the embedded schema.

Usage:
    validate-langchain-rag-pipeline.py <file.json>
    validate-langchain-rag-pipeline.py --self-test
    validate-langchain-rag-pipeline.py --help
...
DECISION_REQUIRED = ['loader', 'splitter', 'chunk_size', 'embedding_model', 'vectorstore', 'retriever_k', 'prompt_template']
DRIVERS_REQUIRED = ['doc_count', 'avg_doc_chars', 'query_pattern', 'latency_budget_ms']
