#!/usr/bin/env python3
"""Validate a llamaindex-ingestion-pipeline decision-record against the embedded schema.

Usage:
    validate-llamaindex-ingestion-pipeline.py <file.json>
    validate-llamaindex-ingestion-pipeline.py --self-test
    validate-llamaindex-ingestion-pipeline.py --help
...
DECISION_REQUIRED = ['loader', 'metadata_extractors', 'node_parser', 'vector_store', 'docstore']
DRIVERS_REQUIRED = ['doc_count', 'update_frequency', 'embedding_budget_usd']
