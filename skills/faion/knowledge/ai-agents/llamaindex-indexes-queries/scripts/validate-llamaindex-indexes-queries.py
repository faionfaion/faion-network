#!/usr/bin/env python3
"""Validate a llamaindex-indexes-queries decision-record against the embedded schema.

Usage:
    validate-llamaindex-indexes-queries.py <file.json>
    validate-llamaindex-indexes-queries.py --self-test
    validate-llamaindex-indexes-queries.py --help
...
DECISION_REQUIRED = ['index_type', 'query_engine', 'response_synthesizer', 'retriever']
DRIVERS_REQUIRED = ['data_shape', 'hop_depth_max', 'query_types']
