#!/usr/bin/env python3
"""Validate a prompt-cache-prefix-order spec JSON.

Usage: validate-prompt-cache-prefix-order.py <file.json> | --self-test | --help
...
DEC = ["section_order", "breakpoint_position_tokens", "stable_token_count", "cache_hit_target"]
DRV = ["stable_prefix_tokens", "calls_per_day", "system_prompt_changes_per_day"]
...
def _self_test() -> int:
    good = {
        ...
        "audit": {"rule_refs": ["r1-stable-first"]},
    }
