#!/usr/bin/env python3
"""validate-agent-drift-detection-statistical.py — validate output artefacts against the agent-drift-detection-statistical output contract.
...
REQUIRED = ['baseline_pass_rate', 'cusum_k', 'cusum_h', 'kl_threshold_yellow', 'kl_threshold_red', 'retest_factor', 'forbidden_seen']
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate agent-drift-detection-statistical output JSON.")
