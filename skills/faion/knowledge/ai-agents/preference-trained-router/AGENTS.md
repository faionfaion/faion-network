...
| File | Purpose |
|---|---|
| `templates/router-spec.md.j2` | Markdown wrapper. |
| `templates/router-spec.md` | Markdown wrapper. Generated from `templates/router-spec.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
