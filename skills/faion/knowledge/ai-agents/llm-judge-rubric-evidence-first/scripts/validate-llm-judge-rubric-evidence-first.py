#!/usr/bin/env python3
"""Validate a llm-judge-rubric-evidence-first decision-record against the embedded schema.

Usage:
    validate-llm-judge-rubric-evidence-first.py <file.json>
    validate-llm-judge-rubric-evidence-first.py --self-test
    validate-llm-judge-rubric-evidence-first.py --help
...
DECISION_REQUIRED = ['criteria', 'judge_model', 'evidence_first', 'json_output', 'bias_mitigations', 'sample_count']
DRIVERS_REQUIRED = ['criteria_count', 'bias_targets', 'judge_model']
