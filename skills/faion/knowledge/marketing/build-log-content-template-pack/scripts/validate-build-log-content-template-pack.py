#!/usr/bin/env python3
"""validate-build-log-content-template-pack.py — validate a build-log-content-template-pack output JSON against the methodology schema.
...
VALID_FIXTURE = {
    "artefact_id": "build-log-content-template-pack-2026-q2",
    "version": "1.1.0",
