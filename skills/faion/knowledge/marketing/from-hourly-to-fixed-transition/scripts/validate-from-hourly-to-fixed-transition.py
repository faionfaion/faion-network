#!/usr/bin/env python3
"""validate-from-hourly-to-fixed-transition.py

Validate the output artefact for the `from-hourly-to-fixed-transition` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#', '$id': 'https://faion.net/schemas/from-hourly-to-fixed-transition.json', 'type': 'object', 'required': ['plan_id', 'phases', 'first_convert_client', 'overlap_clients', 'productized_sku', 'reprice_window', 'cash_bridge_weeks', 'owner', 'produced_at'], 'additionalProperties': True}
...
OK = {'plan_id': 'transition-2026-Q2', 'phases': [{'phase': 'audit', 'weeks': [1, 4]}, {'phase': 'pilot', 'weeks': [5, 8]}, {'phase': 'convert', 'weeks': [9, 12]}], 'first_convert_client': {'name': 'Acme', 'margin_pct': 1.2}, 'overlap_clients': ['Beta', 'Gamma'], 'productized_sku': {'name': '30-day Audit Sprint', 'appearances_in_past_engagements': 4}, 'reprice_window': {'start': '2026-08-01', 'end': '2026-08-07'}, 'cash_bridge_weeks': 7, 'owner': {'name': 'Olha Riznyk', 'role': 'founder'}, 'produced_at': '2026-05-23T11:00:00Z'}
BAD = {'plan_id': 'x', 'cash_bridge_weeks': 2, 'overlap_clients': []}
