...
| `templates/shutdown-customer-email-pack.md.j2` | Markdown skeleton with the required fields. |
| `templates/shutdown-customer-email-pack.md` | Markdown skeleton with the required fields. Generated from `templates/shutdown-customer-email-pack.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
