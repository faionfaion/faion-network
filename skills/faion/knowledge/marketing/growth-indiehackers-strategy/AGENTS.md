...
| `templates/growth-indiehackers-strategy.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/growth-indiehackers-strategy.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/growth-indiehackers-strategy.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
