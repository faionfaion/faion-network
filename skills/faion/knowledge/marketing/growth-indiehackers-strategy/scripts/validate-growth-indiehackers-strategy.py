#!/usr/bin/env python3
"""validate-growth-indiehackers-strategy.py — validate a growth-indiehackers-strategy output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'ih_handle', 'give_first_weeks', 'monthly_update_topics', 'kpis', 'stop_condition', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['give_first_weeks']
NUM_FIELDS = []
ARRAY_FIELDS = ['monthly_update_topics']
OBJECT_FIELDS = ['kpis']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'ih_handle', 'stop_condition', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "growth-indiehackers-strategy-2026-q2", "version": "1.1.0", "last_reviewed": "2026-05-23", "ih_handle": "<ih_handle>", "give_first_weeks": 1, "monthly_update_topics": [], "kpis": {}, "stop_condition": "<stop_condition>", "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"ih_handle": "<ih_handle>", "give_first_weeks": 1, "monthly_update_topics": [], "kpis": {}, "stop_condition": "<stop_condition>", "owner": "team"}')
