#!/usr/bin/env python3
"""validate-agency-niche-positioning.py

Validate the output artefact for the `agency-niche-positioning` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/agency-niche-positioning.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'agency-niche-positioning',
    'title': 'Agency Niche Positioning',
...
BAD = {"slug": "BAD_agency-niche-positioning", "owner": "someone"}
