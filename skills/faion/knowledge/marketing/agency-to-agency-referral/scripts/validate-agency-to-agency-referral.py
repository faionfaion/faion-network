#!/usr/bin/env python3
"""validate-agency-to-agency-referral.py

Validate the output artefact for the `agency-to-agency-referral` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/agency-to-agency-referral.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'agency-to-agency-referral',
    'title': 'Agency-to-Agency Referral',
...
BAD = {"slug": "BAD_agency-to-agency-referral", "owner": "someone"}
