...
| File | Purpose |
|------|---------|
| `templates/agency-content-pillars-niche.playbook-step.md.j2` | Markdown playbook-step skeleton with 5-line header |
| `templates/agency-content-pillars-niche.playbook-step.md` | Markdown playbook-step skeleton with 5-line header Generated from `templates/agency-content-pillars-niche.playbook-step.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
