...
| `templates/instagram-growth.md.j2` | Markdown skeleton with the required fields. |
| `templates/instagram-growth.md` | Markdown skeleton with the required fields. Generated from `templates/instagram-growth.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
