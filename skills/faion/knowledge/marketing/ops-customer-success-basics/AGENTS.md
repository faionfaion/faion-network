...
| File | Purpose |
|------|---------|
| `templates/ops-customer-success-basics.md.j2` | Working skeleton for the `ops-customer-success-basics` artefact with required fields and `not_applicable: <reason>` markers per row. |
