...
| `templates/twitter-x-monetization-thread-to-product.md.j2` | Markdown skeleton with the required fields. |
| `templates/twitter-x-monetization-thread-to-product.md` | Markdown skeleton with the required fields. Generated from `templates/twitter-x-monetization-thread-to-product.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
