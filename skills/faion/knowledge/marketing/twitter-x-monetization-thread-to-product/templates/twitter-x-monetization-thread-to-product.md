<!--
purpose: Markdown skeleton for a Twitter X Monetization Thread To Product artefact.
consumes: Inputs from the Prerequisites table in AGENTS.md.
produces: a Markdown artefact rendering the JSON output contract for humans.
depends-on: content/02-output-contract.xml + templates/twitter-x-monetization-thread-to-product.json.
