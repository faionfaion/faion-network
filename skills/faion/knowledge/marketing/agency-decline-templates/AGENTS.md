...
| File | Purpose |
|------|---------|
| `templates/agency-decline-templates.md.j2` | Markdown skeleton with required fields. |
| `templates/agency-decline-templates.md` | Markdown skeleton with required fields. Generated from `templates/agency-decline-templates.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
