...
| File | Purpose |
|------|---------|
| `templates/hourly-rate-floor-calculation.md.j2` | Working skeleton for the `hourly-rate-floor-calculation` artefact with required fields and `not_applicable: <reason>` markers per row. |
| `templates/hourly-rate-floor-calculation.md` | Working skeleton for the `hourly-rate-floor-calculation` artefact with required fields and `not_applicable: <reason>` markers per row. Generated from `templates/hourly-rate-floor-calculation.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
