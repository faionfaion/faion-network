#!/usr/bin/env python3
"""validate-build-in-public-content-engine.py — validate a build-in-public-content-engine output JSON against the methodology schema.
...
VALID_FIXTURE = {
    "artefact_id": "build-in-public-content-engine-2026-q2",
    "version": "1.1.0",
