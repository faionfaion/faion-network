...
| File | Purpose |
|------|---------|
| `templates/growth-tiktok-basics.md.j2` | Markdown skeleton: artefact body + per-section table. |
| `templates/growth-tiktok-basics.md` | Markdown skeleton: artefact body + per-section table. Generated from `templates/growth-tiktok-basics.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/growth-tiktok-basics.json`

```json
{
  "artefact_id": "growth-tiktok-basics-<client>-<YYYY-MM-DD>",
