...
| File | Purpose |
|------|---------|
| `templates/indie-mini-crm-notion.md.j2` | Markdown skeleton: artefact body + per-section table. |
| `templates/indie-mini-crm-notion.md` | Markdown skeleton: artefact body + per-section table. Generated from `templates/indie-mini-crm-notion.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/indie-mini-crm-notion.json`

```json
{
  "artefact_id": "indie-mini-crm-notion-<client>-<YYYY-MM-DD>",
