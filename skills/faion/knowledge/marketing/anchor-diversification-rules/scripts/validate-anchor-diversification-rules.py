#!/usr/bin/env python3
"""validate-anchor-diversification-rules.py

Validate the output artefact for the `anchor-diversification-rules` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/anchor-diversification-rules.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'anchor-diversification-rules',
    'title': 'Anchor Diversification Rules',
...
BAD = {"slug": "BAD_anchor-diversification-rules", "owner": "someone"}
