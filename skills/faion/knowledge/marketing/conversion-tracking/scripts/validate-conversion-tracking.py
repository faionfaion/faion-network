...
Validates a config artefact produced by methodology 'conversion-tracking' against the
...
def validate(obj) -> list:
    ...
    if "slug" in obj and obj["slug"] != "conversion-tracking":
        errs.append(f"slug must equal 'conversion-tracking'")
...
FIXTURE_OK = {"slug": "conversion-tracking", "owner": "growth ops", "settings": {"property_id": "G-XXXXXXX", "stream": "web", "consent_mode": "v2"}, "deviation_log_reference": "ops/deviation-log.md#L120"}
...
def self_test() -> int:
    ...
    if errs:
        ...
        return 1
    errs2 = validate({"slug": "conversion-tracking"})
    if not errs2:
