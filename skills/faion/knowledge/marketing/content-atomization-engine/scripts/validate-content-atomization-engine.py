#!/usr/bin/env python3
"""validate-content-atomization-engine.py — validate a content-atomization-engine output JSON against the methodology schema.
...
VALID_FIXTURE = {
    "artefact_id": "content-atomization-engine-2026-q2",
    "version": "1.1.0",
