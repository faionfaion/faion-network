...
| File | Purpose |
|------|---------|
| `templates/retainer-conversion-script.md.j2` | Working skeleton for the `retainer-conversion-script` artefact with required fields and `not_applicable: <reason>` markers per row. |
| `templates/retainer-conversion-script.md` | Working skeleton for the `retainer-conversion-script` artefact with required fields and `not_applicable: <reason>` markers per row. Generated from `templates/retainer-conversion-script.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
