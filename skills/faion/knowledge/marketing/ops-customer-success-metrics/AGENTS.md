...
| File | Purpose |
|------|---------|
| `templates/ops-customer-success-metrics.md.j2` | Working skeleton for the `ops-customer-success-metrics` artefact with required fields and `not_applicable: <reason>` markers per row. |
