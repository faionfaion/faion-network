...
| Status | Customers | % of total | MRR | % of MRR | MoM change |
|--------|-----------|------------|-----|----------|------------|
| Healthy (80+) | [X] | [X%] | $[X] | [X%] | [+/-X] |
| Stable (60-79) | [X] | [X%] | $[X] | [X%] | [+/-X] |
| At-risk (40-59) | [X] | [X%] | $[X] | [X%] | [+/-X] |
| Critical (<40) | [X] | [X%] | $[X] | [X%] | [+/-X] |
| **Total** | **[X]** | | **$[X]** | | |

## At-Risk Accounts (40–59)
...
| Account | Health score | Current plan | Expansion opportunity | Signal |
|---------|-------------|--------------|----------------------|--------|
| [Name] | [95] | Pro | Enterprise | [3 new seats added] |
| [Name] | [88] | Basic | Pro | [Advanced feature used 8x] |

## Trend Summary

- Health distribution shift MoM: [describe direction]
- NRR this month: [X%] vs. target [100%+]
- Accounts resolved from at-risk: [X]
- New accounts entering at-risk: [X]
- Expansion revenue from CS team: $[X]
