...
| File | Purpose |
|------|---------|
| `templates/ops-legal-compliance-checklist.md.j2` | Working skeleton for the `ops-legal-compliance-checklist` artefact with required fields and `not_applicable: <reason>` markers per row. |
