<!-- purpose: canonical markdown skeleton for the Threads Basics artefact -->
<!-- consumes: typed inputs declared in content/02-output-contract.xml -->
<!-- produces: filled artefact for validate-threads-basics.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~500 tokens when fully filled -->

---
artefact_id: threads-basics-<YYYY-MM-DD>-<NN>
owner: <named-human>
version: 1.0.0
