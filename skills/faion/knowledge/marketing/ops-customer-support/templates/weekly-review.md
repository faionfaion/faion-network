...
## Performance
- Avg first response time: X hours (target: under 4h)
- Avg resolution time: X hours (target: under 24h)
- First contact resolution rate: X% (target: above 70%)
- CSAT score: X/5 (target: above 4.5)
