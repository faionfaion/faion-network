#!/usr/bin/env python3
"""validate-ops-customer-support.py — validate a ops-customer-support output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'self_serve_assets', 'sla_by_tier', 'canned_reply_count', 'review_cadence', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['canned_reply_count']
NUM_FIELDS = []
ARRAY_FIELDS = ['self_serve_assets']
OBJECT_FIELDS = ['sla_by_tier']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'review_cadence', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "ops-customer-support-2026-q2", "version": "1.1.0", "last_reviewed": "2026-05-23", "self_serve_assets": [], "sla_by_tier": {}, "canned_reply_count": 1, "review_cadence": "<review_cadence>", "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"self_serve_assets": [], "sla_by_tier": {}, "canned_reply_count": 1, "review_cadence": "<review_cadence>", "owner": "team"}')
