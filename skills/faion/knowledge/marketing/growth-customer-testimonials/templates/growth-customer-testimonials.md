<!-- purpose: Markdown skeleton for Customer Testimonials and Social Proof testimonial-bank artefact. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a testimonial-bank artefact validating against scripts/validate-growth-customer-testimonials.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# Customer Testimonials and Social Proof — Artefact Skeleton
...
Run `python scripts/validate-growth-customer-testimonials.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
