#!/usr/bin/env python3
"""validate-growth-customer-testimonials.py — stdlib-only validator for the Customer Testimonials and Social Proof artefact.
...
REQUIRED = ["artefact_id", "owner", "version", "last_reviewed", "inputs_used",
...
def validate(obj: dict) -> list[str]:
    ...
    if isinstance(rat, str) and rat and len(rat) < 20:
        errs.append("rationale shorter than 20 chars")
    return errs


OK_JSON = '{"artefact_id": "growth-customer-testimonials-acme-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "inputs_used": [{"name": "engagement charter", "source": "docs/charters/acme.md"}], "findings": [{"id": "f1", "summary": "pattern", "severity": "high"}], "decision": "ship the artefact.", "rationale": "Finding f1 supports the decision by triangulating three inputs."}'
