...
| File | Purpose |
|------|---------|
| `templates/growth-customer-testimonials.md.j2` | Markdown skeleton: artefact body + per-section table. |
| `templates/growth-customer-testimonials.md` | Markdown skeleton: artefact body + per-section table. Generated from `templates/growth-customer-testimonials.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/growth-customer-testimonials.json`

```json
{
  "artefact_id": "growth-customer-testimonials-<client>-<YYYY-MM-DD>",
