#!/usr/bin/env python3
"""validate-ops-pricing-strategy.py — validate a ops-pricing-strategy output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'cost_floor_usd', 'value_ceiling_usd', 'pricing_model', 'price_points', 'test_plan_60d', 'grandfather_policy', 'owner']
ENUMS = {'pricing_model': ['subscription', 'usage', 'hybrid', 'one-time']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = ['cost_floor_usd', 'value_ceiling_usd']
ARRAY_FIELDS = ['price_points']
OBJECT_FIELDS = ['test_plan_60d']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'pricing_model', 'grandfather_policy', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "ops-pricing-strategy-2026-q2", "version": "1.1.0", "last_reviewed": "2026-05-23", "cost_floor_usd": 1.0, "value_ceiling_usd": 1.0, "pricing_model": "subscription", "price_points": [], "test_plan_60d": {}, "grandfather_policy": "<grandfather_policy>", "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"cost_floor_usd": 1.0, "value_ceiling_usd": 1.0, "pricing_model": "subscription", "price_points": [], "test_plan_60d": {}, "grandfather_policy": "<grandfather_policy>", "owner": "team"}')
