...
| File | Purpose |
|------|---------|
| `templates/rate-raise-conversation-script.md.j2` | Markdown skeleton (5-line header) for the artefact body. |
| `templates/rate-raise-conversation-script.md` | Markdown skeleton (5-line header) for the artefact body. Generated from `templates/rate-raise-conversation-script.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/rate-raise-conversation-script.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/rate-raise-conversation-script.json",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
