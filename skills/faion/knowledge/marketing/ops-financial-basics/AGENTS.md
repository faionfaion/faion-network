...
| File | Purpose |
|------|---------|
| `templates/ops-financial-basics.md.j2` | Working skeleton for the `ops-financial-basics` artefact with required fields and `not_applicable: <reason>` markers per row. |
