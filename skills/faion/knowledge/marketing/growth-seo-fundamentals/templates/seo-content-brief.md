...
### Top 3 Results
1. <url> - <word_count> words - Key sections: [list]
2. <url> - <word_count> words - Key sections: [list]
3. <url> - <word_count> words - Key sections: [list]
...
## Internal Links
- Link TO these pages from this article: <existing_pages>
