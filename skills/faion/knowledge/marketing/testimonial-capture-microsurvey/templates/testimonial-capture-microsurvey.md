<!-- purpose: canonical markdown skeleton for the Testimonial Capture Microsurvey artefact -->
<!-- consumes: typed inputs declared in content/02-output-contract.xml -->
<!-- produces: filled artefact for validate-testimonial-capture-microsurvey.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~500 tokens when fully filled -->

---
artefact_id: testimonial-capture-microsurvey-<YYYY-MM-DD>-<NN>
