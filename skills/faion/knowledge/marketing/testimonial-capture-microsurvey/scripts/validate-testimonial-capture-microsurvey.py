#!/usr/bin/env python3
"""validate-testimonial-capture-microsurvey.py

Validate an artefact produced by the `testimonial-capture-microsurvey` methodology against the
...
_OK_FIXTURE = {
    "artefact_id": "testimonial-capture-microsurvey-2026-05-23-01",
    "owner": "Anna Schmidt",
