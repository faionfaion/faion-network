...
| File | Purpose |
|------|---------|
| `templates/testimonial-capture-microsurvey.md.j2` | Markdown skeleton (5-line header) for the artefact body. |
| `templates/testimonial-capture-microsurvey.md` | Markdown skeleton (5-line header) for the artefact body. Generated from `templates/testimonial-capture-microsurvey.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/testimonial-capture-microsurvey.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/testimonial-capture-microsurvey.json",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
