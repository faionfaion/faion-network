...
| File | Purpose |
|------|---------|
| `templates/ops-contractor-management.md.j2` | Working skeleton for the `ops-contractor-management` artefact with required fields and `not_applicable: <reason>` markers per row. |
