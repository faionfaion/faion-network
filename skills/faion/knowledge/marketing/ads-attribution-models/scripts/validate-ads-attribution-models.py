#!/usr/bin/env python3
"""validate-ads-attribution-models.py

Validate the artefact produced by the ads-attribution-models methodology against the JSON
