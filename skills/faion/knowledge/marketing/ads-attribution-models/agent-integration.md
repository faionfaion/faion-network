...
- `/faion` (sdd-batch-orchestrator workflow) — wraps the warehouse / dbt build pipeline as feature work.
- `/faion` (knowledge/solo/sdd/sdd/) — quality gates around SQL views feeding the attribution dashboard.
