<!-- purpose: Markdown checklist: robots.txt / sitemap / HTTPS / hreflang / semantic HTML / CWV gates with pass/fail criteria. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a checklist artefact validating against scripts/validate-seo-basics.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# SEO Basics — Artefact Skeleton
...
Run `python scripts/validate-seo-basics.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
