...
### Key Results
| KR | Baseline | Target | Due | Data Source |
|----|----------|--------|-----|-------------|
| [Measurable outcome 1] | [current] | [target] | [date] | [tool] |
| [Measurable outcome 2] | [current] | [target] | [date] | [tool] |
...
## Scoring rubric
- 1.0: Ambitious but credible target fully achieved
- 0.7: Significant progress, one KR missed
- 0.5: Some progress, majority of KRs missed
- Below 0.5: Objective did not materialize — root-cause review required
