...
| File | Purpose |
|------|---------|
| `templates/ops-annual-planning-templates.md.j2` | Working skeleton for the `ops-annual-planning-templates` artefact with required fields and `not_applicable: <reason>` markers per row. |
