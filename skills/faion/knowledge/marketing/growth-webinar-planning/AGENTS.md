...
| File | Purpose |
|------|---------|
| `templates/growth-webinar-planning.md.j2` | Markdown skeleton: artefact body + per-section table. |
| `templates/growth-webinar-planning.md` | Markdown skeleton: artefact body + per-section table. Generated from `templates/growth-webinar-planning.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/growth-webinar-planning.json`

```json
{
  "artefact_id": "growth-webinar-planning-<client>-<YYYY-MM-DD>",
