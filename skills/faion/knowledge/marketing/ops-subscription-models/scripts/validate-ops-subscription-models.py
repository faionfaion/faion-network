#!/usr/bin/env python3
"""validate-ops-subscription-models.py — validate a ops-subscription-models output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'model_type', 'tiers', 'metrics_instrumented', 'dunning_config', 'lifecycle_stages', 'grandfather_months', 'owner']
ENUMS = {'model_type': ['saas', 'membership', 'replenishment', 'curation']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['grandfather_months']
NUM_FIELDS = []
ARRAY_FIELDS = ['tiers', 'metrics_instrumented', 'lifecycle_stages']
OBJECT_FIELDS = ['dunning_config']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'model_type', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "ops-subscription-models-2026-q2", "version": "1.1.0", "last_reviewed": "2026-05-23", "model_type": "saas", "tiers": [], "metrics_instrumented": [], "dunning_config": {}, "lifecycle_stages": [], "grandfather_months": 1, "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"model_type": "saas", "tiers": [], "metrics_instrumented": [], "dunning_config": {}, "lifecycle_stages": [], "grandfather_months": 1, "owner": "team"}')
