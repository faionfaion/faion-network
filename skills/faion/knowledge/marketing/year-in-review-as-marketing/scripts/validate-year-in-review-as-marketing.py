#!/usr/bin/env python3
"""validate-year-in-review-as-marketing.py

Validate an artefact produced by the `year-in-review-as-marketing` methodology against the
...
_OK_FIXTURE = {
    "artefact_id": "year-in-review-as-marketing-2026-05-23-01",
    "owner": "Anna Schmidt",
