#!/usr/bin/env python3
"""validate-ops-legal-compliance.py

Validate the output artefact for the `ops-legal-compliance` methodology against the JSON Schema
