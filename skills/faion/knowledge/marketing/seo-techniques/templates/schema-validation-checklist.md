<!-- purpose: Markdown checklist: schema JSON-LD types, llms.txt placement, OG meta, internal-link audit; all gated by Rich Results Test pass. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a checklist artefact validating against scripts/validate-seo-techniques.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# SEO Techniques — Artefact Skeleton
...
Run `python scripts/validate-seo-techniques.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
