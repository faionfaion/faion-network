#!/usr/bin/env python3
"""validate-content-distribution-orchestration.py

Validate the output artefact for the `content-distribution-orchestration` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/content-distribution-orchestration.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'content-distribution-orchestration',
    'title': 'Content Distribution Orchestration',
...
BAD = {"slug": "BAD_content-distribution-orchestration", "owner": "someone"}
