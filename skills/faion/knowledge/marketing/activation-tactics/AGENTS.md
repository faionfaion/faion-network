...
| File | Purpose |
|------|---------|
| `templates/activation-tactics.playbook-step.md.j2` | Markdown playbook-step skeleton with 5-line header |
...
### `templates/activation-tactics.example.json`

```json
{
  "slug": "activation-tactics",
