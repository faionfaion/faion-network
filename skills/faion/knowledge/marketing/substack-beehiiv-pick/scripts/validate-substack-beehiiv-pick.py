#!/usr/bin/env python3
"""validate-substack-beehiiv-pick.py — validate output artefacts against the substack-beehiiv-pick output contract.
...
REQUIRED = ['recommendation', 'rationale_criteria', 'scores', 'migration_cost_estimate_usd', 'date', 'signature', 'forbidden_seen']
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate substack-beehiiv-pick output JSON.")
