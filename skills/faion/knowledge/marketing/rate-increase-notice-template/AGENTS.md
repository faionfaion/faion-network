...
| File | Purpose |
|------|---------|
| `templates/rate-increase-notice-template.md.j2` | Markdown skeleton (5-line header) for the artefact body. |
| `templates/rate-increase-notice-template.md` | Markdown skeleton (5-line header) for the artefact body. Generated from `templates/rate-increase-notice-template.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/rate-increase-notice-template.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/rate-increase-notice-template.json",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
