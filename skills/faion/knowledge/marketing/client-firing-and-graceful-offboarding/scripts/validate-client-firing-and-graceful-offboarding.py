#!/usr/bin/env python3
"""validate-client-firing-and-graceful-offboarding.py

Validate the output artefact for the `client-firing-and-graceful-offboarding` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/client-firing-and-graceful-offboarding.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'client-firing-and-graceful-offboarding',
    'title': 'Client Firing and Graceful Offboarding',
    ...
    'sections': [   {'heading': 'Overview', 'body': '…'},
                    ...
                    {'heading': 'Fitness functions', 'body': '…'}]}
BAD = {"slug": "BAD_client-firing-and-graceful-offboarding", "owner": "someone"}
