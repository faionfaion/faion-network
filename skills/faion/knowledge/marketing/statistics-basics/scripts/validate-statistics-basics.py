#!/usr/bin/env python3
"""validate-statistics-basics.py

Validate the output artefact for the `statistics-basics` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#', '$id': 'https://faion.net/schemas/statistics-basics.json', 'type': 'object', 'required': ['test_id', 'alpha', 'power', 'mde', 'baseline_rate', 'sample_size_per_arm', 'hypothesis', 'peeking_policy', 'produced_at'], 'additionalProperties': True}
...
OK = {'test_id': 'cta-color-2026-04', 'alpha': 0.05, 'power': 0.8, 'mde': 0.02, 'baseline_rate': 0.085, 'sample_size_per_arm': 7800, 'hypothesis': {'h0': 'p_control == p_treatment', 'h1': 'p_control != p_treatment', 'sides': 2}, 'peeking_policy': 'fixed_horizon_no_peek', 'produced_at': '2026-05-23T09:00:00Z'}
BAD = {'test_id': 'x', 'alpha': 0.5, 'hypothesis': 'tbd'}
