...
| `templates/email-preflight-checklist.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/email-preflight-checklist.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/email-preflight-checklist.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/email-preflight-checklist.json`

```json
{
  "artefact_id": "email-preflight-checklist-<project>-<period>",
  "version": "1.1.0",
