#!/usr/bin/env python3
"""validate-email-preflight-checklist.py — validate a email-preflight-checklist output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'send_id', 'items', 'pass_rate', 'owner', 'decision']
ENUMS = {'decision': ['go', 'hold', 'abort']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = ['pass_rate']
ARRAY_FIELDS = ['items']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'send_id', 'owner', 'decision']
...
VALID_FIXTURE = json.loads('{"artefact_id": "email-preflight-checklist-2026-q2", "version": "1.1.0", "last_reviewed": "2026-05-23", "send_id": "<send_id>", "items": [], "pass_rate": 1.0, "owner": "@ruslan", "decision": "go"}')
INVALID_FIXTURE = json.loads('{"send_id": "<send_id>", "items": [], "pass_rate": 1.0, "owner": "team", "decision": "go"}')
