#!/usr/bin/env python3
"""validate-ops-financial-planning.py — validate a ops-financial-planning output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'cash_balance_usd', 'monthly_burn_usd', 'runway_months', 'projection_3m', 'projection_12m', 'reserve_pct', 'reinvestment_pct', 'founder_pay_pct', 'tax_rate_pct', 'next_review', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed', 'next_review']
INT_FIELDS = []
NUM_FIELDS = ['cash_balance_usd', 'monthly_burn_usd', 'runway_months', 'reserve_pct', 'reinvestment_pct', 'founder_pay_pct', 'tax_rate_pct']
ARRAY_FIELDS = ['projection_3m', 'projection_12m']
OBJECT_FIELDS = []
BOOL_FIELDS = []
...
VALID_FIXTURE = json.loads('{"artefact_id": "ops-financial-planning-2026-q2", "version": "1.1.0", "last_reviewed": "2026-05-23", "cash_balance_usd": 1.0, "monthly_burn_usd": 1.0, "runway_months": 1.0, "projection_3m": [], "projection_12m": [], "reserve_pct": 1.0, "reinvestment_pct": 1.0, "founder_pay_pct": 1.0, "tax_rate_pct": 1.0, "next_review": "2026-05-23", "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"cash_balance_usd": 1.0, "monthly_burn_usd": 1.0, "runway_months": 1.0, "projection_3m": [], "projection_12m": [], "reserve_pct": 1.0, "reinvestment_pct": 1.0, "founder_pay_pct": 1.0, "tax_rate_pct": 1.0, "next_review": "2026-05-23", "owner": "team"}')
