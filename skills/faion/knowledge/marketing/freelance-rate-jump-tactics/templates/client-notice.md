<!-- purpose: Existing-client rate-change notice template -->
<!-- consumes: rollout_plan -->
<!-- produces: written notice (rule 60-day-notice-existing-clients) -->
<!-- depends-on: content/01-core-rules.xml -->
<!-- token-budget-impact: ~300 tokens when filled -->

Subject: Rate update for `<CLIENT>` starting `<EXISTING_CLIENTS_AT>`
...
If this raises any questions about scope or timeline, let me know — happy to walk through it.
