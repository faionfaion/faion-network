...
| File | Purpose |
|------|---------|
| `templates/topic-cluster-architecture-with-eeat.md.j2` | Markdown skeleton (5-line header) for the artefact body. |
| `templates/topic-cluster-architecture-with-eeat.md` | Markdown skeleton (5-line header) for the artefact body. Generated from `templates/topic-cluster-architecture-with-eeat.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/topic-cluster-architecture-with-eeat.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/topic-cluster-architecture-with-eeat.json",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
