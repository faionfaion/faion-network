#!/usr/bin/env python3
"""validate-white-label-partnership-design.py

Validate an artefact produced by the `white-label-partnership-design` methodology against the
...
_OK_FIXTURE = {
    "artefact_id": "white-label-partnership-design-2026-05-23-01",
    "owner": "Anna Schmidt",
