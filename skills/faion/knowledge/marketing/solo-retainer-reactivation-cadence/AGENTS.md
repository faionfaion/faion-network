...
| File | Purpose |
|------|---------|
| `templates/solo-retainer-reactivation-cadence.md.j2` | Markdown skeleton (5-line header) for the artefact body. |
| `templates/solo-retainer-reactivation-cadence.md` | Markdown skeleton (5-line header) for the artefact body. Generated from `templates/solo-retainer-reactivation-cadence.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/solo-retainer-reactivation-cadence.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/solo-retainer-reactivation-cadence.json",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
