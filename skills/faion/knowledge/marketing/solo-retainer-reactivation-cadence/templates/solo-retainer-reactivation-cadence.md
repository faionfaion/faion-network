<!-- purpose: canonical markdown skeleton for the Solo Retainer Reactivation Cadence artefact -->
<!-- consumes: typed inputs declared in content/02-output-contract.xml -->
<!-- produces: filled artefact for validate-solo-retainer-reactivation-cadence.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~500 tokens when fully filled -->

---
artefact_id: solo-retainer-reactivation-cadence-<YYYY-MM-DD>-<NN>
owner: <named-human>
version: 1.0.0
