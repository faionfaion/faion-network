#!/usr/bin/env python3
"""validate-solo-retainer-reactivation-cadence.py

Validate an artefact produced by the `solo-retainer-reactivation-cadence` methodology against the
...
_OK_FIXTURE = {
    "artefact_id": "solo-retainer-reactivation-cadence-2026-05-23-01",
    "owner": "Anna Schmidt",
