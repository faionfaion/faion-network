...
[Supporting detail: proof point, stat, or feature benefit]
...
### Image Concept
[Description of visual: professional setting, data visualization, person at work, etc.]

---

## Variant Matrix (create 2-3 per angle)

| Variant | Angle | Intro | Headline | Hypothesis |
|---------|-------|-------|----------|------------|
| A | Pain | ... | ... | ICP responds to problem framing |
| B | Social Proof | ... | ... | Peer validation drives clicks |
| C | ROI | ... | ... | Quantified outcome converts |
