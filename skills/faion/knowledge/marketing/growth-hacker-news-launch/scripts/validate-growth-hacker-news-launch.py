#!/usr/bin/env python3
"""validate-growth-hacker-news-launch.py — validate a growth-hacker-news-launch output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'hn_account', 'account_karma', 'post_title', 'post_window_utc', 'demo_url', 'engagement_owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['account_karma']
NUM_FIELDS = []
ARRAY_FIELDS = []
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'hn_account', 'post_title', 'post_window_utc', 'demo_url', 'engagement_owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "growth-hacker-news-launch-2026-q2", "version": "1.1.0", "last_reviewed": "2026-05-23", "hn_account": "<hn_account>", "account_karma": 1, "post_title": "<post_title>", "post_window_utc": "<post_window_utc>", "demo_url": "<demo_url>", "engagement_owner": "<engagement_owner>"}')
INVALID_FIXTURE = json.loads('{"hn_account": "<hn_account>", "account_karma": 1, "post_title": "<post_title>", "post_window_utc": "<post_window_utc>", "demo_url": "<demo_url>", "engagement_owner": "<engagement_owner>"}')
