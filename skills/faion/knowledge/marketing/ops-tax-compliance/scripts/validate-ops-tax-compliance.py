#!/usr/bin/env python3
"""validate-ops-tax-compliance.py

Validate the output artefact for the `ops-tax-compliance` methodology against the JSON Schema
