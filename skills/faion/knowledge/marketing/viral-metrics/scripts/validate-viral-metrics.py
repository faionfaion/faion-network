#!/usr/bin/env python3
"""validate-viral-metrics.py

Validate the output artefact for the `viral-metrics` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#', '$id': 'https://faion.net/schemas/viral-metrics.json', 'type': 'object', 'required': ['metrics', 'sql_refs', 'cadence', 'owner', 'produced_at'], 'additionalProperties': True}
...
OK = {'metrics': ['invites_per_user_i', 'invite_conversion_c', 'k_factor', 'viral_cycle_time_days', 'k_effective'], 'sql_refs': {'k_factor': 'sql/k_factor.sql', 'k_effective': 'sql/k_effective.sql'}, 'cadence': {'default': 'weekly', 'deep_dive': 'monthly'}, 'owner': {'name': 'Olha Riznyk', 'role': 'head of growth'}, 'produced_at': '2026-05-23T12:00:00Z'}
BAD = {'metrics': ['k_total'], 'cadence': 'quarterly'}
