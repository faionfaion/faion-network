...
| File | Purpose |
|------|---------|
| `templates/solo-niche-narrative-framework.md.j2` | Working skeleton for the `solo-niche-narrative-framework` artefact with required fields and `not_applicable: <reason>` markers per row. |
| `templates/solo-niche-narrative-framework.md` | Working skeleton for the `solo-niche-narrative-framework` artefact with required fields and `not_applicable: <reason>` markers per row. Generated from `templates/solo-niche-narrative-framework.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
