...
| `templates/freelancer-positioning-content-calendar.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/freelancer-positioning-content-calendar.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/freelancer-positioning-content-calendar.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/freelancer-positioning-content-calendar.json`

```json
{
  "artefact_id": "freelancer-positioning-content-calendar-<project>-<period>",
  "version": "1.1.0",
