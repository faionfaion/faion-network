#!/usr/bin/env python3
"""validate-freelancer-positioning-content-calendar.py — validate a freelancer-positioning-content-calendar output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'pillars', 'weeks', 'cadence_per_week', 'owner', 'next_review']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed', 'next_review']
INT_FIELDS = ['cadence_per_week']
NUM_FIELDS = []
ARRAY_FIELDS = ['pillars', 'weeks']
OBJECT_FIELDS = []
BOOL_FIELDS = []
...
VALID_FIXTURE = json.loads('{"artefact_id": "freelancer-positioning-content-calendar-2026-q2", "version": "1.1.0", "last_reviewed": "2026-05-23", "pillars": [], "weeks": [], "cadence_per_week": 1, "owner": "@ruslan", "next_review": "2026-05-23"}')
INVALID_FIXTURE = json.loads('{"pillars": [], "weeks": [], "cadence_per_week": 1, "owner": "team", "next_review": "2026-05-23"}')
