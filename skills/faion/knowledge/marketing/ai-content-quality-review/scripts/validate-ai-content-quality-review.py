#!/usr/bin/env python3
"""validate-ai-content-quality-review.py — validate a ai-content-quality-review output JSON against the methodology schema.
...
VALID_FIXTURE = {
    "artefact_id": "ai-content-quality-review-2026-q2",
    "version": "1.1.0",
