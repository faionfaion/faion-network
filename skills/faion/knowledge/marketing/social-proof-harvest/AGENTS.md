...
| `templates/social-proof-harvest.md.j2` | Markdown skeleton with the required fields. |
| `templates/social-proof-harvest.md` | Markdown skeleton with the required fields. Generated from `templates/social-proof-harvest.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
