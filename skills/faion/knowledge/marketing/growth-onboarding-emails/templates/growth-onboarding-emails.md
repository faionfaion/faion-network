<!-- purpose: Markdown skeleton for Behavior-Triggered Onboarding Emails onboarding-sequence artefact. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a onboarding-sequence artefact validating against scripts/validate-growth-onboarding-emails.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# Behavior-Triggered Onboarding Emails — Artefact Skeleton
...
Run `python scripts/validate-growth-onboarding-emails.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
