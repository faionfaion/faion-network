#!/usr/bin/env python3
"""validate-reference-program-playbook.py

Validate the output artefact for the `reference-program-playbook` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#', '$id': 'https://faion.net/schemas/reference-program-playbook.json', 'type': 'object', 'required': ['playbook_version', 'reference_tiers', 'case_studies', 'ask_triggers', 'intro_protocol', 'owner', 'produced_at'], 'additionalProperties': True}
...
OK = {'playbook_version': '2026-Q2', 'reference_tiers': [{'tier': 1, 'client': 'Acme Co', 'permissions': ['named', 'case_study', 'peer_call']}, {'tier': 2, 'client': 'Beta Inc', 'permissions': ['named', 'case_study']}, {'tier': 3, 'client': 'Gamma Ltd', 'permissions': ['anonymous_case_study']}], 'case_studies': [{'client': 'Acme Co', 'outcome_metric': '+34% MQL'}], 'ask_triggers': ['peak_satisfaction_event', 'public_win', 'renewal_signed'], 'intro_protocol': 'double_opt_in', 'owner': {'name': 'Olha Riznyk', 'role': 'founder'}, 'produced_at': '2026-05-23T12:00:00Z'}
BAD = {'reference_tiers': 'tier1', 'intro_protocol': 'single_step'}
