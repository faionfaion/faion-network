<!-- purpose: Markdown topic-map spec: pillar / cluster / supporting structure with entity coverage matrix and internal-link plan. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a spec artefact validating against scripts/validate-topical-authority.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# Topical Authority — Artefact Skeleton
...
Run `python scripts/validate-topical-authority.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
