#!/usr/bin/env python3
"""validate-growth-copywriting-fundamentals.py — validate a growth-copywriting-fundamentals output JSON against the methodology schema.
...
VALID_FIXTURE = {
    "artefact_id": "growth-copywriting-fundamentals-2026-q2",
    "version": "1.1.0",
