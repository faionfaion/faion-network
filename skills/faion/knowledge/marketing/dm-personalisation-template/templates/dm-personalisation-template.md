<!-- purpose: Markdown skeleton for DM Personalisation Template dm-personalisation artefact. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a dm-personalisation artefact validating against scripts/validate-dm-personalisation-template.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# DM Personalisation Template — Artefact Skeleton
...
Run `python scripts/validate-dm-personalisation-template.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
