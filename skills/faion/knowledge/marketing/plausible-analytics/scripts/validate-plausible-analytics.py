#!/usr/bin/env python3
"""validate-plausible-analytics.py — validate a plausible-analytics output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'site_domain', 'script_host', 'goals', 'custom_props', 'shared_links', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['goals', 'custom_props', 'shared_links']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'site_domain', 'script_host', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "plausible-analytics-2026-q2", "version": "1.1.0", "last_reviewed": "2026-05-23", "site_domain": "<site_domain>", "script_host": "<script_host>", "goals": [], "custom_props": [], "shared_links": [], "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"site_domain": "<site_domain>", "script_host": "<script_host>", "goals": [], "custom_props": [], "shared_links": [], "owner": "team"}')
