<!-- purpose: Markdown launch-day log: timestamped slots PT-anchored, comment-class triage table, signup conversion log. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a playbook-step artefact validating against scripts/validate-ph-launch-day-runbook.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# PH Launch Day Runbook — Artefact Skeleton

## Metadata

- `artefact_id`: <artefact_slug>-<context>-<artefact_id>
...
Run `python scripts/validate-ph-launch-day-runbook.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
