<!-- purpose: Markdown brief: intent / entities / JTBD / SERP-features / contract blocks per rule. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a spec artefact validating against scripts/validate-search-intent-to-brief.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# Search Intent To Brief — Artefact Skeleton
...
Run `python scripts/validate-search-intent-to-brief.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
