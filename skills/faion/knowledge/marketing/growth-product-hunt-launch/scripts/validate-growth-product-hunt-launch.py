#!/usr/bin/env python3
"""validate-growth-product-hunt-launch.py — validate a growth-product-hunt-launch output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'pre_list_size', 'hunter', 'hunter_followers', 'launch_datetime_pt', 'assets', 'engagement_sla_minutes', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['pre_list_size', 'hunter_followers', 'engagement_sla_minutes']
NUM_FIELDS = []
ARRAY_FIELDS = []
OBJECT_FIELDS = ['assets']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'hunter', 'launch_datetime_pt', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "growth-product-hunt-launch-2026-q2", "version": "1.1.0", "last_reviewed": "2026-05-23", "pre_list_size": 1, "hunter": "<hunter>", "hunter_followers": 1, "launch_datetime_pt": "<launch_datetime_pt>", "assets": {}, "engagement_sla_minutes": 1, "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"pre_list_size": 1, "hunter": "<hunter>", "hunter_followers": 1, "launch_datetime_pt": "<launch_datetime_pt>", "assets": {}, "engagement_sla_minutes": 1, "owner": "team"}')
