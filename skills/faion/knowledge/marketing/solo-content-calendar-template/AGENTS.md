...
| `templates/solo-content-calendar-template.md.j2` | Markdown skeleton with the required fields. |
| `templates/solo-content-calendar-template.md` | Markdown skeleton with the required fields. Generated from `templates/solo-content-calendar-template.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
