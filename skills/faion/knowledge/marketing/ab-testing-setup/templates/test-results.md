...
- SRM check: PASS / FAIL (chi2 p = ______)
...
## Decision
- [ ] Ship B to 100% (phased: 10% → 50% → 100%)
- [ ] Keep A
- [ ] Retest with larger sample
- [ ] Investigate guardrail regression before deciding

## Learning
[One paragraph: what did we learn? What does this imply for future tests?]

## Next Steps
[Follow-up experiment or product action]
