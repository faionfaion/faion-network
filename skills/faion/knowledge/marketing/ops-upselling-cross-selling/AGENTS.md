...
| File | Purpose |
|------|---------|
| `templates/ops-upselling-cross-selling.md.j2` | Working skeleton for the `ops-upselling-cross-selling` artefact with required fields and `not_applicable: <reason>` markers per row. |
