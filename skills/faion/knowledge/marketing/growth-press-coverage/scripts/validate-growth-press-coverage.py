#!/usr/bin/env python3
"""validate-growth-press-coverage.py

Validate the output artefact for the `growth-press-coverage` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#', '$id': 'https://faion.net/schemas/growth-press-coverage.json', 'type': 'object', 'required': ['campaign_id', 'journalists', 'angle', 'pitch_word_count', 'followups', 'assets_offered', 'owner', 'produced_at'], 'additionalProperties': True}
...
OK = {'campaign_id': 'launch-2026-Q2', 'journalists': [{'name': 'Alex K', 'publication': 'RetentionWeek (Tier-3)', 'beat': 'B2B SaaS retention', 'researched': True, 'recent_article_ref': 'https://retentionweek.com/post-funded-startups-churn'}], 'angle': 'data_first', 'pitch_word_count': 132, 'followups': [{'day': 4, 'kind': 'reminder'}, {'day': 10, 'kind': 'value_add'}], 'assets_offered': ['exec_interview', 'exclusive_data_table', 'demo_video'], 'owner': {'name': 'Tetiana Lytvyn', 'role': 'founder'}, 'produced_at': '2026-05-23T16:00:00Z'}
BAD = {'campaign_id': 'x', 'angle': 'we_launched', 'pitch_word_count': 480}
