...
| `templates/email-lifecycle-architecture.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/email-lifecycle-architecture.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/email-lifecycle-architecture.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/email-lifecycle-architecture.json`

```json
{
  "artefact_id": "email-lifecycle-architecture-<project>-<period>",
  "version": "1.1.0",
