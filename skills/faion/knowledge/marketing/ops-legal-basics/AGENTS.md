...
| File | Purpose |
|------|---------|
| `templates/ops-legal-basics.md.j2` | Working skeleton for the `ops-legal-basics` artefact with required fields and `not_applicable: <reason>` markers per row. |
| `templates/ops-legal-basics.md` | Working skeleton for the `ops-legal-basics` artefact with required fields and `not_applicable: <reason>` markers per row. Generated from `templates/ops-legal-basics.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
