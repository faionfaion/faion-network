...
| `templates/positioning-diff-log.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/positioning-diff-log.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/positioning-diff-log.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/positioning-diff-log.json`

```json
{
  "artefact_id": "positioning-diff-log-<project>-<period>",
  "version": "1.1.0",
