#!/usr/bin/env python3
"""validate-ops-churn-basics.py

Validate the output artefact for the `ops-churn-basics` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#', '$id': 'https://faion.net/schemas/ops-churn-basics.json', 'type': 'object', 'required': ['report_period', 'customer_churn_rate', 'mrr_churn_rate', 'nrr', 'voluntary_split', 'cohort_grid', 'leading_indicators', 'owner', 'produced_at'], 'additionalProperties': True}
...
OK = {'report_period': '2026-04', 'customer_churn_rate': 0.042, 'mrr_churn_rate': 0.031, 'nrr': 1.08, 'voluntary_split': {'voluntary': 0.028, 'involuntary': 0.014}, 'cohort_grid': [{'cohort': '2026-01', 'plan': 'starter', 'churn': 0.09}], 'leading_indicators': ['login_freq_drop', 'feature_usage_delta', 'support_score'], 'owner': {'name': 'Olha Riznyk', 'role': 'head of growth'}, 'produced_at': '2026-05-23T09:00:00Z'}
BAD = {'customer_churn_rate': 0.6, 'nrr': 'high'}
