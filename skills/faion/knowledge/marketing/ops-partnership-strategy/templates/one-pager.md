...
[2-3 sentences: what you do, who you serve, and one proof point — number of customers, notable case study, or metric]
...
- [Benefit 3 — e.g., "minimal effort: we handle all logistics, you provide 30 minutes of your time"]
...
- [Size and description — e.g., "8,500 newsletter subscribers, 70% founders and indie hackers"]
- [Engagement — e.g., "28% average open rate, 4.2% CTR"]
- [Relevance — why our audience is valuable to their business]

## Proof of Prior Partnerships

- [Previous partnership result if available — e.g., "our last co-webinar produced 420 registrations"]

## Next Steps

1. Reply to schedule a 15-minute intro call
