...
| `templates/objection-bank.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/objection-bank.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/objection-bank.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/objection-bank.json`

```json
{
  "artefact_id": "objection-bank-<project>-<period>",
  "version": "1.1.0",
  "last_reviewed": "2026-05-23",
  "entries": [],
  "top10_snapshot_date": "2026-05-23",
  "owner": "<@handle>",
