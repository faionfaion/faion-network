#!/usr/bin/env python3
"""validate-objection-bank.py — validate a objection-bank output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'entries', 'top10_snapshot_date', 'owner', 'next_review']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed', 'top10_snapshot_date', 'next_review']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['entries']
OBJECT_FIELDS = []
BOOL_FIELDS = []
...
VALID_FIXTURE = json.loads('{"artefact_id": "objection-bank-2026-q2", "version": "1.1.0", "last_reviewed": "2026-05-23", "entries": [], "top10_snapshot_date": "2026-05-23", "owner": "@ruslan", "next_review": "2026-05-23"}')
INVALID_FIXTURE = json.loads('{"entries": [], "top10_snapshot_date": "2026-05-23", "owner": "team", "next_review": "2026-05-23"}')
