...
| `templates/growth-twitter-x-growth.md.j2` | Markdown skeleton with the required fields. |
| `templates/growth-twitter-x-growth.md` | Markdown skeleton with the required fields. Generated from `templates/growth-twitter-x-growth.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
| `templates/_smoke-test.json` | Minimum viable filled-in example (passes the validator). |

Files the packer does not ship standalone have their bodies inlined under `## Template Contents` at the end of this file - read them there, do not fetch the path.
| `templates/build-in-public.md.j2` | Markdown skeleton for a monthly build-in-public update post. |
| `templates/build-in-public.md` | Markdown skeleton for a monthly build-in-public update post. Generated from `templates/build-in-public.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
| `templates/thread-template.md.j2` | Markdown skeleton for a generic X thread (non-launch variant). |
| `templates/thread-template.md` | Markdown skeleton for a generic X thread (non-launch variant). Generated from `templates/thread-template.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
