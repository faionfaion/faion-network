<!--
purpose: Markdown skeleton for a Growth Social Media Strategy artefact.
consumes: Inputs from the Prerequisites table in AGENTS.md.
produces: a Markdown artefact rendering the JSON output contract for humans.
depends-on: content/02-output-contract.xml + templates/growth-social-media-strategy.json.
