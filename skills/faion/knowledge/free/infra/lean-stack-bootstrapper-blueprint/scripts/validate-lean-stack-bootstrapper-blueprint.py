#!/usr/bin/env python3
"""validate-lean-stack-bootstrapper-blueprint.py — validate output artefacts against the lean-stack-bootstrapper-blueprint output contract.
...
REQUIRED = ['services', 'monthly_ceiling_usd', 'alert_threshold_pct', 'upgrade_triggers', 'vendor_lock_acceptance', 'forbidden_seen']
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate lean-stack-bootstrapper-blueprint output JSON.")
