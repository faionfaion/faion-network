#!/usr/bin/env python3
"""Validate output contract for python-pytest-setup.

USAGE:
    validate-python-pytest-setup.py <input.json>        Validate a JSON artefact.
    validate-python-pytest-setup.py --self-test         Run built-in fixture.
    validate-python-pytest-setup.py --help              Show this help.
...
REQUIRED_FIELDS = ['pytest_in_pyproject', 'strict_markers', 'coverage_threshold>0', 'tests_mirror_src', 'xdist_in_ci']
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(prog="validate-python-pytest-setup.py")
