#!/usr/bin/env python3
"""Validate output contract for django-testing.

USAGE:
    validate-django-testing.py <input.json>        Validate a JSON artefact.
    validate-django-testing.py --self-test         Run built-in fixture.
    validate-django-testing.py --help              Show this help.
...
REQUIRED_FIELDS = ['pytest_config_present', 'django_db_marker_present', 'format_json_used', 'force_authenticate_used', 'orm_mocking_count==0']
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(prog="validate-django-testing.py")
