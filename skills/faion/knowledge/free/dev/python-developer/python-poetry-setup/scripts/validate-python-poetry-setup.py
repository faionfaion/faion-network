#!/usr/bin/env python3
"""Validate output contract for python-poetry-setup.

USAGE:
    validate-python-poetry-setup.py <input.json>        Validate a JSON artefact.
    validate-python-poetry-setup.py --self-test         Run built-in fixture.
    validate-python-poetry-setup.py --help              Show this help.
...
REQUIRED_FIELDS = ['pep621_present', 'lockfile_committed', 'dev_group_separate', 'venv_in_project']
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(prog="validate-python-poetry-setup.py")
