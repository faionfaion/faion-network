#!/usr/bin/env python3
"""Validate output contract for python-modern-2026.

USAGE:
    validate-python-modern-2026.py <input.json>        Validate a JSON artefact.
    validate-python-modern-2026.py --self-test         Run built-in fixture.
    validate-python-modern-2026.py --help              Show this help.
...
REQUIRED_FIELDS = ['python_version_pinned', 'target_versions_synced', 'uv_only_package_manager', 'pep695_generics_used']
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(prog="validate-python-modern-2026.py")
