#!/usr/bin/env python3
"""Validate output contract for python-type-hints.

USAGE:
    validate-python-type-hints.py <input.json>        Validate a JSON artefact.
    validate-python-type-hints.py --self-test         Run built-in fixture.
    validate-python-type-hints.py --help              Show this help.
...
REQUIRED_FIELDS = ['mypy_strict_at_boundary', 'pydantic_at_io', 'no_legacy_typing_imports', 'no_bare_any']
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(prog="validate-python-type-hints.py")
