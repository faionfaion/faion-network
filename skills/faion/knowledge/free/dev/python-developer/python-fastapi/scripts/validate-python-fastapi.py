#!/usr/bin/env python3
"""Validate output contract for python-fastapi.

USAGE:
    validate-python-fastapi.py <input.json>        Validate a JSON artefact.
    validate-python-fastapi.py --self-test         Run built-in fixture.
    validate-python-fastapi.py --help              Show this help.
...
REQUIRED_FIELDS = ['thin_route_no_orm', 'pydantic_in_out', 'asyncsession_per_task', 'openapi_snapshot_present']
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(prog="validate-python-fastapi.py")
