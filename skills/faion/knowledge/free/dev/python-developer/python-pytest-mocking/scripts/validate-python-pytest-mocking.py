#!/usr/bin/env python3
"""Validate output contract for python-pytest-mocking.

USAGE:
    validate-python-pytest-mocking.py <input.json>        Validate a JSON artefact.
    validate-python-pytest-mocking.py --self-test         Run built-in fixture.
    validate-python-pytest-mocking.py --help              Show this help.
...
REQUIRED_FIELDS = ['uses_mocker_fixture', 'patches_use_site', 'autospec_used', 'asyncmock_for_async', 'no_orm_mocking']
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(prog="validate-python-pytest-mocking.py")
