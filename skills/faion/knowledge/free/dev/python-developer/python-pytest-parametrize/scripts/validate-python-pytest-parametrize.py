#!/usr/bin/env python3
"""Validate output contract for python-pytest-parametrize.

USAGE:
    validate-python-pytest-parametrize.py <input.json>        Validate a JSON artefact.
    validate-python-pytest-parametrize.py --self-test         Run built-in fixture.
    validate-python-pytest-parametrize.py --help              Show this help.
...
REQUIRED_FIELDS = ['parametrize_used_for_repeats', 'ids_present', 'no_cartesian_explosion', 'pytest_param_for_per_case_marks']
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(prog="validate-python-pytest-parametrize.py")
