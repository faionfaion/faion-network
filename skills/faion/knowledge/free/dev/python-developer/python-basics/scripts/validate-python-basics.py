#!/usr/bin/env python3
"""Validate output contract for python-basics.

USAGE:
    validate-python-basics.py <input.json>        Validate a JSON artefact.
    validate-python-basics.py --self-test         Run built-in fixture.
    validate-python-basics.py --help              Show this help.
...
REQUIRED_FIELDS = ['uses_builtin_generics', 'no_mutable_default_args', 'no_bare_except', 'pathlib_over_ospath']
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(prog="validate-python-basics.py")
