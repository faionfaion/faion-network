#!/usr/bin/env python3
"""validate-testing-go.py — validate output artefacts against the testing-go output contract.
...
REQUIRED = ['test_files', 'test_function_count', 'table_driven_count', 'forbidden_seen', 'require_used']
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate testing-go output JSON.")
