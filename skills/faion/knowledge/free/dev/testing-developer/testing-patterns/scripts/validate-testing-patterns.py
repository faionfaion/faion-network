#!/usr/bin/env python3
"""validate-testing-patterns.py — validate output artefacts against the testing-patterns output contract.
...
REQUIRED = ['strategy_doc', 'pyramid_target', 'data_pattern', 'ui_pattern', 'forbidden_seen']
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate testing-patterns output JSON.")
