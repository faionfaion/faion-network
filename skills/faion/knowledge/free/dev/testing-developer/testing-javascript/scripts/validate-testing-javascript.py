#!/usr/bin/env python3
"""validate-testing-javascript.py — validate output artefacts against the testing-javascript output contract.
...
REQUIRED = ['runner', 'config_file', 'environment', 'coverage_threshold', 'forbidden_seen']
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate testing-javascript output JSON.")
