#!/usr/bin/env python3
"""validate-testing-pytest.py — validate output artefacts against the testing-pytest output contract.
...
REQUIRED = ['test_files', 'fixture_count', 'parametrize_uses', 'scope_distribution', 'coverage_threshold', 'forbidden_seen']
FORBIDDEN_KEYS = ['f1', 'f2', 'f3', 'f4', 'f5']
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate testing-pytest output JSON.")
