#!/usr/bin/env python3
"""validate-unit-testing.py — validate output artefacts against the unit-testing output contract.
...
REQUIRED = ['naming_convention', 'aaa_compliance', 'avg_runtime_ms', 'coverage_line', 'coverage_branch', 'forbidden_seen']
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate unit-testing output JSON.")
