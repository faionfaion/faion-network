#!/usr/bin/env python3
"""validate-code-review-basics.py — validate a code-review-basics output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'pr_ref', 'checklist', 'verdict']
