#!/usr/bin/env python3
"""validate-refactoring-patterns.py — validate a refactoring-patterns output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'file', 'plan']
