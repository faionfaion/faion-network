#!/usr/bin/env python3
"""validate-code-decomposition-patterns.py — validate a code-decomposition-patterns output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'pattern', 'moves']
