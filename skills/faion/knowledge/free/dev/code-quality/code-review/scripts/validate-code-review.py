#!/usr/bin/env python3
"""validate-code-review.py — validate a code-review output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'pr_ref', 'verdict', 'categories', 'comments']
