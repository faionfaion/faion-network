#!/usr/bin/env python3
"""validate-code-decomposition-principles.py — validate a code-decomposition-principles output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'file_path', 'decision', 'signals', 'owner']
