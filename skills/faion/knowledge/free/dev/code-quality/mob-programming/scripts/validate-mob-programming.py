#!/usr/bin/env python3
"""validate-mob-programming.py — validate a mob-programming output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'topic', 'attendees', 'facilitator', 'rotation_minutes', 'agent_role']
