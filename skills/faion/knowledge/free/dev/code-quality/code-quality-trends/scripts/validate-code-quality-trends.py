#!/usr/bin/env python3
"""validate-code-quality-trends.py — validate a code-quality-trends output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'stack', 'categories', 'owner']
