#!/usr/bin/env python3
"""validate-code-review-process.py — validate a code-review-process output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'platform', 'pr_template', 'branch_protection', 'scenarios', 'metrics']
