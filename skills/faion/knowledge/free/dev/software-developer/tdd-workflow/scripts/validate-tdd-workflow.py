#!/usr/bin/env python3
"""Validate output contract for tdd-workflow.

USAGE:
    validate-tdd-workflow.py <input.json>        Validate a JSON artefact.
    validate-tdd-workflow.py --self-test         Run built-in fixture.
    validate-tdd-workflow.py --help              Show this help.
...
REQUIRED_FIELDS = ['red_commit_present', 'single_assertion_red', 'refactor_stays_green', 'spec_referenced']
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(prog="validate-tdd-workflow.py")
