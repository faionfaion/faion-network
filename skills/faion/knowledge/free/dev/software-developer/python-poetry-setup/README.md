...
- [PEP 517 - Build System](https://peps.python.org/pep-0517/) - Build system specification
- [PEP 518 - pyproject.toml](https://peps.python.org/pep-0518/) - Project metadata standard
- [Poetry GitHub](https://github.com/python-poetry/poetry) - Source code and issues
- [Poetry CI/CD Guide](https://python-poetry.org/docs/ci/) - Integration examples
