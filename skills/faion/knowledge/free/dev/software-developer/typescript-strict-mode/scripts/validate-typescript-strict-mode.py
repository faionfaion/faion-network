#!/usr/bin/env python3
"""Validate output contract for typescript-strict-mode.

USAGE:
    validate-typescript-strict-mode.py <input.json>        Validate a JSON artefact.
    validate-typescript-strict-mode.py --self-test         Run built-in fixture.
    validate-typescript-strict-mode.py --help              Show this help.
...
REQUIRED_FIELDS = ['strict_true', 'four_extras_enabled', 'zod_at_io', 'no_bare_any', 'no_unjustified_ts_ignore']
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(prog="validate-typescript-strict-mode.py")
