#!/usr/bin/env python3
"""validate-django-imports.py — Validate the django-imports output record against 02-output-contract.xml.
...
def validate(rec: dict) -> list[str]:
    out: list[str] = []
    if rec.get("produced_by") != "django-imports":
        out.append("produced_by must equal 'django-imports'")
