#!/usr/bin/env python3
"""validate-django-testing.py — Validate the django-testing output record against 02-output-contract.xml.
...
def validate(rec: dict) -> list[str]:
    out: list[str] = []
    if rec.get("produced_by") != "django-testing":
        out.append("produced_by must equal 'django-testing'")
