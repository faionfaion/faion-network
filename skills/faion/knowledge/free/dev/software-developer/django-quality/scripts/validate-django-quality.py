#!/usr/bin/env python3
"""validate-django-quality.py — Validate the django-quality output record against 02-output-contract.xml.
...
def validate(rec: dict) -> list[str]:
    out: list[str] = []
    if rec.get("produced_by") != "django-quality":
        out.append("produced_by must equal 'django-quality'")
