#!/usr/bin/env python3
"""validate-django-api.py — Validate the django-api output record against 02-output-contract.xml.
...
def validate(rec: dict) -> list[str]:
    out: list[str] = []
    if rec.get("produced_by") != "django-api":
        out.append("produced_by must equal 'django-api'")
