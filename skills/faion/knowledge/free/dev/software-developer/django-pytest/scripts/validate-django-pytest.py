#!/usr/bin/env python3
"""validate-django-pytest.py — Validate the django-pytest output record against 02-output-contract.xml.
...
def validate(rec: dict) -> list[str]:
    out: list[str] = []
    if rec.get("produced_by") != "django-pytest":
        out.append("produced_by must equal 'django-pytest'")
