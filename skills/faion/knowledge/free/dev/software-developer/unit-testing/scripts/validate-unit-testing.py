#!/usr/bin/env python3
"""Validate output contract for unit-testing.

USAGE:
    validate-unit-testing.py <input.json>        Validate a JSON artefact.
    validate-unit-testing.py --self-test         Run built-in fixture.
    validate-unit-testing.py --help              Show this help.
...
REQUIRED_FIELDS = ['aaa_explicit', 'single_behaviour_per_test', 'no_real_io_in_unit', 'descriptive_name']
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(prog="validate-unit-testing.py")
