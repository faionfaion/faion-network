#!/usr/bin/env python3
"""validate-code-review.py — Validate the code-review output record against 02-output-contract.xml.
...
def validate(rec: dict) -> list[str]:
    out: list[str] = []
    if rec.get("produced_by") != "code-review":
        out.append("produced_by must equal 'code-review'")
