#!/usr/bin/env python3
"""validate-javascript-testing.py — validate a javascript-testing output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'runner', 'dom', 'http_mock', 'coverage']
