#!/usr/bin/env python3
"""validate-javascript-modern.py — validate a javascript-modern output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'runtime', 'package_manager', 'tsconfig', 'eslint_config', 'named_exports_only']
