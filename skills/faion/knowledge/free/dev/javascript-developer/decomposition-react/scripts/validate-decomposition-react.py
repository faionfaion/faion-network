#!/usr/bin/env python3
"""validate-decomposition-react.py — validate a decomposition-react output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'component', 'extractions']
