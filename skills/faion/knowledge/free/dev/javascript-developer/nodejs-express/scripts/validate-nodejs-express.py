#!/usr/bin/env python3
"""validate-nodejs-express.py — validate a nodejs-express output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'service_name', 'routes', 'middleware', 'auth']
