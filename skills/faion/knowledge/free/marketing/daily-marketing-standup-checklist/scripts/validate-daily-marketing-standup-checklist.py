#!/usr/bin/env python3
"""validate-daily-marketing-standup-checklist.py — validate output artefacts against the daily-marketing-standup-checklist output contract.
...
REQUIRED = ['date', 'owner', 'one_thing_focus', 'content_queue_status', 'social_pulse', 'anomalies', 'forbidden_seen']
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate daily-marketing-standup-checklist output JSON.")
