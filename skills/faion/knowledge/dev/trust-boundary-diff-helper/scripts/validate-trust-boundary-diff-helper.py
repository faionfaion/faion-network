#!/usr/bin/env python3
"""validate-trust-boundary-diff-helper.py

Validate the artefact produced by the `trust-boundary-diff-helper` methodology against the
...
REQUIRED = ["artefact_id", "owner", "findings", "rationale", "inputs_used", "version", "last_reviewed"]
...
OK = json.loads(r"""{
  "artefact_id": "trust-boundary-diff-helper-2026Q2-001",
  "owner": "ruslan@faion.net",
  "findings": [
    {
      "id": "F-1",
      "severity": "high",
      "description": "Observed gap; cited evidence; owner assigned."
    }
  ],
