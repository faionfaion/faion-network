<!-- purpose: minimal E2E-to-Contract Migration Recipe artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-e2e-to-contract-migration-recipe.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# E2E-to-Contract Migration Recipe — Artefact

| Field | Value |
|-------|-------|
| artefact_id | e2e-to-contract-migration-recipe-YYYY-MM-DD |
