#!/usr/bin/env python3
"""validate-e2e-to-contract-migration-recipe.py

Validate a E2E-to-Contract Migration Recipe artefact against the JSON Schema (draft-07) defined in
...
OK = {'artefact_id': 'e2e-to-contract-migration-recipe-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'schema_path': 'draft', 'moved_cases': ['item-1'], 'stayed_cases': ['item-1'], 'pre_metrics': {'key': 'value'}, 'post_metrics': {'key': 'value'}, 'rollback_plan': 'draft'}
