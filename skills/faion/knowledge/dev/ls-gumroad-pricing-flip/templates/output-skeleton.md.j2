<!-- purpose: minimal LS / Gumroad Pricing Flip artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: decision-record artefact validated by scripts/validate-ls-gumroad-pricing-flip.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# LS / Gumroad Pricing Flip — Artefact

| Field | Value |
|-------|-------|
| artefact_id | ls-gumroad-pricing-flip-YYYY-MM-DD |
...
- [ ] `scripts/validate-ls-gumroad-pricing-flip.py --file artefact.json` exits 0
