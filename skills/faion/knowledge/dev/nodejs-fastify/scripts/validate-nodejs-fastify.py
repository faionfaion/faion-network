#!/usr/bin/env python3
"""validate-nodejs-fastify.py — validate a nodejs-fastify output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'service_name', 'routes', 'plugins']
