...
| `templates/charter.md.j2` | Markdown skeleton for the artefact. |
| `templates/charter.md` | Markdown skeleton for the artefact. Generated from `templates/charter.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
