#!/usr/bin/env python3
"""validate-github-repo-bootstrap.py — validate a github-repo-bootstrap output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'namespace', 'name', 'visibility', 'license', 'ci_stack', 'merge_mode']
