...
| `templates/compliance-aware-code-review-checklist.md.j2` | Markdown skeleton with the required fields |
| `templates/compliance-aware-code-review-checklist.md` | Markdown skeleton with the required fields Generated from `templates/compliance-aware-code-review-checklist.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/compliance-aware-code-review-checklist.json`

```json
{
  "$schema": "https://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/compliance-aware-code-review-checklist.json",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
...
```json
{
  "artefact_id": "compliance-aware-code-review-checklist-2026-05-23-001",
