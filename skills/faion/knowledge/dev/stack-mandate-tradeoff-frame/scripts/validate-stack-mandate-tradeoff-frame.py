#!/usr/bin/env python3
"""validate-stack-mandate-tradeoff-frame.py

Validate the artefact produced by the `stack-mandate-tradeoff-frame` methodology against the
...
OK = json.loads(r"""{
  "artefact_id": "stack-mandate-tradeoff-frame-2026Q2-001",
  "owner": "ruslan@faion.net",
  "title": "Example spec for stack-mandate-tradeoff-frame",
  "sections": [
    {
      "name": "Constraints",
