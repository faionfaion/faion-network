...
| File | Purpose |
|------|---------|
| `templates/output.md.j2` | Decision-record skeleton matching the schema in 02-output-contract.xml |
| `templates/output.md` | Decision-record skeleton matching the schema in 02-output-contract.xml Generated from `templates/output.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
