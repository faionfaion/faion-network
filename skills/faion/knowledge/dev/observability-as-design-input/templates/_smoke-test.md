<!--
purpose: Filled-in canonical example for observability-as-design-input
consumes: see AGENTS.md Prerequisites
produces: Observability As Design Input spec
depends-on: content/02-output-contract.xml schema
token-budget-impact: ~400 tokens when filled
-->

# Observability As Design Input — _smoke-test.md
