<!-- purpose: minimal Dependency Spike Kill-Criteria Template artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-dependency-spike-kill-criteria-template.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Dependency Spike Kill-Criteria Template — Artefact

| Field | Value |
|-------|-------|
| artefact_id | dependency-spike-kill-criteria-template-YYYY-MM-DD |
