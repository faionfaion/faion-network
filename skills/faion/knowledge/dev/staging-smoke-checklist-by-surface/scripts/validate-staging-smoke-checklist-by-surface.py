#!/usr/bin/env python3
"""validate-staging-smoke-checklist-by-surface.py

Validate an artefact produced by the staging-smoke-checklist-by-surface methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/staging-smoke-checklist-by-surface.json", "type": "object", "required": ["surfaces", "sign_off", "build_sha"], "properties": {"surfaces": {"type": "array", "minItems": 1, "maxItems": 3, "items": {"type": "object", "required": ["name", "items"], "properties": {"name": {"type": "string"}, "items": {"type": "array", "minItems": 1, "items": {"type": "object", "required": ["click", "expect"], "properties": {"click": {"type": "string"}, "expect": {"type": "string"}}}}}}}, "sign_off": {"type": "object", "required": ["initials", "utc_timestamp"], "properties": {"initials": {"type": "string"}, "utc_timestamp": {"type": "string"}}}, "build_sha": {"type": "string"}}}')
