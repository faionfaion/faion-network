#!/usr/bin/env python3
"""validate-debt-interest-vs-principal-rubric.py

Validate a debt-interest-vs-principal-rubric output artefact against the JSON Schema in
content/02-output-contract.xml (mirrored in templates/debt-interest-vs-principal-rubric.json).
...
def validate(obj: dict) -> list[str]:
    ...
    if "produces" in obj and obj["produces"] != "rubric":
        errs.append("produces must equal 'rubric' for this methodology")
    return errs
