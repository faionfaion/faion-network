...
| File | Purpose |
|------|---------|
| `templates/test-as-living-documentation.md.j2` | Markdown skeleton for the Test as Living Documentation artefact. |
| `templates/test-as-living-documentation.md` | Markdown skeleton for the Test as Living Documentation artefact. Generated from `templates/test-as-living-documentation.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
