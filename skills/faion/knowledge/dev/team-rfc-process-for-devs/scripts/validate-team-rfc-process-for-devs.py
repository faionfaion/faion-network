#!/usr/bin/env python3
"""validate-team-rfc-process-for-devs.py

Validate the artefact produced by the `team-rfc-process-for-devs` methodology against the
...
OK = json.loads(r"""{
  "artefact_id": "team-rfc-process-for-devs-2026Q2-001",
  "owner": "ruslan@faion.net",
  "title": "Example spec for team-rfc-process-for-devs",
  "sections": [
    {
      "name": "Constraints",
