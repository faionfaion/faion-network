<!--
purpose: Canonical skeleton for the `claude-md-creation` artefact.
consumes: A trigger URL + named owner + typed inputs from upstream methodologies.
produces: A committed artefact file at .product/claude-md-creation/<instance>.md.
depends-on: templates/header.yaml, scripts/validate-claude-md-creation.py.
