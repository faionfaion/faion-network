<!--
purpose: Log capturing reviewer + timestamp + check pass/fail per PR
consumes: see AGENTS.md Prerequisites
produces: Audit-Grade Code Review Checklist checklist
depends-on: content/02-output-contract.xml schema
token-budget-impact: ~400 tokens when filled
-->

# Audit-Grade Code Review Checklist — review-evidence-log.md
