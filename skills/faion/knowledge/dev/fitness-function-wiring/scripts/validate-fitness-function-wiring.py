#!/usr/bin/env python3
"""validate-fitness-function-wiring.py

Validate a fitness-function-wiring output artefact against the JSON Schema in
content/02-output-contract.xml (mirrored in templates/fitness-function-wiring.json).
...
def validate(obj: dict) -> list[str]:
    ...
    if "produces" in obj and obj["produces"] != "config":
        errs.append("produces must equal 'config' for this methodology")
    return errs
