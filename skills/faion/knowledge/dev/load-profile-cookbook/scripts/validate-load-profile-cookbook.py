#!/usr/bin/env python3
"""validate-load-profile-cookbook.py — validate load-profile-cookbook output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-load-profile-cookbook.py",
        description="Validate load-profile-cookbook output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
