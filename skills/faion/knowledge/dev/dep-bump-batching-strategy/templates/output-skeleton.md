<!-- purpose: minimal Dep Bump Batching Strategy artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: playbook-step artefact validated by scripts/validate-dep-bump-batching-strategy.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Dep Bump Batching Strategy — Artefact

| Field | Value |
|-------|-------|
| artefact_id | dep-bump-batching-strategy-YYYY-MM-DD |
