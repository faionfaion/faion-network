#!/usr/bin/env python3
"""validate-ai-pairing-decision-tree.py

Validate a AI Pairing Decision Tree artefact against the JSON Schema (draft-07) declared in
...
ARRAY_FIELDS = []
OBJECT_FIELDS = []
STRING_FIELDS = ["task_id", "stakes", "reversibility", "novelty", "supervision_budget", "verdict", "rationale"]
...
OK = {'artefact_id': 'ai-pairing-decision-tree-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'task_id': 'draft', 'stakes': 'draft', 'reversibility': 'draft', 'novelty': 'draft', 'supervision_budget': 'draft', 'verdict': 'draft', 'rationale': 'draft'}
BAD = {"foo": "bar"}
