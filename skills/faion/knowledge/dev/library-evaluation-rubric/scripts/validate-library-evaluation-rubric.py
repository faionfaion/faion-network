#!/usr/bin/env python3
"""validate-library-evaluation-rubric.py

Validate a Library Evaluation Rubric artefact against the JSON Schema (draft-07) declared in
...
REQUIRED = ['artefact_id', 'owner', 'last_touched', 'template_version', 'status', 'evidence', 'rubric_id', 'criteria', 'scores']
...
NUM_FIELDS = []
BOOL_FIELDS = []
ARRAY_FIELDS = ['criteria']
OBJECT_FIELDS = ['scores']
STRING_FIELDS = ['rubric_id']
...
OK = {'artefact_id': 'library-evaluation-rubric-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'rubric_id': 'draft', 'criteria': ['draft-criterion'], 'scores': {'key': 0}}
BAD = {"foo": "bar"}
