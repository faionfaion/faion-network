#!/usr/bin/env python3
"""validate-django-coding-standards.py — Validate the django-coding-standards output record against 02-output-contract.xml.
...
VALID = {
    "produced_by": "django-coding-standards",
    "version": "1.1.0",
...
def validate(rec: dict) -> list[str]:
    out: list[str] = []
    if rec.get("produced_by") != "django-coding-standards":
        out.append("produced_by must equal 'django-coding-standards'")
