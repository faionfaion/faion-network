<!--
purpose: Filled-in canonical example for perf-regression-alert-recipe
consumes: see AGENTS.md Prerequisites
produces: Perf Regression Alert Recipe config
depends-on: content/02-output-contract.xml schema
token-budget-impact: ~400 tokens when filled
-->

# Perf Regression Alert Recipe — _smoke-test.md
...
[Fill the config-shaped content here per content/02-output-contract.xml.]
