#!/usr/bin/env python3
"""validate-perf-regression-alert-recipe.py — validate perf-regression-alert-recipe output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-perf-regression-alert-recipe.py",
        description="Validate perf-regression-alert-recipe output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
