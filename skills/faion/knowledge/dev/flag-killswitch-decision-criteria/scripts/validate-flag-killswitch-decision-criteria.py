#!/usr/bin/env python3
"""validate-flag-killswitch-decision-criteria.py

Validate a flag-killswitch-decision-criteria output artefact against the JSON Schema in
content/02-output-contract.xml (mirrored in templates/flag-killswitch-decision-criteria.json).
...
def validate(obj: dict) -> list[str]:
    ...
    if "produces" in obj and obj["produces"] != "decision-record":
        errs.append("produces must equal 'decision-record' for this methodology")
    return errs
