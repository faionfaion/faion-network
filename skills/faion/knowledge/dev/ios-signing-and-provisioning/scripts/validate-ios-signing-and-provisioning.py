#!/usr/bin/env python3
"""validate-ios-signing-and-provisioning.py — validate ios-signing-and-provisioning output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        ...
        description="Validate ios-signing-and-provisioning output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
