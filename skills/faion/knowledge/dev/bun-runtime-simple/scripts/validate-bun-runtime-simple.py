#!/usr/bin/env python3
"""validate-bun-runtime-simple.py — validate a bun-runtime-simple output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'service_name', 'routes', 'auth']
