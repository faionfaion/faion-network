#!/usr/bin/env python3
"""validate-mobile-device-matrix-strategy.py — validate mobile-device-matrix-strategy output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-mobile-device-matrix-strategy.py",
        description="Validate mobile-device-matrix-strategy output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
