...
- Task is an instance of "unflake and parallelize a slow E2E suite" or a closely-adjacent variant.
...
|------|---------|--------------|
| `scripts/validate-e2e-suite-parallelization.py` | Enforce E2E Suite Parallelization output contract against the JSON Schema | After subagent returns, before downstream consumer reads |

## Related

- parent skill: `pro/dev/software-developer/`
- upstream activity: `unflake and parallelize a slow E2E suite`
...
### `templates/e2e-suite-parallelization.json`

```json
{
  "$schema": "https://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/e2e-suite-parallelization.json",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
...
```json
{
  "artefact_id": "e2e-suite-parallelization-2026-05-23-001",
