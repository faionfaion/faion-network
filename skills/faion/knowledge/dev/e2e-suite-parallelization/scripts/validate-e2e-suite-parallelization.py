#!/usr/bin/env python3
"""validate-e2e-suite-parallelization.py

Validate a e2e-suite-parallelization output artefact against the JSON Schema in
content/02-output-contract.xml (mirrored in templates/e2e-suite-parallelization.json).
