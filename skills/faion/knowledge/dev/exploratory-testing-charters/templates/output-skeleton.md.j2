<!-- purpose: minimal Exploratory Testing Charters artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-exploratory-testing-charters.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Exploratory Testing Charters — Artefact

| Field | Value |
|-------|-------|
| artefact_id | exploratory-testing-charters-YYYY-MM-DD |
