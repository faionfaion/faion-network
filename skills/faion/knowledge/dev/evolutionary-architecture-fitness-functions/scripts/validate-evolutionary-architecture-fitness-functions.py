#!/usr/bin/env python3
"""validate-evolutionary-architecture-fitness-functions.py — Validate a `evolutionary-architecture-fitness-functions` artefact against the output-contract schema.
