...
| `templates/figma-code-connect.md.j2` | Markdown skeleton with the required fields |
| `templates/figma-code-connect.md` | Markdown skeleton with the required fields Generated from `templates/figma-code-connect.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/figma-code-connect.json`

```json
{
  "$schema": "https://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/figma-code-connect.json",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
...
```json
{
  "artefact_id": "figma-code-connect-2026-05-23-001",
