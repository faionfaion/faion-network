#!/usr/bin/env python3
"""validate-figma-code-connect.py

Validate a figma-code-connect output artefact against the JSON Schema in
content/02-output-contract.xml (mirrored in templates/figma-code-connect.json).
