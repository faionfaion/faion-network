#!/usr/bin/env python3
"""validate-dual-write-outbox-decision-guide.py

Validate a dual-write-outbox-decision-guide output artefact against the JSON Schema in
content/02-output-contract.xml (mirrored in templates/dual-write-outbox-decision-guide.json).
