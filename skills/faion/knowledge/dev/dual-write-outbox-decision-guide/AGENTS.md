...
| `templates/dual-write-outbox-decision-guide.md.j2` | Markdown skeleton with the required fields |
| `templates/dual-write-outbox-decision-guide.md` | Markdown skeleton with the required fields Generated from `templates/dual-write-outbox-decision-guide.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
