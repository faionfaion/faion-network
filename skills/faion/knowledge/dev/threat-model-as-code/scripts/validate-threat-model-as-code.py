#!/usr/bin/env python3
"""validate-threat-model-as-code.py

Validate the artefact produced by the `threat-model-as-code` methodology against the
...
OK = json.loads(r"""{
  "artefact_id": "threat-model-as-code-2026Q2-001",
