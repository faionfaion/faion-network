<!--
purpose: Filled-in canonical example for lock-in-risk-scoring-rubric
consumes: see AGENTS.md Prerequisites
produces: Lock In Risk Scoring Rubric rubric
depends-on: content/02-output-contract.xml schema
token-budget-impact: ~400 tokens when filled
-->

# Lock In Risk Scoring Rubric — _smoke-test.md
