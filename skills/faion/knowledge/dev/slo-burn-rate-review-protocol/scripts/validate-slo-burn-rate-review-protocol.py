#!/usr/bin/env python3
"""validate-slo-burn-rate-review-protocol.py — validate output artefacts against the slo-burn-rate-review-protocol output contract.
...
REQUIRED = ["week_id", "date", "attendees", "burn_trace", "matrix_actions", "decisions_made"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate slo-burn-rate-review-protocol output JSON.")
