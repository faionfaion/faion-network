#!/usr/bin/env python3
"""validate-seo-for-spas.py

Validate an artefact produced by the seo-for-spas methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/seo-for-spas.json", "type": "object", "required": ["routes", "metadata_strategy", "structured_data", "sitemap", "cwv_targets"], "properties": {"routes": {"type": "array", "minItems": 1, "items": {"type": "object", "required": ["path", "rendering_mode"]}}, "metadata_strategy": {"type": "string", "enum": ["per_route", "global_only"]}, "structured_data": {"type": "object", "required": ["enabled", "types"]}, "sitemap": {"type": "object", "required": ["path", "auto_generated"]}, "hreflang": {"type": "array", "items": {"type": "string"}}, "cwv_targets": {"type": "object", "required": ["lcp_ms", "inp_ms", "cls"]}}}')
