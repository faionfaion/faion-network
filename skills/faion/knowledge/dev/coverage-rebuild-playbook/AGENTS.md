...
| `templates/coverage-rebuild-playbook.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/coverage-rebuild-playbook.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/coverage-rebuild-playbook.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/coverage-rebuild-playbook.json`

```json
{
  "artefact_id": "coverage-rebuild-playbook-example",
  "version": "1.0.0",
