#!/usr/bin/env python3
"""validate-openapi-specification.py

Validate an artefact produced by the openapi-specification methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/openapi-specification.json", "type": "object", "required": ["openapi_version", "canonical_path", "lint_config", "breaking_change_gate", "operation_id_coverage"], "properties": {"openapi_version": {"type": "string", "enum": ["3.0.3", "3.1.0", "3.1.1"]}, "canonical_path": {"type": "string"}, "lint_config": {"type": "object", "required": ["redocly", "spectral"]}, "breaking_change_gate": {"type": "object", "required": ["enabled", "tool"]}, "operation_id_coverage": {"type": "object", "required": ["covered", "total"]}, "components_reuse_ratio": {"type": "number"}}}')
