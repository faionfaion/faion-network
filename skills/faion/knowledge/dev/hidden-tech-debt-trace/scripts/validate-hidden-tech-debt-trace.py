#!/usr/bin/env python3
"""validate-hidden-tech-debt-trace.py

Validate a Hidden Tech Debt Trace artefact against the JSON Schema (draft-07) declared in
...
REQUIRED = ['artefact_id', 'owner', 'last_touched', 'template_version', 'status', 'evidence', 'report_id', 'findings', 'recommendations']
...
OK = {'artefact_id': 'hidden-tech-debt-trace-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'report_id': 'draft', 'findings': ['draft-finding'], 'recommendations': ['draft-rec']}
BAD = {"foo": "bar"}
