<!--
purpose: Filled-in canonical example for junior-next-pr-checklist-template
consumes: see AGENTS.md Prerequisites
produces: Junior Next Pr Checklist Template checklist
depends-on: content/02-output-contract.xml schema
token-budget-impact: ~400 tokens when filled
-->

# Junior Next Pr Checklist Template — _smoke-test.md
...
[Fill the checklist-shaped content here per content/02-output-contract.xml.]
