#!/usr/bin/env python3
"""validate-contract-testing-consumer-driven.py

Validate a contract-testing-consumer-driven output artefact against the JSON Schema in
content/02-output-contract.xml (mirrored in templates/contract-testing-consumer-driven.json).
