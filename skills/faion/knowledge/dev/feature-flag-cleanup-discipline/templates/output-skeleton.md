<!-- purpose: minimal Feature Flag Cleanup Discipline artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: playbook-step artefact validated by scripts/validate-feature-flag-cleanup-discipline.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Feature Flag Cleanup Discipline — Artefact

| Field | Value |
|-------|-------|
| artefact_id | feature-flag-cleanup-discipline-YYYY-MM-DD |
