#!/usr/bin/env python3
"""validate-weekly-arch-review-agenda-template.py — validate output artefacts against the weekly-arch-review-agenda-template output contract.
...
REQUIRED = ["week_id", "date", "attendees", "items", "decisions_made"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate weekly-arch-review-agenda-template output JSON.")
