#!/usr/bin/env python3
"""Validate output contract for tailwind.

USAGE:
    validate-tailwind.py <input.json>        Validate a JSON artefact.
    validate-tailwind.py --self-test         Run built-in fixture.
    validate-tailwind.py --help              Show this help.
...
REQUIRED_FIELDS = ['tokens_in_config', 'cn_with_merge_used', 'no_hardcoded_token_equivalents', 'mobile_first_prefixes']
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(prog="validate-tailwind.py")
