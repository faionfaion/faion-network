...
| File | Purpose |
|------|---------|
| `templates/tech-debt-sprint-template.md.j2` | Markdown skeleton for the Tech Debt Sprint Template artefact. |
| `templates/tech-debt-sprint-template.md` | Markdown skeleton for the Tech Debt Sprint Template artefact. Generated from `templates/tech-debt-sprint-template.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
