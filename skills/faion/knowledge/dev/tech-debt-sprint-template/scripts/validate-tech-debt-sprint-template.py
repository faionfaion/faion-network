#!/usr/bin/env python3
"""validate-tech-debt-sprint-template.py

Validate an artefact produced by the tech-debt-sprint-template methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/tech-debt-sprint-template.json", "type": "object", "required": ["artefact_id", "owner", "sprint_window", "scope_items", "guardrails", "exit_metrics", "version", "last_reviewed"], "properties": {"artefact_id": {"type": "string", "minLength": 1}, "owner": {"type": "string", "minLength": 1}, "sprint_window": {"type": "object", "required": ["start", "end"], "properties": {"start": {"type": "string"}, "end": {"type": "string"}}}, "scope_items": {"type": "array", "minItems": 1, "items": {"type": "object", "required": ["id", "title", "size"], "properties": {"id": {"type": "string"}, "title": {"type": "string"}, "size": {"type": "string", "enum": ["XS", "S", "M", "L"]}}}}, "guardrails": {"type": "array", "minItems": 1, "items": {"type": "string"}}, "exit_metrics": {"type": "object", "required": ["lint_warn_before", "lint_warn_target"], "properties": {"lint_warn_before": {"type": "integer", "minimum": 0}, "lint_warn_target": {"type": "integer", "minimum": 0}, "coverage_pct_target": {"type": "number"}}}, "retro_link": {"type": "string"}, "version": {"type": "string", "minLength": 1}, "last_reviewed": {"type": "string", "minLength": 1}}}')
