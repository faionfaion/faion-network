#!/usr/bin/env python3
"""validate-qa-metrics-slos.py

Validate the output artefact for the `qa-metrics-slos` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/qa-metrics-slos.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'qa-metrics-slos',
    'title': 'QA Metrics & SLOs',
...
BAD = {"slug": "BAD_qa-metrics-slos", "owner": "someone"}
