#!/usr/bin/env python3
"""validate-visual-regression-testing.py

Validate the output artefact for the `visual-regression-testing` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/visual-regression-testing.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'visual-regression-testing',
...
BAD = {"slug": "BAD_visual-regression-testing", "owner": "someone"}
