<!--
purpose: Filled-in canonical example for pr-pattern-mining-for-feedback
consumes: see AGENTS.md Prerequisites
produces: Pr Pattern Mining For Feedback report
depends-on: content/02-output-contract.xml schema
token-budget-impact: ~400 tokens when filled
-->

# Pr Pattern Mining For Feedback — _smoke-test.md
