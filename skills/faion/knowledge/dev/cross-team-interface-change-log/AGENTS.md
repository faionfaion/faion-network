...
- Task is an instance of "cross-team architecture sync (weekly)" or a closely-adjacent variant.
...
| File | Purpose |
|------|---------|
| `templates/cross-team-interface-change-log.json` | JSON Schema for the report output contract |
| `templates/cross-team-interface-change-log.md.j2` | Markdown skeleton with the required fields |
| `templates/cross-team-interface-change-log.md` | Markdown skeleton with the required fields Generated from `templates/cross-team-interface-change-log.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
|------|---------|--------------|
| `scripts/validate-cross-team-interface-change-log.py` | Enforce Cross Team Interface Change Log output contract against the JSON Schema | After subagent returns, before downstream consumer reads |

## Related

- parent skill: `pro/dev/software-developer/`
- upstream activity: `cross-team architecture sync (weekly)`
