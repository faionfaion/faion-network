#!/usr/bin/env python3
"""validate-diagram-as-code-mermaid-structurizr.py

Validate a Diagram-as-Code with Mermaid / Structurizr artefact against the JSON Schema (draft-07) defined in
...
OK = {'artefact_id': 'diagram-as-code-mermaid-structurizr-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'diagrams': ['item-1'], 'render_command': 'draft', 'ci_check': 'draft', 'doc_links': ['item-1']}
