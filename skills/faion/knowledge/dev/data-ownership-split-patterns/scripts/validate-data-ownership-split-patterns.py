#!/usr/bin/env python3
"""validate-data-ownership-split-patterns.py

Validate a data-ownership-split-patterns output artefact against the JSON Schema in
content/02-output-contract.xml (mirrored in templates/data-ownership-split-patterns.json).
