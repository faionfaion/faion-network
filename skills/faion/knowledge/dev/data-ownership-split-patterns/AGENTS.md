...
| `templates/data-ownership-split-patterns.md.j2` | Markdown skeleton with the required fields |
| `templates/data-ownership-split-patterns.md` | Markdown skeleton with the required fields Generated from `templates/data-ownership-split-patterns.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/data-ownership-split-patterns.json`

```json
{
  "$schema": "https://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/data-ownership-split-patterns.json",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
...
```json
{
  "artefact_id": "data-ownership-split-patterns-2026-05-23-001",
