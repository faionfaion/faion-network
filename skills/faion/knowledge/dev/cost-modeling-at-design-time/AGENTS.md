...
- Task is an instance of "cost + latency budget before design freeze" or a closely-adjacent variant.
...
|------|---------|--------------|
| `scripts/validate-cost-modeling-at-design-time.py` | Enforce Cost Modeling At Design Time output contract against the JSON Schema | After subagent returns, before downstream consumer reads |

## Related

- parent skill: `pro/dev/software-developer/`
- upstream activity: `cost + latency budget before design freeze`
...
### `templates/cost-modeling-at-design-time.json`

```json
{
  "$schema": "https://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/cost-modeling-at-design-time.json",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
...
```json
{
  "artefact_id": "cost-modeling-at-design-time-2026-05-23-001",
