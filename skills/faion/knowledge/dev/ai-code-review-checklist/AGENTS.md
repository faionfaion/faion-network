...
| `templates/checklist-trace.md.j2` | Markdown skeleton the reviewer fills (12 rows + verdict). |
| `templates/checklist-trace.md` | Markdown skeleton the reviewer fills (12 rows + verdict). Generated from `templates/checklist-trace.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
