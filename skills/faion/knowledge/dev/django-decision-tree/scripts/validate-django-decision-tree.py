#!/usr/bin/env python3
"""validate-django-decision-tree.py — Validate the django-decision-tree output record against 02-output-contract.xml.
...
VALID = {
    "produced_by": "django-decision-tree",
    "version": "1.1.0",
...
def validate(rec: dict) -> list[str]:
    out: list[str] = []
    if rec.get("produced_by") != "django-decision-tree":
        out.append("produced_by must equal 'django-decision-tree'")
