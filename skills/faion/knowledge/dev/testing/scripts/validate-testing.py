#!/usr/bin/env python3
"""Validate output contract for testing.

USAGE:
    validate-testing.py <input.json>        Validate a JSON artefact.
    validate-testing.py --self-test         Run built-in fixture.
    validate-testing.py --help              Show this help.
...
REQUIRED_FIELDS = ['aaa_pattern', 'tests_isolated', 'tests_idempotent', 'coverage_gate_present', 'lanes_separated']
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(prog="validate-testing.py")
