#!/usr/bin/env python3
"""validate-performance-budget-design.py — validate performance-budget-design output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-performance-budget-design.py",
        description="Validate performance-budget-design output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
