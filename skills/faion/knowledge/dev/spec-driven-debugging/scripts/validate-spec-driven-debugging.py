#!/usr/bin/env python3
"""validate-spec-driven-debugging.py

Validate an artefact produced by the spec-driven-debugging methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/spec-driven-debugging.json", "type": "object", "required": ["bug_id", "symptom", "expected", "repro_loc", "fix_commit", "regression_test_path"], "properties": {"bug_id": {"type": "string"}, "symptom": {"type": "string"}, "expected": {"type": "string"}, "repro_loc": {"type": "integer", "maximum": 20}, "bisect_commit": {"type": "string"}, "fix_commit": {"type": "string"}, "regression_test_path": {"type": "string"}, "incident_link": {"type": "string"}}}')
