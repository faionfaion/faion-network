#!/usr/bin/env python3
"""validate-qa-test-pyramid-vs-trophy-decision.py — validate a qa-test-pyramid-vs-trophy-decision output JSON against the methodology schema.
...
VALID_FIXTURE = {
    "artefact_id": "qa-test-pyramid-vs-trophy-decision-2026-q2",
    "version": "1.1.0",
