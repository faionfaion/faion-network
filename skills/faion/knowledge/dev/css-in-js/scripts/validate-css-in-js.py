#!/usr/bin/env python3
"""validate-css-in-js.py — Validate the css-in-js output record against 02-output-contract.xml.
...
def validate(rec: dict) -> list[str]:
    out: list[str] = []
    if rec.get("produced_by") != "css-in-js":
        out.append("produced_by must equal 'css-in-js'")
