#!/usr/bin/env python3
"""validate-distributed-pitfalls-catalog.py

Validate a distributed-pitfalls-catalog output artefact against the JSON Schema in
content/02-output-contract.xml (mirrored in templates/distributed-pitfalls-catalog.json).
