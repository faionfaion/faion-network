...
| File | Purpose |
|------|---------|
| `templates/distributed-pitfalls-catalog.json` | JSON Schema for the report output contract |
| `templates/distributed-pitfalls-catalog.md.j2` | Markdown skeleton with the required fields |
| `templates/distributed-pitfalls-catalog.md` | Markdown skeleton with the required fields Generated from `templates/distributed-pitfalls-catalog.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
|------|---------|--------------|
| `scripts/validate-distributed-pitfalls-catalog.py` | Enforce Distributed Pitfalls Catalog output contract against the JSON Schema | After subagent returns, before downstream consumer reads |
...
### `templates/distributed-pitfalls-catalog.json`

```json
{
  "$schema": "https://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/distributed-pitfalls-catalog.json",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
...
```json
{
  "artefact_id": "distributed-pitfalls-catalog-2026-05-23-001",
