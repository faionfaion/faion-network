#!/usr/bin/env python3
"""validate-weekly-branch-hygiene-checklist.py — validate a weekly-branch-hygiene-checklist output JSON against the methodology schema.
...
VALID_FIXTURE = {
    "artefact_id": "weekly-branch-hygiene-checklist-2026-q2",
    "version": "1.1.0",
