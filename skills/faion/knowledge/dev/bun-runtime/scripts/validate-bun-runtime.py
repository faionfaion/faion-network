#!/usr/bin/env python3
"""validate-bun-runtime.py — Validate the bun-runtime output record against 02-output-contract.xml.
...
def validate(rec: dict) -> list[str]:
    out: list[str] = []
    if rec.get("produced_by") != "bun-runtime":
        out.append("produced_by must equal 'bun-runtime'")
