<!-- purpose: minimal Hot Path Baseline Template artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-hot-path-baseline-template.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Hot Path Baseline Template — Artefact

| Field | Value |
|-------|-------|
| artefact_id | hot-path-baseline-template-YYYY-MM-DD |
...
- [ ] `scripts/validate-hot-path-baseline-template.py --file artefact.json` exits 0
