...
| File | Purpose |
|------|---------|
| `templates/page-object-pattern-guide.md.j2` | Markdown skeleton for the Page Object Pattern at Scale (Playwright / Cypress) artefact. |
| `templates/page-object-pattern-guide.md` | Markdown skeleton for the Page Object Pattern at Scale (Playwright / Cypress) artefact. Generated from `templates/page-object-pattern-guide.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
