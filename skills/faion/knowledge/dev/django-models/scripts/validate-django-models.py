#!/usr/bin/env python3
"""validate-django-models.py — Validate the django-models output record against 02-output-contract.xml.
...
def validate(rec: dict) -> list[str]:
    out: list[str] = []
    if rec.get("produced_by") != "django-models":
        out.append("produced_by must equal 'django-models'")
