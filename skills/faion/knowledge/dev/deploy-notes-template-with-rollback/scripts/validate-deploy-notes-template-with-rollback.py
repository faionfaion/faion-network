#!/usr/bin/env python3
"""validate-deploy-notes-template-with-rollback.py

Validate a Deploy Notes Template with Rollback artefact against the JSON Schema (draft-07) defined in
...
OK = {'artefact_id': 'deploy-notes-template-with-rollback-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'deployable_id': 'draft', 'blast_radius': ['item-1'], 'rollback_recipe': 'draft', 'verification_steps': [{'key': 'value'}, {'key': 'value-1'}], 'rollback_window': 'draft', 'operator': 'draft'}
