<!-- purpose: minimal Deploy Notes Template with Rollback artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-deploy-notes-template-with-rollback.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Deploy Notes Template with Rollback — Artefact

| Field | Value |
|-------|-------|
| artefact_id | deploy-notes-template-with-rollback-YYYY-MM-DD |
