...
| `templates/agent-prompt.md.j2` | Prompt skeleton for an LLM scrape agent (forces robots.txt + tool order). |
| `templates/agent-prompt.md` | Prompt skeleton for an LLM scrape agent (forces robots.txt + tool order). Generated from `templates/agent-prompt.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
