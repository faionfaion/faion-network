...
| File | Purpose |
|------|---------|
| `templates/feature-flag-weekly-review-template.json` | JSON Schema for the report output contract |
| `templates/feature-flag-weekly-review-template.md.j2` | Markdown skeleton with the required fields |
| `templates/feature-flag-weekly-review-template.md` | Markdown skeleton with the required fields Generated from `templates/feature-flag-weekly-review-template.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
|------|---------|--------------|
| `scripts/validate-feature-flag-weekly-review-template.py` | Enforce Feature Flag Weekly Review Template output contract against the JSON Schema | After subagent returns, before downstream consumer reads |
...
### `templates/feature-flag-weekly-review-template.json`

```json
{
  "$schema": "https://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/feature-flag-weekly-review-template.json",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
...
```json
{
  "artefact_id": "feature-flag-weekly-review-template-2026-05-23-001",
