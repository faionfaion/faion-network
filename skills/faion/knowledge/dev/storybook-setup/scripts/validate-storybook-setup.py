#!/usr/bin/env python3
"""Validate output contract for storybook-setup.

USAGE:
    validate-storybook-setup.py <input.json>        Validate a JSON artefact.
    validate-storybook-setup.py --self-test         Run built-in fixture.
    validate-storybook-setup.py --help              Show this help.
...
REQUIRED_FIELDS = ['csf3_used', 'autodocs_present', 'args_cover_required', 'chromatic_in_ci']
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(prog="validate-storybook-setup.py")
