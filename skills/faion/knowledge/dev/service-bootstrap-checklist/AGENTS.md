...
| `templates/runbook.md.j2` | Markdown skeleton for the artefact. |
| `templates/runbook.md` | Markdown skeleton for the artefact. Generated from `templates/runbook.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
