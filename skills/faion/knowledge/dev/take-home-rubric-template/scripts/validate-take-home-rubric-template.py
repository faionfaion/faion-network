#!/usr/bin/env python3
"""validate-take-home-rubric-template.py — validate output artefacts against the take-home-rubric-template output contract.
...
REQUIRED = ["rubric_id", "criteria", "weights", "anchors", "threshold", "owner"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate take-home-rubric-template output JSON.")
