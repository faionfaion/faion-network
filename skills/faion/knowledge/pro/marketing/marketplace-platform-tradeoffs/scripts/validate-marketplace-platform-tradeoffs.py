#!/usr/bin/env python3
"""validate-marketplace-platform-tradeoffs.py

Validate the artefact produced by the marketplace-platform-tradeoffs methodology against the JSON
