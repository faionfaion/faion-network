<!-- purpose: canonical markdown skeleton for the Scope Creep Prevention On Hourly artefact -->
<!-- consumes: typed inputs declared in content/02-output-contract.xml -->
<!-- produces: filled artefact for validate-scope-creep-prevention-on-hourly.py -->
...
# Scope Creep Prevention On Hourly
