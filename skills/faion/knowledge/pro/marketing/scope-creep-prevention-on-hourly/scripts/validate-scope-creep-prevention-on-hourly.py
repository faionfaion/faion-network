#!/usr/bin/env python3
"""validate-scope-creep-prevention-on-hourly.py

Validate an artefact produced by the `scope-creep-prevention-on-hourly` methodology against the
...
_OK_FIXTURE = {
    "artefact_id": "scope-creep-prevention-on-hourly-2026-05-23-01",
    "owner": "Anna Schmidt",
