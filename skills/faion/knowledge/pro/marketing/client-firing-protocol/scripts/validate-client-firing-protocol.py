#!/usr/bin/env python3
"""validate-client-firing-protocol.py

Validate the output artefact for the `client-firing-protocol` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/client-firing-protocol.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'client-firing-protocol',
    'title': 'Client Firing Protocol',
...
BAD = {"slug": "BAD_client-firing-protocol", "owner": "someone"}
