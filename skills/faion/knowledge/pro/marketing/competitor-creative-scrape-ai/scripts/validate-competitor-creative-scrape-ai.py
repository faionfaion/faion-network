#!/usr/bin/env python3
"""validate-competitor-creative-scrape-ai.py

Validate the output artefact for the `competitor-creative-scrape-ai` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/competitor-creative-scrape-ai.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'competitor-creative-scrape-ai',
    'title': 'Competitor Creative Scrape AI',
...
BAD = {"slug": "BAD_competitor-creative-scrape-ai", "owner": "someone"}
