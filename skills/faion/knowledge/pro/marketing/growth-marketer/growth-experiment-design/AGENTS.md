...
summary: Generates a one-page growth experiment doc: hypothesis, ICE score, control group, instrumentation playback, sample size, write-up template.
content_id: "2b8aa83b65c3ce6a"
complexity: medium
produces: spec
est_tokens: 4900
tags: [growth, experiments, ice, hypothesis, ab-test, instrumentation]
---
...
| File | Purpose |
|------|---------|
| `templates/growth-experiment-design.spec.md` | Markdown spec skeleton with 5-line header |
