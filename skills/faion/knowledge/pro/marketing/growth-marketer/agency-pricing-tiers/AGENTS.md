...
maintainers: [faion]
summary: End-to-end playbook for agency pricing tiers that walks an operator from trigger to closed outcome with named artefacts at each step.
content_id: "79a86048f51e6066"
tags: [agency, marketing, playbook]
---
# Agency Pricing Tiers

## Summary

**One-sentence:** End-to-end playbook for agency pricing tiers that walks an operator from trigger to closed outcome with named artefacts at each step.

**One-paragraph:** End-to-end playbook for agency pricing tiers that walks an operator from trigger to closed outcome with named artefacts at each step. ops-pricing-strategy is generic SaaS-flavored. Agencies need a good/better/best service-tier construction methodology: what to put in each tier so the 'best' is the actual margin tier, how to anchor on the middle, how to handle scope-up mid-engagement. This is missing.

## Applies If (ALL must hold)

- You are executing the cross-cutting workflow addressed by agency pricing tiers end to end.
