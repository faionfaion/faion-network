...
Validates a playbook-step artefact produced by methodology 'agency-pricing-tiers' against the
...
def validate(obj) -> list:
    ...
    if "slug" in obj and obj["slug"] != "agency-pricing-tiers":
        errs.append(f"slug must equal 'agency-pricing-tiers'")
    if "steps" in obj:
...
def self_test() -> int:
    ...
    if errs:
        ...
        return 1
    errs2 = validate({"slug": "agency-pricing-tiers"})
    if not errs2:
