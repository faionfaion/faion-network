#!/usr/bin/env python3
"""validate-retention-strategies.py

Validate the output artefact for the `retention-strategies` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#', '$id': 'https://faion.net/schemas/retention-strategies.json', 'type': 'object', 'required': ['primary_loop', 'secondary_loop', 'mechanics', 're_engagement_windows', 'ab_test_status', 'owner', 'produced_at'], 'additionalProperties': True}
...
OK = {'primary_loop': 'content_publishing', 'secondary_loop': 'workflow_habit', 'mechanics': [{'name': 'streaks', 'schedule': 'variable', 'ab_status': 'validated_2026-Q1'}], 're_engagement_windows': [30, 60, 90], 'ab_test_status': 'passed', 'owner': {'name': 'Olha Riznyk', 'role': 'head of product'}, 'produced_at': '2026-05-23T10:00:00Z'}
BAD = {'primary_loop': ['content', 'viral', 'social', 'workflow'], 'ab_test_status': 'skipped'}
