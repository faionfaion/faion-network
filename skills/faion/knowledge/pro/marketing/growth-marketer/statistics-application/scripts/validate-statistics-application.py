#!/usr/bin/env python3
"""validate-statistics-application.py

Validate the output artefact for the `statistics-application` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#', '$id': 'https://faion.net/schemas/statistics-application.json', 'type': 'object', 'required': ['test_id', 'n1', 'x1', 'n2', 'x2', 'mde_declared', 'sample_size_pre_committed', 'p_value', 'confidence_interval', 'verdict', 'produced_at'], 'additionalProperties': True}
...
OK = {'test_id': 'headline-2026-04', 'n1': 4200, 'x1': 412, 'n2': 4180, 'x2': 489, 'mde_declared': 0.015, 'sample_size_pre_committed': True, 'p_value': 0.018, 'confidence_interval': [0.004, 0.034], 'verdict': 'significant_ship', 'produced_at': '2026-05-23T10:00:00Z'}
BAD = {'test_id': 'x', 'verdict': 'looks good'}
