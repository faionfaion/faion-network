#!/usr/bin/env python3
"""validate-agency-content-pillars-niche.py

Validates a playbook-step artefact produced by methodology 'agency-content-pillars-niche' against the
...
def validate(obj) -> list:
    ...
    if "slug" in obj and obj["slug"] != "agency-content-pillars-niche":
        errs.append(f"slug must equal 'agency-content-pillars-niche'")
    if "steps" in obj:
...
def self_test() -> int:
    ...
    if errs:
        ...
        return 1
    errs2 = validate({"slug": "agency-content-pillars-niche"})
    if not errs2:
