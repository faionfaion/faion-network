#!/usr/bin/env python3
"""validate-viral-loops.py

Validate the output artefact for the `viral-loops` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#', '$id': 'https://faion.net/schemas/viral-loops.json', 'type': 'object', 'required': ['primary_archetype', 'secondary_archetype', 'k_factor_target', 'k_factor_actual', 'retention_d30', 'incentive_cost_pct_cac', 'owner', 'produced_at'], 'additionalProperties': True}
...
OK = {'primary_archetype': 'inherent', 'secondary_archetype': 'content', 'k_factor_target': 0.45, 'k_factor_actual': 0.38, 'retention_d30': 0.42, 'incentive_cost_pct_cac': 0.3, 'owner': {'name': 'Olha Riznyk', 'role': 'head of growth'}, 'produced_at': '2026-05-23T11:00:00Z'}
BAD = {'primary_archetype': ['wom', 'incentivized'], 'k_factor_target': 2.0}
