#!/usr/bin/env python3
"""validate-retention-metrics.py

Validate the output artefact for the `retention-metrics` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#', '$id': 'https://faion.net/schemas/retention-metrics.json', 'type': 'object', 'required': ['metrics', 'sql_refs', 'cadence', 'segments', 'owner', 'produced_at'], 'additionalProperties': True}
...
OK = {'metrics': ['d1_retention', 'd7_retention', 'd30_retention', 'dau_mau', 'monthly_churn', 'churn_risk_score'], 'sql_refs': {'d1_retention': 'sql/d1_retention.sql', 'monthly_churn': 'sql/monthly_churn.sql'}, 'cadence': {'default': 'monthly', 'deep_dive': 'quarterly'}, 'segments': ['plan_tier', 'acquisition_cohort'], 'owner': {'name': 'Tetiana Lytvyn', 'role': 'head of product'}, 'produced_at': '2026-05-23T09:00:00Z'}
BAD = {'metrics': ['dau_only'], 'cadence': 'quarterly'}
