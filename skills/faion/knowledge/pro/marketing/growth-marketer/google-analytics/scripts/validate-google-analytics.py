...
Validates a config artefact produced by methodology 'google-analytics' against the
...
def validate(obj) -> list:
    ...
    if "slug" in obj and obj["slug"] != "google-analytics":
        errs.append(f"slug must equal 'google-analytics'")
...
FIXTURE_OK = {"slug": "google-analytics", "owner": "growth ops", "settings": {"property_id": "G-XXXXXXX", "stream": "web", "consent_mode": "v2"}, "deviation_log_reference": "ops/deviation-log.md#L120"}
...
def self_test() -> int:
    ...
    if errs:
        ...
        return 1
    errs2 = validate({"slug": "google-analytics"})
    if not errs2:
