#!/usr/bin/env python3
"""validate-viral-optimization.py

Validate the output artefact for the `viral-optimization` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#', '$id': 'https://faion.net/schemas/viral-optimization.json', 'type': 'object', 'required': ['test_id', 'leg_tested', 'variant', 'k_lift_raw', 'k_lift_effective', 'cycles_run', 'ship_decision', 'owner', 'produced_at'], 'additionalProperties': True}
...
OK = {'test_id': 'invite-landing-v3', 'leg_tested': 'c', 'variant': 'single-cta-headline', 'k_lift_raw': 0.08, 'k_lift_effective': 0.06, 'cycles_run': 3, 'ship_decision': 'ship', 'owner': {'name': 'Olha Riznyk', 'role': 'head of growth'}, 'produced_at': '2026-05-23T13:00:00Z'}
BAD = {'test_id': 'x', 'leg_tested': 'both', 'ship_decision': 'maybe'}
