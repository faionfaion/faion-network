#!/usr/bin/env python3
"""validate-serp-movement-alert-rules.py

Validate the output artefact for the `serp-movement-alert-rules` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#', '$id': 'https://faion.net/schemas/serp-movement-alert-rules.json', 'type': 'object', 'required': ['alert_rules', 'owners', 'review_sla_hours', 'alert_destinations', 'produced_at'], 'additionalProperties': True}
...
OK = {'alert_rules': [{'id': 'impressions_drop_30pct', 'metric': 'impressions_wow_delta', 'threshold': -0.3, 'window_days': 7, 'owner': 'Olha Riznyk'}, {'id': 'position_delta_3', 'metric': 'avg_position_delta', 'threshold': 3, 'window_days': 7, 'owner': 'Olha Riznyk'}, {'id': 'ai_overview_appearance', 'metric': 'ai_overview_present', 'threshold': 'any', 'window_days': 1, 'owner': 'Olha Riznyk'}], 'owners': {'Olha Riznyk': 'head of seo'}, 'review_sla_hours': 48, 'alert_destinations': ['#seo-alerts', 'olha@example.com'], 'produced_at': '2026-05-23T11:00:00Z'}
BAD = {'alert_rules': [], 'review_sla_hours': 'soon'}
