#!/usr/bin/env python3
"""validate-agency-cashflow-management.py

Validate the output artefact for the `agency-cashflow-management` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/agency-cashflow-management.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'agency-cashflow-management',
    'title': 'Agency Cashflow Management',
...
BAD = {"slug": "BAD_agency-cashflow-management", "owner": "someone"}
