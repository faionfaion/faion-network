#!/usr/bin/env python3
"""validate-rate-raise-conversation-script.py

Validate an artefact produced by the `rate-raise-conversation-script` methodology against the
...
_OK_FIXTURE = {
    "artefact_id": "rate-raise-conversation-script-2026-05-23-01",
    "owner": "Anna Schmidt",
