#!/usr/bin/env python3
"""validate-plg-metrics.py

Validate the output artefact for the `plg-metrics` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/plg-metrics.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
BAD = {"slug": "BAD_plg-metrics", "owner": "someone"}
