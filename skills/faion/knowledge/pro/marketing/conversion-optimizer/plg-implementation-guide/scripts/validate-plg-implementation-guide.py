#!/usr/bin/env python3
"""validate-plg-implementation-guide.py

Validate the output artefact for the `plg-implementation-guide` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/plg-implementation-guide.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'plg-implementation-guide',
    'title': 'PLG Implementation Guide',
...
BAD = {"slug": "BAD_plg-implementation-guide", "owner": "someone"}
