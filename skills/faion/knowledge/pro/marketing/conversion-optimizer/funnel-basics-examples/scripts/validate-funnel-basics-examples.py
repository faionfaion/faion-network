#!/usr/bin/env python3
"""validate-funnel-basics-examples.py

Validate the output artefact for the `funnel-basics-examples` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/funnel-basics-examples.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'funnel-basics-examples',
    'title': 'Funnel Basics Examples',
...
BAD = {"slug": "BAD_funnel-basics-examples", "owner": "someone"}
