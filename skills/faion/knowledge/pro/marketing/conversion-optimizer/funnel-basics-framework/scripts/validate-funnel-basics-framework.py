#!/usr/bin/env python3
"""validate-funnel-basics-framework.py

Validate the output artefact for the `funnel-basics-framework` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/funnel-basics-framework.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'funnel-basics-framework',
    'title': 'Funnel Basics Framework',
...
BAD = {"slug": "BAD_funnel-basics-framework", "owner": "someone"}
