#!/usr/bin/env python3
"""validate-funnel-tactics-advanced.py

Validate the output artefact for the `funnel-tactics-advanced` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/funnel-tactics-advanced.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'funnel-tactics-advanced',
    'title': 'Funnel Tactics Advanced',
...
BAD = {"slug": "BAD_funnel-tactics-advanced", "owner": "someone"}
