#!/usr/bin/env python3
"""validate-agency-case-study-template.py

Validate the output artefact for the `agency-case-study-template` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/agency-case-study-template.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'agency-case-study-template',
    'title': 'Agency Case Study Template',
...
BAD = {"slug": "BAD_agency-case-study-template", "owner": "someone"}
