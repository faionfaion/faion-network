#!/usr/bin/env python3
"""validate-plg-basics.py

Validate the output artefact for the `plg-basics` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/plg-basics.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
BAD = {"slug": "BAD_plg-basics", "owner": "someone"}
