#!/usr/bin/env python3
"""validate-growth-conversion-optimization.py

Validate the output artefact for the `growth-conversion-optimization` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/growth-conversion-optimization.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'growth-conversion-optimization',
...
BAD = {"slug": "BAD_growth-conversion-optimization", "owner": "someone"}
