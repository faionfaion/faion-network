#!/usr/bin/env python3
"""validate-funnel-tactics-basics.py

Validate the output artefact for the `funnel-tactics-basics` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/funnel-tactics-basics.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'funnel-tactics-basics',
    'title': 'Funnel Tactics Basics',
...
BAD = {"slug": "BAD_funnel-tactics-basics", "owner": "someone"}
