#!/usr/bin/env python3
"""validate-onboarding-flows.py

Validate the output artefact for the `onboarding-flows` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/onboarding-flows.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
BAD = {"slug": "BAD_onboarding-flows", "owner": "someone"}
