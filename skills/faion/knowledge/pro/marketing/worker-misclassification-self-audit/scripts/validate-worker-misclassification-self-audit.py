#!/usr/bin/env python3
"""validate-worker-misclassification-self-audit.py

Validate an artefact produced by the `worker-misclassification-self-audit` methodology against the
...
_OK_FIXTURE = {
    "artefact_id": "worker-misclassification-self-audit-2026-05-23-01",
    "owner": "Anna Schmidt",
