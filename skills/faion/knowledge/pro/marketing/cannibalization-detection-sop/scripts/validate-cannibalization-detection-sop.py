#!/usr/bin/env python3
"""validate-cannibalization-detection-sop.py

Validate the output artefact for the `cannibalization-detection-sop` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/cannibalization-detection-sop.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'cannibalization-detection-sop',
    'title': 'Cannibalization Detection SOP',
...
BAD = {"slug": "BAD_cannibalization-detection-sop", "owner": "someone"}
