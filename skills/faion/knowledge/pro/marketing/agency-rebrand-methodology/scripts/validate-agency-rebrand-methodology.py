#!/usr/bin/env python3
"""validate-agency-rebrand-methodology.py

Validate the output artefact for the `agency-rebrand-methodology` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/agency-rebrand-methodology.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'agency-rebrand-methodology',
    'title': 'Agency Rebrand Methodology',
...
BAD = {"slug": "BAD_agency-rebrand-methodology", "owner": "someone"}
