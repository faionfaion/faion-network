#!/usr/bin/env python3
"""validate-topic-cluster-architecture-with-eeat.py

Validate an artefact produced by the `topic-cluster-architecture-with-eeat` methodology against the
...
_OK_FIXTURE = {
    "artefact_id": "topic-cluster-architecture-with-eeat-2026-05-23-01",
    "owner": "Anna Schmidt",
