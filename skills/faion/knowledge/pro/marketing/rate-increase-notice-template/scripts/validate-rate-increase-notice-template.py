#!/usr/bin/env python3
"""validate-rate-increase-notice-template.py

Validate an artefact produced by the `rate-increase-notice-template` methodology against the
...
_OK_FIXTURE = {
    "artefact_id": "rate-increase-notice-template-2026-05-23-01",
    "owner": "Anna Schmidt",
