#!/usr/bin/env python3
"""validate-ads-conversion-tracking.py

Validate the artefact produced by the ads-conversion-tracking methodology against the JSON
