#!/usr/bin/env python3
"""validate-growth-brand-positioning.py

Validate the output artefact for the `growth-brand-positioning` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#', '$id': 'https://faion.net/schemas/growth-brand-positioning.json', 'type': 'object', 'required': ['customer_definition', 'alternatives', 'only_we_differentiator', 'category', 'positioning_statement', 'interview_count', 'owner', 'produced_at'], 'additionalProperties': True}
...
OK = {'customer_definition': {'buying_authority': 'head of growth', 'trigger': 'churn pain >5% monthly', 'firmographic': 'B2B SaaS series-A'}, 'alternatives': ['spreadsheets', 'internal tool', 'do_nothing', 'Competitor X'], 'only_we_differentiator': '30-day cohort retention monitoring without a data engineer', 'category': 'retention analytics for growth-stage B2B SaaS', 'positioning_statement': 'For heads of growth at B2B SaaS series-A with churn pain, RetentionHQ is retention analytics that gives a cohort dashboard in 30 minutes — unlike spreadsheets or warehouse tools, no data engineer required.', 'interview_count': 12, 'owner': {'name': 'Tetiana Lytvyn', 'role': 'founder'}, 'produced_at': '2026-05-23T13:00:00Z'}
BAD = {'customer_definition': 'marketers', 'interview_count': 0}
