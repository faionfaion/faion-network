#!/usr/bin/env python3
"""validate-solo-freelancer-contract-clauses.py

Validate an artefact produced by the `solo-freelancer-contract-clauses` methodology against the
...
_OK_FIXTURE = {
    "artefact_id": "solo-freelancer-contract-clauses-2026-05-23-01",
    "owner": "Anna Schmidt",
