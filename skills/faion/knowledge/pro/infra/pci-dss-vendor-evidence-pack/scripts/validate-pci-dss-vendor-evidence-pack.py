#!/usr/bin/env python3
"""validate-pci-dss-vendor-evidence-pack.py — enforce the output contract for PCI-DSS Vendor Evidence Pack.
...
CLI:
  ...
  python validate-pci-dss-vendor-evidence-pack.py <artefact.json>      validate an artefact file
  python validate-pci-dss-vendor-evidence-pack.py --help               print help
  python validate-pci-dss-vendor-evidence-pack.py --self-test          run built-in fixture
"""
...
SLUG = "pci-dss-vendor-evidence-pack"
EXPECTED_PRODUCES = "report"
