<!-- purpose: Parameterized architecture design prompt -->
...
# AWS Infrastructure Design — LLM Prompt Templates — design-prompt.md
...
Replace this section with the methodology-specific body. See AGENTS.md for required structure.
