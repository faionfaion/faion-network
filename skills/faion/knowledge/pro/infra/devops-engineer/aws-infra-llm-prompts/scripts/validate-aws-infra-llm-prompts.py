#!/usr/bin/env python3
"""validate-aws-infra-llm-prompts.py — validate artefact produced by the aws-infra-llm-prompts methodology.
...
OK_FIXTURE = {
    "artefact_id": "aws-infra-llm-prompts-2026-05-23-001",
...
BAD_FIXTURE = {
    "artefact_id": "aws-infra-llm-prompts-bad",
    "owner": "team",
    "decision": "apply",
    "rationale": "obvious",
    "inputs_used": [],
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Validate AWS Infrastructure Design — LLM Prompt Templates artefact",
