#!/usr/bin/env python3
"""validate-finops-devops-cost-tagging.py

Validate a `config` artefact for the finops-devops-cost-tagging methodology against the
...
OK = {'slug': 'finops-devops-cost-tagging', 'version': '1.0.0', 'settings': {'key1': 'value1', 'key2': 'value2', 'key3': 'value3'}, 'applied_to': ['prod'], 'notes': 'Generated by finops-devops-cost-tagging methodology.'}
BAD = {'slug': 'finops-devops-cost-tagging'}
