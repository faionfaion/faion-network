...
Validate a `checklist` artefact for the kubernetes methodology against the
...
OK = {'slug': 'kubernetes', 'summary': 'Validated kubernetes checklist applied to a single review.', 'items': [{'id': 'i1', 'rule': 'First rule verified in scope', 'must_or_should': 'MUST', 'evidence': 'PR comment ID 42'}, {'id': 'i2', 'rule': 'Second rule verified in scope', 'must_or_should': 'MUST', 'evidence': 'plan output line 7'}, {'id': 'i3', 'rule': 'Third rule verified in scope', 'must_or_should': 'SHOULD', 'evidence': 'monitoring dashboard'}, {'id': 'i4', 'rule': 'Fourth rule verified in scope', 'must_or_should': 'MUST', 'evidence': 'policy report'}, {'id': 'i5', 'rule': 'Fifth rule verified in scope', 'must_or_should': 'SHOULD', 'evidence': 'design doc section 3'}]}
BAD = {'slug': 'kubernetes'}
