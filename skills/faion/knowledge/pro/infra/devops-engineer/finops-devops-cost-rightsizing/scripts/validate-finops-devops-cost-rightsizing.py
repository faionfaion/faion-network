#!/usr/bin/env python3
"""validate-finops-devops-cost-rightsizing.py

Validate a `report` artefact for the finops-devops-cost-rightsizing methodology against the
...
OK = {'slug': 'finops-devops-cost-rightsizing', 'period': {'from': '2026-04-01', 'to': '2026-04-30'}, 'findings': [{'id': 'f1', 'severity': 'high', 'summary': 'Over-provisioned m5.4xlarge in api-prod'}], 'recommendations': [{'id': 'r1', 'action': 'downsize to m5.2xlarge', 'expected_saving_usd': 1280}], 'estimated_savings_usd': 1280}
BAD = {'slug': 'finops-devops-cost-rightsizing'}
