...
summary: Generates a production-ready HAProxy (or Nginx) load-balancer config — frontend/backend separation, ACL path routing, sticky cookies, stick-table rate-limiting, L4 DB mode, SSL termination, and Docker Compose bundle.
content_id: "e61fef0f16d9edfd"
complexity: medium
produces: config
est_tokens: 4500
