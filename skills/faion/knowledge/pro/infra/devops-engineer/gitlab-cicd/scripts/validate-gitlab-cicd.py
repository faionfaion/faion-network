...
Validate a `config` artefact for the gitlab-cicd methodology against the
...
OK = {'slug': 'gitlab-cicd', 'version': '1.0.0', 'settings': {'key1': 'value1', 'key2': 'value2', 'key3': 'value3'}, 'applied_to': ['prod'], 'notes': 'Generated by gitlab-cicd methodology.'}
BAD = {'slug': 'gitlab-cicd'}
