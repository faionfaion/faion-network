#!/usr/bin/env python3
"""validate-gcp-landing-zone.py

Validate a `spec` artefact for the gcp-landing-zone methodology against the
...
OK = {'slug': 'gcp-landing-zone', 'title': 'Gcp Landing Zone', 'scope': 'Production deployment for service X across two environments.', 'components': [{'name': 'frontend'}, {'name': 'api'}], 'decisions': [{'id': 'd1', 'topic': 'topology', 'choice': 'regional'}, {'id': 'd2', 'topic': 'pool', 'choice': 'spot'}, {'id': 'd3', 'topic': 'identity', 'choice': 'WIF'}]}
BAD = {'slug': 'gcp-landing-zone'}
