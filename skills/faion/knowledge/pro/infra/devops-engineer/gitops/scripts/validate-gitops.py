...
Validate a `spec` artefact for the gitops methodology against the
...
OK = {'slug': 'gitops', 'title': 'Gitops', 'scope': 'Production deployment for service X across two environments.', 'components': [{'name': 'frontend'}, {'name': 'api'}], 'decisions': [{'id': 'd1', 'topic': 'topology', 'choice': 'regional'}, {'id': 'd2', 'topic': 'pool', 'choice': 'spot'}, {'id': 'd3', 'topic': 'identity', 'choice': 'WIF'}]}
BAD = {'slug': 'gitops'}
