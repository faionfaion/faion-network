#!/usr/bin/env python3
"""validate-gcp-gke-architecture.py

Validate a `spec` artefact for the gcp-gke-architecture methodology against the
...
OK = {'slug': 'gcp-gke-architecture', 'title': 'Gcp Gke Architecture', 'scope': 'Production deployment for service X across two environments.', 'components': [{'name': 'frontend'}, {'name': 'api'}], 'decisions': [{'id': 'd1', 'topic': 'topology', 'choice': 'regional'}, {'id': 'd2', 'topic': 'pool', 'choice': 'spot'}, {'id': 'd3', 'topic': 'identity', 'choice': 'WIF'}]}
BAD = {'slug': 'gcp-gke-architecture'}
