#!/usr/bin/env python3
"""validate-alert-deduplication-playbook.py — validate artefact produced by the alert-deduplication-playbook methodology.
...
OK_FIXTURE = {
    "artefact_id": "alert-deduplication-playbook-2026-05-23-001",
...
BAD_FIXTURE = {
    "artefact_id": "alert-deduplication-playbook-bad",
    "owner": "team",
    "decision": "apply",
    "rationale": "obvious",
    "inputs_used": [],
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Validate Alert Deduplication Playbook artefact",
