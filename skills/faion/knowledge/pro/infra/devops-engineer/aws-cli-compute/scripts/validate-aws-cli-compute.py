#!/usr/bin/env python3
"""validate-aws-cli-compute.py — validate artefact produced by the aws-cli-compute methodology.
...
OK_FIXTURE = {
    "artefact_id": "aws-cli-compute-2026-05-23-001",
...
BAD_FIXTURE = {
    "artefact_id": "aws-cli-compute-bad",
    "owner": "team",
    "decision": "apply",
    "rationale": "obvious",
    "inputs_used": [],
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Validate AWS CLI Compute and Storage Operations (EC2 S3 Lambda) artefact",
