#!/usr/bin/env python3
"""validate-agency-year-end-close-checklist.py — validate artefact produced by the agency-year-end-close-checklist methodology.
...
OK_FIXTURE = {
    "artefact_id": "agency-year-end-close-checklist-2026-05-23-001",
...
BAD_FIXTURE = {
    "artefact_id": "agency-year-end-close-checklist-bad",
    "owner": "team",
    "decision": "apply",
    "rationale": "obvious",
    "inputs_used": [],
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Validate Agency Year-End Close Checklist artefact",
