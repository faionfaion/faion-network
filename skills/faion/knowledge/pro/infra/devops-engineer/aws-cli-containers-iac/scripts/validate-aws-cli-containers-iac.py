#!/usr/bin/env python3
"""validate-aws-cli-containers-iac.py — validate artefact produced by the aws-cli-containers-iac methodology.
...
OK_FIXTURE = {
    "artefact_id": "aws-cli-containers-iac-2026-05-23-001",
...
BAD_FIXTURE = {
    "artefact_id": "aws-cli-containers-iac-bad",
    "owner": "team",
    "decision": "apply",
    "rationale": "obvious",
    "inputs_used": [],
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Validate AWS CLI Containers Databases IaC Identity Monitoring artefact",
