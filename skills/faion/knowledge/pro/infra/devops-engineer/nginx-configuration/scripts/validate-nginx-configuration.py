...
Validate a `config` artefact for the nginx-configuration methodology against the
...
OK = {'slug': 'nginx-configuration', 'version': '1.0.0', 'settings': {'key1': 'value1', 'key2': 'value2', 'key3': 'value3'}, 'applied_to': ['prod'], 'notes': 'Generated by nginx-configuration methodology.'}
BAD = {'slug': 'nginx-configuration'}
