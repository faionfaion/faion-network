#!/usr/bin/env python3
"""validate-opentelemetry-rollout-runbook.py — enforce the output contract for OpenTelemetry Rollout Runbook.
...
CLI:
  ...
  python validate-opentelemetry-rollout-runbook.py <artefact.json>      validate an artefact file
  python validate-opentelemetry-rollout-runbook.py --help               print help
  python validate-opentelemetry-rollout-runbook.py --self-test          run built-in fixture
"""
