#!/usr/bin/env python3
"""validate-shared-infra-capacity-board.py

Validate the output artefact for the `shared-infra-capacity-board` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#',
 '$id': 'https://faion.net/schemas/shared-infra-capacity-board.json',
 'type': 'object',
 'required': ['slug',
              'title',
              'owner',
...
OK = {'slug': 'shared-infra-capacity-board',
 'title': 'Shared Infra Capacity Board',
