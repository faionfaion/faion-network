#!/usr/bin/env python3
"""validate-on-call-shift-retro-cadence.py — enforce the output contract for On-Call Shift Retro Cadence.
...
CLI:
  ...
  python validate-on-call-shift-retro-cadence.py <artefact.json>      validate an artefact file
  python validate-on-call-shift-retro-cadence.py --help               print help
  python validate-on-call-shift-retro-cadence.py --self-test          run built-in fixture
"""
