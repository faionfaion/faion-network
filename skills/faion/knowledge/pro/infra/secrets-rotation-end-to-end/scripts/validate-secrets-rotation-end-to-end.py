#!/usr/bin/env python3
"""validate-secrets-rotation-end-to-end.py

Validate the output artefact for the `secrets-rotation-end-to-end` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#',
 '$id': 'https://faion.net/schemas/secrets-rotation-end-to-end.json',
 'type': 'object',
 'required': ['slug',
              'title',
              'owner',
...
OK = {'slug': 'secrets-rotation-end-to-end',
 'title': 'Secrets Rotation End-to-End',
