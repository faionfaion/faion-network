<!--
purpose: Terraform Modules — Structure - spec skeleton matching `produces=spec`
consumes: typed inputs from AGENTS.md Prerequisites table
produces: filled spec artefact validated by scripts/validate-terraform-modules-structure.py
depends-on: content/01-core-rules.xml, content/02-output-contract.xml
token-budget-impact: ~600 tokens for a typical instance
-->
# Terraform Modules — Structure — {artefact_id}
