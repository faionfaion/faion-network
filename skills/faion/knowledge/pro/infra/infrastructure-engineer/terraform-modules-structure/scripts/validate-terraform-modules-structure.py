#!/usr/bin/env python3
"""validate-terraform-modules-structure.py — enforce the output contract for Terraform Modules — Structure.
...
CLI:
  ...
  python validate-terraform-modules-structure.py <artefact.json>      validate an artefact file
  python validate-terraform-modules-structure.py --help               print help
  python validate-terraform-modules-structure.py --self-test          run built-in fixture
"""
