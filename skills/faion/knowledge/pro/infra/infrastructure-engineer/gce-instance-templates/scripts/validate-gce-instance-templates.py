#!/usr/bin/env python3
"""validate-gce-instance-templates.py — F-066 output-contract validator for `gce-instance-templates`.
...
REQUIRED = ["name", "machine_type", "image", "service_account", "startup_script", "metadata"]
...
OK_FIXTURE = {"name": "example-name", "machine_type": "example-machine_type", "image": "example-image", "service_account": 1, "startup_script": "example-startup_script", "metadata": "example-metadata"}
