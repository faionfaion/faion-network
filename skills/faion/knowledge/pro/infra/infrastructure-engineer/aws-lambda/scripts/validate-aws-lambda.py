#!/usr/bin/env python3
"""validate-aws-lambda.py

Validate the output artefact for the `aws-lambda` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/aws-lambda.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
BAD = {"slug": "BAD_aws-lambda", "owner": "someone"}
