#!/usr/bin/env python3
"""validate-aws-ec2-ecs.py

Validate the output artefact for the `aws-ec2-ecs` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/aws-ec2-ecs.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
BAD = {"slug": "BAD_aws-ec2-ecs", "owner": "someone"}
