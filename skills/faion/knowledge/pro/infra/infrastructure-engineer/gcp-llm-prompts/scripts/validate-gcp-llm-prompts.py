#!/usr/bin/env python3
"""validate-gcp-llm-prompts.py — F-066 output-contract validator for `gcp-llm-prompts`.
...
REQUIRED = ["task", "template_id", "inputs", "expected_output_shape", "constraints"]
...
OK_FIXTURE = {"task": "example-task", "template_id": "example-template_id", "inputs": [], "expected_output_shape": "example-expected_output_shape", "constraints": "example-constraints"}
