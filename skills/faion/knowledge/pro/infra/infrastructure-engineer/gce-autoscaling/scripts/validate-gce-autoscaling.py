#!/usr/bin/env python3
"""validate-gce-autoscaling.py — F-066 output-contract validator for `gce-autoscaling`.
...
REQUIRED = ["mig", "metric", "target", "min_replicas", "max_replicas", "cool_down_seconds"]
...
OK_FIXTURE = {"mig": "example-mig", "metric": "example-metric", "target": "example-target", "min_replicas": 1, "max_replicas": 1, "cool_down_seconds": 1}
