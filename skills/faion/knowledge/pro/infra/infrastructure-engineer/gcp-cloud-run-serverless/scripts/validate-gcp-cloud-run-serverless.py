#!/usr/bin/env python3
"""validate-gcp-cloud-run-serverless.py — F-066 output-contract validator for `gcp-cloud-run-serverless`.
...
REQUIRED = ["name", "image", "min_instances", "max_instances", "concurrency", "cpu", "memory"]
...
OK_FIXTURE = {"name": "example-name", "image": "example-image", "min_instances": 1, "max_instances": 1, "concurrency": 1, "cpu": "example-cpu", "memory": 1}
