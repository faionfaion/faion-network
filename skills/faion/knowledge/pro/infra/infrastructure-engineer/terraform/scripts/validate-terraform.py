#!/usr/bin/env python3
"""validate-terraform.py — enforce the output contract for Terraform (Advanced).
...
CLI:
  ...
  python validate-terraform.py <artefact.json>      validate an artefact file
  python validate-terraform.py --help               print help
  python validate-terraform.py --self-test          run built-in fixture
"""
