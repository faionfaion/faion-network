#!/usr/bin/env python3
"""validate-cloud-run-monitoring.py — F-066 output-contract validator for `cloud-run-monitoring`.
...
REQUIRED = ["service_name", "log_format", "alert_policies", "trace_propagation", "notification_channels"]
...
OK_FIXTURE = {"service_name": "example-service_name", "log_format": "example-log_format", "alert_policies": [], "trace_propagation": True, "notification_channels": []}
