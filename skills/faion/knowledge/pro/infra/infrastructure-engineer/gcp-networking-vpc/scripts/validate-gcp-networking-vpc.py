#!/usr/bin/env python3
"""validate-gcp-networking-vpc.py — F-066 output-contract validator for `gcp-networking-vpc`.
...
REQUIRED = ["vpc_name", "mode", "subnets", "firewall_basis", "flow_logs"]
...
OK_FIXTURE = {"vpc_name": "example-vpc_name", "mode": "example-mode", "subnets": [], "firewall_basis": "example-firewall_basis", "flow_logs": "example-flow_logs"}
