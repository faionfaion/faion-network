#!/usr/bin/env python3
"""validate-terraform-modules-composition.py — enforce the output contract for Terraform Modules — Composition.
...
CLI:
  ...
  python validate-terraform-modules-composition.py <artefact.json>      validate an artefact file
  python validate-terraform-modules-composition.py --help               print help
  python validate-terraform-modules-composition.py --self-test          run built-in fixture
"""
