#!/usr/bin/env python3
"""validate-gcp-overview-cli.py — F-066 output-contract validator for `gcp-overview-cli`.

Validates a checklist artefact (JSON / YAML / Markdown front-matter) against the
...
REQUIRED = ["configuration", "auth_mode", "default_project", "impersonation_target"]
...
OK_FIXTURE = {"configuration": "example-configuration", "auth_mode": "example-auth_mode", "default_project": "example-default_project", "impersonation_target": "example-impersonation_target"}
