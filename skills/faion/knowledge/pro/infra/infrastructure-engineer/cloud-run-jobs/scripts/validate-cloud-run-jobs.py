#!/usr/bin/env python3
"""validate-cloud-run-jobs.py — F-066 output-contract validator for `cloud-run-jobs`.
...
REQUIRED = ["name", "image", "task_count", "parallelism", "task_timeout", "max_retries", "idempotent"]
...
OK_FIXTURE = {"name": "example-name", "image": "example-image", "task_count": 1, "parallelism": "example-parallelism", "task_timeout": 1, "max_retries": 1, "idempotent": True}
