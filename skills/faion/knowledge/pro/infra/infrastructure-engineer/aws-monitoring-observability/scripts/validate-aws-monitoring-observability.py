#!/usr/bin/env python3
"""validate-aws-monitoring-observability.py

Validate the output artefact for the `aws-monitoring-observability` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/aws-monitoring-observability.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'aws-monitoring-observability',
    'title': 'AWS Monitoring + Observability',
...
BAD = {"slug": "BAD_aws-monitoring-observability", "owner": "someone"}
