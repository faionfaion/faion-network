#!/usr/bin/env python3
"""validate-docker.py — F-066 output-contract validator for `docker`.
...
REQUIRED = ["base_image", "multi_stage", "user", "healthcheck", "pinned_digest"]
...
OK_FIXTURE = {"base_image": "example-base_image", "multi_stage": True, "user": "example-user", "healthcheck": "example-healthcheck", "pinned_digest": True}
