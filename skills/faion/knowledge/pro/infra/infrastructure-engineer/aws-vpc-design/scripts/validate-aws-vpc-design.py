#!/usr/bin/env python3
"""validate-aws-vpc-design.py

Validate the output artefact for the `aws-vpc-design` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/aws-vpc-design.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
BAD = {"slug": "BAD_aws-vpc-design", "owner": "someone"}
