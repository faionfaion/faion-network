#!/usr/bin/env python3
"""validate-gcp-org-policies.py — F-066 output-contract validator for `gcp-org-policies`.
...
REQUIRED = ["constraint", "level", "enforcement", "exceptions"]
...
OK_FIXTURE = {"constraint": "example-constraint", "level": "example-level", "enforcement": "example-enforcement", "exceptions": []}
