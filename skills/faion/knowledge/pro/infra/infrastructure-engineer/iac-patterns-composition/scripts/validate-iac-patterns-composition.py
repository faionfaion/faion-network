#!/usr/bin/env python3
"""validate-iac-patterns-composition.py

Validate the output artefact for the `iac-patterns-composition` methodology against the JSON
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#', '$id': 'https://faion.net/schemas/iac-patterns-composition.json', 'type': 'object', 'required': ['root_name', 'leaves', 'graph_acyclic', 'outputs_documented', 'owner', 'produced_at'], 'properties': {'root_name': {'type': 'string', 'pattern': '^[a-z][a-z0-9-]+$'}, 'leaves': {'type': 'array', 'items': {'type': 'object', 'required': ['name', 'version', 'owners'], 'properties': {'name': {'type': 'string'}, 'version': {'type': 'string'}, 'owners': {'type': 'array', 'items': {'type': 'string'}, 'minItems': 1}}}, 'minItems': 1}, 'graph_acyclic': {'type': 'boolean', 'const': True}, 'outputs_documented': {'type': 'boolean', 'const': True}, 'owner': {'type': 'object', 'required': ['name', 'role'], 'properties': {'name': {'type': 'string'}, 'role': {'type': 'string'}}}, 'produced_at': {'type': 'string', 'format': 'date-time'}}, 'additionalProperties': True}
...
OK = {'root_name': 'acme-prod-root', 'leaves': [{'name': 'network', 'version': 'v1.4.0', 'owners': ['platform']}, {'name': 'iam', 'version': 'v2.0.0', 'owners': ['security']}, {'name': 'workload', 'version': 'v0.7.2', 'owners': ['app-team']}], 'graph_acyclic': True, 'outputs_documented': True, 'owner': {'name': 'Andriy Koval', 'role': 'platform lead'}, 'produced_at': '2026-05-23T10:00:00Z'}
BAD = {'root_name': 'BAD', 'leaves': []}
