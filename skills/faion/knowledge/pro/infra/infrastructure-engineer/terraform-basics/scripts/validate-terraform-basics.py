#!/usr/bin/env python3
"""validate-terraform-basics.py — enforce the output contract for Terraform Basics.
...
CLI:
  ...
  python validate-terraform-basics.py <artefact.json>      validate an artefact file
  python validate-terraform-basics.py --help               print help
  python validate-terraform-basics.py --self-test          run built-in fixture
"""
