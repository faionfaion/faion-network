<!--
purpose: smoke-test fixture for terraform-basics
consumes: nothing; self-contained fixture
produces: minimum-viable filled instance; passes `scripts/validate-terraform-basics.py`
depends-on: templates/spec.md
token-budget-impact: ~250 tokens
-->

# Terraform Basics — terraform-basics-smoke-test

| Field | Value |
|-------|-------|
| artefact_id | terraform-basics-smoke-test |
| produces | spec |
