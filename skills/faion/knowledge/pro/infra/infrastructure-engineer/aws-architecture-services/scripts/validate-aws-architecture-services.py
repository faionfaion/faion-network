#!/usr/bin/env python3
"""validate-aws-architecture-services.py

Validate the output artefact for the `aws-architecture-services` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/aws-architecture-services.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'aws-architecture-services',
...
BAD = {"slug": "BAD_aws-architecture-services", "owner": "someone"}
