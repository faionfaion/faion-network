#!/usr/bin/env python3
"""validate-aws-ec2-provisioning.py

Validate the output artefact for the `aws-ec2-provisioning` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/aws-ec2-provisioning.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
BAD = {"slug": "BAD_aws-ec2-provisioning", "owner": "someone"}
