#!/usr/bin/env python3
"""validate-gcp-resource-hierarchy.py — F-066 output-contract validator for `gcp-resource-hierarchy`.

Validates a spec artefact (JSON / YAML / Markdown front-matter) against the
...
REQUIRED = ["organization", "folders", "projects", "naming_convention", "policy_inheritance"]
...
OK_FIXTURE = {"organization": "example-organization", "folders": [], "projects": [], "naming_convention": "example-naming_convention", "policy_inheritance": "example-policy_inheritance"}
