#!/usr/bin/env python3
"""validate-cloud-run-vpc-access.py — F-066 output-contract validator for `cloud-run-vpc-access`.
...
REQUIRED = ["service", "egress_mode", "connector_or_subnet", "egress_setting"]
...
OK_FIXTURE = {"service": "example-service", "egress_mode": "example-egress_mode", "connector_or_subnet": "example-connector_or_subnet", "egress_setting": "example-egress_setting"}
