#!/usr/bin/env python3
"""validate-cloud-run-autoscaling.py

Validate the output artefact for the `cloud-run-autoscaling` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/cloud-run-autoscaling.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
BAD = {"slug": "BAD_cloud-run-autoscaling", "owner": "someone"}
