#!/usr/bin/env python3
"""validate-gce-spot-vms.py — F-066 output-contract validator for `gce-spot-vms`.
...
REQUIRED = ["scheduling", "provisioning_model", "instance_termination_action", "checkpoint_target"]
...
OK_FIXTURE = {"scheduling": "example-scheduling", "provisioning_model": "example-provisioning_model", "instance_termination_action": "example-instance_termination_action", "checkpoint_target": "example-checkpoint_target"}
