#!/usr/bin/env python3
"""validate-aws-cost-optimization.py

Validate the output artefact for the `aws-cost-optimization` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/aws-cost-optimization.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
BAD = {"slug": "BAD_aws-cost-optimization", "owner": "someone"}
