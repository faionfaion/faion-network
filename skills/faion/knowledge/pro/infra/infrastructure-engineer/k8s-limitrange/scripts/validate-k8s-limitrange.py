#!/usr/bin/env python3
"""validate-k8s-limitrange.py

Validate the output artefact for the `k8s-limitrange` methodology against the JSON
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#', '$id': 'https://faion.net/schemas/k8s-limitrange.json', 'type': 'object', 'required': ['namespace', 'tier', 'container_defaults', 'container_default_requests', 'container_max', 'owner', 'produced_at'], 'properties': {'namespace': {'type': 'string', 'pattern': '^[a-z][a-z0-9-]+$'}, 'tier': {'enum': ['dev', 'staging', 'prod']}, 'container_defaults': {'type': 'object', 'required': ['cpu', 'memory'], 'properties': {'cpu': {'type': 'string'}, 'memory': {'type': 'string'}}}, 'container_default_requests': {'type': 'object', 'required': ['cpu', 'memory'], 'properties': {'cpu': {'type': 'string'}, 'memory': {'type': 'string'}}}, 'container_max': {'type': 'object', 'required': ['cpu', 'memory'], 'properties': {'cpu': {'type': 'string'}, 'memory': {'type': 'string'}}}, 'container_min': {'type': 'object'}, 'max_limit_request_ratio': {'type': 'object'}, 'owner': {'type': 'object', 'required': ['name', 'role'], 'properties': {'name': {'type': 'string'}, 'role': {'type': 'string'}}}, 'produced_at': {'type': 'string', 'format': 'date-time'}}, 'additionalProperties': True}
...
OK = {'namespace': 'acme-prod', 'tier': 'prod', 'container_defaults': {'cpu': '500m', 'memory': '512Mi'}, 'container_default_requests': {'cpu': '100m', 'memory': '128Mi'}, 'container_max': {'cpu': '4', 'memory': '8Gi'}, 'container_min': {'cpu': '50m', 'memory': '64Mi'}, 'max_limit_request_ratio': {'cpu': '10', 'memory': '4'}, 'owner': {'name': 'Andriy Koval', 'role': 'platform engineer'}, 'produced_at': '2026-05-23T10:00:00Z'}
BAD = {'namespace': 'Acme', 'tier': 'prod'}
