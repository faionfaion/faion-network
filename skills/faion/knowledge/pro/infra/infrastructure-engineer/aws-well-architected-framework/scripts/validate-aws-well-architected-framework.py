#!/usr/bin/env python3
"""validate-aws-well-architected-framework.py

Validate the output artefact for the `aws-well-architected-framework` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/aws-well-architected-framework.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'aws-well-architected-framework',
...
BAD = {"slug": "BAD_aws-well-architected-framework", "owner": "someone"}
