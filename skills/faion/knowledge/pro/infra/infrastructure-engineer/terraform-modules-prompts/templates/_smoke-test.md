<!--
purpose: smoke-test fixture for terraform-modules-prompts
consumes: nothing; self-contained fixture
produces: minimum-viable filled instance; passes `scripts/validate-terraform-modules-prompts.py`
depends-on: templates/spec.md
token-budget-impact: ~250 tokens
-->

# Terraform Modules — Prompts — terraform-modules-prompts-smoke-test

| Field | Value |
|-------|-------|
| artefact_id | terraform-modules-prompts-smoke-test |
| produces | spec |
