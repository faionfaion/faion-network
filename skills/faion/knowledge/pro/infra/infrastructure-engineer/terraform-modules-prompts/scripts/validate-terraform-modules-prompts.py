#!/usr/bin/env python3
"""validate-terraform-modules-prompts.py — enforce the output contract for Terraform Modules — Prompts.
...
CLI:
  ...
  python validate-terraform-modules-prompts.py <artefact.json>      validate an artefact file
  python validate-terraform-modules-prompts.py --help               print help
  python validate-terraform-modules-prompts.py --self-test          run built-in fixture
"""
