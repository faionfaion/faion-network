#!/usr/bin/env python3
"""validate-aws-iam-security-foundations.py

Validate the output artefact for the `aws-iam-security-foundations` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/aws-iam-security-foundations.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'aws-iam-security-foundations',
    'title': 'AWS IAM Security Foundations',
...
BAD = {"slug": "BAD_aws-iam-security-foundations", "owner": "someone"}
