#!/usr/bin/env python3
"""validate-soc2-control-map-vendor-side.py

Validate the output artefact for the `soc2-control-map-vendor-side` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#',
 '$id': 'https://faion.net/schemas/soc2-control-map-vendor-side.json',
 'type': 'object',
 'required': ['slug',
              'title',
              'owner',
...
OK = {'slug': 'soc2-control-map-vendor-side',
 'title': 'SOC 2 Control Map (Vendor Side)',
