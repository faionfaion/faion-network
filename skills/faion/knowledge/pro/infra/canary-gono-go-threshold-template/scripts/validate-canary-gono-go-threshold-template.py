#!/usr/bin/env python3
"""validate-canary-gono-go-threshold-template.py

Validate the output artefact for the `canary-gono-go-threshold-template` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/canary-gono-go-threshold-template.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'canary-gono-go-threshold-template',
    'title': 'Canary Go/No-Go Threshold Template',
...
BAD = {"slug": "BAD_canary-gono-go-threshold-template", "owner": "someone"}
