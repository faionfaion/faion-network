#!/usr/bin/env python3
"""validate-burn-rate-multi-window-alerting.py

Validate the output artefact for the `burn-rate-multi-window-alerting` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/burn-rate-multi-window-alerting.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'burn-rate-multi-window-alerting',
    'title': 'Burn-rate Multi-window Alerting',
...
BAD = {"slug": "BAD_burn-rate-multi-window-alerting", "owner": "someone"}
