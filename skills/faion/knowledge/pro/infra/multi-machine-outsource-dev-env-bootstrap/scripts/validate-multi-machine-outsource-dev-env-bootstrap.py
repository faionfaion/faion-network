#!/usr/bin/env python3
"""validate-multi-machine-outsource-dev-env-bootstrap.py — enforce the output contract for Multi-Machine Outsource Dev Env Bootstrap.
...
CLI:
  ...
  python validate-multi-machine-outsource-dev-env-bootstrap.py <artefact.json>      validate an artefact file
  python validate-multi-machine-outsource-dev-env-bootstrap.py --help               print help
  python validate-multi-machine-outsource-dev-env-bootstrap.py --self-test          run built-in fixture
"""
