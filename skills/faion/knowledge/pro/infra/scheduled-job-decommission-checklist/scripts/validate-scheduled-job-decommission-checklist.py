#!/usr/bin/env python3
"""validate-scheduled-job-decommission-checklist.py

Validate the output artefact for the `scheduled-job-decommission-checklist` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#',
 '$id': 'https://faion.net/schemas/scheduled-job-decommission-checklist.json',
 'type': 'object',
 'required': ['slug',
              'title',
              'owner',
 ...
 'properties': {'slug': {'type': 'string', 'pattern': '^[a-z][a-z0-9-]+$'},
                ...
                'items': {'type': 'array',
                          'minItems': 1,
                          'items': {'type': 'object',
                                    'required': ['id', 'statement', 'executor', 'artefact'],
                                    'properties': {'id': {'type': 'string',
                                                          'pattern': '^[a-z0-9-]+$'},
                                                   'statement': {'type': 'string', 'minLength': 3},
                                                   'executor': {'type': 'string', 'minLength': 2},
                                                   'artefact': {'type': 'string', 'minLength': 2},
...
OK = {'slug': 'scheduled-job-decommission-checklist',
 'title': 'Scheduled-Job Decommission Checklist',
 ...
 'status': 'active',
 'items': [{'id': 'step-01',
            'statement': 'Confirm preconditions hold per AGENTS.md.',
            'executor': 'lead-engineer',
