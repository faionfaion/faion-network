#!/usr/bin/env python3
"""validate-observability-stack-decision-matrix.py — enforce the output contract for Observability Stack Decision Matrix.
...
CLI:
  ...
  python validate-observability-stack-decision-matrix.py <artefact.json>      validate an artefact file
  python validate-observability-stack-decision-matrix.py --help               print help
  python validate-observability-stack-decision-matrix.py --self-test          run built-in fixture
"""
...
EXPECTED_PRODUCES = "decision-record"
