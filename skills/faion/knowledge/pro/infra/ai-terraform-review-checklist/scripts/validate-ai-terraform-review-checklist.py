#!/usr/bin/env python3
"""validate-ai-terraform-review-checklist.py

Validate the output artefact for the `ai-terraform-review-checklist` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/ai-terraform-review-checklist.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'ai-terraform-review-checklist',
    'title': 'AI Terraform Review Checklist',
...
BAD = {"slug": "BAD_ai-terraform-review-checklist", "owner": "someone"}
