#!/usr/bin/env python3
"""validate-rto-rpo-measurement-template.py

Validate the output artefact for the `rto-rpo-measurement-template` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#',
 '$id': 'https://faion.net/schemas/rto-rpo-measurement-template.json',
 'type': 'object',
 'required': ['slug',
              'title',
              'owner',
...
OK = {'slug': 'rto-rpo-measurement-template',
 'title': 'RTO/RPO Measurement Template',
