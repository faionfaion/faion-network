#!/usr/bin/env python3
"""validate-release-strategy-canary-blue-green-feature-flag.py

Validate the output artefact for the `release-strategy-canary-blue-green-feature-flag` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#',
 '$id': 'https://faion.net/schemas/release-strategy-canary-blue-green-feature-flag.json',
 'type': 'object',
 'required': ['slug',
              'title',
              'owner',
 ...
 'properties': {'slug': {'type': 'string', 'pattern': '^[a-z][a-z0-9-]+$'},
                ...
                'evidence': {'type': 'array',
                             'items': {'type': 'object',
                                       'required': ['claim', 'link'],
                                       'properties': {'claim': {'type': 'string', 'minLength': 3},
...
OK = {'slug': 'release-strategy-canary-blue-green-feature-flag',
 'title': 'Release Strategy: Canary / Blue-Green / Feature-Flag',
 'owner': {'name': 'Tetiana Lytvyn', 'role': 'lead engineer'},
 'produced_at': '2026-05-23T10:00:00Z',
 'evidence': [{'claim': 'baseline captured', 'link': 'https://wiki.example.com/baseline'}],
 'version': '1.0.0',
 'last_reviewed': '2026-05-23',
 'status': 'active',
 'decision': 'Option A',
 'rationale': 'Option A best fits the constraints declared in inputs.',
 'options_considered': [{'name': 'Option A', 'verdict': 'chosen', 'reason': 'fits constraint set'},
                        {'name': 'Option B',
                         'verdict': 'rejected',
                         'reason': 'exceeds cost budget'}]}
