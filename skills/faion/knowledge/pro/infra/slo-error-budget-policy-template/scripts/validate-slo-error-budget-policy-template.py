#!/usr/bin/env python3
"""validate-slo-error-budget-policy-template.py

Validate the output artefact for the `slo-error-budget-policy-template` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#',
 '$id': 'https://faion.net/schemas/slo-error-budget-policy-template.json',
 'type': 'object',
 'required': ['slug',
              'title',
              'owner',
...
OK = {'slug': 'slo-error-budget-policy-template',
 'title': 'SLO Error Budget Policy Template',
