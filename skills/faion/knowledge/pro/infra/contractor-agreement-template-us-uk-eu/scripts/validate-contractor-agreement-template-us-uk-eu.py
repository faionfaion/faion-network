#!/usr/bin/env python3
"""validate-contractor-agreement-template-us-uk-eu.py — validate artefact produced by the contractor-agreement-template-us-uk-eu methodology.
...
OK_FIXTURE = {
    "artefact_id": "contractor-agreement-template-us-uk-eu-2026-05-23-001",
...
BAD_FIXTURE = {
    "artefact_id": "contractor-agreement-template-us-uk-eu-bad",
    "owner": "team",
    "decision": "apply",
    "rationale": "obvious",
    "inputs_used": [],
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Validate Contractor Agreement Template (US / UK / EU) artefact",
