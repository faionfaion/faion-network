#!/usr/bin/env python3
"""validate-on-call-handoff-template.py — enforce the output contract for On-Call Handoff Template.
...
CLI:
  ...
  python validate-on-call-handoff-template.py <artefact.json>      validate an artefact file
  python validate-on-call-handoff-template.py --help               print help
  python validate-on-call-handoff-template.py --self-test          run built-in fixture
"""
