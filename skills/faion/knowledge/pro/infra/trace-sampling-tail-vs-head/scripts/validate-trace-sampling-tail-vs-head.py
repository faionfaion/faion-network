#!/usr/bin/env python3
"""validate-trace-sampling-tail-vs-head.py

Validate the output artefact for the `trace-sampling-tail-vs-head` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#',
 '$id': 'https://faion.net/schemas/trace-sampling-tail-vs-head.json',
 'type': 'object',
 'required': ['slug',
              'title',
              'owner',
...
OK = {'slug': 'trace-sampling-tail-vs-head',
 'title': 'Trace Sampling: Tail vs Head',
