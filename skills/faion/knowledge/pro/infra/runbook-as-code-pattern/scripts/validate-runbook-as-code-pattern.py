#!/usr/bin/env python3
"""validate-runbook-as-code-pattern.py

Validate the output artefact for the `runbook-as-code-pattern` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#',
 '$id': 'https://faion.net/schemas/runbook-as-code-pattern.json',
 'type': 'object',
 'required': ['slug',
              'title',
              'owner',
...
OK = {'slug': 'runbook-as-code-pattern',
