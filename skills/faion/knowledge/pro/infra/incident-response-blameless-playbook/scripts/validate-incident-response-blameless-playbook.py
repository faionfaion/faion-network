#!/usr/bin/env python3
"""validate-incident-response-blameless-playbook.py

Validate the output artefact for the `incident-response-blameless-playbook` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/incident-response-blameless-playbook.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'incident-response-blameless-playbook',
    'title': 'Incident Response Blameless Playbook',
...
BAD = {"slug": "BAD_incident-response-blameless-playbook", "owner": "someone"}
