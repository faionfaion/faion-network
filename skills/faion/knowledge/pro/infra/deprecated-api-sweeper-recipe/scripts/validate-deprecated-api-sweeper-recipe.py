#!/usr/bin/env python3
"""validate-deprecated-api-sweeper-recipe.py — validate artefact produced by the deprecated-api-sweeper-recipe methodology.
...
OK_FIXTURE = {
    "artefact_id": "deprecated-api-sweeper-recipe-2026-05-23-001",
...
BAD_FIXTURE = {
    "artefact_id": "deprecated-api-sweeper-recipe-bad",
    "owner": "team",
    "decision": "apply",
    "rationale": "obvious",
    "inputs_used": [],
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Validate Deprecated API Sweeper Recipe artefact",
