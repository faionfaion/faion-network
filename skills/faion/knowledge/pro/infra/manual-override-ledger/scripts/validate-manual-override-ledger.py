#!/usr/bin/env python3
"""validate-manual-override-ledger.py — enforce the output contract for Manual Override Ledger.
...
CLI:
  ...
  python validate-manual-override-ledger.py <artefact.json>      validate an artefact file
  python validate-manual-override-ledger.py --help               print help
  python validate-manual-override-ledger.py --self-test          run built-in fixture
"""
