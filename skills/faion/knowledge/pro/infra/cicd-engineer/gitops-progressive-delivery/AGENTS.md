...
summary: Generates a progressive-delivery config (canary or blue-green via Flagger or Argo Rollouts + automated metric-based rollback + traffic shifting via service mesh or ingress).
content_id: "d49f3320a4fc1adf"
complexity: deep
produces: config
est_tokens: 4300
