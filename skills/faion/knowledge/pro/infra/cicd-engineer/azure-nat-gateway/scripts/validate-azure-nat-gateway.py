#!/usr/bin/env python3
"""validate-azure-nat-gateway.py

Validate the output artefact for the `azure-nat-gateway` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/azure-nat-gateway.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'azure-nat-gateway',
    'title': 'Azure NAT Gateway for Outbound Connectivity',
...
BAD = {"slug": "BAD_azure-nat-gateway", "owner": "someone"}
