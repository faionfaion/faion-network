#!/usr/bin/env python3
"""validate-fco-commitment-pricing.py

Validate the artefact for the fco-commitment-pricing methodology against the JSON Schema in
...
REQUIRED = ['baseline_months', 'commitment_kind', 'term_years', 'base_coverage_percentile', 'utilization_alert_pct', 'staggered_renewal']

ENUMS = { 'commitment_kind': ['standard-ri', 'convertible-ri', 'compute-savings-plan', 'ec2-instance-savings-plan'], 'term_years': [1, 3] }
CONSTS = { 'staggered_renewal': True }
INT_BOUNDS = { 'baseline_months': (3, None), 'base_coverage_percentile': (10, 30), 'utilization_alert_pct': (70, 90) }
ARRAY_MIN = {  }
OBJECT_REQUIRED = {  }
...
OK = {'baseline_months': 3, 'commitment_kind': 'standard-ri', 'term_years': 1, 'base_coverage_percentile': 10, 'utilization_alert_pct': 70, 'staggered_renewal': True}
BAD = {'baseline_months': None}
