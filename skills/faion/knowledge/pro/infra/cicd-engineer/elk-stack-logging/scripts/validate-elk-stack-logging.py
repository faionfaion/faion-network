#!/usr/bin/env python3
"""validate-elk-stack-logging.py

Validate the artefact for the elk-stack-logging methodology against the JSON Schema in
...
REQUIRED = ['stack', 'ilm_policy', 'security_enabled', 'agent_auth', 'structured_logs_only', 'kibana_dashboards_versioned']

ENUMS = { 'stack': ['elasticsearch-elk', 'opensearch'], 'agent_auth': ['mtls', 'api-token'] }
CONSTS = { 'security_enabled': True, 'structured_logs_only': True, 'kibana_dashboards_versioned': True }
INT_BOUNDS = {  }
ARRAY_MIN = {  }
OBJECT_REQUIRED = { 'ilm_policy': ['hot_days', 'warm_days', 'cold_days', 'delete_days'] }
...
OK = {'stack': 'elasticsearch-elk', 'ilm_policy': {'hot_days': 'x', 'warm_days': 'x', 'cold_days': 'x', 'delete_days': 'x'}, 'security_enabled': True, 'agent_auth': 'mtls', 'structured_logs_only': True, 'kibana_dashboards_versioned': True}
BAD = {'stack': None}
