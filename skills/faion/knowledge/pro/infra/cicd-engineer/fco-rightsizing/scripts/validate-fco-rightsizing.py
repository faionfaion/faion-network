#!/usr/bin/env python3
"""validate-fco-rightsizing.py

Validate the artefact for the fco-rightsizing methodology against the JSON Schema in
...
REQUIRED = ['baseline_weeks', 'recommended_family', 'graviton_evaluated', 'headroom_pct_over_p95', 'rollout_strategy', 'estimated_monthly_savings_usd']

ENUMS = { 'rollout_strategy': ['blue-green', 'canary'] }
CONSTS = { 'graviton_evaluated': True }
INT_BOUNDS = { 'baseline_weeks': (4, None), 'headroom_pct_over_p95': (20, None), 'estimated_monthly_savings_usd': (0, None) }
ARRAY_MIN = {  }
OBJECT_REQUIRED = {  }
...
OK = {'baseline_weeks': 4, 'recommended_family': 'ok', 'graviton_evaluated': True, 'headroom_pct_over_p95': 20, 'rollout_strategy': 'blue-green', 'estimated_monthly_savings_usd': 1.0}
BAD = {'baseline_weeks': None}
