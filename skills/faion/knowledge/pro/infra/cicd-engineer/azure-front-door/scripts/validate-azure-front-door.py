#!/usr/bin/env python3
"""validate-azure-front-door.py

Validate the output artefact for the `azure-front-door` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/azure-front-door.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'azure-front-door',
    'title': 'Azure Front Door Premium (Global LB + WAF + CDN)',
...
BAD = {"slug": "BAD_azure-front-door", "owner": "someone"}
