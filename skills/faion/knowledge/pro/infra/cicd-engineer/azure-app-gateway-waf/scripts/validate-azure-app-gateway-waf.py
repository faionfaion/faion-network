#!/usr/bin/env python3
"""validate-azure-app-gateway-waf.py

Validate the output artefact for the `azure-app-gateway-waf` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/azure-app-gateway-waf.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'azure-app-gateway-waf',
    'title': 'Azure Application Gateway v2 + WAF',
...
BAD = {"slug": "BAD_azure-app-gateway-waf", "owner": "someone"}
