#!/usr/bin/env python3
"""validate-cicd-mtls-deployment.py

Validate the artefact for the cicd-mtls-deployment methodology against the JSON Schema in
...
REQUIRED = ['ca_kind', 'cert_lifetime_hours', 'per_workload_identity', 'ssl_verify_client', 'revocation']

ENUMS = { 'ca_kind': ['step-ca', 'vault-pki', 'spiffe-spire', 'service-mesh-issuer'], 'ssl_verify_client': ['on', 'on-strict'], 'revocation': ['ocsp-stapling', 'crl-dp'] }
CONSTS = { 'per_workload_identity': True }
INT_BOUNDS = { 'cert_lifetime_hours': (1, 24) }
ARRAY_MIN = {  }
OBJECT_REQUIRED = {  }
...
OK = {'ca_kind': 'step-ca', 'cert_lifetime_hours': 1, 'per_workload_identity': True, 'ssl_verify_client': 'on', 'revocation': 'ocsp-stapling'}
BAD = {'ca_kind': None}
