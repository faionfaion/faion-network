#!/usr/bin/env python3
"""validate-cicd-tls-validation-gate.py

Validate the artefact for the cicd-tls-validation-gate methodology against the JSON Schema in
...
REQUIRED = ['scanners', 'required_grade', 'cipher_profile', 'hsts_max_age_seconds', 'gate_blocks_promotion', 'scan_target']

ENUMS = { 'cipher_profile': ['mozilla-intermediate', 'mozilla-modern'], 'scan_target': ['staging', 'pre-prod'] }
CONSTS = { 'required_grade': 'A+', 'gate_blocks_promotion': True }
INT_BOUNDS = { 'hsts_max_age_seconds': (31536000, None) }
ARRAY_MIN = { 'scanners': 1 }
OBJECT_REQUIRED = {  }
...
OK = {'scanners': ['testssl'], 'required_grade': 'A+', 'cipher_profile': 'mozilla-intermediate', 'hsts_max_age_seconds': 31536000, 'gate_blocks_promotion': True, 'scan_target': 'staging'}
BAD = {'scanners': None}
