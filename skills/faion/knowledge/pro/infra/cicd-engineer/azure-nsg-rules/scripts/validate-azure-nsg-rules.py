#!/usr/bin/env python3
"""validate-azure-nsg-rules.py

Validate the output artefact for the `azure-nsg-rules` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/azure-nsg-rules.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'azure-nsg-rules',
    'title': 'Azure NSG Rules and Flow Logs',
...
BAD = {"slug": "BAD_azure-nsg-rules", "owner": "someone"}
