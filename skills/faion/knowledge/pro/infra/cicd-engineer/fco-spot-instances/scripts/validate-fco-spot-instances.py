#!/usr/bin/env python3
"""validate-fco-spot-instances.py

Validate the artefact for the fco-spot-instances methodology against the JSON Schema in
...
REQUIRED = ['checkpoint_interval_seconds', 'interruption_handler', 'instance_diversification_count', 'az_count', 'max_price_cap', 'on_demand_floor_pct']

ENUMS = { 'max_price_cap': ['on-demand', 'below-on-demand'] }
CONSTS = { 'interruption_handler': True }
INT_BOUNDS = { 'checkpoint_interval_seconds': (None, 300), 'instance_diversification_count': (3, None), 'az_count': (2, None), 'on_demand_floor_pct': (10, None) }
ARRAY_MIN = {  }
OBJECT_REQUIRED = {  }
...
OK = {'checkpoint_interval_seconds': 1, 'interruption_handler': True, 'instance_diversification_count': 3, 'az_count': 2, 'max_price_cap': 'on-demand', 'on_demand_floor_pct': 10}
BAD = {'checkpoint_interval_seconds': None}
