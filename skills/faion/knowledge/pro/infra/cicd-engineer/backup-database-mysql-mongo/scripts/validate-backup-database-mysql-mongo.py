#!/usr/bin/env python3
"""validate-backup-database-mysql-mongo.py

Validate the output artefact for the `backup-database-mysql-mongo` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/backup-database-mysql-mongo.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'backup-database-mysql-mongo',
    'title': 'MySQL + MongoDB Backup Implementation',
...
BAD = {"slug": "BAD_backup-database-mysql-mongo", "owner": "someone"}
