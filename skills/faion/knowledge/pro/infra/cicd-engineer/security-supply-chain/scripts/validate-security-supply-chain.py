#!/usr/bin/env python3
"""validate-security-supply-chain.py — validate artefact produced by the security-supply-chain methodology.
...
OK_FIXTURE = {
    "artefact_id": "security-supply-chain-2026-05-23-001",
...
BAD_FIXTURE = {
    "artefact_id": "security-supply-chain-bad",
    "owner": "team",
    "decision": "apply",
    "rationale": "obvious",
    "inputs_used": [],
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Validate Supply Chain Security: Secrets, SCA, SBOM, SLSA artefact",
