#!/usr/bin/env python3
"""validate-backup-cloud-aws.py

Validate the output artefact for the `backup-cloud-aws` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/backup-cloud-aws.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'backup-cloud-aws',
    'title': 'Cloud-native Backup with AWS Backup and S3',
...
BAD = {"slug": "BAD_backup-cloud-aws", "owner": "someone"}
