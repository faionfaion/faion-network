#!/usr/bin/env python3
"""validate-azure-compute.py

Validate the output artefact for the `azure-compute` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/azure-compute.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'azure-compute',
    'title': 'Azure Compute Tier Selection',
...
BAD = {"slug": "BAD_azure-compute", "owner": "someone"}
