#!/usr/bin/env python3
"""validate-argocd-gitops.py

Validate the output artefact for the `argocd-gitops` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/argocd-gitops.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'argocd-gitops',
    'title': 'ArgoCD GitOps Deployment Policy',
...
BAD = {"slug": "BAD_argocd-gitops", "owner": "someone"}
