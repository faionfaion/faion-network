#!/usr/bin/env python3
"""validate-multi-machine-offline-cache.py — enforce the output contract for Multi-Machine Offline Cache.
...
CLI:
  ...
  python validate-multi-machine-offline-cache.py <artefact.json>      validate an artefact file
  python validate-multi-machine-offline-cache.py --help               print help
  python validate-multi-machine-offline-cache.py --self-test          run built-in fixture
"""
