#!/usr/bin/env python3
"""validate-capacity-planning-at-design-time.py

Validate the output artefact for the `capacity-planning-at-design-time` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/capacity-planning-at-design-time.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'capacity-planning-at-design-time',
    'title': 'Capacity Planning at Design Time',
...
BAD = {"slug": "BAD_capacity-planning-at-design-time", "owner": "someone"}
