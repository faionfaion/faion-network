...
summary: Restore drill template: fixed-shape weekly backup-verification artefact with RTO targets per data class, evidence anchors, and named owner for outcome review.
content_id: "e123d1ba7c04b364"
complexity: medium
produces: checklist
est_tokens: 4600
tags: [infra, pro, restore, backup, drill, rto]
---
...
| File | Purpose |
|------|---------|
| `templates/restore-drill-template.md` | Working skeleton for the `restore-drill-template` artefact with required fields and `not_applicable: <reason>` markers per row. |
