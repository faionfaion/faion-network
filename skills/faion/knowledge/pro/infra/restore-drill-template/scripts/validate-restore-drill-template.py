#!/usr/bin/env python3
"""validate-restore-drill-template.py

Validate the output artefact for the `restore-drill-template` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#',
 '$id': 'https://faion.net/schemas/restore-drill-template.json',
 'type': 'object',
 'required': ['slug',
              'title',
              'owner',
...
OK = {'slug': 'restore-drill-template',
 'title': 'Restore Drill Template',
