#!/usr/bin/env python3
"""validate-vendor-lock-in-audit-checklist.py

Validate the output artefact for the `vendor-lock-in-audit-checklist` methodology against the JSON Schema
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#',
 '$id': 'https://faion.net/schemas/vendor-lock-in-audit-checklist.json',
 'type': 'object',
 'required': ['slug',
              'title',
              'owner',
...
OK = {'slug': 'vendor-lock-in-audit-checklist',
 'title': 'Vendor Lock-In Audit Checklist',
