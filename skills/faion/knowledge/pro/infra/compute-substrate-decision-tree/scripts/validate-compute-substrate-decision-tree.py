#!/usr/bin/env python3
"""validate-compute-substrate-decision-tree.py — validate artefact produced by the compute-substrate-decision-tree methodology.
...
OK_FIXTURE = {
    "artefact_id": "compute-substrate-decision-tree-2026-05-23-001",
...
BAD_FIXTURE = {
    "artefact_id": "compute-substrate-decision-tree-bad",
    "owner": "team",
    "decision": "apply",
    "rationale": "obvious",
    "inputs_used": [],
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Validate Compute Substrate Decision Tree artefact",
