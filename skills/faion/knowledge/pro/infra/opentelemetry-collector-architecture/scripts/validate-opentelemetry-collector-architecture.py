#!/usr/bin/env python3
"""validate-opentelemetry-collector-architecture.py — enforce the output contract for OpenTelemetry Collector Architecture.
...
CLI:
  ...
  python validate-opentelemetry-collector-architecture.py <artefact.json>      validate an artefact file
  python validate-opentelemetry-collector-architecture.py --help               print help
  python validate-opentelemetry-collector-architecture.py --self-test          run built-in fixture
"""
