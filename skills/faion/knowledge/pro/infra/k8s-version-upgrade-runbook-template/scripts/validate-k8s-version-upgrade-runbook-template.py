#!/usr/bin/env python3
"""validate-k8s-version-upgrade-runbook-template.py — enforce the output contract for K8s Version Upgrade Runbook Template.
...
CLI:
  ...
  python validate-k8s-version-upgrade-runbook-template.py <artefact.json>      validate an artefact file
  python validate-k8s-version-upgrade-runbook-template.py --help               print help
  python validate-k8s-version-upgrade-runbook-template.py --self-test          run built-in fixture
"""
