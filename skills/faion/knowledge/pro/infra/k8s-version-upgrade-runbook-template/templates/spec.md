<!--
purpose: K8s Version Upgrade Runbook Template - spec skeleton matching `produces=spec`
consumes: typed inputs from AGENTS.md Prerequisites table
produces: filled spec artefact validated by scripts/validate-k8s-version-upgrade-runbook-template.py
