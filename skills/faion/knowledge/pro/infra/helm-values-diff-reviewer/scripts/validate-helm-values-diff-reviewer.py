#!/usr/bin/env python3
"""validate-helm-values-diff-reviewer.py

Validate the output artefact for the `helm-values-diff-reviewer` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/helm-values-diff-reviewer.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'helm-values-diff-reviewer',
    'title': 'Helm Values Diff Reviewer',
...
BAD = {"slug": "BAD_helm-values-diff-reviewer", "owner": "someone"}
