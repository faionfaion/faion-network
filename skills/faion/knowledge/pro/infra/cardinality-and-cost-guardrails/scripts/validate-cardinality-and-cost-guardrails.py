#!/usr/bin/env python3
"""validate-cardinality-and-cost-guardrails.py

Validate the output artefact for the `cardinality-and-cost-guardrails` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/cardinality-and-cost-guardrails.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
    ...
    'properties': {   'slug': {'type': 'string', 'pattern': '^[a-z][a-z0-9-]+$'},
                      ...
                      'audit_cadence': {'enum': ['daily', 'weekly', 'biweekly', 'monthly']}},
...
OK = {   'slug': 'cardinality-and-cost-guardrails',
    'title': 'Cardinality and Cost Guardrails',
    ...
    'allow_list': ['claude-code', 'cursor'],
    'deny_list': ['copilot-mcp-remote'],
    'audit_cadence': 'weekly'}
BAD = {"slug": "BAD_cardinality-and-cost-guardrails", "owner": "someone"}
