...
summary: SLO design from user journeys: anchors SLIs and SLO targets on observable user journeys (not infra metrics) before the first production deploy so error budget tracks real harm.
content_id: "a6f4927075b6a68a"
complexity: deep
produces: spec
est_tokens: 4700
tags: [infra, pro, slo, sli, user-journey]
---
...
| File | Purpose |
|------|---------|
| `templates/slo-design-from-user-journeys.md` | Working skeleton for the `slo-design-from-user-journeys` artefact with required fields and `not_applicable: <reason>` markers per row. |
