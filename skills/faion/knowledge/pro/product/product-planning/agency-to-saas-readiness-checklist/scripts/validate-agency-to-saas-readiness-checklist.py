#!/usr/bin/env python3
"""validate-agency-to-saas-readiness-checklist.py

Validate an output artefact for the `agency-to-saas-readiness-checklist` methodology against the JSON Schema
...
SCHEMA = json.loads(r"""{
    ...
    "$id": "https://faion.net/schemas/agency-saas-readiness.json",
    "type": "object",
    "required": [
        "assessment_date",
        "candidate_asset",
...
VALID_FIXTURE = json.loads(r"""{
  ...
  "candidate_asset": "ddl-builder",
  "sections": {
    "ip_rights": {
      "score": "green",
      "owner": "ruslan",
      "evidence": "all engagements include WFA assignment"
    },
    "repeatable_assets": {
      "score": "green",
      "owner": "ruslan",
      "evidence": "5 paying engagements"
    },
    "codebase_ownership": {
      "score": "green",
      "owner": "ruslan",
      "evidence": "monorepo audit"
    },
    "retainer_base": {
      "score": "yellow",
      "owner": "ruslan",
      "evidence": "12 months runway"
    },
    "founder_bandwidth": {
      "score": "green",
      "owner": "ruslan",
