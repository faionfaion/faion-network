...
Validate an output artefact for the `continuous-discovery-habits` methodology against the JSON Schema
...
SCHEMA = json.loads(r"""{
    ...
    "$id": "https://faion.net/schemas/discovery-spec.json",
    "type": "object",
    "required": [
        "week",
        "trio",
...
VALID_FIXTURE = json.loads(r"""{
  ...
  "ost": {
    "outcome": "raise activation 20%",
    "opportunities": [
      "new-user friction in step 2"
    ]
  },
  "specs": [
    {
      "id": "spec-onboard-v2",
      "opportunity_id": "opp-step2"
    }
  ],
  "assumption_tests": [
    {
      "solution_id": "sol-tooltip",
      "assumption": "tooltip clarifies step 2",
      "test": "fake-door 5%"
    }
  ]
}""")
