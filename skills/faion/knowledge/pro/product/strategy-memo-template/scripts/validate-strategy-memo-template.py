#!/usr/bin/env python3
"""validate-strategy-memo-template.py

Validate an output artefact for the `strategy-memo-template` methodology against the JSON Schema
...
SCHEMA = json.loads(r"""{
    ...
    "$id": "https://faion.net/schemas/strategy-memo.json",
    "type": "object",
    "required": [
        "title",
        "word_count",
...
VALID_FIXTURE = json.loads(r"""{
  "title": "Faion 2026 Strategy",
  "word_count": 1150,
  "vision": "Be the methodology base of choice for AI-augmented solopreneur devs by 2027.",
  "bets": [
    {
      "statement": "CLI distribution beats web for pro tier",
      "signal": "CLI active users",
      "threshold": ">2000",
      "window": "6 months"
    }
  ],
  "non_bets": [
    "no enterprise SSO this year",
    "no team plans",
    "no on-prem",
    "no co-pilot integration",
    "no white-label"
  ],
  "success_metrics": [
    {
