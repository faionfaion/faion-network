#!/usr/bin/env python3
"""validate-feature-flag-rollout-decision.py

Validate an artefact produced by the feature-flag-rollout-decision methodology against the schema
declared in content/02-output-contract.xml (mirrored in templates/feature-flag-rollout-decision.schema.json).

Inputs:
    --file PATH       path to artefact (JSON or Markdown-with-table)
    --schema PATH     path to JSON schema (default: templates/feature-flag-rollout-decision.schema.json)
