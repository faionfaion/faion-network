...
maintainers: [faion]
content_id: "595503270bcbf03d"
summary: Post Launch 72h Watch Runbook — pinned runbook for the product manager: fixed shape + named owner + evidence anchors + outcome review, so launch pr sign-off + coordination stops being folklore and starts being a reviewable operating tool.
tags: [product, pro, runbook, post, launch, 72h, watch]
---
# Post Launch 72h Watch Runbook

## Summary

**One-sentence:** Post Launch 72h Watch Runbook — pinned runbook for the product manager: fixed shape + named owner + evidence anchors + outcome review, so launch pr sign-off + coordination stops being folklore and starts being a reviewable operating tool.

**One-paragraph:** In product management, the product manager runs launch pr sign-off + coordination on a recurring cadence — but the corpus only covers the upstream concepts, not the artefact that closes the loop. Post-launch monitoring is currently folk wisdom; need a runbook covering metric guardrails, rollback triggers, comms cadence. `post-launch-72h-watch-runbook` pins the artefact: a fixed shape, named owner, evidence anchors, and a published review cadence. It is loaded when the product manager starts the block named in the trigger and produces a committed artefact reviewed against outcomes at the next iteration. Mechanism: rule-bound output contract + per-application evidence + outcome review. Primary output: a versioned, owned, evidence-anchored runbook committed to the team's knowledge space.

## Applies If (ALL must hold)

- the block this methodology unblocks is on the operating cadence: - `role-product-manager/Launch PR sign-off + coordination`
