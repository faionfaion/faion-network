#!/usr/bin/env python3
"""validate-design-partner-program-template.py

Validate an artefact produced by the design-partner-program-template methodology against the schema
declared in content/02-output-contract.xml (mirrored in templates/design-partner-program-template.schema.json).

Inputs:
    --file PATH       path to artefact (JSON or Markdown-with-table)
    --schema PATH     path to JSON schema (default: templates/design-partner-program-template.schema.json)
