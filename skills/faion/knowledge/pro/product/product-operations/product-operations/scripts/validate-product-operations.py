...
Validate an output artefact for the `product-operations` methodology against the JSON Schema
...
SCHEMA = json.loads(r"""{
    ...
    "$id": "https://faion.net/schemas/product-ops-config.json",
    "type": "object",
    "required": [
        "function",
        "owned_systems",
...
VALID_FIXTURE = json.loads(r"""{
  ...
  "canonical_rollup": {
    "owner": "ruslan",
    "cadence": "weekly",
    "template": ".aidocs/process/weekly-rollup.md"
  },
  "process_docs": [
    {
      "process": "intake",
      "canonical_path": ".aidocs/process/intake.md"
    }
  ],
