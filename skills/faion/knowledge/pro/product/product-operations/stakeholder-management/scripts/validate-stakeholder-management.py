...
Validate an output artefact for the `stakeholder-management` methodology against the JSON Schema
...
SCHEMA = json.loads(r"""{
    ...
    "$id": "https://faion.net/schemas/stakeholder-register.json",
    "type": "object",
    "required": [
        "project",
        "stakeholders",
