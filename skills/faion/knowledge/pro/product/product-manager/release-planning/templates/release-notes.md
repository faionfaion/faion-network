...
## Highlights
[1-2 sentences, plain English, no marketing adjectives. Lead with what changed for users.]
...
## Breaking Changes
[If any — include migration steps, not just a warning. Omit section if none.]
...
<!-- Anti-fluff rules (enforced by lint):
  ...
  - Each bullet cites merge SHA in HTML comment for traceability: <!-- sha:abc1234 -->
  - Known Issues section is required if any exist; absence for 2+ releases is a smell
-->
