...
|-------------|------|------|-----|-------|
| Executive sponsor | Status, decisions, risks | Monthly written brief | 1-page brief (3 sections only) | PM |
| Dev team | Requirements, changes, decisions | Daily | Stand-up | PM |
| Sales team | Features, timeline, PQL definition | Bi-weekly | Email update | PM |
...
[The single decision the executive must make, with a clear deadline]
...
Items the PM decides without escalation (list here to prevent upward-comms inflation):
- [Decision type 1]
- [Decision type 2]
