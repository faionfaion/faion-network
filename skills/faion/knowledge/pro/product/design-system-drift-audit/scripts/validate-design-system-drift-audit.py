#!/usr/bin/env python3
"""validate-design-system-drift-audit.py

Validate an artefact produced by the design-system-drift-audit methodology against the schema
declared in content/02-output-contract.xml (mirrored in templates/design-system-drift-audit.schema.json).

Inputs:
    --file PATH       path to artefact (JSON or Markdown-with-table)
    --schema PATH     path to JSON schema (default: templates/design-system-drift-audit.schema.json)
