#!/usr/bin/env python3
"""validate-mutation-testing-bootstrap.py — validate a mutation-testing-bootstrap output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'language', 'tool', 'scope', 'survivor_gate_pct', 'ci_budget_minutes']
ENUMS = {'language': ['python', 'javascript', 'typescript', 'php', 'java'], 'tool': ['mutmut', 'stryker', 'infection', 'pitest'], 'scope': ['pr-changed-files', 'full-repo-nightly', 'module']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['survivor_gate_pct', 'ci_budget_minutes']
ARRAY_FIELDS = []
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'flake_rate_baseline']
...
VALID_FIXTURE = json.loads('{"artefact_id": "mut-2026-0007", "version": "1.1.0", "last_reviewed": "2026-05-23", "language": "python", "tool": "mutmut", "scope": "pr-changed-files", "survivor_gate_pct": 20, "ci_budget_minutes": 8, "flake_rate_baseline": "0%"}')
INVALID_FIXTURE = json.loads('{"language": "ruby", "tool": "mutant", "scope": "full-repo", "survivor_gate_pct": 40, "ci_budget_minutes": 60}')
