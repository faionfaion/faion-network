<!-- purpose: working playbook-step skeleton for the Scope-Creep Firewall methodology -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a playbook-step artefact validating against scripts/validate-scope-creep-firewall.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1200 tokens once filled -->

# Scope-Creep Firewall — Artefact Skeleton
...
Run `python scripts/validate-scope-creep-firewall.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
