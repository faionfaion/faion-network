#!/usr/bin/env python3
"""validate-discovery-to-delivery-handover-protocol.py

Validate the artefact for discovery-to-delivery-handover-protocol against the schema in content/02-output-contract.xml.
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["artefact-bundle-required"],
        "evidence": [
            {
                "rule_id": "artefact-bundle-required",
