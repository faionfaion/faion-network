#!/usr/bin/env python3
"""validate-interview-recording-redaction-pipeline.py

Validate the artefact for interview-recording-redaction-pipeline against the schema in content/02-output-contract.xml.
...
OK_FIXTURE = json.dumps(
    {
        ...
        "trigger": "interview-recording-redaction-pipeline engagement",
        "rules_applied": ["consent-record-required"],
        "evidence": [
            {
                "rule_id": "consent-record-required",
