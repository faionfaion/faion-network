#!/usr/bin/env python3
"""validate-hipaa-baa-vendor-checklist.py

Validate the artefact for hipaa-baa-vendor-checklist against the schema in content/02-output-contract.xml.
...
OK_FIXTURE = json.dumps(
    {
        ...
        "trigger": "hipaa-baa-vendor-checklist engagement",
        "rules_applied": ["signed-baa-required"],
        "evidence": [
            {
                "rule_id": "signed-baa-required",
