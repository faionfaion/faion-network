#!/usr/bin/env python3
"""validate-nda-msa-obligation-extractor.py

Validate the artefact for nda-msa-obligation-extractor against the schema in content/02-output-contract.xml.
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["obligation-record-shape"],
        "evidence": [
            {
                "rule_id": "obligation-record-shape",
