#!/usr/bin/env python3
"""validate-glossary-management-as-code.py

Validate the artefact for glossary-management-as-code against the schema in content/02-output-contract.xml.
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["yaml-source-of-truth"],
        "evidence": [
            {
                "rule_id": "yaml-source-of-truth",
