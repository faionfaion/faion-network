...
| Best fit | Single team / 2-3 teams | Mid-org, mixed cadences | Large enterprise (50+) |
...
| # | Principle | Score 1-5 | Evidence quote | Action |
|---|-----------|-----------|----------------|--------|
| 1 | See the Whole | | | |
...
Principles with score < 3 → flag as constitution review items.
