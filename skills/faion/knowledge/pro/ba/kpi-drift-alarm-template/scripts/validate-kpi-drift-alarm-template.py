#!/usr/bin/env python3
"""validate-kpi-drift-alarm-template.py

Validate the artefact for kpi-drift-alarm-template against the schema in content/02-output-contract.xml.
...
OK_FIXTURE = json.dumps(
    {
        ...
        "trigger": "kpi-drift-alarm-template engagement",
        "rules_applied": ["baseline-rolling-window"],
        "evidence": [
            {
                "rule_id": "baseline-rolling-window",
