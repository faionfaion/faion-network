...
<!-- produces: artefact instance that MUST validate via scripts/validate-sow-template-with-traced-assumptions.py -->
<!-- depends-on: templates/sow-template-with-traced-assumptions.md, content/02-output-contract.xml -->
<!-- token-budget-impact: ~200 tokens -->

# SoW Template with Traced Assumptions — Smoke Test Fixture

```json
{
  "artefact_id": "sow-template-with-traced-assumptions-acme-2026-05-23",
