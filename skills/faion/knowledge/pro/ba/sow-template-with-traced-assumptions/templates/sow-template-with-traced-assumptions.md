<!-- purpose: working spec skeleton for the SoW Template with Traced Assumptions methodology -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a spec artefact validating against scripts/validate-sow-template-with-traced-assumptions.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1200 tokens once filled -->

# SoW Template with Traced Assumptions — Artefact Skeleton
...
Run `python scripts/validate-sow-template-with-traced-assumptions.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
