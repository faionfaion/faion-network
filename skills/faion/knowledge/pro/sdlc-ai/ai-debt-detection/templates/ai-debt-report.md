<!-- purpose: Report skeleton: signals / thresholds / severity-ranked findings / routes. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a report artefact validating against scripts/validate-ai-debt-detection.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# AI Debt Detection — Artefact Skeleton
...
Run `python scripts/validate-ai-debt-detection.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
