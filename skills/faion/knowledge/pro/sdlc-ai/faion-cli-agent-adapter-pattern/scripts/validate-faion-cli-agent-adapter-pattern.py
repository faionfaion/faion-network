#!/usr/bin/env python3
"""validate-faion-cli-agent-adapter-pattern.py — stdlib-only validator for the Faion CLI Agent Adapter Pattern code artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'inputs_used'] + ["modules"]
...
OK_JSON = """{"artefact_id": "faion-cli-agent-adapter-pattern-acme-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "inputs_used": [{"name": "engagement charter", "source": "docs/charters/acme.md"}], "modules": [{"name": "anthropic", "path": "templates/anthropic-adapter.py", "language": "python"}]}"""
