<!-- purpose: Inventory + parameter map skeleton + validation-suite stub. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a spec artefact validating against scripts/validate-ai-agent-prompt-handover.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# AI Agent Prompt Handover — Artefact Skeleton
...
Run `python scripts/validate-ai-agent-prompt-handover.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
