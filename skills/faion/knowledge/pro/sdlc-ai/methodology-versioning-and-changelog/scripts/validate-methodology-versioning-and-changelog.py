#!/usr/bin/env python3
"""validate-methodology-versioning-and-changelog.py — validate a methodology-versioning-and-changelog output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'slug', 'previous_version', 'bump', 'changelog_entry', 'content_id']
ENUMS = {'bump': ['MAJOR', 'MINOR', 'PATCH']}
SEMVER_FIELDS = ['version', 'previous_version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
ARRAY_FIELDS = ['removed_rule_ids']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'slug', 'changelog_entry', 'migration_plan_url', 'content_id']
...
VALID_FIXTURE = json.loads('{"artefact_id": "ver-2026-0014", "version": "1.1.0", "last_reviewed": "2026-05-23", "slug": "code-review", "previous_version": "1.0.0", "bump": "MINOR", "changelog_entry": "Added rule no-sole-approver-agent; no schema change.", "content_id": "ee8a70147c263798", "removed_rule_ids": []}')
INVALID_FIXTURE = json.loads('{"version": "2", "slug": "code-review", "bump": "major", "removed_rule_ids": ["old-rule"]}')
