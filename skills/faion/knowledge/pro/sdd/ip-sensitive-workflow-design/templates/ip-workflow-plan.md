<!-- purpose: Plan skeleton: 4 separation layers + per-commit attribution log columns. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a spec artefact validating against scripts/validate-ip-sensitive-workflow-design.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# IP-Sensitive Workflow Design — Artefact Skeleton
...
Run `python scripts/validate-ip-sensitive-workflow-design.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
