<!-- purpose: Spike skeleton: question / timebox / exit criteria / outcome / next action. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a spec artefact validating against scripts/validate-spike-protocol-template.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# Spike Protocol Template — Artefact Skeleton
...
Run `python scripts/validate-spike-protocol-template.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
