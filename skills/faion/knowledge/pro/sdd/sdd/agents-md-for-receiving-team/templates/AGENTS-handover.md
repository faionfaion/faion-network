<!-- purpose: Four-section skeleton: context / rituals / gotchas / no-go zones. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a spec artefact validating against scripts/validate-agents-md-for-receiving-team.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# AGENTS.md for Receiving Team — Artefact Skeleton
...
Run `python scripts/validate-agents-md-for-receiving-team.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
