#!/usr/bin/env python3
"""validate-definition-of-done-template.py — stdlib-only validator for the Definition of Done Template checklist artefact.
...
OK_JSON = """{"artefact_id": "definition-of-done-template-acme-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "inputs_used": [{"name": "engagement charter", "source": "docs/charters/acme.md"}], "items": [{"id": "c1", "statement": "Run precondition check", "done": true}, {"id": "c2", "statement": "Validate inputs", "done": true}, {"id": "c3", "statement": "Capture signoff", "done": false}]}"""
