<!-- purpose: 5-session pack skeleton: architecture / hot files / on-call / contacts / AI rules. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a report artefact validating against scripts/validate-dark-knowledge-extraction-protocol.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# Dark Knowledge Extraction Protocol — Artefact Skeleton
...
Run `python scripts/validate-dark-knowledge-extraction-protocol.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
