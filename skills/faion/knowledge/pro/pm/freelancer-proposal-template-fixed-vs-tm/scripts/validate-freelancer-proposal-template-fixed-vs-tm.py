#!/usr/bin/env python3
"""validate-freelancer-proposal-template-fixed-vs-tm.py

Validate a Freelancer Proposal Template Fixed-vs-T&M artefact against the output-contract schema declared in
...
OK = {
    ...
    "decision": "Apply Freelancer Proposal Template Fixed-vs-T&M to the smoke-test scope.",
