#!/usr/bin/env python3
"""validate-change-request-rate-card-template.py

Validate a Change Request Rate Card Template `spec` artefact against the JSON Schema in
