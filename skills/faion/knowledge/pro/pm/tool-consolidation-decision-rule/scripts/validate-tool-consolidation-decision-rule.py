#!/usr/bin/env python3
"""validate-tool-consolidation-decision-rule.py

Validate an artefact produced by the tool-consolidation-decision-rule methodology against the schema
declared in content/02-output-contract.xml (mirrored in templates/tool-consolidation-decision-rule.schema.json).

Inputs:
    --file PATH       path to artefact (JSON or Markdown-with-table)
    --schema PATH     path to JSON schema (default: templates/tool-consolidation-decision-rule.schema.json)
