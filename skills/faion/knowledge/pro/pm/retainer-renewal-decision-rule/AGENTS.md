...
maintainers: [faion]
content_id: "0142f9a760362b9a"
summary: Retainer Renewal Decision Rule — pinned decision-rule for the micro-agency founder: fixed shape + named owner + evidence anchors + outcome review, so quarterly retainer review per client stops being folklore and starts being a reviewable operating tool.
tags: [pm, pro, decision-rule, retainer, renewal, decision, rule]
---
# Retainer Renewal Decision Rule

## Summary

**One-sentence:** Retainer Renewal Decision Rule — pinned decision-rule for the micro-agency founder: fixed shape + named owner + evidence anchors + outcome review, so quarterly retainer review per client stops being folklore and starts being a reviewable operating tool.

**One-paragraph:** In project / programme management, the micro-agency founder runs quarterly retainer review per client on a recurring cadence — but the corpus only covers the upstream concepts, not the artefact that closes the loop. Founders re-sign loss-making clients out of inertia; an explicit kill/keep/upsell rule cuts emotional decisions. `retainer-renewal-decision-rule` pins the artefact: a fixed shape, named owner, evidence anchors, and a published review cadence. It is loaded when the micro-agency founder starts the block named in the trigger and produces a committed artefact reviewed against outcomes at the next iteration. Mechanism: rule-bound output contract + per-application evidence + outcome review. Primary output: a versioned, owned, evidence-anchored decision-rule committed to the team's knowledge space.

## Applies If (ALL must hold)

- the block this methodology unblocks is on the operating cadence: - `p5-micro-agency-founder/Quarterly retainer review per client`
