#!/usr/bin/env python3
"""validate-bench-management-tiering.py

Validate an artefact produced by the `bench-management-tiering` methodology against the
...
_OK_FIXTURE = {
    "artefact_id": "bench-management-tiering-2026-05-23-01",
    "owner": "Anna Schmidt",
