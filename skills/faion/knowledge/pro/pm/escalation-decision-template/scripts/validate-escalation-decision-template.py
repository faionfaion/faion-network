#!/usr/bin/env python3
"""validate-escalation-decision-template.py

Validate a Escalation Decision Template artefact against the output-contract schema declared in
...
OK = {
    ...
    "decision": "Apply Escalation Decision Template to the smoke-test scope.",
