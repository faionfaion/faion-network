#!/usr/bin/env python3
"""validate-founder-as-pm-survival-kit.py

Validate a Founder-as-PM Survival Kit artefact against the output-contract schema declared in
...
OK = {
    ...
    "decision": "Apply Founder-as-PM Survival Kit to the smoke-test scope.",
