#!/usr/bin/env python3
"""validate-vendor-management-pm.py

Validate an artefact produced by the vendor-management-pm methodology against the schema
declared in content/02-output-contract.xml (mirrored in templates/vendor-management-pm.schema.json).

Inputs:
    --file PATH       path to artefact (JSON or Markdown-with-table)
    --schema PATH     path to JSON schema (default: templates/vendor-management-pm.schema.json)
