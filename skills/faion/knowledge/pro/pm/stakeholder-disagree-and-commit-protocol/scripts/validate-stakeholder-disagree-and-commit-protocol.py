#!/usr/bin/env python3
"""validate-stakeholder-disagree-and-commit-protocol.py

Validate an artefact produced by the stakeholder-disagree-and-commit-protocol methodology against the schema
declared in content/02-output-contract.xml (mirrored in templates/stakeholder-disagree-and-commit-protocol.schema.json).

Inputs:
    --file PATH       path to artefact (JSON or Markdown-with-table)
    --schema PATH     path to JSON schema (default: templates/stakeholder-disagree-and-commit-protocol.schema.json)
