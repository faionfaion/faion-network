#!/usr/bin/env python3
"""validate-freelancer-handover-bundle-template.py

Validate a Freelancer Handover Bundle Template artefact against the output-contract schema declared in
...
OK = {
    ...
    "decision": "Apply Freelancer Handover Bundle Template to the smoke-test scope.",
