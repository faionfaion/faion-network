...
summary: Generates a weighted go/no-go score on bidding a fixed-price RFP — margin, fit, compliance, AI-leverage as scored dimensions with explicit threshold.
content_id: "81ac6af0d2a50367"
complexity: medium
produces: rubric
est_tokens: 3800
tags: [bid-no-bid-scorecard, pm, pro, rubric]
---
...
| `templates/bid-no-bid-scorecard.md` | Markdown skeleton with the required fields for the Bid No Bid Scorecard artefact |
