#!/usr/bin/env python3
"""validate-benefits-realisation-template-outsource.py

Validate a Benefits Realisation Template Outsource `spec` artefact against the JSON Schema in
...
REQUIRED = ['artefact_id', 'owner', 'decision', 'rationale', 'inputs_used', 'version', 'last_reviewed', 'spec_body']
...
OK_FIXTURE = json.loads("{\"artefact_id\": \"benefits-realisation-template-outsource-2026-05-23-acme\", \"owner\": \"ruslan@faion.net\", \"decision\": \"Proceed with the agreed plan per inputs.\", \"rationale\": \"Decision rests on engagement-notes-2026-05-22 and baseline-2026-05-15; both inputs corroborate the same direction.\", \"inputs_used\": [{\"name\": \"engagement-notes-2026-05-22\", \"source\": \"wiki://pm/acme/notes.md\"}], \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"spec_body\": \"1. Scope. 2. Owner ruslan@faion.net. 3. Weekly cadence. 4. Client sign-off acceptance.\"}")
