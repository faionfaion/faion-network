...
Validate the `report` artefact for the `pm-certification-changes-2026` methodology against the
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#', '$id': 'https://faion.net/schemas/pm-certification-changes-2026.json', 'title': 'PM Certification Exam Changes 2026', 'type': 'object', 'additionalProperties': False, 'required': ['slug', 'period', 'summary', 'findings'], 'properties': {'slug': {'type': 'string', 'const': 'pm-certification-changes-2026'}, 'period': {'type': 'string'}, 'summary': {'type': 'string', 'minLength': 10}, 'findings': {'type': 'array', 'minItems': 1, 'items': {'type': 'object', 'required': ['id', 'severity', 'evidence'], 'properties': {'id': {'type': 'string'}, 'severity': {'enum': ['LOW', 'MEDIUM', 'HIGH', 'CRITICAL']}, 'evidence': {'type': 'string'}}}}, 'rag': {'enum': ['GREEN', 'YELLOW', 'RED']}}}

OK_FIXTURE = {'slug': 'pm-certification-changes-2026', 'period': '2026-Q2', 'summary': 'Three findings; one HIGH.', 'findings': [{'id': 'F-01', 'severity': 'HIGH', 'evidence': 'metric snapshot M3'}], 'rag': 'YELLOW'}

BAD_FIXTURE = {'slug': 'pm-certification-changes-2026', 'period': '2026-Q2'}
