...
summary: Hidden stakeholders block projects at the worst possible moments.
content_id: "219540d3f32b17ad"
tags: [stakeholder-management, register, pmi, governance, risk-management]
---
# Stakeholder Register

## Summary

**One-sentence:** Hidden stakeholders block projects at the worst possible moments.

**One-paragraph:** Hidden stakeholders block projects at the worst possible moments. A register built from authoritative directory data (org chart, CRM) rather than the PM's memory surfaces gatekeepers (infosec, procurement, works council) who are systematically missed. Attitude documented with evidence enables targeted engagement; attitude assumed from seniority misleads. The register is the source of truth for all engagement planning and communications.
