...
summary: The five Scrum events — Sprint Planning, Daily Standup, Sprint Review, Sprint Retrospective, and Backlog Refinement — with time-boxes, facilitation patterns (including async/remote variants), tool configurations, and quality gates.
content_id: "698c149f3e078611"
tags: [scrum, ceremonies, ceremonies, sprint, agile]
---
# Scrum Ceremonies

## Summary

**One-sentence:** The five Scrum events — Sprint Planning, Daily Standup, Sprint Review, Sprint Retrospective, and Backlog Refinement — with time-boxes, facilitation patterns (including async/remote variants), tool configurations, and quality gates.
