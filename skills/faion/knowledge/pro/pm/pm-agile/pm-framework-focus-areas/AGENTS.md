...
summary: PMBOK 8 replaces Process Groups with five method-agnostic Focus Areas — Initiating, Planning, Executing, Monitoring & Controlling, Closing — distributed across 40 non-prescriptive processes.
content_id: "60e130e628fc7825"
tags: [pmbok, focus-areas, agile, lifecycle, project-governance]
---
# PMBOK 8 Focus Areas

## Summary

**One-sentence:** PMBOK 8 replaces Process Groups with five method-agnostic Focus Areas — Initiating, Planning, Executing, Monitoring & Controlling, Closing — distributed across 40 non-prescriptive processes.

**One-paragraph:** PMBOK 8 replaces Process Groups with five method-agnostic Focus Areas — Initiating, Planning, Executing, Monitoring & Controlling, Closing — distributed across 40 non-prescriptive processes. Focus areas answer "when in the project lifecycle" (orthogonal to the seven performance domains which answer "what area of work"). Teams tailor which focus areas need full treatment vs. light coverage based on project type, size, and regulatory regime.
