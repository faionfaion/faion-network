...
summary: PMBOK 7 defines six guiding principles for every project management decision: Adopt Holistic View, Focus on Value, Embed Quality, Lead Accountably, Integrate Sustainability, and Build Empowered Teams.
content_id: "eca92daa4b009d14"
tags: [pmbok7, principles, decision-making, governance, audit]
---
# Six Core Principles (PMBOK 7)

## Summary

**One-sentence:** PMBOK 7 defines six guiding principles for every project management decision: Adopt Holistic View, Focus on Value, Embed Quality, Lead Accountably, Integrate Sustainability, and Build Empowered Teams.

**One-paragraph:** PMBOK 7 defines six guiding principles for every project management decision: Adopt Holistic View, Focus on Value, Embed Quality, Lead Accountably, Integrate Sustainability, and Build Empowered Teams. Each principle acts as a pre-commitment heuristic — run the six-question audit before committing to a plan, scope change, or architectural decision to surface violations before they compound.
