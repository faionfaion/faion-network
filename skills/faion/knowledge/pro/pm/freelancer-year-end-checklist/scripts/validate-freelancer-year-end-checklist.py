#!/usr/bin/env python3
"""validate-freelancer-year-end-checklist.py

Validate a Freelancer Year-End Checklist artefact against the output-contract schema declared in
...
OK = {
    ...
    "decision": "Apply Freelancer Year-End Checklist to the smoke-test scope.",
