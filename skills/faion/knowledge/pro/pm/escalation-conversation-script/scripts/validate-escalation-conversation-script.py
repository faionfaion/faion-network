#!/usr/bin/env python3
"""validate-escalation-conversation-script.py

Validate a Escalation Conversation Script artefact against the output-contract schema declared in
...
OK = {
    ...
    "decision": "Apply Escalation Conversation Script to the smoke-test scope.",
