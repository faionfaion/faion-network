---
slug: proposal-red-team-checklist
tier: pro
group: pm
domain: pm
version: 1.0.0
...
maintainers: [faion]
content_id: "5cd6154d986b15f4"
summary: Proposal Red Team Checklist — pinned checklist for the outsource delivery specialist: fixed shape + named owner + evidence anchors + outcome review, so fixed-price bid discovery + estimation (1 week) stops being folklore and starts being a reviewable operating tool.
tags: [pm, pro, checklist, proposal, red, team]
---
# Proposal Red Team Checklist

## Summary

**One-sentence:** Proposal Red Team Checklist — pinned checklist for the outsource delivery specialist: fixed shape + named owner + evidence anchors + outcome review, so fixed-price bid discovery + estimation (1 week) stops being folklore and starts being a reviewable operating tool.

**One-paragraph:** In project / programme management, the outsource delivery specialist runs fixed-price bid discovery + estimation (1 week) on a recurring cadence — but the corpus only covers the upstream concepts, not the artefact that closes the loop. Vendors lose margin to proposals that pass an internal sniff test but blow up in delivery. A red-team checklist that an architect + delivery manager can run in an hour is missing. `proposal-red-team-checklist` pins the artefact: a fixed shape, named owner, evidence anchors, and a published review cadence. It is loaded when the outsource delivery specialist starts the block named in the trigger and produces a committed artefact reviewed against outcomes at the next iteration. Mechanism: rule-bound output contract + per-application evidence + outcome review. Primary output: a versioned, owned, evidence-anchored checklist committed to the team's knowledge space.

## Applies If (ALL must hold)

- the block this methodology unblocks is on the operating cadence: - `p4-outsource-specialist/Fixed-price bid discovery + estimation (1 week)`
