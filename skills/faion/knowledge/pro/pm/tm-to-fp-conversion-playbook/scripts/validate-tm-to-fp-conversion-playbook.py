#!/usr/bin/env python3
"""validate-tm-to-fp-conversion-playbook.py

Validate an artefact produced by the tm-to-fp-conversion-playbook methodology against the schema
declared in content/02-output-contract.xml (mirrored in templates/tm-to-fp-conversion-playbook.schema.json).

Inputs:
    --file PATH       path to artefact (JSON or Markdown-with-table)
    --schema PATH     path to JSON schema (default: templates/tm-to-fp-conversion-playbook.schema.json)
