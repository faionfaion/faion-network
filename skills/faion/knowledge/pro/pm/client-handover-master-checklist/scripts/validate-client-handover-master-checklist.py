#!/usr/bin/env python3
"""validate-client-handover-master-checklist.py

Validate a Client Handover Master Checklist `checklist` artefact against the JSON Schema in
