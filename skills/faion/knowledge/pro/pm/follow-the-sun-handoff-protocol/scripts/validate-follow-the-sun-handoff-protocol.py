#!/usr/bin/env python3
"""validate-follow-the-sun-handoff-protocol.py

Validate a Follow-The-Sun Handoff Protocol artefact against the output-contract schema declared in
...
OK = {
    ...
    "decision": "Apply Follow-The-Sun Handoff Protocol to the smoke-test scope.",
