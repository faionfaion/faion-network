#!/usr/bin/env python3
"""validate-timezone-overlap-comms-charter.py

Validate an artefact produced by the timezone-overlap-comms-charter methodology against the schema
declared in content/02-output-contract.xml (mirrored in templates/timezone-overlap-comms-charter.schema.json).

Inputs:
    --file PATH       path to artefact (JSON or Markdown-with-table)
    --schema PATH     path to JSON schema (default: templates/timezone-overlap-comms-charter.schema.json)
