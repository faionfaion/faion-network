#!/usr/bin/env python3
"""validate-project-integration.py

Validate the spec artefact for the project-integration methodology against the schema
...
VERSION = "1.1.0"
PRODUCES = "spec"
RULES = ['single-source-of-truth', 'charter-as-code', 'cross-area-impact-memo', 'numeric-thresholds-for-status', 'rebaseline-only-on-cr', 'decision-log-adr-per-cr']
...
OK = {"__faion_header__": {"methodology": "project-integration", "version": "1.1.0", "produces": "spec", "rules_satisfied": ["single-source-of-truth", "charter-as-code", "cross-area-impact-memo"]}, "artefact_path": "docs/project-integration.md", "sections": [{"id": "S1", "title": "Scope"}, {"id": "S2", "title": "Deliverables"}]}
BAD = {"artefact_path": "docs/project-integration.md"}
