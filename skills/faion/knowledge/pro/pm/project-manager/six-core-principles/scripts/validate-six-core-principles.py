...
Validate the checklist artefact for the six-core-principles methodology against the schema
...
METHODOLOGY = "six-core-principles"
VERSION = "1.1.0"
PRODUCES = "checklist"
RULES = ['positive-evidence-required', 'fail-blocks-gate', 'canonical-six-names', 'sustainability-numeric-proxy', 'pin-pmbok-edition']
...
OK = {"__faion_header__": {"methodology": "six-core-principles", "version": "1.1.0", "produces": "checklist", "rules_satisfied": ["positive-evidence-required", "fail-blocks-gate", "canonical-six-names"]}, "items": [{"id": "C1", "status": "pass", "evidence": "verified by sign-off 2026-05-23"}]}
BAD = {"artefact_path": "docs/six-core-principles.md"}
