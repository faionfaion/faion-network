...
summary: Identify required skills and quantities per work package, assess real availability (capped at 75-80% effective capacity), map resources to activities, level overloads via delay/split/add/cut options, and monitor utilization weekly against plan.
...
**One-sentence:** Identify required skills and quantities per work package, assess real availability (capped at 75-80% effective capacity), map resources to activities, level overloads via delay/split/add/cut options, and monitor utilization weekly against plan.
