#!/usr/bin/env python3
"""validate-resource-management.py

Validate the spec artefact for the resource-management methodology against the schema
...
VERSION = "1.1.0"
PRODUCES = "spec"
RULES = ['cap-effective-capacity-80', 'bus-factor-min-2', 'skill-matrix-last-used', 'reconcile-with-schedule-cost', 'stretch-bench', 'calendar-subjects-redacted']
...
OK = {"__faion_header__": {"methodology": "resource-management", "version": "1.1.0", "produces": "spec", "rules_satisfied": ["cap-effective-capacity-80", "bus-factor-min-2", "skill-matrix-last-used"]}, "artefact_path": "docs/resource-management.md", "sections": [{"id": "S1", "title": "Scope"}, {"id": "S2", "title": "Deliverables"}]}
BAD = {"artefact_path": "docs/resource-management.md"}
