...
Validate the spec artefact for the schedule-development methodology against the schema
...
VERSION = "1.1.0"
PRODUCES = "spec"
RULES = ['fs-by-default', 'track-near-critical-paths', 'lock-baseline', 'effort-not-duration', 'explicit-predecessors', 'business-calendar']
...
OK = {"__faion_header__": {"methodology": "schedule-development", "version": "1.1.0", "produces": "spec", "rules_satisfied": ["fs-by-default", "track-near-critical-paths", "lock-baseline"]}, "artefact_path": "docs/schedule-development.md", "sections": [{"id": "S1", "title": "Scope"}, {"id": "S2", "title": "Deliverables"}]}
BAD = {"artefact_path": "docs/schedule-development.md"}
