...
Validate the report artefact for the project-closure methodology against the schema
...
METHODOLOGY = "project-closure"
VERSION = "1.1.0"
PRODUCES = "report"
RULES = ['signed-acceptance-required', 'acceptance-criteria-precede-closure', 'lessons-before-dispersal', 'staged-decommission', 'access-revocation-after-handover', 'cancellation-rationale-signed']
...
OK = {"__faion_header__": {"methodology": "project-closure", "version": "1.1.0", "produces": "report", "rules_satisfied": ["signed-acceptance-required", "acceptance-criteria-precede-closure", "lessons-before-dispersal"]}, "report_id": "project-closure-2026-05-23", "data": {"summary": "ok"}}
BAD = {"artefact_path": "docs/project-closure.md"}
