...
maintainers: [faion]
summary: Reusable template for agency annual plan template that codifies the structure, named fields, and decision points so each new instance ships in minutes instead of being re-invented.
content_id: "f38d2fa3b66e914a"
...
**One-sentence:** Reusable template for agency annual plan template that codifies the structure, named fields, and decision points so each new instance ships in minutes instead of being re-invented.

**One-paragraph:** Reusable template for agency annual plan template that codifies the structure, named fields, and decision points so each new instance ships in minutes instead of being re-invented. ops-annual-planning-templates is generic; an agency-specific template (revenue mix, contractor capacity, service portfolio, risk register) is missing.

## Applies If (ALL must hold)

- You are starting a new instance of the artefact addressed by agency annual plan template (kickoff, contract, brief, deck).
