#!/usr/bin/env python3
"""validate-stakeholder-engagement.py

Validate the spec artefact for the stakeholder-engagement methodology against the schema
...
VERSION = "1.1.0"
PRODUCES = "spec"
RULES = ['default-cadence-by-quadrant', 'evidence-required-for-attitude', 'triangulate-with-behaviour', 'hidden-stakeholder-pass', 'register-in-git', 'no-auto-send-execs']
...
OK = {"__faion_header__": {"methodology": "stakeholder-engagement", "version": "1.1.0", "produces": "spec", "rules_satisfied": ["default-cadence-by-quadrant", "evidence-required-for-attitude", "triangulate-with-behaviour"]}, "artefact_path": "docs/stakeholder-engagement.md", "sections": [{"id": "S1", "title": "Scope"}, {"id": "S2", "title": "Deliverables"}]}
BAD = {"artefact_path": "docs/stakeholder-engagement.md"}
