...
Validate the config artefact for the quality-management methodology against the schema
...
VERSION = "1.1.0"
PRODUCES = "config"
RULES = ['dod-as-code', 'must-vs-should-split', 'twice-not-duplicated', 'escape-rate-leading-indicator', 'higher-bar-for-agent-code', 'no-auto-skip-na']
...
OK = {"__faion_header__": {"methodology": "quality-management", "version": "1.1.0", "produces": "config", "rules_satisfied": ["dod-as-code", "must-vs-should-split", "twice-not-duplicated"]}, "config_path": "config/quality-management.yaml", "entries": [{"key": "k1", "value": "v1"}]}
BAD = {"artefact_path": "docs/quality-management.md"}
