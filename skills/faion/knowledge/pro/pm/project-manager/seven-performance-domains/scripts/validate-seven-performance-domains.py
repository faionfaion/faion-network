...
Validate the rubric artefact for the seven-performance-domains methodology against the schema
...
METHODOLOGY = "seven-performance-domains"
VERSION = "1.1.0"
PRODUCES = "rubric"
RULES = ['canonical-seven', 'fixed-domain-order', 'audit-before-steering', 'gap-equals-risk', 'default-to-governance']
...
OK = {"__faion_header__": {"methodology": "seven-performance-domains", "version": "1.1.0", "produces": "rubric", "rules_satisfied": ["canonical-seven", "fixed-domain-order", "audit-before-steering"]}, "rubric_id": "seven-performance-domains-rubric-v1", "criteria": [{"id": "R1", "weight": 0.5}]}
BAD = {"artefact_path": "docs/seven-performance-domains.md"}
