#!/usr/bin/env python3
"""validate-engagement-handover-playbook.py

Validate a Engagement Handover Playbook artefact against the output-contract schema declared in
...
OK = {
    ...
    "decision": "Apply Engagement Handover Playbook to the smoke-test scope.",
