#!/usr/bin/env python3
"""validate-client-status-email-template-agency.py

Validate a Client Status Email Template Agency `spec` artefact against the JSON Schema in
