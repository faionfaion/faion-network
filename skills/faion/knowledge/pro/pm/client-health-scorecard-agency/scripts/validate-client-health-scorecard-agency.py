#!/usr/bin/env python3
"""validate-client-health-scorecard-agency.py

Validate a Client Health Scorecard Agency `rubric` artefact against the JSON Schema in
