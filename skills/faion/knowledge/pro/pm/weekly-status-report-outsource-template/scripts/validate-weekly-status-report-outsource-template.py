#!/usr/bin/env python3
"""validate-weekly-status-report-outsource-template.py

Validate an artefact produced by the weekly-status-report-outsource-template methodology against the schema
declared in content/02-output-contract.xml (mirrored in templates/weekly-status-report-outsource-template.schema.json).

Inputs:
    --file PATH       path to artefact (JSON or Markdown-with-table)
    --schema PATH     path to JSON schema (default: templates/weekly-status-report-outsource-template.schema.json)
