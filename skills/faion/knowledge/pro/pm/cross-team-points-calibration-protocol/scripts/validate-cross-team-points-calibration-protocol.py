#!/usr/bin/env python3
"""validate-cross-team-points-calibration-protocol.py

Validate a Cross Team Points Calibration Protocol `spec` artefact against the JSON Schema in
