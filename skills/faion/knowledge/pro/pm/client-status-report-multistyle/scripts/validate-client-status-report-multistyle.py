#!/usr/bin/env python3
"""validate-client-status-report-multistyle.py

Validate a Client Status Report Multistyle `report` artefact against the JSON Schema in
...
REQUIRED = ['artefact_id', 'owner', 'decision', 'rationale', 'inputs_used', 'version', 'last_reviewed', 'sections']
...
OK_FIXTURE = json.loads("{\"artefact_id\": \"client-status-report-multistyle-2026-05-23-acme\", \"owner\": \"ruslan@faion.net\", \"decision\": \"Proceed with the agreed plan per inputs.\", \"rationale\": \"Decision rests on engagement-notes-2026-05-22 and baseline-2026-05-15; both inputs corroborate the same direction.\", \"inputs_used\": [{\"name\": \"engagement-notes-2026-05-22\", \"source\": \"wiki://pm/acme/notes.md\"}], \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"sections\": [{\"heading\": \"Executive summary\", \"body\": \"On track.\"}, {\"heading\": \"Risks\", \"body\": \"Credentials owner unassigned.\"}]}")
