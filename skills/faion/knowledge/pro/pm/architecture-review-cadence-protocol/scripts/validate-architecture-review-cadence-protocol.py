#!/usr/bin/env python3
"""validate-architecture-review-cadence-protocol.py

Validate an artefact produced by the `architecture-review-cadence-protocol` methodology against the
...
_OK_FIXTURE = {
    "artefact_id": "architecture-review-cadence-protocol-2026-05-23-01",
    "owner": "Anna Schmidt",
