#!/usr/bin/env python3
"""validate-sprint-demo-script-template.py

Validate an artefact produced by the sprint-demo-script-template methodology against the schema
declared in content/02-output-contract.xml (mirrored in templates/sprint-demo-script-template.schema.json).

Inputs:
    --file PATH       path to artefact (JSON or Markdown-with-table)
    --schema PATH     path to JSON schema (default: templates/sprint-demo-script-template.schema.json)
