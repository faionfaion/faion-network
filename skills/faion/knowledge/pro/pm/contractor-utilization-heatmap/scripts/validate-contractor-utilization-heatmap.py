#!/usr/bin/env python3
"""validate-contractor-utilization-heatmap.py

Validate a Contractor Utilization Heatmap `report` artefact against the JSON Schema in
