#!/usr/bin/env python3
"""validate-capacity-vs-ask-balancer.py

Validate a Capacity vs Ask Balancer `decision-record` artefact against the JSON Schema in
