#!/usr/bin/env python3
"""validate-client-maturity-assessment-rubric.py

Validate a Client Maturity Assessment Rubric `rubric` artefact against the JSON Schema in
...
REQUIRED = ['artefact_id', 'owner', 'decision', 'rationale', 'inputs_used', 'version', 'last_reviewed', 'dimensions', 'threshold']
...
OK_FIXTURE = json.loads("{\"artefact_id\": \"client-maturity-assessment-rubric-2026-05-23-acme\", \"owner\": \"ruslan@faion.net\", \"decision\": \"Proceed with the agreed plan per inputs.\", \"rationale\": \"Decision rests on engagement-notes-2026-05-22 and baseline-2026-05-15; both inputs corroborate the same direction.\", \"inputs_used\": [{\"name\": \"engagement-notes-2026-05-22\", \"source\": \"wiki://pm/acme/notes.md\"}], \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"dimensions\": [{\"name\": \"margin\", \"weight\": 0.5, \"score\": 3.5, \"evidence\": \"finance sheet 2026-Q2\"}, {\"name\": \"fit\", \"weight\": 0.5, \"score\": 4.0, \"evidence\": \"stack overlap with prior wins\"}], \"threshold\": 3.0}")
