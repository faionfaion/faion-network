#!/usr/bin/env python3
"""validate-freelance-capacity-model.py

Validate a Freelance Capacity Model artefact against the output-contract schema declared in
...
OK = {
    ...
    "decision": "Apply Freelance Capacity Model to the smoke-test scope.",
