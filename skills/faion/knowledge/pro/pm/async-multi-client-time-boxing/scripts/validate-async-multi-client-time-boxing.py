#!/usr/bin/env python3
"""validate-async-multi-client-time-boxing.py

Validate an artefact produced by the `async-multi-client-time-boxing` methodology against the
...
_OK_FIXTURE = {
    "artefact_id": "async-multi-client-time-boxing-2026-05-23-01",
    "owner": "Anna Schmidt",
