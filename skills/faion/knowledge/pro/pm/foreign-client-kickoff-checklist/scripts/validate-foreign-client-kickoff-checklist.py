#!/usr/bin/env python3
"""validate-foreign-client-kickoff-checklist.py

Validate a Foreign Client Kickoff Checklist artefact against the output-contract schema declared in
...
OK = {
    ...
    "decision": "Apply Foreign Client Kickoff Checklist to the smoke-test scope.",
