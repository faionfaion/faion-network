#!/usr/bin/env python3
"""validate-contractor-onboarding-runbook.py — stdlib-only validator for the Contractor Onboarding Runbook playbook-step artefact.
