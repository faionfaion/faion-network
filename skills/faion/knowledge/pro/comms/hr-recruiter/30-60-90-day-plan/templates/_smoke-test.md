...
<!-- produces: artefact instance that MUST validate via scripts/validate-30-60-90-day-plan.py -->
<!-- depends-on: templates/30-60-90-day-plan.md, content/02-output-contract.xml -->
<!-- token-budget-impact: ~200 tokens -->

# 30-60-90 Day Plan — Smoke Test Fixture

```json
{
  "artefact_id": "30-60-90-day-plan-acme-2026-05-23",
