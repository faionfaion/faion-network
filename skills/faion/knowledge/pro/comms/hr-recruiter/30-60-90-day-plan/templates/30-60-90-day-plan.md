<!-- purpose: working spec skeleton for the 30-60-90 Day Plan methodology -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a spec artefact validating against scripts/validate-30-60-90-day-plan.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1200 tokens once filled -->

# 30-60-90 Day Plan — Artefact Skeleton
...
Run `python scripts/validate-30-60-90-day-plan.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
