<!-- purpose: working spec skeleton for the Interview Methods methodology -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a spec artefact validating against scripts/validate-interview-methods.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1200 tokens once filled -->

# Interview Methods — Artefact Skeleton
...
Run `python scripts/validate-interview-methods.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
