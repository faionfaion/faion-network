...
Question generation:
```
You are designing a STAR question bank per skills/faion/knowledge/pro/comms/hr-recruiter/star-interview-method/README.md.
...
- Internal: `skills/faion/knowledge/pro/comms/hr-recruiter/structured-interview-design/agent-integration.md`.
