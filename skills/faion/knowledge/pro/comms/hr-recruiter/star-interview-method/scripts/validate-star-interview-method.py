#!/usr/bin/env python3
"""validate-star-interview-method.py — validate star-interview-method output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-star-interview-method.py",
        description="Validate star-interview-method output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
