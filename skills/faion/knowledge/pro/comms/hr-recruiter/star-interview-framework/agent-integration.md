...
- `skills/faion/knowledge/pro/comms/hr-recruiter/star-interview-method/agent-integration.md`
...
- Sibling: `skills/faion/knowledge/pro/comms/hr-recruiter/star-interview-method/agent-integration.md` (canonical).
- Parent process: `skills/faion/knowledge/pro/comms/hr-recruiter/structured-interview-design/agent-integration.md`.
- Bundle index: `skills/faion/knowledge/pro/comms/hr-recruiter/interview-methods/agent-integration.md`.
