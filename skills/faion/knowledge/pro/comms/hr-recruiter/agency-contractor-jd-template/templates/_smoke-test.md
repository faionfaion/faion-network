...
<!-- produces: artefact instance that MUST validate via scripts/validate-agency-contractor-jd-template.py -->
<!-- depends-on: templates/agency-contractor-jd-template.md, content/02-output-contract.xml -->
<!-- token-budget-impact: ~200 tokens -->

# Agency Contractor JD Template — Smoke Test Fixture

```json
{
  "artefact_id": "agency-contractor-jd-template-acme-2026-05-23",
