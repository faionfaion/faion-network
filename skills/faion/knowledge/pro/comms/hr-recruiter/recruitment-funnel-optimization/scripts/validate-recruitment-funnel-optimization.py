#!/usr/bin/env python3
"""validate-recruitment-funnel-optimization.py — validate recruitment-funnel-optimization output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-recruitment-funnel-optimization.py",
        description="Validate recruitment-funnel-optimization output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
