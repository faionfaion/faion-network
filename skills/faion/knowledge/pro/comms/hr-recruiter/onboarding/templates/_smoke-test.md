...
<!-- produces: artefact instance that MUST validate via scripts/validate-onboarding.py -->
<!-- depends-on: templates/onboarding.md, content/02-output-contract.xml -->
<!-- token-budget-impact: ~200 tokens -->

# Onboarding Program Design — Smoke Test Fixture

```json
{
  "artefact_id": "onboarding-acme-2026-05-23",
