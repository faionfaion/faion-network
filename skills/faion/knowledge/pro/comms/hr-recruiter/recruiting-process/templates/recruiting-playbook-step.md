<!--
purpose: Full-cycle step skeleton with inputs/outputs/exit-criteria per stage
consumes: see AGENTS.md Prerequisites
produces: Recruiting Process (Full-Cycle) playbook-step
depends-on: content/02-output-contract.xml schema
token-budget-impact: ~400 tokens when filled
-->

# Recruiting Process (Full-Cycle) — recruiting-playbook-step.md
