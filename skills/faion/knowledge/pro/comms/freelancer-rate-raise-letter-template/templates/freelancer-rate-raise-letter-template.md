<!-- purpose: working spec skeleton for the Freelancer Rate Raise Letter Template methodology -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a spec artefact validating against scripts/validate-freelancer-rate-raise-letter-template.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1200 tokens once filled -->

# Freelancer Rate Raise Letter Template — Artefact Skeleton
