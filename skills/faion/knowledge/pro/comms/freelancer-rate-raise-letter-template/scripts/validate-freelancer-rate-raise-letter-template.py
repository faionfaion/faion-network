#!/usr/bin/env python3
"""validate-freelancer-rate-raise-letter-template.py — stdlib-only validator for the Freelancer Rate Raise Letter Template spec artefact.
