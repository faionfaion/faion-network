<!-- purpose: PR description eval-delta template -->
...
_Skeleton for the `eval-driven-development-tdd-for-ai` methodology output. Fill each section; do not leave headings empty._
...
- Timestamp
- Validator run: `python scripts/validate-eval-driven-development-tdd-for-ai.py --file out.json`
