<!-- purpose: Inventory report skeleton -->
...
_Skeleton for the `ai-call-site-inventory` methodology output. Fill each section; do not leave headings empty._
...
- Timestamp
- Validator run: `python scripts/validate-ai-call-site-inventory.py --file out.json`
