---
slug: ai-feedback-triage-protocol
tier: pro
group: ai
...
maintainers: [faion]
summary: End-to-end playbook for ai feedback triage protocol that walks an operator from trigger to closed outcome with named artefacts at each step.
content_id: "e707062dd825c25e"
tags: [ai, playbook]
---
...
**One-sentence:** End-to-end playbook for ai feedback triage protocol that walks an operator from trigger to closed outcome with named artefacts at each step.

**One-paragraph:** End-to-end playbook for ai feedback triage protocol that walks an operator from trigger to closed outcome with named artefacts at each step. Generic product-feedback triage exists; AI-specific clustering (hallucination / refusal / wrong-tool / out-of-scope) and routing to ML vs product is missing.

## Applies If (ALL must hold)

- You are executing the cross-cutting workflow addressed by ai feedback triage protocol end to end.
