<!-- purpose: Post-mortem report skeleton with AI-specific sections -->
...
_Skeleton for the `ai-post-mortem-template` methodology output. Fill each section; do not leave headings empty._
...
- Timestamp
- Validator run: `python scripts/validate-ai-post-mortem-template.py --file out.json`
