<!-- purpose: minimal Opportunity Solution Trees artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-opportunity-solution-trees.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Opportunity Solution Trees — Artefact

| Field | Value |
|-------|-------|
| artefact_id | opportunity-solution-trees-YYYY-MM-DD |
