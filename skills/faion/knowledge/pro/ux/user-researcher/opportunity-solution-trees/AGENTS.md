...
summary: A visual discovery framework that links one product outcome to a hierarchy of customer opportunities, candidate solutions, and experiments.
...
**One-sentence:** A visual discovery framework that links one product outcome to a hierarchy of customer opportunities, candidate solutions, and experiments.

**One-paragraph:** A visual discovery framework that links one product outcome to a hierarchy of customer opportunities, candidate solutions, and experiments. The tree enforces outcome-first thinking: no solution may exist without a parent opportunity, and no opportunity is valid without customer-interview evidence.
