#!/usr/bin/env python3
"""validate-opportunity-solution-trees.py

Validate a Opportunity Solution Trees artefact against the JSON Schema (draft-07) defined in
...
REQUIRED = ['artefact_id', 'outcome', 'opportunities', 'solutions', 'experiments', 'evidence', 'owner', 'last_touched', 'template_version']
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'opportunity-solution-trees-2026-05-23', 'outcome': 'draft', 'opportunities': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'solutions': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'experiments': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
