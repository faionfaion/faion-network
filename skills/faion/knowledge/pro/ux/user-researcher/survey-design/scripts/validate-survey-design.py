#!/usr/bin/env python3
"""validate-survey-design.py

Validate a Survey Design artefact against the JSON Schema (draft-07) defined in
...
REQUIRED = ['artefact_id', 'research_objective', 'question_bank', 'flow', 'pilot_log', 'analysis_plan', 'evidence', 'owner', 'last_touched', 'template_version']
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'survey-design-2026-05-23', 'research_objective': 'draft', 'question_bank': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'flow': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'pilot_log': {'key': 'value'}, 'analysis_plan': {'key': 'value'}, 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
