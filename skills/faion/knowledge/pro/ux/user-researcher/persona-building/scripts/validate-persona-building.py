...
Validate a Persona Building artefact against the JSON Schema (draft-07) defined in
...
REQUIRED = ['artefact_id', 'interviews_count', 'clusters', 'primary_persona', 'negative_persona', 'validation_cohort', 'evidence', 'owner', 'last_touched', 'template_version']
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'persona-building-2026-05-23', 'interviews_count': 10, 'clusters': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'primary_persona': {'key': 'value'}, 'negative_persona': {'key': 'value'}, 'validation_cohort': {'key': 'value'}, 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
