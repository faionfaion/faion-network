<!-- purpose: minimal User Research at Scale artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-user-research-at-scale.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# User Research at Scale — Artefact

| Field | Value |
|-------|-------|
| artefact_id | user-research-at-scale-YYYY-MM-DD |
