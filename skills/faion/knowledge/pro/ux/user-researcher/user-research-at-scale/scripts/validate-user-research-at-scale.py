#!/usr/bin/env python3
"""validate-user-research-at-scale.py

Validate a User Research at Scale artefact against the JSON Schema (draft-07) defined in
...
REQUIRED = ['artefact_id', 'intake_pipeline', 'agent_tagging_rules', 'clustering_strategy', 'human_verification_sample', 'repository_spec', 'evidence', 'owner', 'last_touched', 'template_version']
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'user-research-at-scale-2026-05-23', 'intake_pipeline': {'key': 'value'}, 'agent_tagging_rules': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'clustering_strategy': {'key': 'value'}, 'human_verification_sample': {'key': 'value'}, 'repository_spec': {'key': 'value'}, 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
