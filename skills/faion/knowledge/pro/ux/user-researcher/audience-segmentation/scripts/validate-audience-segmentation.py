#!/usr/bin/env python3
"""validate-audience-segmentation.py

Validate a Audience Segmentation artefact against the JSON Schema (draft-07) defined in
...
REQUIRED = ['artefact_id', 'dimensions', 'segments', 'segment_scores', 'target_segment', 'rationale', 'evidence', 'owner', 'last_touched', 'template_version']
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'audience-segmentation-2026-05-23', 'dimensions': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'segments': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'segment_scores': {'key': 'value'}, 'target_segment': 'draft', 'rationale': 'draft', 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
