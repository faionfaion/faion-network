#!/usr/bin/env python3
"""validate-design-qa-during-build.py

Validate a Design QA During Build artefact against the JSON Schema (draft-07) defined in
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'design-qa-during-build-2026-05-23', 'sprint_id': 'draft', 'build_ref': 'draft', 'screens_audited': ['draft-item'], 'drift_count': 1, 'deviation_log': ['draft-item'], 'fix_tickets': ['draft-item'], 'signed_off_by': 'draft', 'remaining_open': ['draft-item'], 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'status': 'ready_for_review'}
