#!/usr/bin/env python3
"""validate-spatial-accessibility.py — validate a spatial-accessibility output JSON against the methodology schema.
...
VALID_FIXTURE = json.loads('{"artefact_id": "spa-2026-0001", "version": "1.1.0", "last_reviewed": "2026-05-23", "owner": "@xr-designer", "scope": {"experience": "workshop-vr", "platforms": ["Quest"], "session_pose": ["seated", "standing"]}, "findings": [{"rule": "reach-zones-pinned", "verdict": "pass"}, {"rule": "height-variability", "verdict": "pass"}, {"rule": "occlusion-budget", "verdict": "pass"}, {"rule": "spatial-audio-directional", "verdict": "pass"}, {"rule": "seated-alternate-required", "verdict": "pass"}], "verdict": "pass"}')
INVALID_FIXTURE = json.loads('{"findings": []}')
