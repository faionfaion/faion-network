#!/usr/bin/env python3
"""validate-vr-design-patterns.py — validate a vr-design-patterns output JSON against the methodology schema.
...
VALID_FIXTURE = json.loads('{"artefact_id": "vr-2026-0001", "version": "1.1.0", "last_reviewed": "2026-05-23", "owner": "@xr-designer", "scope": {"experience": "training-vr", "platform": "Quest"}, "findings": [{"rule": "snap-turn-default", "verdict": "pass"}, {"rule": "vignette-on-during-locomotion", "verdict": "pass"}, {"rule": "locomotion-choice", "verdict": "pass"}, {"rule": "hand-presence-options", "verdict": "pass"}, {"rule": "retreat-affordance", "verdict": "pass"}], "verdict": "pass"}')
