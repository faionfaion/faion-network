#!/usr/bin/env python3
"""validate-immersive-design-principles.py — validate a immersive-design-principles output JSON against the methodology schema.
...
VALID_FIXTURE = json.loads('{"artefact_id": "imm-2026-0001", "version": "1.1.0", "last_reviewed": "2026-05-23", "owner": "@xr-lead", "scope": {"experience": "training-vr", "platform": "Quest", "session_minutes": 12}, "findings": [{"rule": "comfort-defaults", "verdict": "pass"}, {"rule": "safe-locomotion-choice", "verdict": "pass"}, {"rule": "sensory-budget-per-minute", "verdict": "pass"}, {"rule": "explicit-agency", "verdict": "pass"}, {"rule": "retreat-option-always", "verdict": "pass"}], "verdict": "pass"}')
INVALID_FIXTURE = json.loads('{"findings": [{"rule": "comfort-defaults", "verdict": "n/a"}]}')
