#!/usr/bin/env python3
"""validate-screen-reader-test-script-templates.py — validate a screen-reader-test-script-templates output JSON against the methodology schema.
...
VALID_FIXTURE = json.loads('{"artefact_id": "sr-script-2026-0001", "version": "1.1.0", "last_reviewed": "2026-05-23", "owner": "@qa-a", "scope": {"flow": "/signup", "device": "iPhone 15", "os": "iOS 17.4", "sr": "VoiceOver", "sr_version": "iOS 17.4"}, "findings": [{"step": 1, "gesture": "right-flick", "expected": "Email, edit text", "criterion": "contains", "sc": "1.3.1", "verdict": "pass"}], "verdict": "pass"}')
INVALID_FIXTURE = json.loads('{"findings": [{"step": 1, "gesture": "swipe", "expected": "Email"}]}')
