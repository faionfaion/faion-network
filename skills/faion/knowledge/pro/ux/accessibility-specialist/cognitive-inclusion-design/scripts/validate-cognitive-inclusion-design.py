#!/usr/bin/env python3
"""validate-cognitive-inclusion-design.py — validate a cognitive-inclusion-design output JSON against the methodology schema.
...
VALID_FIXTURE = json.loads('{"artefact_id": "cog-2026-0001", "version": "1.1.0", "last_reviewed": "2026-05-23", "owner": "@designer", "scope": {"component": "signup-flow", "reading_level": {"flesch": 72, "grade": 6}, "language": "en"}, "findings": [{"rule": "plain-language-target", "verdict": "pass"}, {"rule": "predictable-navigation", "verdict": "pass"}, {"rule": "error-tolerance", "verdict": "pass"}, {"rule": "recoverable-critical-actions", "verdict": "pass"}, {"rule": "time-extension-defaults", "verdict": "pass"}], "verdict": "pass"}')
INVALID_FIXTURE = json.loads('{"scope": {"reading_level": {"flesch": 35}}, "findings": []}')
