...
Validate a VUI + IoT Integration artefact against the JSON Schema (draft-07) defined in
...
REQUIRED = ['artefact_id', 'command_patterns', 'scene_grammar', 'partial_failure_handling', 'undo_support', 'evidence', 'owner', 'last_touched', 'template_version']
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'vui-iot-integration-2026-05-23', 'command_patterns': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'scene_grammar': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'partial_failure_handling': {'key': 'value'}, 'undo_support': {'key': 'value'}, 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
