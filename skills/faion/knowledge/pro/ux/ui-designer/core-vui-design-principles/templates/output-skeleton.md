<!-- purpose: minimal Core VUI Design Principles artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: rubric artefact validated by scripts/validate-core-vui-design-principles.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Core VUI Design Principles — Artefact

| Field | Value |
|-------|-------|
| artefact_id | core-vui-design-principles-YYYY-MM-DD |
