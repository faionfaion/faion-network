...
Validate a Spatial Design Tools artefact against the JSON Schema (draft-07) defined in
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'spatial-design-tools-2026-05-23', 'report_id': 'draft', 'tools_evaluated': ['draft-item'], 'selected_stack': 'draft', 'handoff_pipeline': 'draft', 'license_map': 'draft', 'ownership': 'draft', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'review_cadence': 'draft', 'status': 'ready_for_review'}
