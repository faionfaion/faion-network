#!/usr/bin/env python3
"""validate-voice-ui-patterns.py

Validate a Voice UI Patterns artefact against the JSON Schema (draft-07) defined in
...
OK = {'owner': 'draft', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'voice-ui-patterns-2026-05-23', 'skill_id': 'draft', 'intent_map': ['draft-item'], 'prompt_rules': ['draft-item'], 'error_ladder_ref': 'draft', 'multimodal_policy': 'draft', 'platform_targets': ['draft-item'], 'kpis': ['draft-item'], 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'status': 'ready_for_review'}
