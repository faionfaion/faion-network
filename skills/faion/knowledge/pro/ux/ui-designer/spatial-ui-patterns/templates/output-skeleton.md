<!-- purpose: minimal Spatial UI Patterns artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-spatial-ui-patterns.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Spatial UI Patterns — Artefact

| Field | Value |
|-------|-------|
| artefact_id | spatial-ui-patterns-YYYY-MM-DD |
