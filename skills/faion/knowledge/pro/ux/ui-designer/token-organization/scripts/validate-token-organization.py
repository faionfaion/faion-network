...
Validate a Token Organization artefact against the JSON Schema (draft-07) defined in
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'token-organization-2026-05-23', 'system_id': 'draft', 'layers': 'draft', 'naming_rules': ['draft-item'], 'category_list': ['draft-item'], 'exceptions_policy': 'draft', 'owners': 'draft', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'review_cadence': 'draft', 'status': 'ready_for_review'}
