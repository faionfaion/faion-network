<!-- purpose: minimal Enterprise XR Applications artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-enterprise-xr-applications.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Enterprise XR Applications — Artefact

| Field | Value |
|-------|-------|
| artefact_id | enterprise-xr-applications-YYYY-MM-DD |
