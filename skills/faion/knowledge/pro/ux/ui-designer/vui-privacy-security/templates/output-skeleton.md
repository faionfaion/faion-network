<!-- purpose: minimal VUI Privacy and Security artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-vui-privacy-security.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# VUI Privacy and Security — Artefact

| Field | Value |
|-------|-------|
| artefact_id | vui-privacy-security-YYYY-MM-DD |
