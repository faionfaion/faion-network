<!-- purpose: minimal Spatial Interaction Patterns artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-spatial-interaction-patterns.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Spatial Interaction Patterns — Artefact

| Field | Value |
|-------|-------|
| artefact_id | spatial-interaction-patterns-YYYY-MM-DD |
