<!-- purpose: minimal Cross-Platform Token Distribution artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-cross-platform-token-distribution.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Cross-Platform Token Distribution — Artefact

| Field | Value |
|-------|-------|
| artefact_id | cross-platform-token-distribution-YYYY-MM-DD |
