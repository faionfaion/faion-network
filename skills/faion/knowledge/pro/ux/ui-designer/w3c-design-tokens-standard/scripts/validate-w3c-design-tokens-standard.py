...
Validate a W3C Design Tokens Standard artefact against the JSON Schema (draft-07) defined in
...
REQUIRED = ['artefact_id', 'token_groups', 'tokens', 'type_coverage', 'aliases_resolved', 'evidence', 'owner', 'last_touched', 'template_version']
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'w3c-design-tokens-standard-2026-05-23', 'token_groups': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'tokens': {'key': 'value'}, 'type_coverage': {'key': 'value'}, 'aliases_resolved': True, 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
