#!/usr/bin/env python3
"""validate-multi-platform-design-parity.py

Validate a Multi-Platform Design Parity artefact against the JSON Schema (draft-07) defined in
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'multi-platform-design-parity-2026-05-23', 'feature_id': 'draft', 'surfaces': ['draft-item'], 'token_map': 'draft', 'gesture_map': 'draft', 'density_tiers': ['draft-item'], 'platform_overrides': ['draft-item'], 'parity_score': 1, 'drift_log': ['draft-item'], 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'status': 'ready_for_review'}
