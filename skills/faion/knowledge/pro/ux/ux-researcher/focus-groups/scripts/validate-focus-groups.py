#!/usr/bin/env python3
"""validate-focus-groups.py

Validate a Focus Groups: Structure, Moderation, and Analysis artefact against the JSON Schema (draft-07) defined in
...
REQUIRED = ['artefact_id', 'screener', 'discussion_guide', 'session_notes', 'themes', 'evidence', 'owner', 'last_touched', 'template_version']
