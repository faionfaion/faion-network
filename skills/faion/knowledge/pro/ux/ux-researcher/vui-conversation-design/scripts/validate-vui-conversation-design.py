...
Validate a VUI Conversation Design artefact against the JSON Schema (draft-07) defined in
...
REQUIRED = ['artefact_id', 'intents', 'slots', 'prompt_classes', 'happy_paths', 'repair_branches', 'evidence', 'owner', 'last_touched', 'template_version']
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'vui-conversation-design-2026-05-23', 'intents': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'slots': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'prompt_classes': {'key': 'value'}, 'happy_paths': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'repair_branches': {'key': 'value'}, 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
