...
Validate a Tree Testing artefact against the JSON Schema (draft-07) defined in
...
REQUIRED = ['artefact_id', 'tree', 'tasks', 'results', 'problem_areas', 'recommendations', 'evidence', 'owner', 'last_touched', 'template_version']
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'tree-testing-2026-05-23', 'tree': {'key': 'value'}, 'tasks': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'results': {'key': 'value'}, 'problem_areas': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'recommendations': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
