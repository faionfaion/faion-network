#!/usr/bin/env python3
"""validate-content-audit-basics.py

Validate a Content Audit Basics artefact against the JSON Schema (draft-07) defined in
...
REQUIRED = ['artefact_id', 'inventory', 'rubric', 'scores', 'decisions', 'evidence', 'owner', 'last_touched', 'template_version']
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'content-audit-basics-2026-05-23', 'inventory': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'rubric': {'key': 'value'}, 'scores': {'key': 'value'}, 'decisions': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
