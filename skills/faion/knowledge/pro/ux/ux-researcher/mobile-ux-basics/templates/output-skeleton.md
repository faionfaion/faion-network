<!-- purpose: minimal Mobile UX Basics: Touch Design, Navigation, and Performance artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-mobile-ux-basics.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Mobile UX Basics: Touch Design, Navigation, and Performance — Artefact

| Field | Value |
|-------|-------|
| artefact_id | mobile-ux-basics-YYYY-MM-DD |
