...
Validate a Surveys and Questionnaires artefact against the JSON Schema (draft-07) defined in
...
REQUIRED = ['artefact_id', 'survey_instance', 'sample_plan', 'metrics', 'verbatims', 'evidence', 'owner', 'last_touched', 'template_version']
