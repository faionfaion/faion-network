...
Validate a Contextual Inquiry artefact against the JSON Schema (draft-07) defined in
...
REQUIRED = ['artefact_id', 'sessions', 'observation_rows', 'tags', 'themes', 'evidence', 'owner', 'last_touched', 'template_version']
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'contextual-inquiry-2026-05-23', 'sessions': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'observation_rows': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'tags': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'themes': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
