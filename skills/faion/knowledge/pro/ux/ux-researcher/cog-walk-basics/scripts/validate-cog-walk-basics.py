#!/usr/bin/env python3
"""validate-cog-walk-basics.py

Validate a Cognitive Walkthrough: Basics artefact against the JSON Schema (draft-07) defined in
...
REQUIRED = ['artefact_id', 'persona', 'task', 'correct_steps', 'step_evaluations', 'issues', 'evidence', 'owner', 'last_touched', 'template_version']
