<!-- purpose: minimal Diary Study Basics artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-diary-study-basics.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Diary Study Basics — Artefact

| Field | Value |
|-------|-------|
| artefact_id | diary-study-basics-YYYY-MM-DD |
