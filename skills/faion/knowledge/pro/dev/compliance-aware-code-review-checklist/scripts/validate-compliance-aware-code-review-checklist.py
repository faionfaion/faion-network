#!/usr/bin/env python3
"""validate-compliance-aware-code-review-checklist.py

Validate a compliance-aware-code-review-checklist output artefact against the JSON Schema in
content/02-output-contract.xml (mirrored in templates/compliance-aware-code-review-checklist.json).
...
def validate(obj: dict) -> list[str]:
    ...
    if "produces" in obj and obj["produces"] != "checklist":
        errs.append("produces must equal 'checklist' for this methodology")
    return errs
