#!/usr/bin/env python3
"""validate-vuln-triage-sla-template.py

Validate the output artefact for the `vuln-triage-sla-template` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/vuln-triage-sla-template.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'vuln-triage-sla-template',
    'title': 'Vuln Triage SLA Template',
...
BAD = {"slug": "BAD_vuln-triage-sla-template", "owner": "someone"}
