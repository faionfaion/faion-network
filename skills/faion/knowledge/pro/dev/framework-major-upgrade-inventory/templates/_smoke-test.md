<!--
purpose: Filled-in canonical example for framework-major-upgrade-inventory
consumes: see AGENTS.md Prerequisites
produces: Framework Major Upgrade Inventory report
depends-on: content/02-output-contract.xml schema
token-budget-impact: ~400 tokens when filled
-->

# Framework Major Upgrade Inventory — _smoke-test.md
