#!/usr/bin/env python3
"""validate-test-pyramid-rebalance-playbook.py

Validate the artefact produced by the `test-pyramid-rebalance-playbook` methodology against the
...
REQUIRED = ["artefact_id", "owner", "step_id", "preconditions", "actions", "postconditions", "rationale", "inputs_used", "version", "last_reviewed"]
...
OK = json.loads(r"""{
  "artefact_id": "test-pyramid-rebalance-playbook-2026Q2-001",
  "owner": "ruslan@faion.net",
  "step_id": "test-pyramid-rebalance-playbook-step-1",
  "preconditions": [
    "input-A available"
  ],
  "actions": [
