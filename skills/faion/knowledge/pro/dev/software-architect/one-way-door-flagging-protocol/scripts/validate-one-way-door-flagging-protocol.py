#!/usr/bin/env python3
"""validate-one-way-door-flagging-protocol.py

Validate the output artefact for the `one-way-door-flagging-protocol` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/one-way-door-flagging-protocol.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'one-way-door-flagging-protocol',
    'title': 'One-Way-Door Flagging Protocol',
...
BAD = {"slug": "BAD_one-way-door-flagging-protocol", "owner": "someone"}
