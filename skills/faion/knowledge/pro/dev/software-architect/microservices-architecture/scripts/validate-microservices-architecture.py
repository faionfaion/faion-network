#!/usr/bin/env python3
"""validate-microservices-architecture.py

Validate the output artefact for the `microservices-architecture` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/microservices-architecture.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'microservices-architecture',
...
BAD = {"slug": "BAD_microservices-architecture", "owner": "someone"}
