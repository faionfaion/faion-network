...
- `faion-research-agent` (under `skills/faion/knowledge/pro/research/researcher/`) — gather industry SLAs and competitive baselines (e.g., "p99 latency for similar SaaS dashboards"); feeds Step 2.
