#!/usr/bin/env python3
"""validate-quality-attributes-analysis.py

Validate the output artefact for the `quality-attributes-analysis` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/quality-attributes-analysis.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'quality-attributes-analysis',
    'title': 'Quality Attributes Analysis',
...
BAD = {"slug": "BAD_quality-attributes-analysis", "owner": "someone"}
