#!/usr/bin/env python3
"""validate-cloud-architecture.py

Validate the output artefact for the `cloud-architecture` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/cloud-architecture.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
BAD = {"slug": "BAD_cloud-architecture", "owner": "someone"}
