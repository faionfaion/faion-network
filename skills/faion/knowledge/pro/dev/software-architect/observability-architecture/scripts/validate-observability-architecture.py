#!/usr/bin/env python3
"""validate-observability-architecture.py

Validate the output artefact for the `observability-architecture` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/observability-architecture.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'observability-architecture',
...
BAD = {"slug": "BAD_observability-architecture", "owner": "someone"}
