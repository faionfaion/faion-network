#!/usr/bin/env python3
"""validate-event-driven-architecture.py

Validate the output artefact for the `event-driven-architecture` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/event-driven-architecture.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'event-driven-architecture',
...
BAD = {"slug": "BAD_event-driven-architecture", "owner": "someone"}
