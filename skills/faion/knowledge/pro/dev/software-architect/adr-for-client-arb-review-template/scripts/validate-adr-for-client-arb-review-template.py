#!/usr/bin/env python3
"""validate-adr-for-client-arb-review-template.py

Validate the output artefact for the `adr-for-client-arb-review-template` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/adr-for-client-arb-review-template.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
    ...
    'properties': {   'slug': {'type': 'string', 'pattern': '^[a-z][a-z0-9-]+$'},
                      ...
                      'trigger': {   'type': 'object',
                                     ...
                                     'properties': {   'kind': {   'enum': [   'event',
                                                       ...
                                                       'value': {   'type': 'string',
                                                                    'minLength': 2}}},
                      'review_cadence': {'enum': ['weekly', 'biweekly', 'monthly', 'quarterly']},
                      ...
                      'decision_class': {'enum': ['one-way-door', 'two-way-door']},
...
OK = {   'slug': 'adr-for-client-arb-review-template',
    'title': 'ADR for Client ARB Review',
    'owner': {'name': 'Tetiana Lytvyn', 'role': 'lead engineer'},
    'trigger': {'kind': 'schedule', 'value': 'weekly:tuesday-14:00-utc'},
    'review_cadence': 'quarterly',
    'last_reviewed': '2026-05-22',
    'evidence': [   {   'claim': 'baseline metric captured',
                        'link': 'https://wiki.example.com/runs/2026-05-22'}],
    'produced_at': '2026-05-22T10:00:00Z',
    'decision_class': 'two-way-door',
    'alternatives_rejected': [   {   'option': 'do-nothing',
                                     'why_rejected': 'misses compliance window'},
                                 {   'option': 'alternative-vendor',
                                     'why_rejected': 'contract terms incompatible'}]}
BAD = {"slug": "BAD_adr-for-client-arb-review-template", "owner": "someone"}
