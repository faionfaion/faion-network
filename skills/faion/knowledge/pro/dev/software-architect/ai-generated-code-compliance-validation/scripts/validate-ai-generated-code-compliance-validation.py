#!/usr/bin/env python3
"""validate-ai-generated-code-compliance-validation.py

Validate the output artefact for the `ai-generated-code-compliance-validation` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/ai-generated-code-compliance-validation.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'ai-generated-code-compliance-validation',
    'title': 'AI-Generated Code Compliance Validation',
    ...
    'findings': [{'id': 'f1', 'summary': 'escape-rate trending up'}],
    'recommendations': ['add mutation-score gate to CI']}
BAD = {"slug": "BAD_ai-generated-code-compliance-validation", "owner": "someone"}
