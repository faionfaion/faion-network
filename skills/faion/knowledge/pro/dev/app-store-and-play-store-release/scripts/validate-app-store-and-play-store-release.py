#!/usr/bin/env python3
"""validate-app-store-and-play-store-release.py — validate app-store-and-play-store-release output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-app-store-and-play-store-release.py",
        description="Validate app-store-and-play-store-release output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
