<!--
purpose: Cross-store release step skeleton with per-store checklists
consumes: see AGENTS.md Prerequisites
produces: App Store and Play Store Release playbook-step
depends-on: content/02-output-contract.xml schema
token-budget-impact: ~400 tokens when filled
-->

# App Store and Play Store Release — release-playbook-step.md
