#!/usr/bin/env python3
"""validate-defect-attribution-by-phase.py

Validate a defect-attribution-by-phase output artefact against the JSON Schema in
content/02-output-contract.xml (mirrored in templates/defect-attribution-by-phase.json).
