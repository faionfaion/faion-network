#!/usr/bin/env python3
"""validate-dependency-adoption-checklist.py

Validate a dependency-adoption-checklist output artefact against the JSON Schema in
content/02-output-contract.xml (mirrored in templates/dependency-adoption-checklist.json).
