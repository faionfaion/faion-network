#!/usr/bin/env python3
"""validate-tech-debt-cost-of-delay-scoring.py

Validate the artefact produced by the `tech-debt-cost-of-delay-scoring` methodology against the
...
REQUIRED = ["artefact_id", "owner", "axes", "scoring", "rationale", "inputs_used", "version", "last_reviewed"]
