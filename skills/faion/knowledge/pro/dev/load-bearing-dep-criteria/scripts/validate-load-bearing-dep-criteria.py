#!/usr/bin/env python3
"""validate-load-bearing-dep-criteria.py — validate load-bearing-dep-criteria output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-load-bearing-dep-criteria.py",
        description="Validate load-bearing-dep-criteria output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
