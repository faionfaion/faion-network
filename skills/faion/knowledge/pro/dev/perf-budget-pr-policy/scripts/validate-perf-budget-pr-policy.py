#!/usr/bin/env python3
"""validate-perf-budget-pr-policy.py — validate perf-budget-pr-policy output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-perf-budget-pr-policy.py",
        description="Validate perf-budget-pr-policy output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
