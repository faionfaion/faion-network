<!--
purpose: 6-month curriculum skeleton with month-by-month milestones
consumes: see AGENTS.md Prerequisites
produces: Architect Mentoring Curriculum spec
depends-on: content/02-output-contract.xml schema
token-budget-impact: ~400 tokens when filled
-->

# Architect Mentoring Curriculum — curriculum-spec.md
