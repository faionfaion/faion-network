#!/usr/bin/env python3
"""validate-architect-mentoring-curriculum.py — validate architect-mentoring-curriculum output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-architect-mentoring-curriculum.py",
        description="Validate architect-mentoring-curriculum output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
