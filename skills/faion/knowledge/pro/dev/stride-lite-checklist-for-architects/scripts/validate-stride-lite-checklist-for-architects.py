#!/usr/bin/env python3
"""validate-stride-lite-checklist-for-architects.py

Validate the artefact produced by the `stride-lite-checklist-for-architects` methodology against the
...
REQUIRED = ["artefact_id", "owner", "items", "verdict", "rationale", "inputs_used", "version", "last_reviewed"]
...
OK = json.loads(r"""{
  "artefact_id": "stride-lite-checklist-for-architects-2026Q2-001",
