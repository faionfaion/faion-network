#!/usr/bin/env python3
"""validate-feature-flag-weekly-review-template.py

Validate a feature-flag-weekly-review-template output artefact against the JSON Schema in
content/02-output-contract.xml (mirrored in templates/feature-flag-weekly-review-template.json).
...
def validate(obj: dict) -> list[str]:
    ...
    if "produces" in obj and obj["produces"] != "report":
        errs.append("produces must equal 'report' for this methodology")
    return errs
