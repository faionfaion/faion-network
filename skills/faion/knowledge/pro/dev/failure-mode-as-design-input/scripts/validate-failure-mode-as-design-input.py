#!/usr/bin/env python3
"""validate-failure-mode-as-design-input.py

Validate a failure-mode-as-design-input output artefact against the JSON Schema in
content/02-output-contract.xml (mirrored in templates/failure-mode-as-design-input.json).
