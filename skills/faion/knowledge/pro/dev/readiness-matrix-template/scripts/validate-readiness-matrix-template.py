#!/usr/bin/env python3
"""validate-readiness-matrix-template.py

Validate the output artefact for the `readiness-matrix-template` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/readiness-matrix-template.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'readiness-matrix-template',
    'title': 'Readiness Matrix Template',
...
BAD = {"slug": "BAD_readiness-matrix-template", "owner": "someone"}
