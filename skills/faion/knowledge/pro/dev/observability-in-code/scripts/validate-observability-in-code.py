#!/usr/bin/env python3
"""validate-observability-in-code.py — validate observability-in-code output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-observability-in-code.py",
        description="Validate observability-in-code output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
