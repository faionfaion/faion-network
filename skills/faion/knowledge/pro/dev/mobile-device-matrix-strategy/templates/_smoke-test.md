<!--
purpose: Filled-in canonical example for mobile-device-matrix-strategy
consumes: see AGENTS.md Prerequisites
produces: Mobile Device Matrix Strategy spec
depends-on: content/02-output-contract.xml schema
token-budget-impact: ~400 tokens when filled
-->

# Mobile Device Matrix Strategy — _smoke-test.md
