#!/usr/bin/env python3
"""validate-hipaa-phi-data-flow-design.py — validate hipaa-phi-data-flow-design output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        ...
        description="Validate hipaa-phi-data-flow-design output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
