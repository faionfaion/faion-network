#!/usr/bin/env python3
"""validate-test-suite-audit-rubric.py

Validate the artefact produced by the `test-suite-audit-rubric` methodology against the
...
OK = json.loads(r"""{
  "artefact_id": "test-suite-audit-rubric-2026Q2-001",
