#!/usr/bin/env python3
"""validate-mobile-expo-eas-pipeline.py — validate mobile-expo-eas-pipeline output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-mobile-expo-eas-pipeline.py",
        description="Validate mobile-expo-eas-pipeline output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
