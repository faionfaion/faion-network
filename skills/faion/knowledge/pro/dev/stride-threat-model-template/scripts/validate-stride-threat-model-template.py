#!/usr/bin/env python3
"""validate-stride-threat-model-template.py

Validate the artefact produced by the `stride-threat-model-template` methodology against the
...
OK = json.loads(r"""{
  "artefact_id": "stride-threat-model-template-2026Q2-001",
  "owner": "ruslan@faion.net",
  "title": "Example spec for stride-threat-model-template",
  "sections": [
    {
      "name": "Constraints",
