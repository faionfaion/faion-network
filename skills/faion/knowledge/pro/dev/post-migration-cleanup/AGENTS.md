...
summary: Post-migration cleanup checklist: dual-write retirement, compat shims, doc refresh, dead-flag removal.
content_id: "8be860eac917eaa9"
complexity: medium
produces: checklist
est_tokens: 4100
tags: [migration, cleanup, deprecation, checklist, post-release]
---
...
| File | Purpose |
|------|---------|
| `templates/output.md` | Checklist skeleton matching the schema in 02-output-contract.xml |
