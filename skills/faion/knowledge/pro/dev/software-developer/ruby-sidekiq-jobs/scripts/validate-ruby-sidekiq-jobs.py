#!/usr/bin/env python3
"""validate-ruby-sidekiq-jobs.py

Validate the artefact produced by the `ruby-sidekiq-jobs` methodology against the
...
REQUIRED = ["artefact_id", "owner", "language", "module", "evidence_quote", "rationale", "inputs_used", "version", "last_reviewed"]
