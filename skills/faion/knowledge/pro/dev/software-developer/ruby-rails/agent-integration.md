...
- `/faion` (sdd-batch-orchestrator workflow) skill — sequential mode keeps migration → model → service → controller → spec ordering correct; out-of-order writes leave failing autoload.
