#!/usr/bin/env python3
"""validate-strangler-fig-migration-pattern.py

Validate the artefact produced by the `strangler-fig-migration-pattern` methodology against the
...
OK = json.loads(r"""{
  "artefact_id": "strangler-fig-migration-pattern-2026Q2-001",
  "owner": "ruslan@faion.net",
  "step_id": "strangler-fig-migration-pattern-step-1",
  "preconditions": [
    "input-A available"
  ],
  "actions": [
