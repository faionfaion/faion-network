...
- `/faion` (sdd-batch-orchestrator workflow) skill — sequential mode is correct: write controller test → service test → repository test → integration test, each gating on green.
