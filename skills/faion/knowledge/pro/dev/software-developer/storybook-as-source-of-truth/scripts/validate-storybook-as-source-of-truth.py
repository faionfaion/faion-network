#!/usr/bin/env python3
"""validate-storybook-as-source-of-truth.py

Validate the artefact produced by the `storybook-as-source-of-truth` methodology against the
...
REQUIRED = ["artefact_id", "owner", "config", "rationale", "inputs_used", "version", "last_reviewed"]
...
OK = json.loads(r"""{
  "artefact_id": "storybook-as-source-of-truth-2026Q2-001",
