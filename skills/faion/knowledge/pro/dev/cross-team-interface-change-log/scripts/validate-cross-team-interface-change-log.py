#!/usr/bin/env python3
"""validate-cross-team-interface-change-log.py

Validate a cross-team-interface-change-log output artefact against the JSON Schema in
content/02-output-contract.xml (mirrored in templates/cross-team-interface-change-log.json).
