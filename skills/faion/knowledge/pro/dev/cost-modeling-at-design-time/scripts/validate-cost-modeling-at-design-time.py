#!/usr/bin/env python3
"""validate-cost-modeling-at-design-time.py

Validate a cost-modeling-at-design-time output artefact against the JSON Schema in
content/02-output-contract.xml (mirrored in templates/cost-modeling-at-design-time.json).
