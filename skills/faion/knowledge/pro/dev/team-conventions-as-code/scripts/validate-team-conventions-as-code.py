#!/usr/bin/env python3
"""validate-team-conventions-as-code.py

Validate the artefact produced by the `team-conventions-as-code` methodology against the
...
OK = json.loads(r"""{
  "artefact_id": "team-conventions-as-code-2026Q2-001",
