#!/usr/bin/env python3
"""validate-crash-pipeline-as-code.py

Validate a crash-pipeline-as-code output artefact against the JSON Schema in
content/02-output-contract.xml (mirrored in templates/crash-pipeline-as-code.json).
