#!/usr/bin/env python3
"""validate-qa-security-triage-runbook.py

Validate the output artefact for the `qa-security-triage-runbook` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/qa-security-triage-runbook.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'qa-security-triage-runbook',
    'title': 'QA Security Triage Runbook',
...
BAD = {"slug": "BAD_qa-security-triage-runbook", "owner": "someone"}
