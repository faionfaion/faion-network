#!/usr/bin/env python3
"""validate-compliance-regime-review-matrix-soc2-hipaa-pci.py

Validate a compliance-regime-review-matrix-soc2-hipaa-pci output artefact against the JSON Schema in
content/02-output-contract.xml (mirrored in templates/compliance-regime-review-matrix-soc2-hipaa-pci.json).
