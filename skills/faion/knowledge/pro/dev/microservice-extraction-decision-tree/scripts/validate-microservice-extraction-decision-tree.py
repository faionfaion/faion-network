#!/usr/bin/env python3
"""validate-microservice-extraction-decision-tree.py — validate microservice-extraction-decision-tree output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-microservice-extraction-decision-tree.py",
        description="Validate microservice-extraction-decision-tree output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
