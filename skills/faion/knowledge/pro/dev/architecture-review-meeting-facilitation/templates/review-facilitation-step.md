<!--
purpose: Playbook step skeleton with pre-meeting / in-meeting / post-meeting phases
consumes: see AGENTS.md Prerequisites
produces: Architecture Review Meeting Facilitation playbook-step
depends-on: content/02-output-contract.xml schema
token-budget-impact: ~400 tokens when filled
-->

# Architecture Review Meeting Facilitation — review-facilitation-step.md
