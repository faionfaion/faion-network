#!/usr/bin/env python3
"""validate-pci-dss-scope-minimisation.py — validate pci-dss-scope-minimisation output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-pci-dss-scope-minimisation.py",
        description="Validate pci-dss-scope-minimisation output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
