#!/usr/bin/env python3
"""validate-pr-pattern-mining-for-feedback.py — validate pr-pattern-mining-for-feedback output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        ...
        description="Validate pr-pattern-mining-for-feedback output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
