#!/usr/bin/env python3
"""validate-csharp-background-services.py — validate csharp-background-services output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        ...
        description="Validate csharp-background-services output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
