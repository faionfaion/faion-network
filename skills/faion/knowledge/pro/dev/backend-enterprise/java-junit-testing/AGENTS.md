...
summary: Layered Spring Boot testing with JUnit 5 + Mockito + AssertJ — @WebMvcTest controllers, plain Mockito services, @DataJpaTest repositories with Testcontainers, Jacoco coverage gate in CI.
