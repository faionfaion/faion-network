#!/usr/bin/env python3
"""validate-audit-grade-api-design.py — validate audit-grade-api-design output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-audit-grade-api-design.py",
        description="Validate audit-grade-api-design output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
