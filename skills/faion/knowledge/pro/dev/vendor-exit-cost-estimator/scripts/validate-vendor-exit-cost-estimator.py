#!/usr/bin/env python3
"""validate-vendor-exit-cost-estimator.py

Validate the artefact produced by the `vendor-exit-cost-estimator` methodology against the
...
OK = json.loads(r"""{
  "artefact_id": "vendor-exit-cost-estimator-2026Q2-001",
