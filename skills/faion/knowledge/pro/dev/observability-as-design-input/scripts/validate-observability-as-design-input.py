#!/usr/bin/env python3
"""validate-observability-as-design-input.py — validate observability-as-design-input output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-observability-as-design-input.py",
        description="Validate observability-as-design-input output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
