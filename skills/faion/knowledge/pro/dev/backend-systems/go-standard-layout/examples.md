...
## Example 4: Multi-binary project
...
|----------|----------|------------|-------------|-------------|
| API server | [approach] | Low | High | [scenario] |
| CLI tool | [approach] | Medium | Medium | [scenario] |
| Library | [approach] | High | High | [scenario] |
| Multi-binary project | [approach] | Medium | High | [scenario] |
...
| Alternative | Make | [Reason for choice] |
| Auxiliary | Docker | [Reason for choice] |
