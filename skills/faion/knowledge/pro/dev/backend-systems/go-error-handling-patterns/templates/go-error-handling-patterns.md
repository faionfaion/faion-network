<!--
purpose: Markdown skeleton for a Go Error Handling Patterns (Wrap, Translate, Sentinel, Log-Once) artefact.
consumes: Inputs from the Prerequisites table in AGENTS.md.
produces: a Markdown artefact consumable by humans + indexable by tools.
depends-on: content/02-output-contract.xml schema.
token-budget-impact: ~180 tokens.
-->

# Go Error Handling Patterns (Wrap, Translate, Sentinel, Log-Once) — &lt;artefact_id&gt;

- **artefact_id**: goep-&lt;kebab-case-slug&gt;
