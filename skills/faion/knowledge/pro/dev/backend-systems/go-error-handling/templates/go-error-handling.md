<!--
purpose: Markdown skeleton for a Go Error Handling (AppError + Centralised Mapper) artefact.
...
# Go Error Handling (AppError + Centralised Mapper) — &lt;artefact_id&gt;

- **artefact_id**: goeh-&lt;kebab-case-slug&gt;
