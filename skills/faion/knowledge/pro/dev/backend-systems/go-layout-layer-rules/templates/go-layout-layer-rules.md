<!--
purpose: Markdown skeleton for a Go Standard Layout — Layer Dependency Rules artefact.
...
# Go Standard Layout — Layer Dependency Rules — &lt;artefact_id&gt;

- **artefact_id**: goll-&lt;kebab-case-slug&gt;
