# NoSQL Patterns Checklist

Step-by-step checklist for implementing nosql patterns in backend systems.
...
- [ ] Evaluate tool options: MongoDB, DynamoDB, Cassandra, Redis
...
| DynamoDB | Tool | Usage |
| Cassandra | Tool | Usage |
| Redis | Cache/queue | Fast data access |
