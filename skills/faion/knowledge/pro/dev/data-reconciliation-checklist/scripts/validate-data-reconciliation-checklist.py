#!/usr/bin/env python3
"""validate-data-reconciliation-checklist.py

Validate a data-reconciliation-checklist output artefact against the JSON Schema in
content/02-output-contract.xml (mirrored in templates/data-reconciliation-checklist.json).
