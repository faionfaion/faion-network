<!-- purpose: Markdown skeleton: themes section + per-theme quote anchors + backlog table. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a report artefact validating against scripts/validate-thematic-analysis.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# Thematic Analysis — Artefact Skeleton
...
Run `python scripts/validate-thematic-analysis.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
