#!/usr/bin/env python3
"""validate-product-development-trends-2026.py

Validate a Product Development Trends 2026 artefact against the JSON Schema (draft-07) defined in
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'product-development-trends-2026-2026-05-23', 'vintage_year': 1, 'trends': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'hype_curve': {'key': 'value'}, 'expired_items': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
