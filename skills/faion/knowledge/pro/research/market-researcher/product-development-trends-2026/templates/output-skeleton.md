<!-- purpose: minimal Product Development Trends 2026 artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: report artefact validated by scripts/validate-product-development-trends-2026.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Product Development Trends 2026 — Artefact

| Field | Value |
|-------|-------|
| artefact_id | product-development-trends-2026-YYYY-MM-DD |
