<!-- purpose: minimal Business Model Planning artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-business-model-planning.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Business Model Planning — Artefact

| Field | Value |
|-------|-------|
| artefact_id | business-model-planning-YYYY-MM-DD |
