#!/usr/bin/env python3
"""validate-risk-assessment.py

Validate a Risk Assessment artefact against the JSON Schema (draft-07) defined in
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'risk-assessment-2026-05-23', 'risks': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'matrix': {'key': 'value'}, 'top_quartile': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'review_cycle': 'draft', 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
