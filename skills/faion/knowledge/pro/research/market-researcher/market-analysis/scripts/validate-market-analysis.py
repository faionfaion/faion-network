#!/usr/bin/env python3
"""validate-market-analysis.py

Validate a Market Analysis artefact against the JSON Schema (draft-07) defined in
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'market-analysis-2026-05-23', 'market_definition': 'draft', 'segments': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'growth_drivers': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'forces': {'key': 'value'}, 'regulation_notes': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
