<!-- purpose: minimal Competitive Intelligence Methods artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: playbook-step artefact validated by scripts/validate-competitive-intelligence-methods.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Competitive Intelligence Methods — Artefact

| Field | Value |
|-------|-------|
| artefact_id | competitive-intelligence-methods-YYYY-MM-DD |
