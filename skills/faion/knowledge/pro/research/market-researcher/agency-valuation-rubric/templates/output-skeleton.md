<!-- purpose: minimal Agency Valuation Rubric artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: rubric artefact validated by scripts/validate-agency-valuation-rubric.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Agency Valuation Rubric — Artefact

| Field | Value |
|-------|-------|
| artefact_id | agency-valuation-rubric-YYYY-MM-DD |
