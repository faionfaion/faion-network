#!/usr/bin/env python3
"""validate-agency-valuation-rubric.py

Validate a Agency Valuation Rubric artefact against the JSON Schema (draft-07) defined in
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'agency-valuation-rubric-2026-05-23', 'target_name': 'draft', 'ebitda_usd': 1.0, 'scores': {'key': 'value'}, 'weighted_total': 1.0, 'multiplier': 1.0, 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}], 'decision': 'draft'}
