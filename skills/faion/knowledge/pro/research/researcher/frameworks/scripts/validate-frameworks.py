#!/usr/bin/env python3
"""validate-frameworks.py

Validate an artefact produced by the frameworks methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/framework-router.json", "type": "object", "required": ["goal", "stage", "picked_slug", "rationale", "rejected"], "properties": {"goal": {"type": "string", "minLength": 10}, "stage": {"enum": ["ideation", "pre-pmf", "post-pmf", "scale"]}, "picked_slug": {"type": "string"}, "rationale": {"type": "string", "minLength": 20}, "rejected": {"type": "array", "minItems": 2}}}')
