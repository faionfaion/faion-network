...
Validate an artefact produced by the product-development-trends-2026 methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/product-development-trends-2026.json", "type": "object", "required": ["year", "buckets", "2025_retro", "bets", "monitor", "ignored"], "properties": {"year": {"const": 2026}, "buckets": {"type": "array", "minItems": 6, "maxItems": 6}, "2025_retro": {"type": "array"}, "bets": {"type": "array"}, "monitor": {"type": "array"}, "ignored": {"type": "array"}}}')
