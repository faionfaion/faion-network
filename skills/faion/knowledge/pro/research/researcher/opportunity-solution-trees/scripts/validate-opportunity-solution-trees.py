...
Validate an artefact produced by the opportunity-solution-trees methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/opportunity-solution-trees.json", "type": "object", "required": ["outcome", "opportunities", "kill_list"], "properties": {"outcome": {"type": "object", "required": ["name", "value", "target"]}, "opportunities": {"type": "array", "minItems": 1, "items": {"type": "object", "required": ["id", "label", "score", "solutions"]}}, "kill_list": {"type": "array"}}}')
