...
Validate an artefact produced by the workflows methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/research-workflows.json", "type": "object", "required": ["mode", "stage", "consumer", "steps"], "properties": {"mode": {"enum": ["market", "competitors", "pricing", "personas", "validation", "names", "pains", "niche"]}, "stage": {"enum": ["ideation", "pre-pmf", "post-pmf", "scale"]}, "consumer": {"type": "string"}, "steps": {"type": "array", "minItems": 1, "maxItems": 6, "items": {"type": "object", "required": ["n", "methodology", "artefact", "acceptance"]}}}}')
