<!-- purpose: minimal Agency Revenue Mix Audit Template artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-agency-revenue-mix-audit-template.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Agency Revenue Mix Audit Template — Artefact

| Field | Value |
|-------|-------|
| artefact_id | agency-revenue-mix-audit-template-YYYY-MM-DD |
