#!/usr/bin/env python3
"""validate-competitor-analysis.py

Validate an artefact produced by the competitor-analysis methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/competitor-analysis.json", "type": "object", "required": ["category", "geography", "competitors", "positioning_matrix", "gaps", "positioning_statement"], "properties": {"category": {"type": "string", "minLength": 5}, "geography": {"type": "string"}, "competitors": {"type": "array", "minItems": 5}, "positioning_matrix": {"type": "object"}, "gaps": {"type": "array", "minItems": 1}, "positioning_statement": {"type": "string", "minLength": 40}}}')
