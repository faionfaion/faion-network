...
Validate an artefact produced by the distribution-channel-research methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/distribution-channel-research.json", "type": "object", "required": ["considered", "shortlist", "tests", "verdict", "tripwires"], "properties": {"considered": {"type": "array", "minItems": 19}, "shortlist": {"type": "array", "minItems": 3, "maxItems": 3}, "tests": {"type": "array", "minItems": 3, "maxItems": 3}, "verdict": {"type": "object", "required": ["primary", "secondary"]}, "tripwires": {"type": "array", "minItems": 1}}}')
