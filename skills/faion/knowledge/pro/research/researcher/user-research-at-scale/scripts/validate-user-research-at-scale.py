...
Validate an artefact produced by the user-research-at-scale methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/user-research-at-scale.json", "type": "object", "required": ["week", "throughput", "findings", "codebook_delta", "hitl_escalations"], "properties": {"week": {"type": "string"}, "throughput": {"type": "object", "required": ["intake", "coded_transcripts", "proposed_codes_pending"]}, "findings": {"type": "array", "items": {"type": "object", "required": ["text", "evidence_count", "session_count", "segment_count", "hitl_passed"]}}, "codebook_delta": {"type": "object"}, "hitl_escalations": {"type": "array"}}}')
