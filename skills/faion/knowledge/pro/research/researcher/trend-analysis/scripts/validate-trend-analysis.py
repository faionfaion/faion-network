...
Validate an artefact produced by the trend-analysis methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/trend-analysis.json", "type": "object", "required": ["trends"], "properties": {"trends": {"type": "array", "minItems": 1, "items": {"type": "object", "required": ["name", "signals", "composite_score", "decay_curve", "verdict"], "properties": {"composite_score": {"type": "number", "minimum": 0, "maximum": 100}, "verdict": {"enum": ["hype", "structural"]}}}}}}')
