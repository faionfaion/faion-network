...
Drafting:
```
You are designing a survey per skills/faion/knowledge/pro/research/researcher/survey-design/README.md.
...
- Internal: `skills/faion/knowledge/pro/research/researcher/agent-invocation/README.md` (mode dispatch).
- Internal: `skills/faion/knowledge/pro/ux/user-researcher/survey-design/README.md` (UX-side counterpart).
