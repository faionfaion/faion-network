...
Validate an artefact produced by the survey-design methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/survey-design.json", "type": "object", "required": ["hypothesis", "questions", "sample_plan", "bias_lint_passed", "pilot_complete"], "properties": {"hypothesis": {"type": "string"}, "questions": {"type": "array", "minItems": 1, "maxItems": 12, "items": {"type": "object", "required": ["id", "text", "type", "required"]}}, "sample_plan": {"type": "object", "required": ["segments", "target_n_per_segment"]}, "bias_lint_passed": {"type": "boolean"}, "pilot_complete": {"type": "boolean"}}}')
