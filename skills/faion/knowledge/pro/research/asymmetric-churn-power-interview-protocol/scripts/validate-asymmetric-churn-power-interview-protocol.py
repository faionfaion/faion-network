#!/usr/bin/env python3
"""validate-asymmetric-churn-power-interview-protocol.py

Validate an output artefact for the `asymmetric-churn-power-interview-protocol` methodology against the JSON Schema
...
SCHEMA = json.loads(r"""{
    ...
    "$id": "https://faion.net/schemas/churn-protocol.json",
    "type": "object",
    "required": [
        "cohort",
        "interviews",
...
VALID_FIXTURE = json.loads(r"""{
  "cohort": {
    "segment": "self-serve pro",
    "window": "2026-Q1",
    "min_usage_threshold": "\u22654 sessions"
  },
  "interviews": [
    {
      "id": "i1",
      "type": "churn",
      "transcript_path": "t1.md",
      "pitch_contamination": false
    },
    {
      "id": "i2",
      "type": "churn",
      "transcript_path": "t2.md",
      "pitch_contamination": false
    },
    {
      "id": "i3",
      "type": "churn",
      "transcript_path": "t3.md",
      "pitch_contamination": false
    },
    {
      "id": "i4",
      "type": "power-user",
      "transcript_path": "t4.md",
      "pitch_contamination": false
    }
  ],
  "themes": [
    {
      "theme": "onboarding pain",
      "evidence_count": 3
    }
  ],
  "coding": {
