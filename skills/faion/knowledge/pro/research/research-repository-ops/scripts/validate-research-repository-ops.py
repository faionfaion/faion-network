#!/usr/bin/env python3
"""validate-research-repository-ops.py

Validate an artefact produced by the research-repository-ops methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/research-repository-ops.json", "type": "object", "required": ["week", "throughput", "retention_pass", "access_changes"], "properties": {"week": {"type": "string"}, "throughput": {"type": "object", "required": ["ingested", "tagged", "deduped"]}, "retention_pass": {"type": "object", "required": ["archived", "deleted", "kept"]}, "access_changes": {"type": "array"}}}')
