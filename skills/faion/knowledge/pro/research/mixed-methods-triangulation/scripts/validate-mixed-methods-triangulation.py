#!/usr/bin/env python3
"""validate-mixed-methods-triangulation.py

Validate a Mixed-Methods Triangulation artefact against the JSON Schema (draft-07) defined in
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'mixed-methods-triangulation-2026-05-23', 'claims': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'methods_used': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'convergence_map': {'key': 'value'}, 'divergences': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}], 'confidence': 'draft'}
