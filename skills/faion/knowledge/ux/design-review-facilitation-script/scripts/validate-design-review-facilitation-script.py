#!/usr/bin/env python3
"""validate-design-review-facilitation-script.py — stdlib-only validator for the design-review-facilitation-script output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'session_id', 'review_ask', 'reviewers', 'feedback_rounds', 'must_fix_per_reviewer', 'committed_actions']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['reviewers', 'must_fix_per_reviewer', 'committed_actions', 'declined_actions']
OBJECT_FIELDS = ['feedback_rounds']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'session_id', 'review_ask']
...
VALID_FIXTURE = json.loads('{"artefact_id": "design-review-facilitation-script-example", "owner": "@solo-founder", "version": "1.0.0", "last_reviewed": "2026-05-23", "session_id": "session_id value", "review_ask": "review_ask value", "reviewers": ["item-1", "item-2", "item-3"], "feedback_rounds": {"key": "value"}, "must_fix_per_reviewer": ["item-1", "item-2", "item-3"], "committed_actions": ["item-1", "item-2", "item-3"], "declined_actions": ["item-1", "item-2", "item-3"]}')
