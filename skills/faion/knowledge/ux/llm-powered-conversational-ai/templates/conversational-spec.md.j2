<!-- purpose: Spec skeleton for conversational UI -->
...
_Skeleton for the `llm-powered-conversational-ai` methodology output. Fill each section; do not leave headings empty._
...
- Timestamp
- Validator run: `python scripts/validate-llm-powered-conversational-ai.py --file out.json`
