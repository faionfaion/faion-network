...
| `templates/a11y-ci.js` | Playwright spec running axe-core (WCAG 2.2 AA tags) per URL; emits a quick-check report JSON with POUR + SC tags and the 30% caveat, fails the PR on critical/serious. |
