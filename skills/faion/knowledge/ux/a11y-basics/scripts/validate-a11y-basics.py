#!/usr/bin/env python3
"""validate-a11y-basics.py — validate a a11y-basics output JSON against the methodology schema.
...
VALID_FIXTURE = json.loads('{"artefact_id": "a11y-bas-2026-0001", "version": "1.1.0", "last_reviewed": "2026-05-23", "owner": "@ruslan", "scope": {"page_url": "https://example.com/signup", "wcag_version": "2.2", "level": "AA"}, "findings": [{"sc": "1.4.3", "principle": "Perceivable", "severity": "high", "description": "Hero subtitle contrast 3.1:1 against off-white background."}, {"sc": "1.3.1", "principle": "Perceivable", "severity": "medium", "description": "Submit button uses placeholder text as the only label."}], "summary": "axe surfaced 2 violations; manual tab pass found focus-trap on cookie banner.", "verdict": "partial"}')
INVALID_FIXTURE = json.loads('{"owner": "team", "findings": "ok"}')
