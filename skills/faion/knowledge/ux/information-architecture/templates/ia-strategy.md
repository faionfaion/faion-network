...
- Priority content: [What must be findable above all else]
- Governance: [Who owns each content area]
- Constraints: [Technical, legal, political]
...
| Label Type | Rules | Examples |
|------------|-------|---------|
| L1 categories | User verbs or goals, not internal names | Shop, Learn, Get Help |
| L2 subcategories | Specific scope, no "misc" | Buying Guides, Style Tips |
| Actions | Platform-standard verbs | View all, Filter, Sort |
