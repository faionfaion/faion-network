<!-- purpose: Problem-validation evidence log and PROCEED/PIVOT/KILL decision (Problem Validation lens) -->
<!-- consumes: interview, forum, review and search-volume evidence for one opportunity -->
<!-- produces: filled problem validation report markdown -->
<!-- depends-on: content/01-core-rules.xml -->
<!-- token-budget-impact: ~210 tokens filled -->
...
| Competition | Exists | 3 competitors | Market |
