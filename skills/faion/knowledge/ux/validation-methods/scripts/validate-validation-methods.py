#!/usr/bin/env python3
"""validate-validation-methods.py

Validate a Validation Methods artefact against the JSON Schema (draft-07) defined in
...
OK = {
    "artefact_id": "validation-methods-2026-05-23",
