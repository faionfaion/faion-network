#!/usr/bin/env python3
"""validate-heuristic-evaluation.py

Validate a Heuristic Evaluation — Nielsen's 10 Usability Heuristics artefact against the JSON Schema (draft-07) defined in
...
OK = {
    "artefact_id": "heuristic-evaluation-2026-05-23",
