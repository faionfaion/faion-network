...
| `templates/ia-framework.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/ia-framework.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/ia-framework.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/ia-framework.json`

```json
{
  "artefact_id": "ia-framework-example",
