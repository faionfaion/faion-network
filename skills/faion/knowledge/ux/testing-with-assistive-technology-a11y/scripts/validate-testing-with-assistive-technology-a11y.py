#!/usr/bin/env python3
"""validate-testing-with-assistive-technology.py — validate a testing-with-assistive-technology output JSON against the methodology schema.
...
VALID_FIXTURE = json.loads('{"artefact_id": "at-2026-0001", "version": "1.1.0", "last_reviewed": "2026-05-23", "owner": "@qa-lead", "scope": {"flows": ["/checkout"], "ats": ["NVDA-2024.2", "VoiceOver-iOS-17.4", "VoiceControl-macOS-14.4"]}, "findings": [{"at": "NVDA-2024.2", "sc": "4.1.2", "severity": "major", "recording_url": "https://artifacts/nvda-checkout.log"}, {"at": "VoiceOver-iOS-17.4", "sc": "1.3.1", "severity": "blocker", "recording_url": "https://artifacts/vo-checkout.mp4"}], "verdict": "fail"}')
INVALID_FIXTURE = json.loads('{"findings": [{"at": "NVDA", "sc": "4.1.2"}]}')
