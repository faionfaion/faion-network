...
| File | Purpose |
|------|---------|
| `templates/design-decision-log-template.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/design-decision-log-template.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/design-decision-log-template.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
