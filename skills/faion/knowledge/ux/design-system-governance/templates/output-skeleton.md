<!-- purpose: minimal Design System Governance artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-design-system-governance.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Design System Governance — Artefact

| Field | Value |
|-------|-------|
| artefact_id | design-system-governance-YYYY-MM-DD |
