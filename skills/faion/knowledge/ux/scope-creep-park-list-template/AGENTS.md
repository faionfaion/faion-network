...
| File | Purpose |
|------|---------|
| `templates/scope-creep-park-list-template.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/scope-creep-park-list-template.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/scope-creep-park-list-template.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
