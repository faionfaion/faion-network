...
| `templates/design-tokens-fundamentals.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/design-tokens-fundamentals.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/design-tokens-fundamentals.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/design-tokens-fundamentals.json`

```json
{
  "artefact_id": "design-tokens-fundamentals-example",
  "owner": "@solo-founder",
  "version": "1.0.0",
  "last_reviewed": "2026-05-23",
  "source_of_truth": "figma-variables",
  "tiers": {
    "key": "value"
  },
  "ci_lint_status": "pass",
