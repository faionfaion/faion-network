#!/usr/bin/env python3
"""validate-design-tokens-fundamentals.py — stdlib-only validator for the design-tokens-fundamentals output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'source_of_truth', 'tiers', 'ci_lint_status', 'consumers']
ENUMS = {'source_of_truth': ['figma-variables', 'tokens-json'], 'ci_lint_status': ['pass', 'fail', 'warn']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['breaking_renames', 'consumers']
OBJECT_FIELDS = ['tiers']
BOOL_FIELDS = []
...
VALID_FIXTURE = json.loads('{"artefact_id": "design-tokens-fundamentals-example", "owner": "@solo-founder", "version": "1.0.0", "last_reviewed": "2026-05-23", "source_of_truth": "figma-variables", "tiers": {"key": "value"}, "ci_lint_status": "pass", "breaking_renames": ["item-1", "item-2", "item-3"], "consumers": ["item-1", "item-2", "item-3"]}')
