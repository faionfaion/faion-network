#!/usr/bin/env python3
"""validate-recognition-over-recall.py — validate a recognition-over-recall output JSON against the methodology schema.
...
VALID_FIXTURE = json.loads('{"artefact_id": "recognition-over-recall-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "owner": "@solo-founder", "subject": "subject under review", "criteria": [{"id": "c1", "score": 4, "weight": 1.0}, {"id": "c2", "score": 3, "weight": 1.0}], "overall": 0.75}')
