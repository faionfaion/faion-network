...
| `templates/recognition-over-recall.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/recognition-over-recall.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/recognition-over-recall.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/recognition-over-recall.json`

```json
{
  "artefact_id": "recognition-over-recall-example",
  "version": "1.0.0",
