...
| File | Purpose |
|------|---------|
| `templates/sr-test-script.md.j2` | Markdown skeleton for SR test script. |
| `templates/sr-test-script.md` | Markdown skeleton for SR test script. Generated from `templates/sr-test-script.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
