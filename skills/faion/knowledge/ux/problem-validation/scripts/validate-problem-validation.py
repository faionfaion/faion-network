#!/usr/bin/env python3
"""validate-problem-validation.py

Validate a Problem Validation artefact against the JSON Schema (draft-07) defined in
...
OK = {
    "artefact_id": "problem-validation-2026-05-23",
