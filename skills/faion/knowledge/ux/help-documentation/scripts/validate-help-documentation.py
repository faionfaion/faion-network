#!/usr/bin/env python3
"""validate-help-documentation.py — validate a help-documentation output JSON against the methodology schema.
...
VALID_FIXTURE = json.loads('{"artefact_id": "help-documentation-example", "scope": "Scope of the spec \\u2014 one paragraph.", "decisions": ["item-1", "item-2", "item-3"], "stakeholders": ["item-1", "item-2"], "open_questions": ["item-1"], "version": "1.0.0", "last_reviewed": "2026-05-23", "lint_status": "pass", "owner": "@solo-founder"}')
