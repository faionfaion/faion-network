...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'iteration_id', 'hypothesis', 'variant_link', 'evidence_link', 'outcome', 'log_row_id', 'time_box_hours']
ENUMS = {'outcome': ['kept', 'rolled-back', 'shipped-with-changes']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['time_box_hours']
NUM_FIELDS = []
ARRAY_FIELDS = []
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'iteration_id', 'hypothesis', 'variant_link', 'evidence_link', 'log_row_id']
...
VALID_FIXTURE = json.loads('{"artefact_id": "prototyping-example", "owner": "@solo-founder", "version": "1.0.0", "last_reviewed": "2026-05-23", "iteration_id": "iteration_id value", "hypothesis": "hypothesis value", "variant_link": "variant_link value", "evidence_link": "evidence_link value", "outcome": "kept", "log_row_id": "log_row_id value", "time_box_hours": 1}')
