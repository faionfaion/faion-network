#!/usr/bin/env python3
"""validate-content-audit-process.py

Validate a Content Audit Process artefact against the JSON Schema (draft-07) defined in
...
OK = {
    "artefact_id": "content-audit-process-2026-05-23",
