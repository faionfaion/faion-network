<!-- purpose: minimal Multi-Platform Design Parity artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-multi-platform-design-parity.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Multi-Platform Design Parity — Artefact

| Field | Value |
|-------|-------|
| artefact_id | multi-platform-design-parity-YYYY-MM-DD |
