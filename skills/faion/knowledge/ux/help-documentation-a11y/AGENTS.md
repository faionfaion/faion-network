...
| `templates/help-audit.md.j2` | Help-coverage audit worksheet with deflection-focused gaps and zero-result search queries |
| `templates/help-audit.md` | Help-coverage audit worksheet with deflection-focused gaps and zero-result search queries Generated from `templates/help-audit.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
| `templates/help-content.md.j2` | Task-oriented help article template with a mandatory Result section closing the confirmation loop |
| `templates/help-content.md` | Task-oriented help article template with a mandatory Result section closing the confirmation loop Generated from `templates/help-content.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
