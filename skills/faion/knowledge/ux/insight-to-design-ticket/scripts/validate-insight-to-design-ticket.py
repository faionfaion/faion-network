#!/usr/bin/env python3
"""validate-insight-to-design-ticket.py — stdlib-only validator for the insight-to-design-ticket output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'ticket_id', 'insight', 'evidence_link', 'hypothesis', 'success_metric', 'design_constraints', 'draft_acceptance_criteria']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['design_constraints', 'draft_acceptance_criteria']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'ticket_id', 'insight', 'evidence_link', 'hypothesis', 'success_metric']
...
VALID_FIXTURE = json.loads('{"artefact_id": "insight-to-design-ticket-example", "owner": "@solo-founder", "version": "1.0.0", "last_reviewed": "2026-05-23", "ticket_id": "ticket_id value", "insight": "insight value", "evidence_link": "evidence_link value", "hypothesis": "hypothesis value", "success_metric": "success_metric value", "design_constraints": ["item-1", "item-2", "item-3"], "draft_acceptance_criteria": ["item-1", "item-2", "item-3"]}')
