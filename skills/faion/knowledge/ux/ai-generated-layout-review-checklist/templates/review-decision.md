<!-- purpose: Markdown skeleton for the ten-check review-decision artefact -->
...
_Skeleton for the `ai-generated-layout-review-checklist` methodology output. Fill each section; do not leave headings empty._
...
- Timestamp
- Validator run: `python scripts/validate-ai-generated-layout-review-checklist.py --file out.json`
