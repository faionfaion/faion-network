...
| File | Purpose |
|------|---------|
| `templates/vpat-acr-template.md.j2` | Markdown VPAT 2.5 ACR skeleton |
| `templates/vpat-acr-template.md` | Markdown VPAT 2.5 ACR skeleton Generated from `templates/vpat-acr-template.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
