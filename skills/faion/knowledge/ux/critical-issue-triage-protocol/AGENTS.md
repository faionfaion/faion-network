...
| `templates/critical-issue-triage-protocol.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/critical-issue-triage-protocol.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/critical-issue-triage-protocol.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/critical-issue-triage-protocol.json`

```json
{
  "artefact_id": "critical-issue-triage-protocol-example",
  "owner": "@solo-founder",
  "version": "1.0.0",
