...
| `templates/segment-profile-card.md.j2` | Single-segment profile card — needs, pains, messaging, reach and sizing |
| `templates/segment-profile-card.md` | Single-segment profile card — needs, pains, messaging, reach and sizing Generated from `templates/segment-profile-card.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
| `templates/segmentation-analysis.md.j2` | Full audience-segmentation working analysis — dimensions, segments, attractiveness scoring, target strategy |
| `templates/segmentation-analysis.md` | Full audience-segmentation working analysis — dimensions, segments, attractiveness scoring, target strategy Generated from `templates/segmentation-analysis.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
