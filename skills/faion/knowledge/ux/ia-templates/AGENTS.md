...
| `templates/ia-templates.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/ia-templates.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/ia-templates.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/ia-templates.json`

```json
{
  "artefact_id": "ia-templates-example",
