#!/usr/bin/env python3
"""validate-edge-case-checklist.py — stdlib-only validator for the edge-case-checklist output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'component_name', 'answers', 'handoff_status']
ENUMS = {'handoff_status': ['ready', 'blocked']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['debt_accepted']
OBJECT_FIELDS = ['answers']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'component_name']
...
VALID_FIXTURE = json.loads('{"artefact_id": "edge-case-checklist-example", "owner": "@solo-founder", "version": "1.0.0", "last_reviewed": "2026-05-23", "component_name": "component_name value", "answers": {"key": "value"}, "debt_accepted": ["item-1", "item-2", "item-3"], "handoff_status": "ready"}')
