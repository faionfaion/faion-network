#!/usr/bin/env python3
"""validate-mobile-ux-basics.py

Validate a Mobile UX Basics: Touch Design, Navigation, and Performance artefact against the JSON Schema (draft-07) defined in
...
REQUIRED = ['artefact_id', 'touch_targets', 'thumb_zones', 'navigation_pattern', 'performance_budget', 'platform_conventions', 'evidence', 'owner', 'last_touched', 'template_version']
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'mobile-ux-basics-2026-05-23', 'touch_targets': {'key': 'value'}, 'thumb_zones': {'key': 'value'}, 'navigation_pattern': 'draft', 'performance_budget': {'key': 'value'}, 'platform_conventions': {'key': 'value'}, 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
