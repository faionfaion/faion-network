...
| Step | Issue | Q | Severity | Component | Status |
|------|-------|---|----------|-----------|--------|
| 1 | [Issue] | Q2 | High | [Component] | Open |
| 3 | [Issue] | Q4 | Medium | [Component] | Open |

## Priority Actions

**Critical (before launch):**
1. Step [N], Q[X]: <specific_fix>
...
2. Step [N]: <what_worked>
3. Step [N]: <what_worked>
