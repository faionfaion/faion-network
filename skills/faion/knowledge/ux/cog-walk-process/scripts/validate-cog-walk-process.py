#!/usr/bin/env python3
"""validate-cog-walk-process.py

Validate a Cognitive Walkthrough: Process artefact against the JSON Schema (draft-07) defined in
...
REQUIRED = ['artefact_id', 'prerequisites', 'evaluators', 'evaluation_forms', 'issues', 'prioritized_findings', 'evidence', 'owner', 'last_touched', 'template_version']
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'cog-walk-process-2026-05-23', 'prerequisites': {'key': 'value'}, 'evaluators': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'evaluation_forms': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'issues': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'prioritized_findings': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
