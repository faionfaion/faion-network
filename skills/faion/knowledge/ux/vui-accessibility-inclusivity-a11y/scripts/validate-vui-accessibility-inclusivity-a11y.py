#!/usr/bin/env python3
"""validate-vui-accessibility-inclusivity.py — validate a vui-accessibility-inclusivity output JSON against the methodology schema.
...
VALID_FIXTURE = json.loads('{"artefact_id": "vui-2026-0001", "version": "1.1.0", "last_reviewed": "2026-05-23", "owner": "@vui-lead", "scope": {"product": "faion-vui", "languages": ["en", "uk"], "wer_floor": "15%"}, "findings": [{"rule": "accent-dialect-coverage", "verdict": "pass"}, {"rule": "text-alternate-required", "verdict": "pass"}, {"rule": "dual-confirmation", "verdict": "pass"}, {"rule": "what-can-i-say-help", "verdict": "pass"}, {"rule": "consent-and-opt-out", "verdict": "pass"}], "verdict": "pass"}')
