#!/usr/bin/env python3
"""validate-figma-comment-triage-protocol.py — stdlib-only validator for the figma-comment-triage-protocol output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'figma_file_url', 'sweep_date', 'rows', 'queue_depth_after_sweep']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed', 'sweep_date']
INT_FIELDS = ['queue_depth_after_sweep']
NUM_FIELDS = []
ARRAY_FIELDS = ['rows', 'sla_warnings']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'figma_file_url']
...
VALID_FIXTURE = json.loads('{"artefact_id": "figma-comment-triage-protocol-example", "owner": "@solo-founder", "version": "1.0.0", "last_reviewed": "2026-05-23", "figma_file_url": "figma_file_url value", "sweep_date": "2026-05-23", "rows": ["item-1", "item-2", "item-3"], "queue_depth_after_sweep": 1, "sla_warnings": ["item-1", "item-2", "item-3"]}')
