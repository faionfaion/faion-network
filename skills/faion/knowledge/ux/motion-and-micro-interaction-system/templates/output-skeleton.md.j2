<!-- purpose: minimal Motion and Micro-Interaction System artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-motion-and-micro-interaction-system.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Motion and Micro-Interaction System — Artefact

| Field | Value |
|-------|-------|
| artefact_id | motion-and-micro-interaction-system-YYYY-MM-DD |
