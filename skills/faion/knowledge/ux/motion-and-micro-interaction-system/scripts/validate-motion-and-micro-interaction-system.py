#!/usr/bin/env python3
"""validate-motion-and-micro-interaction-system.py

Validate a Motion and Micro-Interaction System artefact against the JSON Schema (draft-07) defined in
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'motion-and-micro-interaction-system-2026-05-23', 'system_id': 'draft', 'duration_tokens': ['draft-item'], 'easing_tokens': ['draft-item'], 'choreography_rules': ['draft-item'], 'reduced_motion_policy': 'draft', 'perceived_perf_budget_ms': 1, 'platform_outputs': ['draft-item'], 'owners': 'draft', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'status': 'ready_for_review'}
