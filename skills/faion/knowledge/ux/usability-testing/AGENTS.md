...
| File | Purpose |
|------|---------|
| `templates/test-plan.md.j2` | Test plan skeleton. |
| `templates/test-plan.md` | Test plan skeleton. Generated from `templates/test-plan.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
| `templates/finding-format.md.j2` | Finding entry format with severity + frequency. |
| `templates/finding-format.md` | Finding entry format with severity + frequency. Generated from `templates/finding-format.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
