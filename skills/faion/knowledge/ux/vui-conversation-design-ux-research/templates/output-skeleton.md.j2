<!-- purpose: minimal VUI Conversation Design artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-vui-conversation-design.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# VUI Conversation Design — Artefact

| Field | Value |
|-------|-------|
| artefact_id | vui-conversation-design-YYYY-MM-DD |
