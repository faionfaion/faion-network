...
| `templates/prompt-writing.md.j2` | Single voice prompt with a 3-level reprompt chain and anti-pattern checklist |
| `templates/prompt-writing.md` | Single voice prompt with a 3-level reprompt chain and anti-pattern checklist Generated from `templates/prompt-writing.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/voice-ui-basics.json`

```json
{
  "artefact_id": "voice-ui-basics-example",
  "owner": "@solo-founder",
  "version": "1.0.0",
  ...
  "destructive_intents_confirmed": true
}
```
