#!/usr/bin/env python3
"""validate-voice-ui-basics.py — stdlib-only validator for the voice-ui-basics output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'platform', 'intents', 'prompts', 'error_matrix', 'destructive_intents_confirmed']
ENUMS = {'platform': ['alexa', 'google-assistant', 'siri', 'custom']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['intents', 'prompts']
OBJECT_FIELDS = ['error_matrix']
BOOL_FIELDS = ['destructive_intents_confirmed']
...
VALID_FIXTURE = json.loads('{"artefact_id": "voice-ui-basics-example", "owner": "@solo-founder", "version": "1.0.0", "last_reviewed": "2026-05-23", "platform": "alexa", "intents": ["item-1", "item-2", "item-3"], "prompts": ["item-1", "item-2", "item-3"], "error_matrix": {"key": "value"}, "destructive_intents_confirmed": true}')
