<!-- purpose: minimal Design System Impact Queue artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: report artefact validated by scripts/validate-design-system-impact-queue.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Design System Impact Queue — Artefact

| Field | Value |
|-------|-------|
| artefact_id | design-system-impact-queue-YYYY-MM-DD |
