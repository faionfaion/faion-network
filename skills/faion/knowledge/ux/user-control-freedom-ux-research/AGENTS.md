...
| `templates/user-control-freedom.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/user-control-freedom.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/user-control-freedom.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/user-control-freedom.json`

```json
{
  "artefact_id": "user-control-freedom-example",
