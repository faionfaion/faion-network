<!-- purpose: minimal Breaking Change Deprecation Policy artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-breaking-change-deprecation-policy.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Breaking Change Deprecation Policy — Artefact

| Field | Value |
|-------|-------|
| artefact_id | breaking-change-deprecation-policy-YYYY-MM-DD |
