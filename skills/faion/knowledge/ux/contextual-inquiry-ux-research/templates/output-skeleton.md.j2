<!-- purpose: minimal Contextual Inquiry artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: report artefact validated by scripts/validate-contextual-inquiry.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Contextual Inquiry — Artefact

| Field | Value |
|-------|-------|
| artefact_id | contextual-inquiry-YYYY-MM-DD |
