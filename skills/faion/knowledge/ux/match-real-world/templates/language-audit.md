...
-->
# Language Audit: <feature_product_area>
...
|--------------|----------------|-------|-----------------------|
| <term> | Y/N | [Jargon / technical / abbreviation / unclear] | <plain_alternative> |
...
|-------------|---------------|---------------|----------------|
| <form_name> | [Current] | <user_natural> | Y/N |

## Localization Gaps

| Element | Issue | Fix |
|---------|-------|-----|
| <date_format> | [US format shown to EU users] | [Use locale detection] |
...
|---------|--------|--------|------------------|
| <login_action> | "Sign in" | "Log in" | [Pick one] |
