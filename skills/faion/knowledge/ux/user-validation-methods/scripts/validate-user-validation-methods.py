#!/usr/bin/env python3
"""validate-user-validation-methods.py

Validate a User Validation Methods artefact against the JSON Schema (draft-07) defined in
...
OK = {
    "artefact_id": "user-validation-methods-2026-05-23",
