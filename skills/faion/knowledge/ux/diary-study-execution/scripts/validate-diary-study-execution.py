#!/usr/bin/env python3
"""validate-diary-study-execution.py

Validate a Diary Study Execution and Analysis artefact against the JSON Schema (draft-07) defined in
...
REQUIRED = ['artefact_id', 'compliance_log', 'low_quality_entries', 'codebook', 'coded_entries', 'temporal_patterns', 'evidence', 'owner', 'last_touched', 'template_version']
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'diary-study-execution-2026-05-23', 'compliance_log': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'low_quality_entries': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'codebook': {'key': 'value'}, 'coded_entries': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'temporal_patterns': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
