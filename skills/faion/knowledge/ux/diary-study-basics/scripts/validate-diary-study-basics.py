#!/usr/bin/env python3
"""validate-diary-study-basics.py

Validate a Diary Study Basics artefact against the JSON Schema (draft-07) defined in
...
REQUIRED = ['artefact_id', 'participants', 'entry_templates', 'reminder_schedule', 'compliance_threshold', 'exit_interview_hook', 'evidence', 'owner', 'last_touched', 'template_version']
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'diary-study-basics-2026-05-23', 'participants': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'entry_templates': {'key': 'value'}, 'reminder_schedule': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'compliance_threshold': {'key': 'value'}, 'exit_interview_hook': 'draft', 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
