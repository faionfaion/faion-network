...
Validate a Personas artefact against the JSON Schema (draft-07) defined in
...
REQUIRED = ['artefact_id', 'data_sources', 'archetypes', 'primary_persona', 'validation_status', 'evidence', 'owner', 'last_touched', 'template_version']
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'personas-2026-05-23', 'data_sources': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'archetypes': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'primary_persona': 'draft', 'validation_status': {'key': 'value'}, 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
