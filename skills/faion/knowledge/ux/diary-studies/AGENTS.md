...
| `templates/entry-daily.md.j2` | Daily reflection entry template |
| `templates/entry-daily.md` | Daily reflection entry template Generated from `templates/entry-daily.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
