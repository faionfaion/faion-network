...
| `templates/mobile-ux-patterns.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/mobile-ux-patterns.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/mobile-ux-patterns.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/mobile-ux-patterns.json`

```json
{
  "artefact_id": "mobile-ux-patterns-example",
