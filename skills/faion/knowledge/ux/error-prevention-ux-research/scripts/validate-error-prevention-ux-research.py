#!/usr/bin/env python3
"""validate-error-prevention.py

Validate a Error Prevention — Nielsen Heuristic #5 artefact against the JSON Schema (draft-07) defined in
...
OK = {
    "artefact_id": "error-prevention-2026-05-23",
