<!--
purpose: Per-dimension rubric skeleton with 5-level anchors and evidence slots
consumes: see AGENTS.md Prerequisites
produces: Paid Test-Task Scoring Rubric rubric
depends-on: content/02-output-contract.xml schema
token-budget-impact: ~400 tokens when filled
-->

# Paid Test-Task Scoring Rubric — test-task-rubric.md
...
[Fill the rubric-shaped content here per content/02-output-contract.xml.]
