<!--
purpose: Promotion case skeleton: scope/impact/judgment/leadership × engagement
consumes: see AGENTS.md Prerequisites
produces: Senior Promotion Case Template (Outsource Shop) spec
depends-on: content/02-output-contract.xml schema
token-budget-impact: ~400 tokens when filled
-->

# Senior Promotion Case Template (Outsource Shop) — promotion-case-spec.md
...
[Fill the spec-shaped content here per content/02-output-contract.xml.]
