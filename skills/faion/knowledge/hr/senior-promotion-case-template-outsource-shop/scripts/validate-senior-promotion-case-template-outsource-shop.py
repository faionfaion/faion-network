#!/usr/bin/env python3
"""validate-senior-promotion-case-template-outsource-shop.py — validate senior-promotion-case-template-outsource-shop output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-senior-promotion-case-template-outsource-shop.py",
        description="Validate senior-promotion-case-template-outsource-shop output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
