...
| File | Purpose |
|------|---------|
| `templates/30-60-90-day-plan.md.j2` | Working spec skeleton with 5-line header |
| `templates/30-60-90-day-plan.md` | Working spec skeleton with 5-line header Generated from `templates/30-60-90-day-plan.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
