...
<!-- produces: artefact instance that MUST validate via scripts/validate-employee-value-proposition.py -->
<!-- depends-on: templates/employee-value-proposition.md, content/02-output-contract.xml -->
<!-- token-budget-impact: ~200 tokens -->

# Employee Value Proposition (EVP) — Smoke Test Fixture

```json
{
  "artefact_id": "employee-value-proposition-acme-2026-05-23",
