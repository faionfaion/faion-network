...
<!-- produces: artefact instance that MUST validate via scripts/validate-interview-methods.py -->
<!-- depends-on: templates/interview-methods.md, content/02-output-contract.xml -->
<!-- token-budget-impact: ~200 tokens -->

# Interview Methods — Smoke Test Fixture

```json
{
  "artefact_id": "interview-methods-acme-2026-05-23",
