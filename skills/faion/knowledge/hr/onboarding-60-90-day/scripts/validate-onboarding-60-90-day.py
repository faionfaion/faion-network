#!/usr/bin/env python3
"""validate-onboarding-60-90-day.py — validate onboarding-60-90-day output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-onboarding-60-90-day.py",
        description="Validate onboarding-60-90-day output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
