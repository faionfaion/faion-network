#!/usr/bin/env python3
"""validate-structured-interview-design.py — validate structured-interview-design output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-structured-interview-design.py",
        description="Validate structured-interview-design output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
