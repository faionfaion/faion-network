...
<!-- produces: artefact instance that MUST validate via scripts/validate-employer-branding.py -->
<!-- depends-on: templates/employer-branding.md, content/02-output-contract.xml -->
<!-- token-budget-impact: ~200 tokens -->

# Employer Branding — Smoke Test Fixture

```json
{
  "artefact_id": "employer-branding-acme-2026-05-23",
