...
<!-- produces: artefact instance that MUST validate via scripts/validate-onboarding-30-day.py -->
<!-- depends-on: templates/onboarding-30-day.md, content/02-output-contract.xml -->
<!-- token-budget-impact: ~200 tokens -->

# 30-Day Onboarding Phase — Smoke Test Fixture

```json
{
  "artefact_id": "onboarding-30-day-acme-2026-05-23",
