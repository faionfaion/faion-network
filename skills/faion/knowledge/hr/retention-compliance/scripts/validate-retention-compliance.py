#!/usr/bin/env python3
"""validate-retention-compliance.py — validate retention-compliance output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-retention-compliance.py",
        description="Validate retention-compliance output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
