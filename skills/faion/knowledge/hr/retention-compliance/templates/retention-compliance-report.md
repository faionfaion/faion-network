<!--
purpose: Diagnostic report skeleton with attrition + compliance findings sections
consumes: see AGENTS.md Prerequisites
produces: Retention and HR Compliance report
depends-on: content/02-output-contract.xml schema
token-budget-impact: ~400 tokens when filled
-->

# Retention and HR Compliance — retention-compliance-report.md
