#!/usr/bin/env python3
"""validate-recruiting-process.py — validate recruiting-process output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-recruiting-process.py",
        description="Validate recruiting-process output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
