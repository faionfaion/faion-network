#!/usr/bin/env python3
"""validate-star-interview-framework.py — validate star-interview-framework output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-star-interview-framework.py",
        description="Validate star-interview-framework output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
