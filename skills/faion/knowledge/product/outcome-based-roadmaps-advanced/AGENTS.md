...
| `templates/outcome-based-roadmaps-advanced.md.j2` | Markdown skeleton with the required fields. |
| `templates/outcome-based-roadmaps-advanced.md` | Markdown skeleton with the required fields. Generated from `templates/outcome-based-roadmaps-advanced.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
