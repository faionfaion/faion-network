#!/usr/bin/env python3
"""validate-demo-hypothesis-template.py — stdlib-only validator for the Demo Hypothesis Template artefact.
...
KNOWN_RULE_IDS = set(["hypothesis-named-pre-demo", "single-success-metric", "kill-signal-required", "follow-up-gate", "artefact-as-agenda", "skip-this-methodology"])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "trigger": "Demo Hypothesis Template engagement",
        "rules_applied": ["hypothesis-named-pre-demo"],
        "evidence": [
            {
                "rule_id": "hypothesis-named-pre-demo",
