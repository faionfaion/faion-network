#!/usr/bin/env python3
"""validate-support-tool-pm-triage-spec.py — validate a support-tool-pm-triage-spec output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'tool', 'tag_taxonomy', 'escalation_rules', 'digest_schedule', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['tag_taxonomy', 'escalation_rules']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'tool', 'digest_schedule', 'owner']
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"support-tool-pm-triage-spec-example\", \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"tool\": \"tool value\", \"tag_taxonomy\": [\"item-1\", \"item-2\", \"item-3\"], \"escalation_rules\": [\"item-1\", \"item-2\", \"item-3\"], \"digest_schedule\": \"digest_schedule value\", \"owner\": \"@solo-founder\"}")
