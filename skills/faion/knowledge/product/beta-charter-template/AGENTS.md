...
| File | Purpose |
|------|---------|
| `templates/beta-charter-template.md.j2` | Markdown skeleton for the spec artefact, matching content/02-output-contract.xml |
| `templates/beta-charter-template.md` | Markdown skeleton for the spec artefact, matching content/02-output-contract.xml Generated from `templates/beta-charter-template.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/beta-charter-template.schema.json`
