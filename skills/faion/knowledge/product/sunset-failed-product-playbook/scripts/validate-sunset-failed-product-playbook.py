#!/usr/bin/env python3
"""validate-sunset-failed-product-playbook.py — validate a sunset-failed-product-playbook output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'product_name', 'sunset_date', 'customer_count', 'refund_total', 'migration_targets', 'retro_url', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed', 'sunset_date']
INT_FIELDS = ['customer_count']
NUM_FIELDS = ['refund_total']
ARRAY_FIELDS = ['migration_targets']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'product_name', 'retro_url', 'owner']
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"sunset-failed-product-playbook-example\", \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"product_name\": \"product_name value\", \"sunset_date\": \"2026-05-23\", \"customer_count\": 1, \"refund_total\": 1.0, \"migration_targets\": [\"item-1\", \"item-2\", \"item-3\"], \"retro_url\": \"retro_url value\", \"owner\": \"@solo-founder\"}")
