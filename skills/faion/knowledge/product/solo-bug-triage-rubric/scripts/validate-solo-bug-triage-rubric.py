#!/usr/bin/env python3
"""validate-solo-bug-triage-rubric.py — validate a solo-bug-triage-rubric output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'bug_id', 'severity', 'scope', 'frequency', 'reachable', 'workaround', 'queue', 'owner', 'retest_threshold']
ENUMS = {'severity': ['p0', 'p1', 'p2', 'p3'], 'queue': ['drop-everything', 'next-sprint', 'accept']}
...
ARRAY_FIELDS = []
OBJECT_FIELDS = []
BOOL_FIELDS = ['reachable']
STRING_FIELDS = ['artefact_id', 'bug_id', 'scope', 'frequency', 'workaround', 'owner', 'retest_threshold']
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"solo-bug-triage-rubric-example\", \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"bug_id\": \"bug_id value\", \"severity\": \"p0\", \"scope\": \"scope value\", \"frequency\": \"frequency value\", \"reachable\": true, \"workaround\": \"workaround value\", \"queue\": \"drop-everything\", \"owner\": \"@solo-founder\", \"retest_threshold\": \"retest_threshold value\"}")
