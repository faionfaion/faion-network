...
- The triggering activity 'Freelance-to-SaaS transition (6-month side build)' (role: p3-technical-freelancer) is in your current workload at least once per cycle.
...
|----------|-------|-----------|
| `design_partner_program_template_template_fill` | haiku | Template fill, no judgment |
| `design_partner_program_template_evidence_check` | sonnet | Bounded comparison + judgment |
| `design_partner_program_template_synthesis` | opus | Cross-input synthesis + final write-up |
...
### `templates/design-partner-program-template.schema.json`

```json
{
  "__faion_header__": {
    "purpose": "JSON Schema for design-partner-program-template",
  ...
  "$id": "https://faion.net/schemas/design-partner-program-template.json",
  "type": "object",
