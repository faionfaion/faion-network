#!/usr/bin/env python3
"""validate-micro-mvp-cut-rubric.py — validate a micro-mvp-cut-rubric output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'riskiest_assumption', 'scope_items', 'cut_decisions', 'final_scope_days', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = ['final_scope_days']
ARRAY_FIELDS = ['scope_items', 'cut_decisions']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'riskiest_assumption', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "micro-mvp-cut-rubric-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "riskiest_assumption": "riskiest_assumption value", "scope_items": ["item-1", "item-2", "item-3"], "cut_decisions": ["item-1", "item-2", "item-3"], "final_scope_days": 1.0, "owner": "@solo-founder"}')
