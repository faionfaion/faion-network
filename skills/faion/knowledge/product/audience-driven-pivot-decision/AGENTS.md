...
| File | Purpose |
|------|---------|
| `templates/audience-driven-pivot-decision.md.j2` | Markdown skeleton for the decision-record artefact, matching content/02-output-contract.xml |
| `templates/audience-driven-pivot-decision.md` | Markdown skeleton for the decision-record artefact, matching content/02-output-contract.xml Generated from `templates/audience-driven-pivot-decision.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/audience-driven-pivot-decision.schema.json`

```json
{
  "artefact_id": "REPLACE-WITH-ULID",
  "trigger": "Audience Driven Pivot Decision engagement",
  "rules_applied": [
