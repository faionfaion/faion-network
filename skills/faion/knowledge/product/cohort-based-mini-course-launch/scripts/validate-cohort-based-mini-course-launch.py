#!/usr/bin/env python3
"""validate-cohort-based-mini-course-launch.py — stdlib-only validator for the Cohort Based Mini Course Launch artefact.
...
KNOWN_RULE_IDS = set(["cohort-cap-twenty", "price-band-99-499", "six-week-cap", "live-session-required", "upsell-hook-pre-graduation", "skip-this-methodology"])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["cohort-cap-twenty"],
        "evidence": [
            {
                "rule_id": "cohort-cap-twenty",
