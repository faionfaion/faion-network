...
| `templates/kill-criteria-template.md.j2` | Markdown skeleton with the required fields. |
| `templates/kill-criteria-template.md` | Markdown skeleton with the required fields. Generated from `templates/kill-criteria-template.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
