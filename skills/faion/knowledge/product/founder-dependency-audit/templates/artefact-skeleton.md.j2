<!-- purpose: Founder Dependency Audit artefact skeleton -->
...
# Founder Dependency Audit — artefact skeleton
...
- **revenue_lines**: `<FILL>`
- **accounts**: `<FILL>`
- **client_relationships**: `<FILL>`
- **dependency_score**: `<FILL>`
- **remediation_plan**: `<FILL>`
