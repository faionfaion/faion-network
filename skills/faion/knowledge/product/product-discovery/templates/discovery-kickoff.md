...
## Core Questions
1. [Key question about value risk]
2. [Key question about usability risk]
3. [Key question about feasibility risk]
4. [Key question about business viability]
...
- Week 2: [Activities — e.g. clickable prototype test]
- Week 3: [Synthesize, update assumption matrix]
