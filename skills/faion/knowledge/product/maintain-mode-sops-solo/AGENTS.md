...
| `templates/maintain-mode-sops-solo.md.j2` | Markdown skeleton with the required fields. |
| `templates/maintain-mode-sops-solo.md` | Markdown skeleton with the required fields. Generated from `templates/maintain-mode-sops-solo.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/maintain-mode-sops-solo.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.network/schema/maintain-mode-sops-solo.json",
  "title": "Maintain Mode SOPs Solo Output Contract",
  "type": "object",
  "required": [
    "product_name",
    "weekly_check",
  ...
  "properties": {
    ...
    "on_call_rule": {
      "type": "object",
      "description": "trigger + max_response_window_hours"
    },
    "sunset_trigger": {
      "type": "string",
      "description": "MRR / churn condition"
    },
    "owner": {
      "type": "string",
