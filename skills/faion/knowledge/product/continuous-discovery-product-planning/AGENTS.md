...
| `templates/continuous-discovery.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/continuous-discovery.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/continuous-discovery.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
