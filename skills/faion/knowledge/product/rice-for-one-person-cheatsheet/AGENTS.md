...
| `templates/rice-for-one-person-cheatsheet.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/rice-for-one-person-cheatsheet.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/rice-for-one-person-cheatsheet.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/rice-for-one-person-cheatsheet.json`

```json
{
  "artefact_id": "rice-for-one-person-cheatsheet-example",
  "version": "1.0.0",
  ...
  "committed_bet_id": "committed_bet_id value",
  "owner": "@solo-founder"
}
```
