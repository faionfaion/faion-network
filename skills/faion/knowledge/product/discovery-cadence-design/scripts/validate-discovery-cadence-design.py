#!/usr/bin/env python3
"""validate-discovery-cadence-design.py

Validate an artefact produced by the discovery-cadence-design methodology against the schema
declared in content/02-output-contract.xml (mirrored in templates/discovery-cadence-design.schema.json).

Inputs:
    --file PATH       path to artefact (JSON or Markdown-with-table)
    --schema PATH     path to JSON schema (default: templates/discovery-cadence-design.schema.json)
