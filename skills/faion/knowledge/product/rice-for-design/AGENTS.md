...
| File | Purpose |
|------|---------|
| `templates/rice-for-design.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/rice-for-design.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/rice-for-design.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
