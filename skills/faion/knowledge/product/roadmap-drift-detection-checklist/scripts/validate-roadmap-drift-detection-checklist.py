#!/usr/bin/env python3
"""validate-roadmap-drift-detection-checklist.py — validate a roadmap-drift-detection-checklist output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'review_period', 'tagged_ratio', 'orphan_tickets', 'decayed_candidates', 'actions', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = ['tagged_ratio']
ARRAY_FIELDS = ['orphan_tickets', 'decayed_candidates', 'actions']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'review_period', 'owner']
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"roadmap-drift-detection-checklist-example\", \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"review_period\": \"review_period value\", \"tagged_ratio\": 1.0, \"orphan_tickets\": [\"item-1\", \"item-2\", \"item-3\"], \"decayed_candidates\": [\"item-1\", \"item-2\", \"item-3\"], \"actions\": [\"item-1\", \"item-2\", \"item-3\"], \"owner\": \"@solo-founder\"}")
