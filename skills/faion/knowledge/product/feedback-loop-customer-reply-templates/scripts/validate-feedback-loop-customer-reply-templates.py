#!/usr/bin/env python3
"""validate-feedback-loop-customer-reply-templates.py — stdlib-only validator for the Feedback Loop Customer Reply Templates artefact.
...
KNOWN_RULE_IDS = set(["five-templates-only", "reply-within-72h", "internal-tag-required", "decline-cites-anti-roadmap", "waitlist-links-smoke-page", "skip-this-methodology"])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["five-templates-only"],
        "evidence": [
            {
                "rule_id": "five-templates-only",
