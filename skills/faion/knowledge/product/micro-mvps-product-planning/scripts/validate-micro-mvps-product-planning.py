#!/usr/bin/env python3
"""validate-micro-mvps.py — validate a micro-mvps output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'risk_tested', 'segment', 'scope_days', 'kill_threshold', 'success_threshold', 'ship_date', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed', 'ship_date']
INT_FIELDS = []
NUM_FIELDS = ['scope_days']
ARRAY_FIELDS = []
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'risk_tested', 'segment', 'kill_threshold', 'success_threshold', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "micro-mvps-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "risk_tested": "risk_tested value", "segment": "segment value", "scope_days": 1.0, "kill_threshold": "kill_threshold value", "success_threshold": "success_threshold value", "ship_date": "2026-05-23", "owner": "@solo-founder"}')
