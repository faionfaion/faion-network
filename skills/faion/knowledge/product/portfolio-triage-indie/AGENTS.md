...
| `templates/portfolio-triage-indie.md.j2` | Markdown skeleton with the required fields. |
| `templates/portfolio-triage-indie.md` | Markdown skeleton with the required fields. Generated from `templates/portfolio-triage-indie.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
