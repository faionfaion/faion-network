#!/usr/bin/env python3
"""validate-discovery-research-handoff-template.py — stdlib-only validator for the Discovery Research Handoff Template artefact.
...
KNOWN_RULE_IDS = set(["one-page-cap", "five-required-sections", "evidence-three-quotes", "dual-signature", "success-metric-singular", "skip-this-methodology"])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["one-page-cap"],
        "evidence": [
            {
                "rule_id": "one-page-cap",
