#!/usr/bin/env python3
"""validate-sunset-vs-fold-framework.py

Validate an output artefact for the `sunset-vs-fold-framework` methodology against the JSON Schema
...
SCHEMA = json.loads(r"""{
    ...
    "$id": "https://faion.net/schemas/sunset-vs-fold-record.json",
    "type": "object",
    "required": [
        "product",
        "decision",
...
VALID_FIXTURE = json.loads(r"""{
  ...
  "criteria_matrix": {
    "revenue": 1,
    "strategic_adjacency": 0,
    "migration_cost": 3,
    "team_morale": 2,
    "customer_concentration": 4
  },
  "migration_path": "Customers migrate to product Y; CSV export by 2026-Q4.",
  "customer_notice_days": 120,
  "approvals": [
    {
      "who": "ruslan",
      "role": "founder"
