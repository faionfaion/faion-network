#!/usr/bin/env python3
"""validate-feature-sunset-and-deprecation.py

Validate an artefact produced by the feature-sunset-and-deprecation methodology against the schema
declared in content/02-output-contract.xml (mirrored in templates/feature-sunset-and-deprecation.schema.json).

Inputs:
    --file PATH       path to artefact (JSON or Markdown-with-table)
    --schema PATH     path to JSON schema (default: templates/feature-sunset-and-deprecation.schema.json)
