#!/usr/bin/env python3
"""validate-mvp-scoping.py — validate a mvp-scoping output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'riskiest_assumption', 'minimum_journey', 'scope_in', 'scope_out', 'kill_threshold', 'ship_date', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed', 'ship_date']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['minimum_journey', 'scope_in', 'scope_out']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'riskiest_assumption', 'kill_threshold', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "mvp-scoping-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "riskiest_assumption": "riskiest_assumption value", "minimum_journey": ["item-1", "item-2", "item-3"], "scope_in": ["item-1", "item-2", "item-3"], "scope_out": ["item-1", "item-2", "item-3"], "kill_threshold": "kill_threshold value", "ship_date": "2026-05-23", "owner": "@solo-founder"}')
