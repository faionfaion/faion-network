#!/usr/bin/env python3
"""validate-build-or-waitlist-decision-tree.py — stdlib-only validator for the Build Or Waitlist Decision Tree artefact.
...
KNOWN_RULE_IDS = set(["three-request-floor", "capacity-check-pre-build", "roadmap-alignment", "kill-criterion-before-build", "decision-record-required", "skip-this-methodology"])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "trigger": "Build Or Waitlist Decision Tree engagement",
        "rules_applied": ["three-request-floor"],
        "evidence": [
            {
                "rule_id": "three-request-floor",
