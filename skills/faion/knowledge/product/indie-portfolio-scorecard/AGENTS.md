...
| File | Purpose |
|------|---------|
| `templates/indie-portfolio-scorecard.md.j2` | Markdown skeleton for the report artefact, matching content/02-output-contract.xml |
| `templates/indie-portfolio-scorecard.md` | Markdown skeleton for the report artefact, matching content/02-output-contract.xml Generated from `templates/indie-portfolio-scorecard.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/indie-portfolio-scorecard.schema.json`
