#!/usr/bin/env python3
"""validate-backlog-management.py — validate a backlog-management output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'states', 'age_caps_days', 'grooming_cadence', 'capacity_ratio', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = ['capacity_ratio']
ARRAY_FIELDS = ['states']
OBJECT_FIELDS = ['age_caps_days']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'grooming_cadence', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "backlog-management-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "states": ["item-1", "item-2", "item-3"], "age_caps_days": {"key": "value"}, "grooming_cadence": "grooming_cadence value", "capacity_ratio": 1.0, "owner": "@solo-founder"}')
