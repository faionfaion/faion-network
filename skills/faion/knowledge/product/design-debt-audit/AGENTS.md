...
|----------|-------|-----------|
| `design_debt_audit_template_fill` | haiku | Template fill, no judgment |
| `design_debt_audit_evidence_check` | sonnet | Bounded comparison + judgment |
| `design_debt_audit_synthesis` | opus | Cross-input synthesis + final write-up |

## Templates

| File | Purpose |
|------|---------|
| `templates/design-debt-audit.md.j2` | Filled artefact skeleton conforming to 02-output-contract.xml |
| `templates/design-debt-audit.md` | Filled artefact skeleton conforming to 02-output-contract.xml Generated from `templates/design-debt-audit.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
