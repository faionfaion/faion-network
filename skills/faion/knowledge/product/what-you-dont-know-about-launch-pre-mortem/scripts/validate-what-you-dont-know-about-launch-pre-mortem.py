#!/usr/bin/env python3
"""validate-what-you-dont-know-about-launch-pre-mortem.py — stdlib-only validator for the What You Don't Know About Launch Pre-Mortem artefact.
...
KNOWN_RULE_IDS = set(['surface-enumerated', 'named-fix-owner', 'detector-per-failure', 'kill-criterion', 'revisit-on-launch-week', 'skip-this-methodology'])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["surface-enumerated"],
        "evidence": [
            {
                "rule_id": "surface-enumerated",
