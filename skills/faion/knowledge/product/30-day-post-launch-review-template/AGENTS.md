...
| `templates/30-day-post-launch-review-template.md.j2` | Markdown skeleton with the required fields. |
| `templates/30-day-post-launch-review-template.md` | Markdown skeleton with the required fields. Generated from `templates/30-day-post-launch-review-template.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
