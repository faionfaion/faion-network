...
| `templates/metric-deviation-hypothesis-framework.md.j2` | Markdown skeleton with the required fields. |
| `templates/metric-deviation-hypothesis-framework.md` | Markdown skeleton with the required fields. Generated from `templates/metric-deviation-hypothesis-framework.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
