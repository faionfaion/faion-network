...
| File | Purpose |
|------|---------|
| `templates/distribution-first-ideation.md.j2` | Markdown skeleton for the decision-record artefact, matching content/02-output-contract.xml |
| `templates/distribution-first-ideation.md` | Markdown skeleton for the decision-record artefact, matching content/02-output-contract.xml Generated from `templates/distribution-first-ideation.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/distribution-first-ideation.schema.json`
