#!/usr/bin/env python3
"""validate-mlp-planning.py — validate a mlp-planning output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'wow_moment', 'critical_path_steps', 'polish_budget_days', 'non_polish_scope', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = ['polish_budget_days']
ARRAY_FIELDS = ['critical_path_steps', 'non_polish_scope']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'wow_moment', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "mlp-planning-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "wow_moment": "wow_moment value", "critical_path_steps": ["item-1", "item-2", "item-3"], "polish_budget_days": 1.0, "non_polish_scope": ["item-1", "item-2", "item-3"], "owner": "@solo-founder"}')
