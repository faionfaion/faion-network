#!/usr/bin/env python3
"""validate-solo-saas-legal-docs-pack.py — validate a solo-saas-legal-docs-pack output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'tos_url', 'privacy_url', 'cookie_url', 'refund_url', 'dpa_url', 'owner']
ENUMS = {}
...
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'tos_url', 'privacy_url', 'cookie_url', 'refund_url', 'dpa_url', 'owner']
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"solo-saas-legal-docs-pack-example\", \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"tos_url\": \"tos_url value\", \"privacy_url\": \"privacy_url value\", \"cookie_url\": \"cookie_url value\", \"refund_url\": \"refund_url value\", \"dpa_url\": \"dpa_url value\", \"owner\": \"@solo-founder\"}")
