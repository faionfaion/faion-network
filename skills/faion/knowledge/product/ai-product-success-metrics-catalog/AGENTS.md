...
| `templates/ai-product-success-metrics-catalog.md.j2` | Markdown skeleton with required metrics. |
| `templates/ai-product-success-metrics-catalog.md` | Markdown skeleton with required metrics. Generated from `templates/ai-product-success-metrics-catalog.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
