#!/usr/bin/env python3
"""validate-solo-kpi-dashboard-template.py — validate a solo-kpi-dashboard-template output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'dashboard_url', 'kpis', 'review_cadence', 'owner']
ENUMS = {}
...
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'dashboard_url', 'review_cadence', 'owner']
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"solo-kpi-dashboard-template-example\", \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"dashboard_url\": \"dashboard_url value\", \"kpis\": [\"item-1\", \"item-2\", \"item-3\"], \"review_cadence\": \"review_cadence value\", \"owner\": \"@solo-founder\"}")
