#!/usr/bin/env python3
"""validate-customer-journey-bottleneck-attack.py

Validate an artefact produced by the customer-journey-bottleneck-attack methodology against the schema
declared in content/02-output-contract.xml (mirrored in templates/customer-journey-bottleneck-attack.schema.json).

Inputs:
    --file PATH       path to artefact (JSON or Markdown-with-table)
    --schema PATH     path to JSON schema (default: templates/customer-journey-bottleneck-attack.schema.json)
...
OK = {
    "artefact_id": "smoke-customer-journey-bottleneck-attack",
    "owner": "Maria Lopes",
