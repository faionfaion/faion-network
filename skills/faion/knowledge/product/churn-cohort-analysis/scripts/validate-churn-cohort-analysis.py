#!/usr/bin/env python3
"""validate-churn-cohort-analysis.py

Validate an artefact produced by the churn-cohort-analysis methodology against the schema
declared in content/02-output-contract.xml (mirrored in templates/churn-cohort-analysis.schema.json).

Inputs:
    --file PATH       path to artefact (JSON or Markdown-with-table)
    --schema PATH     path to JSON schema (default: templates/churn-cohort-analysis.schema.json)
