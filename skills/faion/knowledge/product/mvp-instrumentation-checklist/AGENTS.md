...
| `templates/mvp-instrumentation-checklist.md.j2` | Markdown skeleton with the required fields. |
| `templates/mvp-instrumentation-checklist.md` | Markdown skeleton with the required fields. Generated from `templates/mvp-instrumentation-checklist.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
