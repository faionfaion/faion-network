#!/usr/bin/env python3
"""validate-friction-to-backlog.py — stdlib-only validator for the Friction To Backlog artefact.
...
KNOWN_RULE_IDS = set(["ticket-cites-friction-id", "impact-quantified", "evidence-count-floor", "priority-formula", "weekly-sync-with-map", "skip-this-methodology"])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "trigger": "Friction To Backlog engagement",
        "rules_applied": ["ticket-cites-friction-id"],
        "evidence": [
            {
                "rule_id": "ticket-cites-friction-id",
