#!/usr/bin/env python3
"""validate-design-partner-cadence-playbook.py

Validate an artefact produced by the design-partner-cadence-playbook methodology against the schema
declared in content/02-output-contract.xml (mirrored in templates/design-partner-cadence-playbook.schema.json).

Inputs:
    --file PATH       path to artefact (JSON or Markdown-with-table)
    --schema PATH     path to JSON schema (default: templates/design-partner-cadence-playbook.schema.json)
