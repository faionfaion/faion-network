<!--
purpose: Dashboard spec — metrics with formula/target/alert threshold, charts, segments, refresh cadence and audience.
consumes: the tracking plan's events/properties and the NSM/leading-metric list (see Prerequisites)
produces: a dashboard spec
depends-on: content/01-core-rules.xml (r2-five-metric-cap, r4-dashboard-first)
