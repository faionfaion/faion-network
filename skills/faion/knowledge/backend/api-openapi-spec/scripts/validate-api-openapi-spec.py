...
Validate a API OpenAPI Spec Authoring artefact against the JSON Schema (draft-07) declared in
...
NUM_FIELDS = []
BOOL_FIELDS = []
ARRAY_FIELDS = ["ci_jobs", "evidence"]
OBJECT_FIELDS = ["shards"]
STRING_FIELDS = ["api_id", "spec_root", "bundler", "spectral_ruleset", "oasdiff_baseline", "status"]
...
OK = {'artefact_id': 'api-openapi-spec-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'api_id': 'draft', 'spec_root': 'draft', 'shards': {'key': 'value'}, 'bundler': 'draft', 'spectral_ruleset': 'draft', 'oasdiff_baseline': 'draft', 'ci_jobs': ['draft-item']}
BAD = {"foo": "bar"}
