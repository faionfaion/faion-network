#!/usr/bin/env python3
"""validate-git-server-workflow.py

Validate the output artefact for the `git-server-workflow` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/git-server-workflow.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'git-server-workflow',
    'title': 'Git Server Workflow (Workspace ↔ Runtime)',
