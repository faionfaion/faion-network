#!/usr/bin/env python3
"""validate-agent-dev-tuning.py

Validate the output artefact for the `agent-dev-tuning` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/agent-dev-tuning.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'agent-dev-tuning',
    'title': 'Agent Dev Tuning for VPS',
