// purpose: service-layer unit test with precise Moq matchers, Verify and FluentAssertions
// consumes: IOrderRepository (mocked) + OrdersService under test
// produces: xunit unit test class conforming to precise-mock-matchers + async-task-return
// depends-on: content/01-core-rules.xml rules precise-mock-matchers, async-task-return,
//             theory-for-params, fluentassertions-not-assert
