#!/usr/bin/env python3
"""validate-shell-productivity.py — validate a shell-productivity output JSON against the methodology schema.
...
REQUIRED = ["artefact_id", "version", "last_reviewed", "shell", "tools", "owner"]
ENUMS = {"shell": ["bash", "zsh"]}
...
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ["artefact_id", "starship_preset", "owner"]
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"shell-faion-net\", \"version\": \"1.1.0\", \"last_reviewed\": \"2026-05-23\", \"shell\": \"bash\", \"tools\": [\"fzf\", \"ripgrep\", \"bat\", \"starship\", \"zoxide\", \"eza\"], \"starship_preset\": \"tokyo-night\", \"owner\": \"@ruslan\"}")
INVALID_FIXTURE = json.loads("{\"shell\": \"fish\", \"tools\": [], \"owner\": \"team\"}")
