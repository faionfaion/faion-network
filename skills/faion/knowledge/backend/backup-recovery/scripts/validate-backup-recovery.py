#!/usr/bin/env python3
"""validate-backup-recovery.py

Validate the output artefact for the `backup-recovery` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/backup-recovery.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'backup-recovery',
    'title': 'Backup and Recovery for Solo VPS',
