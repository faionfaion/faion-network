#!/usr/bin/env python3
"""Validate output contract for python-code-quality.

USAGE:
    validate-python-code-quality.py <input.json>        Validate a JSON artefact.
    validate-python-code-quality.py --self-test         Run built-in fixture.
    validate-python-code-quality.py --help              Show this help.
...
REQUIRED_FIELDS = ['ruff_configured', 'mypy_strict', 'coverage_gate>0', 'precommit_installed', 'no_legacy_black_isort']
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(prog="validate-python-code-quality.py")
