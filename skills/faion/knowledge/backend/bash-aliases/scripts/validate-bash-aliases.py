#!/usr/bin/env python3
"""validate-bash-aliases.py

Validate the output artefact for the `bash-aliases` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/bash-aliases.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'bash-aliases',
    'title': 'Bash Aliases for Solo Developer Productivity',
