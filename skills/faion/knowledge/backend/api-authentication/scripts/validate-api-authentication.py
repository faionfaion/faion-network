...
Validate a API Authentication artefact against the JSON Schema (draft-07) declared in
...
INT_FIELDS = ["token_ttl_minutes"]
NUM_FIELDS = []
BOOL_FIELDS = ["refresh_rotation"]
ARRAY_FIELDS = ["allowed_algorithms", "claims_validated", "negative_tests", "evidence"]
OBJECT_FIELDS = []
STRING_FIELDS = ["api_id", "mechanism", "storage", "rotation_plan", "status"]
...
OK = {'artefact_id': 'api-authentication-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'api_id': 'draft', 'mechanism': 'draft', 'token_ttl_minutes': 1, 'refresh_rotation': True, 'allowed_algorithms': ['draft-item'], 'claims_validated': ['draft-item'], 'storage': 'draft', 'negative_tests': ['draft-item'], 'rotation_plan': 'draft'}
BAD = {"foo": "bar"}
