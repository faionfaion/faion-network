...
Validate a API Gateway Patterns artefact against the JSON Schema (draft-07) declared in
...
NUM_FIELDS = []
BOOL_FIELDS = []
ARRAY_FIELDS = ["routes", "evidence"]
OBJECT_FIELDS = ["cors_policy", "observability"]
STRING_FIELDS = ["gateway_id", "engine", "auth_strategy", "rate_limit_backend", "status"]
...
OK = {'artefact_id': 'api-gateway-patterns-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'gateway_id': 'draft', 'engine': 'draft', 'routes': ['draft-item'], 'auth_strategy': 'draft', 'rate_limit_backend': 'draft', 'cors_policy': {'key': 'value'}, 'observability': {'key': 'value'}}
BAD = {"foo": "bar"}
