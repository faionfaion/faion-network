#!/usr/bin/env python3
"""validate-tmux-power-user.py — validate a tmux-power-user output JSON against the methodology schema.
...
REQUIRED = ["artefact_id", "version", "last_reviewed", "prefix", "plugins", "history_limit", "owner"]
ENUMS = {}
SEMVER_FIELDS = ["version"]
DATE_FIELDS = ["last_reviewed"]
INT_FIELDS = ["history_limit"]
ARRAY_FIELDS = ["plugins", "os_targets"]
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ["artefact_id", "prefix", "owner"]
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"tmux-faion\", \"version\": \"1.1.0\", \"last_reviewed\": \"2026-05-23\", \"prefix\": \"C-a\", \"plugins\": [\"tmux-plugins/tpm\", \"tmux-plugins/tmux-resurrect\", \"tmux-plugins/tmux-continuum\"], \"history_limit\": 100000, \"os_targets\": [\"linux\", \"macos\"], \"owner\": \"@ruslan\"}")
INVALID_FIXTURE = json.loads("{\"prefix\": \"C-b\", \"plugins\": [], \"history_limit\": 1024, \"owner\": \"team\"}")
