#!/usr/bin/env python3
"""validate-firewall-management.py

Validate the output artefact for the `firewall-management` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/firewall-management.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
