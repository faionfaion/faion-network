<!-- purpose: minimal Node.js Service Layer Architecture artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-nodejs-service-layer-architecture.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Node.js Service Layer Architecture — Artefact

| Field | Value |
|-------|-------|
| artefact_id | nodejs-service-layer-architecture-YYYY-MM-DD |
...
| decisions | key:value design decisions |
...
- [ ] `scripts/validate-nodejs-service-layer-architecture.py --file artefact.json` exits 0
