...
### `templates/topology-contract.yaml`

```yaml
topology: work-queue
queue_name: orders.fulfill.v1
schema_ref: schemas/orders/fulfill/v1.avsc
retry_policy:
  max_retries: 5
  backoff: exponential+jitter
dlq_target: orders.fulfill.v1.dlq
idempotency_strategy: payload-key
```
