#!/usr/bin/env python3
"""Validate output contract for python-overview.

USAGE:
    validate-python-overview.py <input.json>        Validate a JSON artefact.
    validate-python-overview.py --self-test         Run built-in fixture.
    validate-python-overview.py --help              Show this help.
...
REQUIRED_FIELDS = ['domain_one_value', 'framework_one_value', 'python_version_pinned', 'downstream_methodologies_listed']
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(prog="validate-python-overview.py")
