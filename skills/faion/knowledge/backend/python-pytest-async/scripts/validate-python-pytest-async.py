#!/usr/bin/env python3
"""Validate output contract for python-pytest-async.

USAGE:
    validate-python-pytest-async.py <input.json>        Validate a JSON artefact.
    validate-python-pytest-async.py --self-test         Run built-in fixture.
    validate-python-pytest-async.py --help              Show this help.
...
REQUIRED_FIELDS = ['asyncio_mode_auto', 'uses_pytest_asyncio_fixture', 'asyncmock_for_async', 'asgitransport_for_fastapi']
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(prog="validate-python-pytest-async.py")
