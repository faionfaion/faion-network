...
| `templates/go-layout-toolchain.md.j2` | Markdown skeleton with the required fields |
| `templates/go-layout-toolchain.md` | Markdown skeleton with the required fields Generated from `templates/go-layout-toolchain.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/go-layout-toolchain.json`

```json
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://faion.network/schema/go-layout-toolchain.json",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
