#!/usr/bin/env python3
"""validate-wireguard-vpn.py — validate a wireguard-vpn output JSON against the methodology schema.
...
REQUIRED = ["artefact_id", "version", "last_reviewed", "server_endpoint", "server_subnet", "peers", "ip_forward", "owner"]
ENUMS = {}
...
ARRAY_FIELDS = ["peers"]
OBJECT_FIELDS = []
BOOL_FIELDS = ["ip_forward"]
STRING_FIELDS = ["artefact_id", "server_endpoint", "server_subnet", "owner"]
