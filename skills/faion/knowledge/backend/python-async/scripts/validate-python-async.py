#!/usr/bin/env python3
"""Validate output contract for python-async.

USAGE:
    validate-python-async.py <input.json>        Validate a JSON artefact.
    validate-python-async.py --self-test         Run built-in fixture.
    validate-python-async.py --help              Show this help.
...
REQUIRED_FIELDS = ['uses_taskgroup_for_fanout', 'asyncio_timeout_used', 'semaphore_for_caps', 'no_blocking_call_in_coroutine']
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(prog="validate-python-async.py")
