...
Validate a API GraphQL Design artefact against the JSON Schema (draft-07) declared in
...
INT_FIELDS = ["depth_limit", "complexity_limit"]
NUM_FIELDS = []
BOOL_FIELDS = ["dataloader_required", "persisted_queries", "introspection_in_prod"]
ARRAY_FIELDS = ["evidence"]
OBJECT_FIELDS = []
STRING_FIELDS = ["api_id", "schema_path", "pagination_style", "status"]
...
OK = {'artefact_id': 'api-graphql-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'api_id': 'draft', 'schema_path': 'draft', 'dataloader_required': True, 'pagination_style': 'draft', 'depth_limit': 1, 'complexity_limit': 1, 'persisted_queries': True, 'introspection_in_prod': True}
BAD = {"foo": "bar"}
