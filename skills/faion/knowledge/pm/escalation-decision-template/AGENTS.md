...
| File | Purpose |
|------|---------|
| `templates/escalation-decision-template.md.j2` | decision-record skeleton with required fields + 5-line header |
| `templates/escalation-decision-template.md` | decision-record skeleton with required fields + 5-line header Generated from `templates/escalation-decision-template.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/escalation-decision-template.schema.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/escalation-decision-template.json",
  "title": "Escalation Decision Template",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
