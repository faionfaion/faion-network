...
| File | Purpose |
|------|---------|
| `templates/skeleton.md.j2` | RetainerDecision skeleton |
| `templates/skeleton.md` | RetainerDecision skeleton Generated from `templates/skeleton.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
