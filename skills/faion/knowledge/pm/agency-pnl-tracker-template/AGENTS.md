...
| File | Purpose |
|------|---------|
| `templates/pnl-monthly.md.j2` | Monthly P&L template. |
| `templates/pnl-monthly.md` | Monthly P&L template. Generated from `templates/pnl-monthly.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
