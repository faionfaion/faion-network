...
| File | Purpose |
|------|---------|
| `templates/founder-as-pm-survival-kit.md.j2` | checklist skeleton with required fields + 5-line header |
| `templates/founder-as-pm-survival-kit.md` | checklist skeleton with required fields + 5-line header Generated from `templates/founder-as-pm-survival-kit.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/founder-as-pm-survival-kit.schema.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/founder-as-pm-survival-kit.json",
  "title": "Founder-as-PM Survival Kit",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
