...
Validate an output artefact for the `learning-speed-competitive-moat` methodology against the JSON Schema
...
SCHEMA = json.loads(r"""{
    ...
    "$id": "https://faion.net/schemas/learning-speed-report.json",
    "type": "object",
    "required": [
        "week",
        "beliefs",
...
VALID_FIXTURE = json.loads(r"""{
  ...
  "beliefs": [
    {
      "id": "b1",
      "assumption": "Mid-market buys plg if seat <$30",
      "confidence": 0.6,
  ...
  "decisions_logged": 4,
  "outside_view_inputs": 3,
  "kill_criteria_present": true
}""")
