...
| `templates/nomad-low-energy-mode.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/nomad-low-energy-mode.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/nomad-low-energy-mode.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
