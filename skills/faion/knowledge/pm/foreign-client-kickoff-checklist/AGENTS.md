...
| File | Purpose |
|------|---------|
| `templates/foreign-client-kickoff-checklist.md.j2` | checklist skeleton with required fields + 5-line header |
| `templates/foreign-client-kickoff-checklist.md` | checklist skeleton with required fields + 5-line header Generated from `templates/foreign-client-kickoff-checklist.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
