...
### `templates/cross-border-tax-cheatsheet.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/pm/cross-border-tax-cheatsheet.json",
  "title": "Cross Border Tax Cheatsheet",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
...
### `templates/cross-border-tax-cheatsheet.example.json`

```json
{
  "artefact_id": "cross-border-tax-cheatsheet-2026-05-23-acme",
