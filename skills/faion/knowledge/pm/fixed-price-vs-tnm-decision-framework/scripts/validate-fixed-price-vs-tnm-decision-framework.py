#!/usr/bin/env python3
"""validate-fixed-price-vs-tnm-decision-framework.py

Validate a Fixed-Price vs T&M Decision Framework artefact against the output-contract schema declared in
...
OK = {
    ...
    "decision": "Apply Fixed-Price vs T&M Decision Framework to the smoke-test scope.",
