...
| File | Purpose |
|------|---------|
| `templates/fixed-price-vs-tnm-decision-framework.md.j2` | decision-record skeleton with required fields + 5-line header |
| `templates/fixed-price-vs-tnm-decision-framework.md` | decision-record skeleton with required fields + 5-line header Generated from `templates/fixed-price-vs-tnm-decision-framework.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/fixed-price-vs-tnm-decision-framework.schema.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/fixed-price-vs-tnm-decision-framework.json",
  "title": "Fixed-Price vs T&M Decision Framework",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
