#!/usr/bin/env python3
"""validate-client-decision-forcing-scripts.py

Validate a Client Decision Forcing Scripts `spec` artefact against the JSON Schema in
