...
### `templates/client-decision-forcing-scripts.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/pm/client-decision-forcing-scripts.json",
  "title": "Client Decision Forcing Scripts",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
...
### `templates/client-decision-forcing-scripts.example.json`

```json
{
  "artefact_id": "client-decision-forcing-scripts-2026-05-23-acme",
