...
| File | Purpose |
|------|---------|
| `templates/bench-management-tiering.md.j2` | Markdown skeleton (5-line header) for the artefact body. |
| `templates/bench-management-tiering.md` | Markdown skeleton (5-line header) for the artefact body. Generated from `templates/bench-management-tiering.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/bench-management-tiering.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/bench-management-tiering.json",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
