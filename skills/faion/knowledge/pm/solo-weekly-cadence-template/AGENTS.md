...
| File | Purpose |
|------|---------|
| `templates/solo-weekly-cadence-template.md.j2` | Markdown skeleton for the checklist artefact, matching content/02-output-contract.xml |
| `templates/solo-weekly-cadence-template.md` | Markdown skeleton for the checklist artefact, matching content/02-output-contract.xml Generated from `templates/solo-weekly-cadence-template.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/solo-weekly-cadence-template.schema.json`

```json
{
  "artefact_id": "REPLACE-WITH-ULID",
  "trigger": "Solo Weekly Cadence Template engagement",
  "rules_applied": [
