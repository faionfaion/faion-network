...
| File | Purpose |
|------|---------|
| `templates/foreign-client-etiquette-playbook.md.j2` | playbook-step skeleton with required fields + 5-line header |
| `templates/foreign-client-etiquette-playbook.md` | playbook-step skeleton with required fields + 5-line header Generated from `templates/foreign-client-etiquette-playbook.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
