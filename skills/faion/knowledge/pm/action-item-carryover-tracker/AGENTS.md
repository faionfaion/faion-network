...
| `templates/action-item-carryover-tracker.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/action-item-carryover-tracker.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/action-item-carryover-tracker.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/action-item-carryover-tracker.json`

```json
{
  "artefact_id": "action-item-tracker-2026-q2",
  "version": "1.0.0",
  "last_reviewed": "2026-05-23",
  "log_url": "notion://workspace/action-items",
  "stale_threshold": 3,
