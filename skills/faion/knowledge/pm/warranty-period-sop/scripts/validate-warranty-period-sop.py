#!/usr/bin/env python3
"""validate-warranty-period-sop.py

Validate an artefact produced by the warranty-period-sop methodology against the schema
declared in content/02-output-contract.xml (mirrored in templates/warranty-period-sop.schema.json).

Inputs:
    --file PATH       path to artefact (JSON or Markdown-with-table)
    --schema PATH     path to JSON schema (default: templates/warranty-period-sop.schema.json)
