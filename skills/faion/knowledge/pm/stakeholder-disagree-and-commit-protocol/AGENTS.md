...
### `templates/stakeholder-disagree-and-commit-protocol.schema.json`

```json
{
  "__faion_header__": {
    "purpose": "JSON Schema for stakeholder-disagree-and-commit-protocol",
  ...
  "$id": "https://faion.net/schemas/stakeholder-disagree-and-commit-protocol.json",
  "type": "object",
