...
| File | Purpose |
|------|---------|
| `templates/architecture-review-cadence-protocol.md.j2` | Markdown skeleton (5-line header) for the artefact body. |
| `templates/architecture-review-cadence-protocol.md` | Markdown skeleton (5-line header) for the artefact body. Generated from `templates/architecture-review-cadence-protocol.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/architecture-review-cadence-protocol.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/architecture-review-cadence-protocol.json",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
