#!/usr/bin/env python3
"""validate-steerco-meeting-playbook.py

Validate the spec artefact for the steerco-meeting-playbook methodology against the schema
...
METHODOLOGY = "steerco-meeting-playbook"
VERSION = "1.1.0"
PRODUCES = "spec"
RULES = ['preread-3-days-early', 'ask-list-binary', 'cancel-if-no-decisions', 'decision-memo-48h', 'asks-not-status-time-split']
...
OK = {"__faion_header__": {"methodology": "steerco-meeting-playbook", "version": "1.1.0", "produces": "spec", "rules_satisfied": ["preread-3-days-early", "ask-list-binary", "cancel-if-no-decisions"]}, "artefact_path": "docs/steerco-meeting-playbook.md", "sections": [{"id": "S1", "title": "Scope"}, {"id": "S2", "title": "Deliverables"}]}
BAD = {"artefact_path": "docs/steerco-meeting-playbook.md"}
