#!/usr/bin/env python3
"""validate-founder-time-audit-tool.py

Validate a Founder Time Audit Tool artefact against the output-contract schema declared in
...
OK = {
    ...
    "decision": "Apply Founder Time Audit Tool to the smoke-test scope.",
