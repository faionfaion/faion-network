...
- Task is an instance of `p4-outsource-specialist/Fixed-price bid discovery + estimation (1 week)` OR a closely-adjacent variant in the same engagement shape.
...
|----------|--------|--------|
| Recent context for the `p4-outsource-specialist/Fixed-price bid discovery + estimation (1 week)` task (last 30 days) | Markdown / chat log | engagement notes |
...
| File | Purpose |
|------|---------|
| `templates/bid-no-bid-scorecard.json` | JSON Schema (draft-07) for the Bid No Bid Scorecard output contract |
| `templates/bid-no-bid-scorecard.md.j2` | Markdown skeleton with the required fields for the Bid No Bid Scorecard artefact |
| `templates/bid-no-bid-scorecard.md` | Markdown skeleton with the required fields for the Bid No Bid Scorecard artefact Generated from `templates/bid-no-bid-scorecard.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
| `templates/bid-no-bid-scorecard.example.json` | Worked filled-in example of a valid Bid No Bid Scorecard artefact |
...
|------|---------|--------------|
| `scripts/validate-bid-no-bid-scorecard.py` | Enforce the Bid No Bid Scorecard output contract against the JSON Schema. | After subagent returns, before downstream consumer reads. |
...
### `templates/bid-no-bid-scorecard.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/pm/bid-no-bid-scorecard.json",
...
### `templates/bid-no-bid-scorecard.example.json`

```json
{
  "artefact_id": "bid-no-bid-scorecard-2026-05-23-acme",
