<!--
purpose: One-page cascade skeleton: company KR + team OBJ + 3-5 team KRs (baseline / target / measure) + contribution map + depends-on + alignment sign-off line.
...
<replace with methodology-specific structured fields — see content/02-output-contract.xml>
