#!/usr/bin/env python3
"""validate-estimation-calibration-loop.py

Validate a Estimation Calibration Loop artefact against the output-contract schema declared in
...
OK = {
    ...
    "decision": "Apply Estimation Calibration Loop to the smoke-test scope.",
