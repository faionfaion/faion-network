#!/usr/bin/env python3
"""validate-billable-vs-internal-allocation-split.py

Validate a Billable vs Internal Allocation Split `decision-record` artefact against the JSON Schema in
...
REQUIRED = ['artefact_id', 'owner', 'decision', 'rationale', 'inputs_used', 'version', 'last_reviewed', 'options', 'default_if_silent']
...
OK_FIXTURE = json.loads("{\"artefact_id\": \"billable-vs-internal-allocation-split-2026-05-23-acme\", \"owner\": \"ruslan@faion.net\", \"decision\": \"Proceed with the agreed plan per inputs.\", \"rationale\": \"Decision rests on engagement-notes-2026-05-22 and baseline-2026-05-15; both inputs corroborate the same direction.\", \"inputs_used\": [{\"name\": \"engagement-notes-2026-05-22\", \"source\": \"wiki://pm/acme/notes.md\"}], \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"options\": [{\"name\": \"option-a\", \"pros\": \"stable margin\", \"cons\": \"slips OKR-2\"}, {\"name\": \"option-b\", \"pros\": \"hits OKR-2\", \"cons\": \"slips roadmap\"}], \"default_if_silent\": \"option-a\"}")
