#!/usr/bin/env python3
"""validate-scope-management.py

Validate the spec artefact for the scope-management methodology against the schema
...
VERSION = "1.1.0"
PRODUCES = "spec"
RULES = ['exclusions-before-inclusions', 'ac-per-must', 'baseline-then-cr', 'rtm-in-source-control', 'must-cap-60', 'must-never-wont', 'freeze-text-diff-edits']
...
OK = {"__faion_header__": {"methodology": "scope-management", "version": "1.1.0", "produces": "spec", "rules_satisfied": ["exclusions-before-inclusions", "ac-per-must", "baseline-then-cr"]}, "artefact_path": "docs/scope-management.md", "sections": [{"id": "S1", "title": "Scope"}, {"id": "S2", "title": "Deliverables"}]}
BAD = {"artefact_path": "docs/scope-management.md"}
