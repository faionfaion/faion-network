#!/usr/bin/env python3
"""validate-client-visibility-vs-velocity-tradeoff.py — validate a client-visibility-vs-velocity-tradeoff output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'clients', 'cadence_policy', 'visibility_budget_hours_per_week', 'update_template_url', 'next_tier_revisit', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed', 'next_tier_revisit']
INT_FIELDS = []
NUM_FIELDS = ['visibility_budget_hours_per_week']
ARRAY_FIELDS = ['clients']
OBJECT_FIELDS = ['cadence_policy']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'update_template_url', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "client-visibility-2026-q2", "version": "1.0.0", "last_reviewed": "2026-05-23", "clients": [{"name": "client-a", "tier": "HIGH", "contract_value": 35000}, {"name": "client-b", "tier": "MID", "contract_value": 12000}, {"name": "client-c", "tier": "LOW", "contract_value": 2500}], "cadence_policy": {"HIGH": "weekly-call + daily-slack", "MID": "weekly-email + as-needed-slack", "LOW": "biweekly-email"}, "visibility_budget_hours_per_week": 6, "update_template_url": "templates/status-update.md", "next_tier_revisit": "2026-08-15", "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"clients": [{"name": "client-a"}], "cadence_policy": {}, "visibility_budget_hours_per_week": 18, "update_template_url": "", "owner": "team"}')
