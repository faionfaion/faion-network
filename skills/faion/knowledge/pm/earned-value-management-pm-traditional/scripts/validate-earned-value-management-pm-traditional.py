...
Validate the `report` artefact for the `earned-value-management` methodology against the
...
SCHEMA = {'$schema': 'http://json-schema.org/draft-07/schema#', '$id': 'https://faion.net/schemas/earned-value-management.json', 'title': 'Earned Value Management', 'type': 'object', 'additionalProperties': False, 'required': ['slug', 'period', 'summary', 'findings'], 'properties': {'slug': {'type': 'string', 'const': 'earned-value-management'}, 'period': {'type': 'string'}, 'summary': {'type': 'string', 'minLength': 10}, 'findings': {'type': 'array', 'minItems': 1, 'items': {'type': 'object', 'required': ['id', 'severity', 'evidence'], 'properties': {'id': {'type': 'string'}, 'severity': {'enum': ['LOW', 'MEDIUM', 'HIGH', 'CRITICAL']}, 'evidence': {'type': 'string'}}}}, 'rag': {'enum': ['GREEN', 'YELLOW', 'RED']}}}

OK_FIXTURE = {'slug': 'earned-value-management', 'period': '2026-Q2', 'summary': 'Three findings; one HIGH.', 'findings': [{'id': 'F-01', 'severity': 'HIGH', 'evidence': 'metric snapshot M3'}], 'rag': 'YELLOW'}

BAD_FIXTURE = {'slug': 'earned-value-management', 'period': '2026-Q2'}
