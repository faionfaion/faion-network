#!/usr/bin/env python3
"""validate-cross-timezone-standup-rotation.py

Validate a Cross Timezone Standup Rotation artefact against the output-contract schema declared in
...
OK = {
    ...
    "decision": "Apply Cross Timezone Standup Rotation to the smoke-test scope.",
