...
[What happened — context and facts only, under 5 sentences. No blame.]

## Impact

[Quantified effect: N days delayed / $X overrun / N incidents / N defects]

## Root Cause (5-Whys)

1. [Symptom / why did X happen?]
2. [Why did that happen?]
3. [Why did that happen?]
4. [Why did that happen?]
5. [Root cause — reject "human error" as terminal]

## Lesson

[Generalizable insight, under 2 sentences. Must be applicable beyond this specific project.]
...
- [Link to incident ticket, PR, or document]
- [Metric or data supporting the impact claim]
