...
| File | Purpose |
|------|---------|
| `templates/freelancer-proposal-template-fixed-vs-tm.md.j2` | spec skeleton with required fields + 5-line header |
| `templates/freelancer-proposal-template-fixed-vs-tm.md` | spec skeleton with required fields + 5-line header Generated from `templates/freelancer-proposal-template-fixed-vs-tm.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/freelancer-proposal-template-fixed-vs-tm.schema.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/freelancer-proposal-template-fixed-vs-tm.json",
  "title": "Freelancer Proposal Template Fixed-vs-T&M",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
