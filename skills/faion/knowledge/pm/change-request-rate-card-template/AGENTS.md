...
### `templates/change-request-rate-card-template.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/pm/change-request-rate-card-template.json",
  "title": "Change Request Rate Card Template",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
...
### `templates/change-request-rate-card-template.example.json`

```json
{
  "artefact_id": "change-request-rate-card-template-2026-05-23-acme",
