...
| File | Purpose |
|------|---------|
| `templates/sprint-goal-formula.md.j2` | Markdown skeleton for the spec artefact, matching content/02-output-contract.xml |
| `templates/sprint-goal-formula.md` | Markdown skeleton for the spec artefact, matching content/02-output-contract.xml Generated from `templates/sprint-goal-formula.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/sprint-goal-formula.schema.json`
