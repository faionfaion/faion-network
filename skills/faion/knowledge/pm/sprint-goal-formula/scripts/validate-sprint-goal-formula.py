#!/usr/bin/env python3
"""validate-sprint-goal-formula.py — stdlib-only validator for the Sprint Goal Formula artefact.
...
KNOWN_RULE_IDS = set(["three-parts-required", "single-sentence-cap", "binary-scope-filter", "binary-review-grade", "no-two-concurrent-goals", "skip-this-methodology"])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["three-parts-required"],
        "evidence": [
            {
                "rule_id": "three-parts-required",
