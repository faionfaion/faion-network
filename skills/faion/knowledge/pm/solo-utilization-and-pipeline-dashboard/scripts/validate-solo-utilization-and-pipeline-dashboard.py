#!/usr/bin/env python3
"""validate-solo-utilization-and-pipeline-dashboard.py

Validate an artefact produced by the solo-utilization-and-pipeline-dashboard methodology against the schema
declared in content/02-output-contract.xml (mirrored in templates/solo-utilization-and-pipeline-dashboard.schema.json).

Inputs:
    --file PATH       path to artefact (JSON or Markdown-with-table)
    --schema PATH     path to JSON schema (default: templates/solo-utilization-and-pipeline-dashboard.schema.json)
