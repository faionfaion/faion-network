...
| File | Purpose |
|------|---------|
| `templates/skeleton.md.j2` | Decision record: incumbent + AI-tier price + integration fit + ROI gate + outcome. |
| `templates/skeleton.md` | Decision record: incumbent + AI-tier price + integration fit + ROI gate + outcome. Generated from `templates/skeleton.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
