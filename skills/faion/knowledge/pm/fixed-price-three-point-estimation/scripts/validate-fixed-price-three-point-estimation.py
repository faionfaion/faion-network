#!/usr/bin/env python3
"""validate-fixed-price-three-point-estimation.py

Validate a Fixed-Price Three-Point Estimation artefact against the output-contract schema declared in
...
OK = {
    ...
    "decision": "Apply Fixed-Price Three-Point Estimation to the smoke-test scope.",
