...
| File | Purpose |
|------|---------|
| `templates/fixed-price-three-point-estimation.md.j2` | spec skeleton with required fields + 5-line header |
| `templates/fixed-price-three-point-estimation.md` | spec skeleton with required fields + 5-line header Generated from `templates/fixed-price-three-point-estimation.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/fixed-price-three-point-estimation.schema.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/fixed-price-three-point-estimation.json",
  "title": "Fixed-Price Three-Point Estimation",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
