...
| File | Purpose |
|------|---------|
| `templates/freelance-capacity-model.md.j2` | spec skeleton with required fields + 5-line header |
| `templates/freelance-capacity-model.md` | spec skeleton with required fields + 5-line header Generated from `templates/freelance-capacity-model.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/freelance-capacity-model.schema.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/freelance-capacity-model.json",
  "title": "Freelance Capacity Model",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
