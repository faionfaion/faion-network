...
Validate the report artefact for the risk-management methodology against the schema
...
VERSION = "1.1.0"
PRODUCES = "report"
RULES = ['track-opportunities-too', 'named-owner-with-trigger', 'contingency-for-accept', 'source-quote-required', 'weekly-15min-review', 'convert-materialised-to-issue']
...
OK = {"__faion_header__": {"methodology": "risk-management", "version": "1.1.0", "produces": "report", "rules_satisfied": ["track-opportunities-too", "named-owner-with-trigger", "contingency-for-accept"]}, "report_id": "risk-management-2026-05-23", "data": {"summary": "ok"}}
BAD = {"artefact_path": "docs/risk-management.md"}
