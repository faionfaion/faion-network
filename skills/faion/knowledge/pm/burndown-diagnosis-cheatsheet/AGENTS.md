...
| `templates/burndown-diagnosis-cheatsheet.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/burndown-diagnosis-cheatsheet.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/burndown-diagnosis-cheatsheet.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
