...
| File | Purpose |
|------|---------|
| `templates/freelancer-client-scorecard.md.j2` | rubric skeleton with required fields + 5-line header |
| `templates/freelancer-client-scorecard.md` | rubric skeleton with required fields + 5-line header Generated from `templates/freelancer-client-scorecard.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/freelancer-client-scorecard.schema.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/freelancer-client-scorecard.json",
  "title": "Freelancer Client Scorecard",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
