#!/usr/bin/env python3
"""validate-freelancer-client-scorecard.py

Validate a Freelancer Client Scorecard artefact against the output-contract schema declared in
...
OK = {
    ...
    "decision": "Apply Freelancer Client Scorecard to the smoke-test scope.",
