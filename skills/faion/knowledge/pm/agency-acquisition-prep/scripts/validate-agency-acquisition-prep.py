#!/usr/bin/env python3
"""validate-agency-acquisition-prep.py

Validate an output artefact for the `agency-acquisition-prep` methodology against the JSON Schema
...
SCHEMA = json.loads(r"""{
    ...
    "$id": "https://faion.net/schemas/agency-acquisition-prep.json",
    "type": "object",
    "required": [
        "cycle_id",
        "lane",
...
VALID_FIXTURE = json.loads(r"""{
  ...
  "items": [
    {
      "id": "data-room-refresh",
      "status": "done",
      "evidence": "https://drive/q2",
      "owner": "ruslan"
    },
    {
      "id": "founder-dep-audit",
      "status": "done",
      "evidence": "playbooks/founder-dep.md",
      "owner": "ruslan"
    },
    {
      "id": "loi-hygiene-template",
      "status": "deferred",
      "evidence": "no template author yet",
      "owner": "ruslan",
      "aging": 1
    }
  ],
  "pass_rate": 0.67,
  "carryover": [
    "loi-hygiene-template"
  ],
  "escalations": [],
  "founder_dependency_pct": 28
}""")
