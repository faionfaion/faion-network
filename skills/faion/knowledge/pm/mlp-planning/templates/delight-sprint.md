...
[Description of current state — specific, not vague]
User quote: "[What users actually say — from feedback log or session replay]"

### Target Experience

[Description of desired state]
User reaction we aim for: "[What we want them to feel or say]"
