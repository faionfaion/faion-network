#!/usr/bin/env python3
"""validate-quarterly-retainer-review-script.py

Validate the spec artefact for the quarterly-retainer-review-script methodology against the schema
...
METHODOLOGY = "quarterly-retainer-review-script"
VERSION = "1.1.0"
PRODUCES = "spec"
RULES = ['45-minute-cap', 'named-decision-exit', 'data-over-narrative', 'scope-delta-written', '24h-follow-up']
...
OK = {"__faion_header__": {"methodology": "quarterly-retainer-review-script", "version": "1.1.0", "produces": "spec", "rules_satisfied": ["45-minute-cap", "named-decision-exit", "data-over-narrative"]}, "artefact_path": "docs/quarterly-retainer-review-script.md", "sections": [{"id": "S1", "title": "Scope"}, {"id": "S2", "title": "Deliverables"}]}
BAD = {"artefact_path": "docs/quarterly-retainer-review-script.md"}
