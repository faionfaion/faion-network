...
| File | Purpose |
|------|---------|
| `templates/timezone-overlap-comms-charter.md.j2` | Filled artefact skeleton conforming to 02-output-contract.xml |
| `templates/timezone-overlap-comms-charter.md` | Filled artefact skeleton conforming to 02-output-contract.xml Generated from `templates/timezone-overlap-comms-charter.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
| `templates/timezone-overlap-comms-charter.schema.json` | JSON Schema for the artefact (mirrors content/02-output-contract.xml) |
| `templates/_smoke-test.md.j2` | Minimum-viable filled-in version exercised by scripts/validate-timezone-overlap-comms-charter.py --self-test |
| `templates/_smoke-test.md` | Minimum-viable filled-in version exercised by scripts/validate-timezone-overlap-comms-charter.py --self-test Generated from `templates/_smoke-test.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/timezone-overlap-comms-charter.schema.json`

```json
{
  "__faion_header__": {
    "purpose": "JSON Schema for timezone-overlap-comms-charter",
  ...
  "$id": "https://faion.net/schemas/timezone-overlap-comms-charter.json",
  "type": "object",
