#!/usr/bin/env python3
"""validate-change-request-pricing-rubric.py

Validate a Change Request Pricing Rubric `rubric` artefact against the JSON Schema in
