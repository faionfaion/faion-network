#!/usr/bin/env python3
"""validate-timezone-overlap-handoff-protocol.py

Validate an artefact produced by the timezone-overlap-handoff-protocol methodology against the schema
declared in content/02-output-contract.xml (mirrored in templates/timezone-overlap-handoff-protocol.schema.json).

Inputs:
    --file PATH       path to artefact (JSON or Markdown-with-table)
    --schema PATH     path to JSON schema (default: templates/timezone-overlap-handoff-protocol.schema.json)
