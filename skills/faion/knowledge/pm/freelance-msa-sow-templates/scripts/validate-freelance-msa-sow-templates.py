#!/usr/bin/env python3
"""validate-freelance-msa-sow-templates.py

Validate a Freelance MSA + SOW Templates artefact against the output-contract schema declared in
...
OK = {
    ...
    "decision": "Apply Freelance MSA + SOW Templates to the smoke-test scope.",
