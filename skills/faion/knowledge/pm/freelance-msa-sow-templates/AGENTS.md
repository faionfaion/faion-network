...
| File | Purpose |
|------|---------|
| `templates/freelance-msa-sow-templates.md.j2` | spec skeleton with required fields + 5-line header |
| `templates/freelance-msa-sow-templates.md` | spec skeleton with required fields + 5-line header Generated from `templates/freelance-msa-sow-templates.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/freelance-msa-sow-templates.schema.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/freelance-msa-sow-templates.json",
  "title": "Freelance MSA + SOW Templates",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
