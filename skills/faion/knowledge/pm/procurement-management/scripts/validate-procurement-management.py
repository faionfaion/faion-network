...
Validate the spec artefact for the procurement-management methodology against the schema
...
VERSION = "1.1.0"
PRODUCES = "spec"
RULES = ['baseline-included', 'contract-type-matches-scope', 'pre-published-weights', 'clause-checklist-pass', 'milestone-gated-payments', 'sensitivity-check']
...
OK = {"__faion_header__": {"methodology": "procurement-management", "version": "1.1.0", "produces": "spec", "rules_satisfied": ["baseline-included", "contract-type-matches-scope", "pre-published-weights"]}, "artefact_path": "docs/procurement-management.md", "sections": [{"id": "S1", "title": "Scope"}, {"id": "S2", "title": "Deliverables"}]}
BAD = {"artefact_path": "docs/procurement-management.md"}
