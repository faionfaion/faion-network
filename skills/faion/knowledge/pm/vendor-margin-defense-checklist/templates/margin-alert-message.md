...
This week I logged <hours> hours on [scope item not in original SOW]. The exchange where this came up was <link_quote_date>. To keep the numbers clean (and not surprise either of us at invoice time) I'd like to capture this as a small change order — <hours_rate_x>, adding [N] days to the <milestone> window.
