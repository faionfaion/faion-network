...
Validate the report artefact for the risk-register methodology against the schema
...
VERSION = "1.1.0"
PRODUCES = "report"
RULES = ['exactly-one-named-owner', 'trigger-observable', 'accept-requires-contingency', 'score-integrity', 'opportunity-quota', 'calibrated-impact-scale', 'risk-driven-contingency']
...
OK = {"__faion_header__": {"methodology": "risk-register", "version": "1.1.0", "produces": "report", "rules_satisfied": ["exactly-one-named-owner", "trigger-observable", "accept-requires-contingency"]}, "report_id": "risk-register-2026-05-23", "data": {"summary": "ok"}}
BAD = {"artefact_path": "docs/risk-register.md"}
