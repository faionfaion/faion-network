#!/usr/bin/env python3
"""validate-scope-change-vs-scope-creep-detection.py

Validate the config artefact for the scope-change-vs-scope-creep-detection methodology against the schema
...
VERSION = "1.1.0"
PRODUCES = "config"
RULES = ['signed-baseline-as-ground-truth', 'four-outcome-routing', 'evidence-citation-required', 'human-override-with-log', 'immutable-audit-trail']
...
OK = {"__faion_header__": {"methodology": "scope-change-vs-scope-creep-detection", "version": "1.1.0", "produces": "config", "rules_satisfied": ["signed-baseline-as-ground-truth", "four-outcome-routing", "evidence-citation-required"]}, "config_path": "config/scope-change-vs-scope-creep-detection.yaml", "entries": [{"key": "k1", "value": "v1"}]}
BAD = {"artefact_path": "docs/scope-change-vs-scope-creep-detection.md"}
