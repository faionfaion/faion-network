#!/usr/bin/env python3
"""validate-github-projects.py — validate a github-projects output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'project_urls', 'linked_repos', 'custom_fields_count', 'primary_axis', 'automation_workflows', 'owner']
ENUMS = {'primary_axis': ['iteration', 'status']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['custom_fields_count']
NUM_FIELDS = []
ARRAY_FIELDS = ['project_urls', 'linked_repos', 'automation_workflows']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'primary_axis', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "github-projects-2026-q2", "version": "1.0.0", "last_reviewed": "2026-05-23", "project_urls": ["https://github.com/orgs/faion/projects/1"], "linked_repos": ["faionfaion/faion-cli", "faionfaion/faion-net"], "custom_fields_count": 6, "primary_axis": "iteration", "automation_workflows": [".github/workflows/project-automation.yml"], "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"project_urls": ["a", "b", "c", "d"], "linked_repos": [], "custom_fields_count": 22, "primary_axis": "neither", "automation_workflows": [], "owner": "team"}')
