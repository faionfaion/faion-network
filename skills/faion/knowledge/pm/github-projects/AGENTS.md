...
| `templates/github-projects.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/github-projects.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/github-projects.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/github-projects.json`

```json
{
  "artefact_id": "github-projects-2026-q2",
  "version": "1.0.0",
  "last_reviewed": "2026-05-23",
  "project_urls": [
    "https://github.com/orgs/faion/projects/1"
  ],
  "linked_repos": [
    "faionfaion/faion-cli",
    "faionfaion/faion-net"
  ],
  "custom_fields_count": 6,
  "primary_axis": "iteration",
