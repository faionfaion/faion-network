#!/usr/bin/env python3
"""validate-freelance-insurance-buyers-guide.py

Validate a Freelance Insurance Buyers Guide artefact against the output-contract schema declared in
...
OK = {
    ...
    "decision": "Apply Freelance Insurance Buyers Guide to the smoke-test scope.",
