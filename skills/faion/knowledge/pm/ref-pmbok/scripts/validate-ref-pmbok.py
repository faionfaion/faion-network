#!/usr/bin/env python3
"""validate-ref-pmbok.py

Validate the rubric artefact for the ref-pmbok methodology against the schema
...
METHODOLOGY = "ref-pmbok"
VERSION = "1.1.0"
PRODUCES = "rubric"
RULES = ['show-formula-and-result', 'clamp-zero-denominators', 'name-estimation-technique', 'one-strategy-per-risk', 'rag-recalibration', 'pin-edition']
...
OK = {"__faion_header__": {"methodology": "ref-pmbok", "version": "1.1.0", "produces": "rubric", "rules_satisfied": ["show-formula-and-result", "clamp-zero-denominators", "name-estimation-technique"]}, "rubric_id": "ref-pmbok-rubric-v1", "criteria": [{"id": "R1", "weight": 0.5}]}
BAD = {"artefact_path": "docs/ref-pmbok.md"}
