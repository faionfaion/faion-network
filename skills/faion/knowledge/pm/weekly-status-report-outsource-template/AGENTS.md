...
| File | Purpose |
|------|---------|
| `templates/weekly-status-report-outsource-template.md.j2` | Filled artefact skeleton conforming to 02-output-contract.xml |
| `templates/weekly-status-report-outsource-template.md` | Filled artefact skeleton conforming to 02-output-contract.xml Generated from `templates/weekly-status-report-outsource-template.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
| `templates/_smoke-test.md.j2` | Minimum-viable filled-in version exercised by scripts/validate-weekly-status-report-outsource-template.py --self-test |
| `templates/_smoke-test.md` | Minimum-viable filled-in version exercised by scripts/validate-weekly-status-report-outsource-template.py --self-test Generated from `templates/_smoke-test.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/weekly-status-report-outsource-template.schema.json`

```json
{
  "__faion_header__": {
    "purpose": "JSON Schema for weekly-status-report-outsource-template",
  ...
  "$id": "https://faion.net/schemas/weekly-status-report-outsource-template.json",
  "type": "object",
