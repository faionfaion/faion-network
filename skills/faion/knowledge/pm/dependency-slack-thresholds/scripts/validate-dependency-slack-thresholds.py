#!/usr/bin/env python3
"""validate-dependency-slack-thresholds.py

Validate a Dependency Slack Thresholds artefact against the output-contract schema declared in
...
OK = {
    ...
    "decision": "Apply Dependency Slack Thresholds to the smoke-test scope.",
