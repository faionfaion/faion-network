...
| File | Purpose |
|------|---------|
| `templates/dependency-slack-thresholds.md.j2` | decision-record skeleton with required fields + 5-line header |
| `templates/dependency-slack-thresholds.md` | decision-record skeleton with required fields + 5-line header Generated from `templates/dependency-slack-thresholds.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/dependency-slack-thresholds.schema.json`

```json
{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://faion.net/schemas/dependency-slack-thresholds.json",
  "title": "Dependency Slack Thresholds",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
