...
Validate a Design System Success Factors artefact against the JSON Schema (draft-07) defined in
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'design-system-success-factors-2026-05-23', 'system_id': 'draft', 'ownership_score': 1, 'usability_score': 1, 'docs_score': 1, 'adoption_score': 1, 'weakest_pillar': 'draft', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'reviewer': 'draft', 'status': 'ready_for_review'}
