<!-- purpose: minimal UI Library Advanced Patterns artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-ui-lib-patterns.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# UI Library Advanced Patterns — Artefact

| Field | Value |
|-------|-------|
| artefact_id | ui-lib-patterns-YYYY-MM-DD |
...
- [ ] `scripts/validate-ui-lib-patterns.py --file artefact.json` exits 0
