#!/usr/bin/env python3
"""validate-error-handling-in-vui.py

Validate a Error Handling in VUI artefact against the JSON Schema (draft-07) defined in
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'error-handling-in-vui-2026-05-23', 'intent_id': 'draft', 'ladder_steps': ['draft-item'], 'retry_budget': 'draft', 'bailout_route': 'draft', 'telemetry_events': ['draft-item'], 'fallback_copy': 'draft', 'human_handoff': 'draft', 'tested_on': 'draft', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'status': 'ready_for_review'}
