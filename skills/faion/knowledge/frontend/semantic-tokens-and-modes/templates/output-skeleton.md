<!-- purpose: minimal Semantic Tokens and Modes artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-semantic-tokens-and-modes.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Semantic Tokens and Modes — Artefact

| Field | Value |
|-------|-------|
| artefact_id | semantic-tokens-and-modes-YYYY-MM-DD |
