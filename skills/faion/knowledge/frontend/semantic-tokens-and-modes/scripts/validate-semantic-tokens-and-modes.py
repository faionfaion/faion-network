...
Validate a Semantic Tokens and Modes artefact against the JSON Schema (draft-07) defined in
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'semantic-tokens-and-modes-2026-05-23', 'system_id': 'draft', 'semantic_tokens': ['draft-item'], 'modes': ['draft-item'], 'primitive_bindings': ['draft-item'], 'figma_variable_map': 'draft', 'fallback_mode': 'draft', 'naming_rules': ['draft-item'], 'owners': 'draft', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'status': 'ready_for_review'}
