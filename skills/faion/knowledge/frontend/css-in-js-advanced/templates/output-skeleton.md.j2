<!-- purpose: minimal CSS-in-JS Advanced artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: code artefact validated by scripts/validate-css-in-js-advanced.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# CSS-in-JS Advanced — Artefact

| Field | Value |
|-------|-------|
| artefact_id | css-in-js-advanced-YYYY-MM-DD |
