<!-- purpose: minimal Token Organization artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-token-organization.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Token Organization — Artefact

| Field | Value |
|-------|-------|
| artefact_id | token-organization-YYYY-MM-DD |
