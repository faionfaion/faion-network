<!-- purpose: minimal Design Tokens Basics artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-design-tokens-basics.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Design Tokens Basics — Artefact

| Field | Value |
|-------|-------|
| artefact_id | design-tokens-basics-YYYY-MM-DD |
