<!-- purpose: minimal UI Component Library Basics artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-ui-lib-basics.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# UI Component Library Basics — Artefact

| Field | Value |
|-------|-------|
| artefact_id | ui-lib-basics-YYYY-MM-DD |
...
- [ ] `scripts/validate-ui-lib-basics.py --file artefact.json` exits 0
