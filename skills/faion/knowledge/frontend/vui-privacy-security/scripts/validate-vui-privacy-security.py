...
Validate a VUI Privacy and Security artefact against the JSON Schema (draft-07) defined in
...
REQUIRED = ['artefact_id', 'privacy_principles', 'classifier_policy', 'redaction_rules', 'deletion_policy', 'evidence', 'owner', 'last_touched', 'template_version']
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'vui-privacy-security-2026-05-23', 'privacy_principles': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'classifier_policy': {'key': 'value'}, 'redaction_rules': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'deletion_policy': {'key': 'value'}, 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
