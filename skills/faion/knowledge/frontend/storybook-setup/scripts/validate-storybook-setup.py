#!/usr/bin/env python3
"""validate-storybook-setup.py

Validate a Storybook Setup artefact against the JSON Schema (draft-07) declared in
...
REQUIRED = ['artefact_id', 'owner', 'last_touched', 'template_version', 'status', 'evidence', 'config_id', 'settings', 'applies_to']
...
NUM_FIELDS = []
BOOL_FIELDS = []
ARRAY_FIELDS = ['applies_to']
OBJECT_FIELDS = ['settings']
STRING_FIELDS = ['config_id']
...
OK = {'artefact_id': 'storybook-setup-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'config_id': 'draft', 'settings': {'key': 'value'}, 'applies_to': ['draft-target']}
BAD = {"foo": "bar"}
