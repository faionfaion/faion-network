<!-- purpose: minimal Storybook Setup artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: config artefact validated by scripts/validate-storybook-setup.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Storybook Setup — Artefact

| Field | Value |
|-------|-------|
| artefact_id | storybook-setup-YYYY-MM-DD |
...
- [ ] `scripts/validate-storybook-setup.py --file artefact.json` exits 0
