#!/usr/bin/env python3
"""validate-css-in-js-basics.py

Validate a CSS-in-JS Basics artefact against the JSON Schema (draft-07) defined in
...
OK = {'artefact_id': 'css-in-js-basics-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'library': 'draft', 'theme_provider_path': 'draft', 'primitive_paths': ['item-1'], 'convention_file_path': 'draft'}
