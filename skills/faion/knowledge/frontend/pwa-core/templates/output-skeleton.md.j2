<!-- purpose: minimal PWA Core Architecture artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-pwa-core.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# PWA Core Architecture — Artefact

| Field | Value |
|-------|-------|
| artefact_id | pwa-core-YYYY-MM-DD |
...
- [ ] `scripts/validate-pwa-core.py --file artefact.json` exits 0
