<!-- purpose: minimal SEO for SPAs artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-seo-for-spas.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# SEO for SPAs — Artefact

| Field | Value |
|-------|-------|
| artefact_id | seo-for-spas-YYYY-MM-DD |
...
- [ ] `scripts/validate-seo-for-spas.py --file artefact.json` exits 0
