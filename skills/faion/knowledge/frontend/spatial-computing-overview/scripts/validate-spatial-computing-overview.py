...
Validate a Spatial Computing Overview artefact against the JSON Schema (draft-07) defined in
...
OK = {'owner': 'draft', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'spatial-computing-overview-2026-05-23', 'report_id': 'draft', 'platforms_covered': ['draft-item'], 'terminology': 'draft', 'market_positioning': 'draft', 'constraints_table': 'draft', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'last_reviewed': 'draft', 'status': 'ready_for_review'}
