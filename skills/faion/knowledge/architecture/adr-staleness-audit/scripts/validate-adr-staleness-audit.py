#!/usr/bin/env python3
"""validate-adr-staleness-audit.py

Validate the output artefact for the `adr-staleness-audit` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/adr-staleness-audit.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'adr-staleness-audit',
    'title': 'ADR Staleness Audit',
...
BAD = {"slug": "BAD_adr-staleness-audit", "owner": "someone"}
