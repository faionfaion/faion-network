#!/usr/bin/env python3
"""validate-architecture-proposal-document-template.py — validate architecture-proposal-document-template output against the 02-output-contract schema.
...
def main(argv: list[str]) -> int:
    p = argparse.ArgumentParser(
        prog="validate-architecture-proposal-document-template.py",
        description="Validate architecture-proposal-document-template output against 02-output-contract schema. Exit 0 on pass, 1 on fail, 2 on usage error.",
    )
