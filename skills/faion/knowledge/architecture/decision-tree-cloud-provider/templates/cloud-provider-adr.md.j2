...
Workload profile: <fill>. Existing investments: <fill>. Compliance constraints: <fill>.

## Decision Drivers

- Existing identity / productivity stack
- Dominant workload type
- Compliance certifications required
- 12-month cost envelope
...
Chosen provider: <fill>. Runner-up: <fill>.

Rationale: <fill>.

## Consequences

Good: <fill>. Bad: <fill>. Reversibility: one-way door (12-18 month migration).
