#!/usr/bin/env python3
"""validate-container-orchestration.py

Validate the output artefact for the `container-orchestration` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/container-orchestration.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'container-orchestration',
...
BAD = {"slug": "BAD_container-orchestration", "owner": "someone"}
