#!/usr/bin/env python3
"""validate-multi-tenancy-patterns.py

Validate the output artefact for the `multi-tenancy-patterns` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/multi-tenancy-patterns.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'multi-tenancy-patterns',
...
BAD = {"slug": "BAD_multi-tenancy-patterns", "owner": "someone"}
