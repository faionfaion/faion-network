<!--
purpose: Weekly report skeleton with hot-spots, debt-delta, risk-register, decision-needed
consumes: see AGENTS.md Prerequisites
produces: Architecture Health Weekly Report Template report
depends-on: content/02-output-contract.xml schema
token-budget-impact: ~400 tokens when filled
-->

# Architecture Health Weekly Report Template — arch-health-weekly.md
...
[Fill the report-shaped content here per content/02-output-contract.xml.]
