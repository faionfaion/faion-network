#!/usr/bin/env python3
"""validate-api-gateway-graphql.py — stdlib-only validator for the api-gateway-graphql output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'supergraph', 'limits', 'authentication']
...
OK_JSON = '{"artefact_id": "api-gateway-graphql-acme-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "supergraph": {"introspection": false, "listen": "0.0.0.0:4000"}, "limits": {"max_depth": 15, "max_aliases": 30, "max_root_fields": 20}, "authentication": {"router": {"jwt": {"header_name": "authorization"}}}}'
BAD_JSON = '{"owner": "team", "supergraph": {"introspection": true, "listen": "0.0.0.0:4000"}, "limits": {"max_depth": 99}}'
