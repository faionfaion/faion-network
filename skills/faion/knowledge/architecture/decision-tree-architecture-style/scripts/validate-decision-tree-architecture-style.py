#!/usr/bin/env python3
"""validate-decision-tree-architecture-style.py — stdlib-only validator for the decision-tree-architecture-style output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'adr_id', 'choice', 'inputs', 'alternatives_rejected', 'reversibility']
...
OK_JSON = '{"artefact_id": "architecture-style-shop-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "adr_id": "041", "choice": "modular-monolith", "inputs": {"team_size": 6, "deploy_frequency": "1/week", "devops_maturity": "medium"}, "alternatives_rejected": [{"option": "microservices", "reason": "team size + DevOps maturity insufficient"}], "reversibility": "partial_two_way"}'
BAD_JSON = '{"owner": "team", "choice": "magic", "inputs": {}, "alternatives_rejected": [], "reversibility": "two_way_door"}'
