...
<!-- depends-on: content/01-core-rules.xml#r3-decorator-cap -->
<!-- token-budget-impact: ~250 tokens when loaded as context -->
<!-- faion_header_json: {"__faion_header__":{"purpose":"Lint / convention enforcing decorator stack depth \u2264 2.","consumes":"see content/02-output-contract.xml","produces":"decision-record","depends_on":"content/01-core-rules.xml#r3-decorator-cap","token_budget_impact":"~250 tokens when loaded as context"}} -->
# Decorator Stack Cap
