#!/usr/bin/env python3
"""validate-api-gateway-security.py — stdlib-only validator for the api-gateway-security output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'tls', 'authentication', 'authorization', 'headers']
...
OK_JSON = '{"artefact_id": "api-gateway-security-acme-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "tls": {"min_version": "1.2"}, "authentication": {"jwt": {"issuer": "https://identity.example.com"}}, "authorization": {"default": "deny"}, "headers": {"x_content_type_options": "nosniff"}}'
BAD_JSON = '{"owner": "team", "tls": {"min_version": "1.0"}, "authorization": {"default": "allow"}}'
