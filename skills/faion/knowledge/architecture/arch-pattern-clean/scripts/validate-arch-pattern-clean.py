#!/usr/bin/env python3
"""validate-arch-pattern-clean.py — stdlib-only validator for the arch-pattern-clean output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'rings', 'dependency_rule_enforced']
...
OK_JSON = '{"artefact_id": "clean-layout-acme-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "rings": [{"name": "entities", "modules": ["domain"]}, {"name": "use-cases", "modules": ["application"]}, {"name": "adapters", "modules": ["adapters"]}, {"name": "frameworks", "modules": ["infrastructure"]}], "dependency_rule_enforced": true, "lint_tool": "importlinter"}'
BAD_JSON = '{"owner": "team", "rings": [{"name": "entities"}], "dependency_rule_enforced": false}'
