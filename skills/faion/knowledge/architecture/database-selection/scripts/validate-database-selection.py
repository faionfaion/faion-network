#!/usr/bin/env python3
"""validate-database-selection.py — stdlib-only validator for the database-selection output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'adr_id', 'chosen_db', 'scoring_matrix', 'alternatives_rejected', 'rollback_path', 'reversibility']
...
OK_JSON = '{"artefact_id": "db-selection-orders-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "adr_id": "031", "chosen_db": "PostgreSQL 16", "scoring_matrix": [{"db": "Postgres", "total": 18}, {"db": "Mongo", "total": 14}], "alternatives_rejected": [{"option": "Mongo", "reason": "weak transactional semantics for orders"}, {"option": "DynamoDB", "reason": "ops team has no AWS muscle memory"}], "rollback_path": {"engineering_weeks": 6, "dollars_contract_exit": 0}, "reversibility": "partial_two_way"}'
BAD_JSON = '{"owner": "team", "alternatives_rejected": [{"option": "Mongo"}], "reversibility": "maybe"}'
