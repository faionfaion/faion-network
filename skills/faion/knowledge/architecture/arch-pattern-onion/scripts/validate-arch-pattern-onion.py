#!/usr/bin/env python3
"""validate-arch-pattern-onion.py — stdlib-only validator for the arch-pattern-onion output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'layers', 'lint_enforced']
...
OK_JSON = '{"artefact_id": "onion-layout-shop-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "layers": [{"name": "domain-model", "modules": ["Domain.Model"]}, {"name": "domain-services", "modules": ["Domain.Services"]}, {"name": "application-services", "modules": ["Application.Services"]}, {"name": "infrastructure-ui-tests", "modules": ["Infrastructure", "UI", "Tests"]}], "lint_enforced": true}'
BAD_JSON = '{"owner": "team", "layers": [{"name": "core"}], "lint_enforced": false}'
