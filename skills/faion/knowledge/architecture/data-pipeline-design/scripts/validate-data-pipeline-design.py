#!/usr/bin/env python3
"""validate-data-pipeline-design.py

Validate the output artefact for the `data-pipeline-design` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/data-pipeline-design.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
BAD = {"slug": "BAD_data-pipeline-design", "owner": "someone"}
