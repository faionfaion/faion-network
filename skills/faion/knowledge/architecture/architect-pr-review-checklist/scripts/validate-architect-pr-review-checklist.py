#!/usr/bin/env python3
"""validate-architect-pr-review-checklist.py — stdlib-only validator for the architect-pr-review-checklist output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'pr_url', 'verdict', 'sections']
...
OK_JSON = '{"artefact_id": "architect-pr-review-acme-431", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "pr_url": "https://github.com/acme/api/pull/431", "verdict": "block", "sections": {"contract": "ok", "dependency_direction": "violation", "error_model": "ok", "observability": "ok", "security": "ok", "adr_conformance": "violation"}, "time_spent_minutes": 14}'
BAD_JSON = '{"owner": "team", "verdict": "lgtm", "sections": {}}'
