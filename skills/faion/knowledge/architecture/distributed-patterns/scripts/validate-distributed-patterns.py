#!/usr/bin/env python3
"""validate-distributed-patterns.py

Validate the output artefact for the `distributed-patterns` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/distributed-patterns.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
BAD = {"slug": "BAD_distributed-patterns", "owner": "someone"}
