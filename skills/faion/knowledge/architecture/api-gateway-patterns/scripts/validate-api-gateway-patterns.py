#!/usr/bin/env python3
"""validate-api-gateway-patterns.py — stdlib-only validator for the api-gateway-patterns output artefact.
...
OK_JSON = '{"artefact_id": "api-gateway-patterns-acme-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "adr_id": "017", "pattern": "bff", "product": "kong", "alternatives_rejected": [{"option": "envoy", "reason": "no managed UX; team has no Envoy operator"}]}'
BAD_JSON = '{"owner": "team", "pattern": "custom", "alternatives_rejected": []}'
