#!/usr/bin/env python3
"""validate-ai-agent-perimeter-policy.py

Validate the output artefact for the `ai-agent-perimeter-policy` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/ai-agent-perimeter-policy.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'ai-agent-perimeter-policy',
...
BAD = {"slug": "BAD_ai-agent-perimeter-policy", "owner": "someone"}
