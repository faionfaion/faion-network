#!/usr/bin/env python3
"""validate-security-adr-pack.py

Validate the output artefact for the `security-adr-pack` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/security-adr-pack.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'security-adr-pack',
    'title': 'Security ADR Pack',
...
BAD = {"slug": "BAD_security-adr-pack", "owner": "someone"}
