#!/usr/bin/env python3
"""validate-arch-pattern-hexagonal.py — stdlib-only validator for the arch-pattern-hexagonal output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'driving_ports', 'driven_ports', 'adapters', 'lint_enforced']
...
OK_JSON = '{"artefact_id": "hex-layout-shop-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "driving_ports": [{"name": "OrderInputPort"}], "driven_ports": [{"name": "OrderRepositoryPort"}, {"name": "PaymentPort"}], "adapters": [{"port": "OrderInputPort", "adapter": "HttpOrderController", "kind": "driving"}], "lint_enforced": true}'
BAD_JSON = '{"owner": "team", "driving_ports": [], "lint_enforced": false}'
