#!/usr/bin/env python3
"""validate-caching-architecture.py — stdlib-only validator for the caching-architecture output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'data_classes', 'single_flight', 'jitter_pct']
...
OK_JSON = '{"artefact_id": "caching-policy-shop-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "data_classes": [{"class": "product-detail", "pattern": "cache-aside", "ttl_seconds": 300, "invalidation": "on write"}], "single_flight": true, "jitter_pct": 10}'
BAD_JSON = '{"owner": "team", "data_classes": [{"class": "product", "pattern": "magic"}], "single_flight": false, "jitter_pct": 60}'
