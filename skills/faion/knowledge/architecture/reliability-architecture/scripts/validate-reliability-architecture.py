#!/usr/bin/env python3
"""validate-reliability-architecture.py

Validate the output artefact for the `reliability-architecture` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/reliability-architecture.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'reliability-architecture',
...
BAD = {"slug": "BAD_reliability-architecture", "owner": "someone"}
