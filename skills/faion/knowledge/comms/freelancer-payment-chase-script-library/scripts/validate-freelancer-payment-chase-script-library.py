#!/usr/bin/env python3
"""validate-freelancer-payment-chase-script-library.py — stdlib-only validator for the Freelancer Payment Chase Script Library checklist artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'items']
...
OK_JSON = """{"artefact_id": "freelancer-payment-chase-script-library-acme-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "items": [{"id": "c1", "statement": "Acknowledge the request before push-back", "done": true, "evidence": "drafts/acme-tweak-reply.md"}, {"id": "c2", "statement": "Reframe as change-order with concrete next step", "done": true}, {"id": "c3", "statement": "Log the send (engagement_id, scenario, phrasing_id)", "done": false}]}"""
BAD = {"owner": "team"}
