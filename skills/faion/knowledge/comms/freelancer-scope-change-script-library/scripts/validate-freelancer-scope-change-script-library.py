#!/usr/bin/env python3
"""validate-freelancer-scope-change-script-library.py

Validate a Freelancer Scope-Change Script Library artefact against the JSON Schema (draft-07) declared in
...
NUM_FIELDS = []
BOOL_FIELDS = []
ARRAY_FIELDS = ["options"]
OBJECT_FIELDS = []
STRING_FIELDS = ["situation_type", "empathy_line", "impact_line", "next_step", "trigger_quote"]
...
OK = {'artefact_id': 'freelancer-scope-change-script-library-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'situation_type': 'draft', 'empathy_line': 'draft', 'impact_line': 'draft', 'options': ['draft-item'], 'next_step': 'draft', 'trigger_quote': 'draft'}
BAD = {"foo": "bar"}
