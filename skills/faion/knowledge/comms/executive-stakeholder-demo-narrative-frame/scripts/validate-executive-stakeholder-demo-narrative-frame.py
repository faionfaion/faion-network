#!/usr/bin/env python3
"""validate-executive-stakeholder-demo-narrative-frame.py — stdlib-only validator for the Executive Stakeholder Demo Narrative Frame spec artefact.
