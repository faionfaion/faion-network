...
| File | Purpose |
|------|---------|
| `templates/executive-stakeholder-demo-narrative-frame.md.j2` | Working spec skeleton with 5-line header |
| `templates/executive-stakeholder-demo-narrative-frame.md` | Working spec skeleton with 5-line header Generated from `templates/executive-stakeholder-demo-narrative-frame.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
