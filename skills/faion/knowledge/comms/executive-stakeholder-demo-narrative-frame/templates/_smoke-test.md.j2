...
<!-- produces: artefact instance that MUST validate via scripts/validate-executive-stakeholder-demo-narrative-frame.py -->
<!-- depends-on: templates/executive-stakeholder-demo-narrative-frame.md, content/02-output-contract.xml -->
<!-- token-budget-impact: ~200 tokens -->

# Executive Stakeholder Demo Narrative Frame — Smoke Test Fixture

```json
{
  "artefact_id": "executive-stakeholder-demo-narrative-frame-acme-2026-05-23",
