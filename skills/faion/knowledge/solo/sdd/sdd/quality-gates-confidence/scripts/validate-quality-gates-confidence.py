#!/usr/bin/env python3
"""validate-quality-gates-confidence.py — validate a quality-gates-confidence output JSON against the methodology schema.
...
VALID_FIXTURE = json.loads('{"artefact_id": "quality-gates-confidence-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "owner": "@solo-founder", "subject": "subject of the report", "findings": ["finding-1", "finding-2", "finding-3"], "score": 0.82, "verdict": "pass"}')
