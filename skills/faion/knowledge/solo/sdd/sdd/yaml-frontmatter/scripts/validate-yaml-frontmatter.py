#!/usr/bin/env python3
"""validate-yaml-frontmatter.py — validate a yaml-frontmatter output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'owner', 'schema_version', 'settings']
ENUMS = {}
...
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'schema_version']
...
VALID_FIXTURE = json.loads('{"artefact_id": "yaml-frontmatter-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "owner": "@solo-founder", "schema_version": "1.0.0", "settings": {"key_a": "value-a", "key_b": true}}')
