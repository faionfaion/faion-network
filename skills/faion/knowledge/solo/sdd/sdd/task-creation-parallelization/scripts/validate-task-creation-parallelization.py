#!/usr/bin/env python3
"""validate-task-creation-parallelization.py — validate a task-creation-parallelization output JSON against the methodology schema.
...
VALID_FIXTURE = json.loads('{"artefact_id": "task-creation-parallelization-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "owner": "@solo-founder", "feature_id": "F-example", "summary": "One-paragraph problem + outcome statement.", "items": ["item-1", "item-2", "item-3"], "out_of_scope": ["item-x", "item-y"]}')
