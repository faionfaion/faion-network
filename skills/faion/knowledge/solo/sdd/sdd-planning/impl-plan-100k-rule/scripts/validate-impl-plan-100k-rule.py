#!/usr/bin/env python3
"""validate-impl-plan-100k-rule.py — validate a impl-plan-100k-rule output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'task_id', 'est_tokens', 'cap_exceeded', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['est_tokens', 'actual_tokens']
NUM_FIELDS = []
ARRAY_FIELDS = ['split_into']
OBJECT_FIELDS = []
BOOL_FIELDS = ['cap_exceeded']
STRING_FIELDS = ['artefact_id', 'task_id', 'exception_reason', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "impl-plan-100k-rule-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "task_id": "task_id value", "est_tokens": 1, "actual_tokens": 1, "cap_exceeded": true, "split_into": ["item-1", "item-2", "item-3"], "exception_reason": "exception_reason value", "owner": "@solo-founder"}')
