#!/usr/bin/env python3
"""validate-spec-example-ecommerce-cart.py — validate a spec-example-ecommerce-cart output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'archetype', 'example_path', 'fields_adapted', 'fields_kept', 'draft_spec_path', 'owner']
ENUMS = {'archetype': ['ecommerce-cart', 'none']}
...
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'example_path', 'draft_spec_path', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "spec-example-ecommerce-cart-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "archetype": "ecommerce-cart", "example_path": "example_path value", "fields_adapted": 1, "fields_kept": 1, "draft_spec_path": "draft_spec_path value", "owner": "@solo-founder"}')
