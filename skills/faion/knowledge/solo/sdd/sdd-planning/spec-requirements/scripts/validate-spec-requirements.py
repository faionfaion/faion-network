#!/usr/bin/env python3
"""validate-spec-requirements.py — validate a spec-requirements output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'requirements', 'frs_count', 'nfrs_count', 'vague_tokens_found', 'orphan_requirements', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['frs_count', 'nfrs_count']
NUM_FIELDS = []
ARRAY_FIELDS = ['requirements', 'vague_tokens_found', 'orphan_requirements']
OBJECT_FIELDS = []
BOOL_FIELDS = []
...
VALID_FIXTURE = json.loads('{"artefact_id": "spec-requirements-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "requirements": ["item-1", "item-2", "item-3"], "frs_count": 1, "nfrs_count": 1, "vague_tokens_found": ["item-1", "item-2", "item-3"], "orphan_requirements": ["item-1", "item-2", "item-3"], "owner": "@solo-founder"}')
