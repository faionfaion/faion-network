#!/usr/bin/env python3
"""validate-api-first-development.py — validate a api-first-development output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'spec_path', 'openapi_version', 'operation_ids', 'lint_status', 'breaking_changes', 'owner']
ENUMS = {'lint_status': ['pass', 'fail', 'warn']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['operation_ids', 'breaking_changes']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'spec_path', 'openapi_version', 'mock_server_url', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "api-first-development-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "spec_path": "spec_path value", "openapi_version": "openapi_version value", "operation_ids": ["item-1", "item-2", "item-3"], "lint_status": "pass", "mock_server_url": "mock_server_url value", "breaking_changes": ["item-1", "item-2", "item-3"], "owner": "@solo-founder"}')
