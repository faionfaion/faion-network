#!/usr/bin/env python3
"""validate-template-design.py — validate a template-design output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'template_path', 'sections_locked', 'lint_status', 'quarterly_review_date', 'back_compat_window_days', 'owner']
ENUMS = {'lint_status': ['pass', 'fail', 'warn']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed', 'quarterly_review_date']
INT_FIELDS = ['back_compat_window_days']
NUM_FIELDS = []
ARRAY_FIELDS = ['sections_locked']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'template_path', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "template-design-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "template_path": "template_path value", "sections_locked": ["item-1", "item-2", "item-3"], "lint_status": "pass", "quarterly_review_date": "2026-05-23", "back_compat_window_days": 1, "owner": "@solo-founder"}')
