#!/usr/bin/env python3
"""validate-template-spec.py — validate a template-spec output JSON against the methodology schema.
...
VALID_FIXTURE = json.loads('{"artefact_id": "template-spec-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "template_path": "template_path value", "sections_locked": ["item-1", "item-2", "item-3"], "lint_status": "pass", "quarterly_review_date": "2026-05-23", "back_compat_window_days": 1, "owner": "@solo-founder"}')
