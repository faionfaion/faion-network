#!/usr/bin/env python3
"""validate-design-doc-writing-process.py — validate a design-doc-writing-process output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'doc_path', 'passes_completed', 'reviewer', 'review_sla_hours', 'comments_total', 'comments_resolved', 'sign_off', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['review_sla_hours', 'comments_total', 'comments_resolved']
NUM_FIELDS = []
ARRAY_FIELDS = ['passes_completed']
OBJECT_FIELDS = ['sign_off']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'doc_path', 'reviewer', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "design-doc-writing-process-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "doc_path": "doc_path value", "passes_completed": ["item-1", "item-2", "item-3"], "reviewer": "reviewer value", "review_sla_hours": 1, "comments_total": 1, "comments_resolved": 1, "sign_off": {"key": "value"}, "owner": "@solo-founder"}')
