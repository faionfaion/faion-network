#!/usr/bin/env python3
"""validate-impl-plan-examples.py — validate a impl-plan-examples output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'archetype', 'example_path', 'tasks_adapted', 'tasks_kept', 'draft_plan_path', 'owner']
ENUMS = {'archetype': ['greenfield', 'refactor', 'migration', 'infra', 'none']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['tasks_adapted', 'tasks_kept']
NUM_FIELDS = []
ARRAY_FIELDS = []
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'example_path', 'draft_plan_path', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "impl-plan-examples-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "archetype": "greenfield", "example_path": "example_path value", "tasks_adapted": 1, "tasks_kept": 1, "draft_plan_path": "draft_plan_path value", "owner": "@solo-founder"}')
