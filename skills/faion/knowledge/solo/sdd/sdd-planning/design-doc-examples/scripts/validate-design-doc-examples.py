#!/usr/bin/env python3
"""validate-design-doc-examples.py — validate a design-doc-examples output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'archetype', 'example_path', 'fields_adapted', 'fields_kept', 'draft_doc_path', 'owner']
ENUMS = {'archetype': ['single-service', 'cross-service', 'migration', 'hot-path', 'none']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['fields_adapted', 'fields_kept']
NUM_FIELDS = []
ARRAY_FIELDS = []
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'example_path', 'draft_doc_path', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "design-doc-examples-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "archetype": "single-service", "example_path": "example_path value", "fields_adapted": 1, "fields_kept": 1, "draft_doc_path": "draft_doc_path value", "owner": "@solo-founder"}')
