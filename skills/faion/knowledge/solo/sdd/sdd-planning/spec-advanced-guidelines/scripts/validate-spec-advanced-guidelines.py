#!/usr/bin/env python3
"""validate-spec-advanced-guidelines.py — validate a spec-advanced-guidelines output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'base_spec_path', 'triggers_fired', 'blocks_included', 'versioning', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = ['ac_rubric_score']
ARRAY_FIELDS = ['triggers_fired', 'blocks_included', 'nfrs', 'glossary_terms']
OBJECT_FIELDS = ['versioning']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'base_spec_path', 'content_id', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "spec-advanced-guidelines-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "base_spec_path": "base_spec_path value", "triggers_fired": ["item-1", "item-2", "item-3"], "blocks_included": ["item-1", "item-2", "item-3"], "nfrs": ["item-1", "item-2", "item-3"], "ac_rubric_score": 1.0, "glossary_terms": ["item-1", "item-2", "item-3"], "versioning": {"key": "value"}, "content_id": "content_id value", "owner": "@solo-founder"}')
