#!/usr/bin/env python3
"""validate-freelancer-weekly-report-template.py

Validate a Freelancer Weekly Report Template artefact against the JSON Schema (draft-07) declared in
...
NUM_FIELDS = []
BOOL_FIELDS = []
ARRAY_FIELDS = ["shipped", "next", "risks", "asks"]
OBJECT_FIELDS = []
STRING_FIELDS = ["report_week", "client", "cadence_anchor"]
...
OK = {'artefact_id': 'freelancer-weekly-report-template-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'report_week': 'draft', 'shipped': ['draft-item'], 'next': ['draft-item'], 'risks': ['draft-item'], 'asks': ['draft-item'], 'client': 'draft', 'cadence_anchor': 'draft'}
BAD = {"foo": "bar"}
