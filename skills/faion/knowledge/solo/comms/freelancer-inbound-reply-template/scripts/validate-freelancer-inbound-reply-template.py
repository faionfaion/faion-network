#!/usr/bin/env python3
"""validate-freelancer-inbound-reply-template.py

Validate a Freelancer Inbound Reply Template artefact against the JSON Schema (draft-07) declared in
...
ARRAY_FIELDS = []
OBJECT_FIELDS = []
STRING_FIELDS = ["acknowledge_line", "qualifier_line", "trust_signal", "next_step", "channel", "sender_excerpt"]
...
OK = {'artefact_id': 'freelancer-inbound-reply-template-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'acknowledge_line': 'draft', 'qualifier_line': 'draft', 'trust_signal': 'draft', 'next_step': 'draft', 'channel': 'draft', 'sender_excerpt': 'draft'}
BAD = {"foo": "bar"}
