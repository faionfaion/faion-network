#!/usr/bin/env python3
"""validate-scope-creep-park-list-template.py — stdlib-only validator for the scope-creep-park-list-template output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'walkthrough_session_id', 'sprint_scope', 'rows']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['rows', 'revisit_outcomes']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'walkthrough_session_id', 'sprint_scope']
...
VALID_FIXTURE = json.loads('{"artefact_id": "scope-creep-park-list-template-example", "owner": "@solo-founder", "version": "1.0.0", "last_reviewed": "2026-05-23", "walkthrough_session_id": "walkthrough_session_id value", "sprint_scope": "sprint_scope value", "rows": ["item-1", "item-2", "item-3"], "revisit_outcomes": ["item-1", "item-2", "item-3"]}')
