#!/usr/bin/env python3
"""validate-prototype-iteration-log-template.py — stdlib-only validator for the prototype-iteration-log-template output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'row_id', 'flow_name', 'problem', 'hypothesis', 'variant', 'evidence_link', 'outcome', 'next']
ENUMS = {'outcome': ['kept', 'rolled-back', 'shipped-with-changes']}
...
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'row_id', 'flow_name', 'problem', 'hypothesis', 'variant', 'evidence_link', 'next']
...
VALID_FIXTURE = json.loads('{"artefact_id": "prototype-iteration-log-template-example", "owner": "@solo-founder", "version": "1.0.0", "last_reviewed": "2026-05-23", "row_id": "row_id value", "flow_name": "flow_name value", "problem": "problem value", "hypothesis": "hypothesis value", "variant": "variant value", "evidence_link": "evidence_link value", "outcome": "kept", "next": "next value"}')
