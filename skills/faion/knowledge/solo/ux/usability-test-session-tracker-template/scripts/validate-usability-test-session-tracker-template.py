#!/usr/bin/env python3
"""validate-usability-test-session-tracker-template.py

Validate a Usability Test Session Tracker Template artefact against the JSON Schema (draft-07) defined in
