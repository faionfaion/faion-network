#!/usr/bin/env python3
"""validate-spatial-ux-fundamentals.py — stdlib-only validator for the spatial-ux-fundamentals output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'device_target', 'field_of_view_deg', 'zones', 'affordance_method', 'motion_velocity_cap_mps', 'session_duration_minutes']
ENUMS = {'affordance_method': ['depth', 'parallax', 'occlusion', 'color', 'shape']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['field_of_view_deg', 'session_duration_minutes']
NUM_FIELDS = ['motion_velocity_cap_mps']
ARRAY_FIELDS = []
OBJECT_FIELDS = ['zones']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'device_target']
...
VALID_FIXTURE = json.loads('{"artefact_id": "spatial-ux-fundamentals-example", "owner": "@solo-founder", "version": "1.0.0", "last_reviewed": "2026-05-23", "device_target": "device_target value", "field_of_view_deg": 1, "zones": {"key": "value"}, "affordance_method": "depth", "motion_velocity_cap_mps": 1.0, "session_duration_minutes": 1}')
