...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'screen_name', 'information_hierarchy', 'layout_grid', 'primary_actions', 'content_slots', 'fidelity_level']
ENUMS = {'fidelity_level': ['wireframe', 'mid', 'high']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['information_hierarchy', 'primary_actions', 'content_slots']
OBJECT_FIELDS = ['layout_grid']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'screen_name']
...
VALID_FIXTURE = json.loads('{"artefact_id": "wireframing-example", "owner": "@solo-founder", "version": "1.0.0", "last_reviewed": "2026-05-23", "screen_name": "screen_name value", "information_hierarchy": ["item-1", "item-2", "item-3"], "layout_grid": {"key": "value"}, "primary_actions": ["item-1", "item-2", "item-3"], "content_slots": ["item-1", "item-2", "item-3"], "fidelity_level": "wireframe"}')
