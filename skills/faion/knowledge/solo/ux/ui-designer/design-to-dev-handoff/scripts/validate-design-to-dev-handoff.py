#!/usr/bin/env python3
"""validate-design-to-dev-handoff.py — stdlib-only validator for the design-to-dev-handoff output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'component_or_flow', 'spec_link', 'video_link', 'acceptance_criteria', 'sync_date', 'eng_owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed', 'sync_date']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['acceptance_criteria']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'component_or_flow', 'spec_link', 'video_link', 'eng_owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "design-to-dev-handoff-example", "owner": "@solo-founder", "version": "1.0.0", "last_reviewed": "2026-05-23", "component_or_flow": "component_or_flow value", "spec_link": "spec_link value", "video_link": "video_link value", "acceptance_criteria": ["item-1", "item-2", "item-3"], "sync_date": "2026-05-23", "eng_owner": "eng_owner value"}')
