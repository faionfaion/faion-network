...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'tokens_json_path', 'tailwind_config_path', 'dark_mode_strategy', 'arbitrary_value_count', 'ci_lint_status']
ENUMS = {'dark_mode_strategy': ['class', 'media', 'none'], 'ci_lint_status': ['pass', 'fail', 'warn']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['arbitrary_value_count']
NUM_FIELDS = []
ARRAY_FIELDS = []
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'tokens_json_path', 'tailwind_config_path']
...
VALID_FIXTURE = json.loads('{"artefact_id": "tailwind-design-tokens-example", "owner": "@solo-founder", "version": "1.0.0", "last_reviewed": "2026-05-23", "tokens_json_path": "tokens_json_path value", "tailwind_config_path": "tailwind_config_path value", "dark_mode_strategy": "class", "arbitrary_value_count": 1, "ci_lint_status": "pass"}')
