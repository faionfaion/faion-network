#!/usr/bin/env python3
"""validate-handoff-spec-template.py — stdlib-only validator for the handoff-spec-template output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'component_name', 'figma_url', 'code_map', 'states', 'tokens_used', 'motion', 'accessibility', 'edge_cases']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['tokens_used', 'motion', 'edge_cases']
OBJECT_FIELDS = ['code_map', 'states', 'accessibility']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'component_name', 'figma_url']
...
VALID_FIXTURE = json.loads('{"artefact_id": "handoff-spec-template-example", "owner": "@solo-founder", "version": "1.0.0", "last_reviewed": "2026-05-23", "component_name": "component_name value", "figma_url": "figma_url value", "code_map": {"key": "value"}, "states": {"key": "value"}, "tokens_used": ["item-1", "item-2", "item-3"], "motion": ["item-1", "item-2", "item-3"], "accessibility": {"key": "value"}, "edge_cases": ["item-1", "item-2", "item-3"]}')
