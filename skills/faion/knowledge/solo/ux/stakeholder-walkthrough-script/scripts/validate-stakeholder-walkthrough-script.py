#!/usr/bin/env python3
"""validate-stakeholder-walkthrough-script.py — stdlib-only validator for the stakeholder-walkthrough-script output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'session_id', 'decision_ask', 'options_presented', 'signed_decision', 'parked_rows']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['options_presented', 'parked_rows']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'session_id', 'decision_ask', 'signed_decision', 'recap_link']
...
VALID_FIXTURE = json.loads('{"artefact_id": "stakeholder-walkthrough-script-example", "owner": "@solo-founder", "version": "1.0.0", "last_reviewed": "2026-05-23", "session_id": "session_id value", "decision_ask": "decision_ask value", "options_presented": ["item-1", "item-2", "item-3"], "signed_decision": "signed_decision value", "parked_rows": ["item-1", "item-2", "item-3"], "recap_link": "recap_link value"}')
