#!/usr/bin/env python3
"""validate-critical-issue-triage-protocol.py — stdlib-only validator for the critical-issue-triage-protocol output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'session_id', 'sample_size_n', 'findings', 'actions_summary']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['sample_size_n']
NUM_FIELDS = []
ARRAY_FIELDS = ['findings', 'overrides']
OBJECT_FIELDS = ['actions_summary']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'session_id']
...
VALID_FIXTURE = json.loads('{"artefact_id": "critical-issue-triage-protocol-example", "owner": "@solo-founder", "version": "1.0.0", "last_reviewed": "2026-05-23", "session_id": "session_id value", "sample_size_n": 1, "findings": ["item-1", "item-2", "item-3"], "actions_summary": {"key": "value"}, "overrides": ["item-1", "item-2", "item-3"]}')
