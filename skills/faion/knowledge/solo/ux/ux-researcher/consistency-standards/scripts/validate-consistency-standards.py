#!/usr/bin/env python3
"""validate-consistency-standards.py

Validate a Consistency and Standards artefact against the JSON Schema (draft-07) defined in
...
OK = {
    "artefact_id": "consistency-standards-2026-05-23",
