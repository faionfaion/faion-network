#!/usr/bin/env python3
"""validate-journey-mapping.py — validate a journey-mapping output JSON against the methodology schema.
...
VALID_FIXTURE = json.loads('{"artefact_id": "journey-mapping-example", "scope": "Scope of the spec \\u2014 one paragraph.", "decisions": ["item-1", "item-2", "item-3"], "stakeholders": ["item-1", "item-2"], "open_questions": ["item-1"], "version": "1.0.0", "last_reviewed": "2026-05-23", "lint_status": "pass", "owner": "@solo-founder"}')
