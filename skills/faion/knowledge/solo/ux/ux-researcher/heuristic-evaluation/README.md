...
|------|-------|----------|
| Heuristic evaluation | haiku | Pattern application: checking against established usability heuristics |

## Sources

- [10 Usability Heuristics](https://www.nngroup.com/articles/ten-usability-heuristics/) - Nielsen Norman Group original
- [How to Conduct Heuristic Evaluation](https://www.nngroup.com/articles/how-to-conduct-a-heuristic-evaluation/) - NNG methodology
- [Usability Inspection Methods](https://www.nngroup.com/articles/usability-inspection-methods/) - Nielsen & Mack
- [Heuristic Evaluation Checklist](https://www.interaction-design.org/literature/article/heuristic-evaluation-how-to-conduct-a-heuristic-evaluation) - IDF guide
- [Beyond Nielsen's Heuristics](https://jnd.org/heuristic-evaluation-considered-harmful/) - Don Norman critique and evolution
