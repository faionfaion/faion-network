...
summary: A reference combining three validation lenses: Problem Validation (evidence hierarchy + 5-step process + PROCEED/PIVOT/KILL decision), Pain Point Mining (tiered source strategy + Pain Intensity Matrix scoring), and Niche Viability Scoring (5-criteria weighted model: market size 25%, competition 20%, barriers 20%, profitability 20%, your fit 15%).
