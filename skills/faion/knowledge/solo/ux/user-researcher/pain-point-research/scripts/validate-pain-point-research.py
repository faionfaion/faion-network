#!/usr/bin/env python3
"""validate-pain-point-research.py

Validate a Pain Point Research artefact against the JSON Schema (draft-07) defined in
...
OK = {
    "artefact_id": "pain-point-research-2026-05-23",
