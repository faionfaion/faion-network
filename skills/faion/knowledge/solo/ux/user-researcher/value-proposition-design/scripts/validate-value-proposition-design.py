#!/usr/bin/env python3
"""validate-value-proposition-design.py

Validate a Value Proposition Design artefact against the JSON Schema (draft-07) defined in
...
OK = {
    "artefact_id": "value-proposition-design-2026-05-23",
