#!/usr/bin/env python3
"""validate-design-decision-log-template.py — stdlib-only validator for the design-decision-log-template output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'row_id', 'context', 'decision', 'alternatives', 'thread_link', 'status']
ENUMS = {'status': ['Accepted', 'Superseded', 'Deprecated']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['alternatives']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'row_id', 'context', 'decision', 'thread_link', 'supersedes']
...
VALID_FIXTURE = json.loads('{"artefact_id": "design-decision-log-template-example", "owner": "@solo-founder", "version": "1.0.0", "last_reviewed": "2026-05-23", "row_id": "row_id value", "context": "context value", "decision": "decision value", "alternatives": ["item-1", "item-2", "item-3"], "thread_link": "thread_link value", "status": "Accepted", "supersedes": "supersedes value"}')
