#!/usr/bin/env python3
"""validate-pattern-bank-tagging-schema.py — stdlib-only validator for the pattern-bank-tagging-schema output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'entry_id', 'surface', 'intent', 'pattern_type', 'severity', 'source_link']
ENUMS = {'surface': ['auth', 'checkout', 'dashboard', 'nav', 'onboarding', 'settings', 'profile', 'search', 'content', 'empty-state', 'error', 'a11y'], 'intent': ['educate', 'persuade', 'confirm', 'warn', 'delight', 'navigate', 'input', 'feedback'], 'pattern_type': ['anti', 'good', 'neutral'], 'severity': ['0', '1', '2', '3', '4']}
...
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'entry_id', 'source_link']
...
VALID_FIXTURE = json.loads('{"artefact_id": "pattern-bank-tagging-schema-example", "owner": "@solo-founder", "version": "1.0.0", "last_reviewed": "2026-05-23", "entry_id": "entry_id value", "surface": "auth", "intent": "educate", "pattern_type": "anti", "severity": "0", "source_link": "source_link value"}')
