#!/usr/bin/env python3
"""validate-information-architecture.py — validate a information-architecture output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'scope', 'decisions', 'stakeholders', 'open_questions', 'version', 'last_reviewed', 'lint_status', 'owner']
ENUMS = {'lint_status': ['pass', 'fail', 'warn']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
ARRAY_FIELDS = ['decisions', 'stakeholders', 'open_questions']
OBJECT_FIELDS = []
...
VALID_FIXTURE = json.loads('{"artefact_id": "information-architecture-example", "scope": "Scope of the spec \\u2014 one paragraph.", "decisions": ["item-1", "item-2", "item-3"], "stakeholders": ["item-1", "item-2"], "open_questions": ["item-1"], "version": "1.0.0", "last_reviewed": "2026-05-23", "lint_status": "pass", "owner": "@solo-founder"}')
