#!/usr/bin/env python3
"""validate-competitive-analysis.py — validate a competitive-analysis output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'method', 'sample_size', 'findings', 'severity_breakdown', 'recommendations', 'version', 'last_reviewed', 'lint_status', 'owner']
ENUMS = {'lint_status': ['pass', 'fail', 'warn']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['sample_size']
ARRAY_FIELDS = ['findings', 'recommendations']
OBJECT_FIELDS = ['severity_breakdown']
STRING_FIELDS = ['artefact_id', 'method', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "competitive-analysis-example", "method": "Method used for the report (e.g. interview / heuristic / test).", "sample_size": 6, "findings": ["item-1", "item-2", "item-3"], "severity_breakdown": {"high": 1, "medium": 2, "low": 0}, "recommendations": ["item-1", "item-2"], "version": "1.0.0", "last_reviewed": "2026-05-23", "lint_status": "pass", "owner": "@solo-founder"}')
