...
summary: User interviews are one-on-one conversations with users or potential users to understand needs, behaviors, motivations, and pain points.
content_id: "aaa39d6a3d30e128"
tags: [user-research, interviews, qualitative, discovery, insights]
---
# User Interviews

## Summary

**One-sentence:** User interviews are one-on-one conversations with users or potential users to understand needs, behaviors, motivations, and pain points.

**One-paragraph:** User interviews are one-on-one conversations with users or potential users to understand needs, behaviors, motivations, and pain points. They are qualitative and exploratory — they reveal the "why" behind observed behaviors. 5-8 participants per distinct user segment is the practical threshold for theme saturation.
