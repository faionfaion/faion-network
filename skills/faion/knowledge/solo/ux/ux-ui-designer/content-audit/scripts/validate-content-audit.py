#!/usr/bin/env python3
"""validate-content-audit.py — validate a content-audit output JSON against the methodology schema.
...
VALID_FIXTURE = json.loads('{"artefact_id": "content-audit-example", "method": "Method used for the report (e.g. interview / heuristic / test).", "sample_size": 6, "findings": ["item-1", "item-2", "item-3"], "severity_breakdown": {"high": 1, "medium": 2, "low": 0}, "recommendations": ["item-1", "item-2"], "version": "1.0.0", "last_reviewed": "2026-05-23", "lint_status": "pass", "owner": "@solo-founder"}')
