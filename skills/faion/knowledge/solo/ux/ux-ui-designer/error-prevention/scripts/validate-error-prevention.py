#!/usr/bin/env python3
"""validate-error-prevention.py — validate a error-prevention output JSON against the methodology schema.
...
VALID_FIXTURE = json.loads('{"artefact_id": "error-prevention-example", "scope": "Scope of the checklist \\u2014 one paragraph.", "checks": ["item-1", "item-2", "item-3"], "blocking_count": 5, "advisory_count": 3, "version": "1.0.0", "last_reviewed": "2026-05-23", "lint_status": "pass", "owner": "@solo-founder"}')
