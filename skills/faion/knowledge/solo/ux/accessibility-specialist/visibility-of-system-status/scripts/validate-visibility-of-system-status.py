#!/usr/bin/env python3
"""validate-visibility-of-system-status.py — validate a visibility-of-system-status output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'owner', 'subject', 'criteria', 'overall']
ENUMS = {}
...
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'subject']
...
VALID_FIXTURE = json.loads('{"artefact_id": "visibility-of-system-status-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "owner": "@solo-founder", "subject": "subject under review", "criteria": [{"id": "c1", "score": 4, "weight": 1.0}, {"id": "c2", "score": 3, "weight": 1.0}], "overall": 0.75}')
