<!-- purpose: minimal Deterministic Test Data Pattern artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: code artefact validated by scripts/validate-deterministic-test-data-pattern.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Deterministic Test Data Pattern — Artefact

| Field | Value |
|-------|-------|
| artefact_id | deterministic-test-data-pattern-YYYY-MM-DD |
