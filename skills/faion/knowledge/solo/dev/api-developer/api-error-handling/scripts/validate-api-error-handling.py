...
Validate a API Error Handling artefact against the JSON Schema (draft-07) declared in
...
INT_FIELDS = []
NUM_FIELDS = []
BOOL_FIELDS = ["field_level_validation", "raw_exception_banned"]
ARRAY_FIELDS = ["error_catalogue", "evidence"]
OBJECT_FIELDS = []
STRING_FIELDS = ["api_id", "envelope_standard", "type_uri_base", "trace_header", "status"]
...
OK = {'artefact_id': 'api-error-handling-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'api_id': 'draft', 'envelope_standard': 'draft', 'type_uri_base': 'draft', 'trace_header': 'draft', 'error_catalogue': ['draft-item'], 'field_level_validation': True, 'raw_exception_banned': True}
BAD = {"foo": "bar"}
