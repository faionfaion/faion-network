...
Validate a API Documentation artefact against the JSON Schema (draft-07) declared in
...
INT_FIELDS = ["examples_per_endpoint"]
NUM_FIELDS = []
BOOL_FIELDS = []
ARRAY_FIELDS = ["sections", "evidence"]
OBJECT_FIELDS = []
STRING_FIELDS = ["api_id", "publisher", "error_catalogue_ref", "changelog_url", "freshness_check", "status"]
...
OK = {'artefact_id': 'api-documentation-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'api_id': 'draft', 'publisher': 'draft', 'sections': ['draft-item'], 'examples_per_endpoint': 1, 'error_catalogue_ref': 'draft', 'changelog_url': 'draft', 'freshness_check': 'draft'}
BAD = {"foo": "bar"}
