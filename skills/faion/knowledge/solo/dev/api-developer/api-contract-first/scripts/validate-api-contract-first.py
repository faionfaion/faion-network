...
Validate a API Contract-First Workflow artefact against the JSON Schema (draft-07) declared in
...
NUM_FIELDS = []
BOOL_FIELDS = []
ARRAY_FIELDS = ["ci_gates", "consumer_sdks", "evidence"]
OBJECT_FIELDS = []
STRING_FIELDS = ["api_id", "spec_path", "generator", "runtime_validator", "status"]
...
OK = {'artefact_id': 'api-contract-first-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'api_id': 'draft', 'spec_path': 'draft', 'generator': 'draft', 'ci_gates': ['draft-item'], 'runtime_validator': 'draft', 'consumer_sdks': ['draft-item']}
BAD = {"foo": "bar"}
