#!/usr/bin/env python3
"""validate-timeboxed-refactor-session-template.py — validate a timeboxed-refactor-session-template output JSON against the methodology schema.
...
VALID_FIXTURE = {
    "artefact_id": "timeboxed-refactor-session-template-2026-q2",
    "version": "1.1.0",
