#!/usr/bin/env python3
"""validate-flaky-test-triage-playbook.py

Validate a Flaky Test Triage Playbook artefact against the JSON Schema (draft-07) defined in
...
OK = {'artefact_id': 'flaky-test-triage-playbook-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'rows': ['item-1'], 'cadence': 'draft', 'triage_date': 'draft'}
