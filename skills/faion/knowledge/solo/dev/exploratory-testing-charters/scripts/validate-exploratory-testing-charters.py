#!/usr/bin/env python3
"""validate-exploratory-testing-charters.py

Validate a Exploratory Testing Charters artefact against the JSON Schema (draft-07) defined in
...
OK = {'artefact_id': 'exploratory-testing-charters-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'mission': 'draft', 'timebox': 'draft', 'threats': ['item-1', {'key': 'value-1'}, {'key': 'value-2'}], 'debrief': {'key': 'value'}}
