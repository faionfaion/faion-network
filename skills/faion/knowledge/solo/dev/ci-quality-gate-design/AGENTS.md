...
summary: Produces a ci-design.md artefact classifying every check into BLOCK/WARN/NIGHTLY tiers with a per-PR wall-clock budget (target <10 min) and written rationale per check.
