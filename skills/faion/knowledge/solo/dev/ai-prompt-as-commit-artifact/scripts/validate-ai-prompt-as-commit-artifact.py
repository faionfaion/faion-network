#!/usr/bin/env python3
"""validate-ai-prompt-as-commit-artifact.py

Validate a AI Prompt as Commit Artefact artefact against the JSON Schema (draft-07) declared in
...
NUM_FIELDS = []
BOOL_FIELDS = []
ARRAY_FIELDS = ["context_refs"]
OBJECT_FIELDS = []
STRING_FIELDS = ["commit_sha", "prompt", "model", "verifier", "author", "status"]
...
OK = {'artefact_id': 'ai-prompt-as-commit-artifact-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'commit_sha': 'draft', 'prompt': 'draft', 'model': 'draft', 'context_refs': ['draft-item'], 'verifier': 'draft', 'author': 'draft'}
BAD = {"foo": "bar"}
