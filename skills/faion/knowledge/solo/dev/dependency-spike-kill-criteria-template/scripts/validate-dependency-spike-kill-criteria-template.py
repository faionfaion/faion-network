#!/usr/bin/env python3
"""validate-dependency-spike-kill-criteria-template.py

Validate a Dependency Spike Kill-Criteria Template artefact against the JSON Schema (draft-07) defined in
...
OK = {'artefact_id': 'dependency-spike-kill-criteria-template-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'criteria': [{'key': 'value'}, {'key': 'value-1'}, {'key': 'value-2'}], 'timebox': 'draft', 'verdict': 'draft', 'rationale': 'draft', 'dependency_name': 'draft'}
