#!/usr/bin/env python3
"""validate-shadcn-ui-architecture.py

Validate an artefact produced by the shadcn-ui-architecture methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/shadcn-ui-architecture.json", "type": "object", "required": ["primitive_dir", "token_source", "variant_policy", "lint_rules", "codeowners_path"], "properties": {"primitive_dir": {"type": "string"}, "token_source": {"type": "string"}, "variant_policy": {"type": "object", "required": ["max_variants_per_prop", "compound_variants_required"]}, "lint_rules": {"type": "array", "minItems": 1, "items": {"type": "string"}}, "codeowners_path": {"type": "string"}, "asChild_required": {"type": "boolean"}}}')
