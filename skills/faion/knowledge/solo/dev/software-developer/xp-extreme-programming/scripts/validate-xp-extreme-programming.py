...
Validate an artefact produced by the xp-extreme-programming methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/xp-extreme-programming.json", "type": "object", "required": ["adoption_order", "practices", "ci_max_minutes", "release_cadence_days", "customer_access"], "properties": {"adoption_order": {"type": "array", "minItems": 1, "items": {"type": "string"}}, "practices": {"type": "object", "required": ["tdd", "pairing", "trunk_based", "refactoring", "small_releases"]}, "ci_max_minutes": {"type": "integer", "maximum": 10}, "release_cadence_days": {"type": "integer", "maximum": 14}, "customer_access": {"type": "object", "required": ["named_person", "sla_hours"]}, "metrics": {"type": "object"}}}')
