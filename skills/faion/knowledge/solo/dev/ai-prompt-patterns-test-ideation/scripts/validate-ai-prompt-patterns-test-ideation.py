#!/usr/bin/env python3
"""validate-ai-prompt-patterns-test-ideation.py

Validate a AI Prompt Patterns for Test Ideation artefact against the JSON Schema (draft-07) declared in
...
INT_FIELDS = []
NUM_FIELDS = ["coverage_target"]
BOOL_FIELDS = []
ARRAY_FIELDS = ["patterns_used", "boundary_cases", "oracles", "mutations_caught", "evidence"]
OBJECT_FIELDS = []
STRING_FIELDS = ["function_id"]
...
OK = {'artefact_id': 'ai-prompt-patterns-test-ideation-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'function_id': 'draft', 'patterns_used': ['draft-item'], 'boundary_cases': ['draft-item'], 'oracles': ['draft-item'], 'mutations_caught': ['draft-item'], 'coverage_target': 1.0}
BAD = {"foo": "bar"}
