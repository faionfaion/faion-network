#!/usr/bin/env python3
"""validate-test-as-living-documentation.py

Validate an artefact produced by the test-as-living-documentation methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/test-as-living-documentation.json", "type": "object", "required": ["artefact_id", "owner", "ac_corpus_link", "framework", "docs_url", "ac_coverage_pct", "version", "last_reviewed"], "properties": {"artefact_id": {"type": "string", "minLength": 1}, "owner": {"type": "string", "minLength": 1}, "ac_corpus_link": {"type": "string", "minLength": 1}, "framework": {"type": "string", "enum": ["cucumber", "behave", "specflow", "pytest-bdd", "custom"]}, "docs_url": {"type": "string", "minLength": 1}, "ac_coverage_pct": {"type": "number", "minimum": 0, "maximum": 100}, "stakeholder_review_date": {"type": "string"}, "version": {"type": "string", "minLength": 1}, "last_reviewed": {"type": "string", "minLength": 1}}}')
