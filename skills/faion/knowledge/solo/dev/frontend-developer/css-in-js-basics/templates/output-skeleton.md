<!-- purpose: minimal CSS-in-JS Basics artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: code artefact validated by scripts/validate-css-in-js-basics.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# CSS-in-JS Basics — Artefact

| Field | Value |
|-------|-------|
| artefact_id | css-in-js-basics-YYYY-MM-DD |
