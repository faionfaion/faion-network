<!-- purpose: minimal shadcn/ui Architecture artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-shadcn-ui-architecture.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# shadcn/ui Architecture — Artefact

| Field | Value |
|-------|-------|
| artefact_id | shadcn-ui-architecture-YYYY-MM-DD |
...
- [ ] `scripts/validate-shadcn-ui-architecture.py --file artefact.json` exits 0
