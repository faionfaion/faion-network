#!/usr/bin/env python3
"""validate-pwa-core.py

Validate a PWA Core Architecture artefact against the JSON Schema (draft-07) declared in
...
OK = {'artefact_id': 'pwa-core-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'title': 'draft', 'scope': ['draft-item'], 'decisions': {'key': 'value'}}
BAD = {"foo": "bar"}
