#!/usr/bin/env python3
"""validate-tailwind.py

Validate a Tailwind CSS artefact against the JSON Schema (draft-07) declared in
...
OK = {'artefact_id': 'tailwind-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'evidence': [{'source': 'https://example.com/source-1', 'citation': 'verbatim quote from source'}], 'config_id': 'draft', 'settings': {'key': 'value'}, 'applies_to': ['draft-target']}
BAD = {"foo": "bar"}
