<!-- purpose: minimal Accessibility artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-accessibility.py -->
...
| Field | Value |
|-------|-------|
| artefact_id | accessibility-YYYY-MM-DD |
