<!-- purpose: minimal Tailwind Patterns with CVA artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-tailwind-patterns.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Tailwind Patterns with CVA — Artefact

| Field | Value |
|-------|-------|
| artefact_id | tailwind-patterns-YYYY-MM-DD |
...
- [ ] `scripts/validate-tailwind-patterns.py --file artefact.json` exits 0
