<!-- purpose: minimal Accessibility as Code artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: code artefact validated by scripts/validate-accessibility-as-code.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Accessibility as Code — Artefact

| Field | Value |
|-------|-------|
| artefact_id | accessibility-as-code-YYYY-MM-DD |
