<!-- purpose: minimal shadcn/ui artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-shadcn-ui.py -->
...
| Field | Value |
|-------|-------|
| artefact_id | shadcn-ui-YYYY-MM-DD |
...
- [ ] `scripts/validate-shadcn-ui.py --file artefact.json` exits 0
