#!/usr/bin/env python3
"""validate-creational-patterns.py — stdlib-only validator for the creational-patterns output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'construction_hotspot', 'pattern', 'di_scope']
...
OK_JSON = '{"artefact_id": "creational-pattern-payment-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "construction_hotspot": "payments.create_processor", "pattern": "AbstractFactory", "di_scope": "request"}'
BAD_JSON = '{"owner": "team", "pattern": "Magic", "di_scope": "global"}'
