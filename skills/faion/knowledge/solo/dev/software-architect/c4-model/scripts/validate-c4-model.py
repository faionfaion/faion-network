#!/usr/bin/env python3
"""validate-c4-model.py — stdlib-only validator for the c4-model output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'toolchain', 'levels', 'sync_policy']
...
OK_JSON = '{"artefact_id": "c4-pack-shop-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "toolchain": "structurizr", "levels": [{"level": 1, "path": "docs/architecture/c4/01-context.dsl"}, {"level": 2, "path": "docs/architecture/c4/02-containers.dsl"}, {"level": 3, "path": "docs/architecture/c4/03-components-api.dsl"}], "sync_policy": "Diagrams updated in every PR that adds/removes a container or external system; CI lint compares L2 against deploy manifest."}'
BAD_JSON = '{"owner": "team", "toolchain": "drawio", "levels": [{"level": 1}]}'
