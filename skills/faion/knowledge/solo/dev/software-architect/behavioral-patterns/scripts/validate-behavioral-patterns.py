#!/usr/bin/env python3
"""validate-behavioral-patterns.py — stdlib-only validator for the behavioral-patterns output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'variance_hotspot', 'pattern', 'refactor_sketch']
...
OK_JSON = '{"artefact_id": "behavioral-pattern-shipping-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "variance_hotspot": "shipping.calculate_cost", "pattern": "Strategy", "refactor_sketch": {"abstract": "ShippingStrategy", "concrete": ["DhlStrategy", "UpsStrategy"]}}'
BAD_JSON = '{"owner": "team", "pattern": "Magic", "refactor_sketch": {}}'
