#!/usr/bin/env python3
"""validate-adr-reversibility-tagging.py — stdlib-only validator for the adr-reversibility-tagging output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'adr_id', 'reversibility', 'rollback_estimate']
...
OK_JSON = '{"artefact_id": "adr-reversibility-023-clerk-migration", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "adr_id": "023", "reversibility": "one_way_door_costly", "rollback_estimate": {"engineering_weeks": 4, "dollars_contract_exit": 12000, "customers_affected": "all_active"}, "pre_mortem": {"reversal_triggers": ["bill/MAU > 2x", "enterprise SSO blocker"]}}'
BAD_JSON = '{"owner": "team", "reversibility": "maybe-reversible", "rollback_estimate": {}}'
