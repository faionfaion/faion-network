#!/usr/bin/env python3
"""validate-decision-tree-build-vs-buy.py — stdlib-only validator for the decision-tree-build-vs-buy output artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'adr_id', 'capability', 'choice', 'scoring', 'alternatives_rejected', 'reversibility']
...
OK_JSON = '{"artefact_id": "build-vs-buy-auth-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "adr_id": "042", "capability": "identity", "choice": "buy", "scoring": {"strategic_differentiation": 1, "tco_3yr": "$36k buy vs $250k build", "time_to_value": "2 weeks buy vs 6 months build", "lock_in_risk": "medium"}, "alternatives_rejected": [{"option": "build", "reason": "not strategic differentiation"}], "reversibility": "one_way_door_costly"}'
BAD_JSON = '{"owner": "team", "choice": "fork-and-build", "scoring": {}, "alternatives_rejected": [], "reversibility": "two_way_door"}'
