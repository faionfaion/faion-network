...
- `faion-research-agent` (`skills/faion/knowledge/pro/research/researcher/`) — gathers comparable scaling data (Shopify, GitHub, Basecamp) when justifying a Monolith-First ADR to skeptics.
