#!/usr/bin/env python3
"""validate-ls-gumroad-pricing-flip.py

Validate a LS / Gumroad Pricing Flip artefact against the JSON Schema (draft-07) declared in
