<!-- purpose: minimal React Component Architecture artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-react-component-architecture.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# React Component Architecture — Artefact

| Field | Value |
|-------|-------|
| artefact_id | react-component-architecture-YYYY-MM-DD |
...
- [ ] `scripts/validate-react-component-architecture.py --file artefact.json` exits 0
