<!-- purpose: minimal Next.js App Router artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: spec artefact validated by scripts/validate-nextjs-app-router.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Next.js App Router — Artefact

| Field | Value |
|-------|-------|
| artefact_id | nextjs-app-router-YYYY-MM-DD |
...
- [ ] `scripts/validate-nextjs-app-router.py --file artefact.json` exits 0
