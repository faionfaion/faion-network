# Web Scraping - LLM-Assisted Prompts
...
```
I need to set up web scraping for my project.
...
```
Review my web scraping configuration and suggest improvements.
...
```
Generate a web scraping implementation with these requirements:
...
```
Refactor this code to follow web scraping best practices.
...
```
Generate comprehensive tests for this web scraping implementation.
...
```
Create a testing strategy for web scraping.
...
```
I'm having an issue with my web scraping implementation.
...
```
Analyze the performance of my web scraping implementation.
...
```
Generate comprehensive documentation for this web scraping implementation.
...
```
Explain web scraping to my team who are unfamiliar with it.
...
```
Create a migration plan to adopt web scraping.
...
```
Design a gradual adoption strategy for web scraping.
...
```
Audit my web scraping implementation against best practices.
...
```
Assess production readiness of my web scraping implementation.
...
```
Create a tutorial teaching web scraping from basics to advanced.
...
```
# Quick help
"Explain web scraping in simple terms"

# Quick example
"Show me a minimal web scraping example"

# Quick fix
"Fix this web scraping error: [ERROR]"

# Quick comparison
"Compare web scraping with [ALTERNATIVE]"

# Quick recommendation
"Should I use web scraping for [USE CASE]?"
```
