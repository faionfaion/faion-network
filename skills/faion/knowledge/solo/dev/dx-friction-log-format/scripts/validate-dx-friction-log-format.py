#!/usr/bin/env python3
"""validate-dx-friction-log-format.py

Validate a DX Friction Log Format artefact against the JSON Schema (draft-07) defined in
...
OK = {'artefact_id': 'dx-friction-log-format-2026-05-23', 'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'status': 'ready_for_review', 'rows': ['item-1'], 'triage_cadence': 'draft'}
