<!-- purpose: minimal Diagram-as-Code with Mermaid / Structurizr artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: code artefact validated by scripts/validate-diagram-as-code-mermaid-structurizr.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Diagram-as-Code with Mermaid / Structurizr — Artefact

| Field | Value |
|-------|-------|
| artefact_id | diagram-as-code-mermaid-structurizr-YYYY-MM-DD |
