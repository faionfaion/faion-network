#!/usr/bin/env python3
"""validate-test-pyramid-policy-enforcement.py — validate a test-pyramid-policy-enforcement output JSON against the methodology schema.
...
VALID_FIXTURE = {
    "artefact_id": "test-pyramid-policy-enforcement-2026-q2",
    "version": "1.1.0",
