#!/usr/bin/env python3
"""validate-idea-generation.py — stdlib-only validator for the Idea Generation for Solopreneurs artefact.
...
KNOWN_RULE_IDS = set(['seed-with-constraints', 'diverge-before-converge', 'second-context-scoring', 'fit-override', 'cap-scoring-at-five', 'dedupe-by-audience-problem', 'skip-this-methodology'])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "trigger": "Idea Generation for Solopreneurs engagement",
        "rules_applied": ["seed-with-constraints"],
        "evidence": [
            {
                "rule_id": "seed-with-constraints",
