#!/usr/bin/env python3
"""validate-idea-generation-methods.py — stdlib-only validator for the Idea Generation Methods artefact.
...
KNOWN_RULE_IDS = set(['method-tagged-per-candidate', 'honest-passion-answer', 'pain-point-evidence-link', 'matrix-weights-pinned', 'pg-four-as-gate', 'skip-this-methodology'])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["method-tagged-per-candidate"],
        "evidence": [
            {
                "rule_id": "method-tagged-per-candidate",
