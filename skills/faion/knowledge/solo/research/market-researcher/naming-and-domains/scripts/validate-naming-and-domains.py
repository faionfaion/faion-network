#!/usr/bin/env python3
"""validate-naming-and-domains.py — stdlib-only validator for the Naming and Domains artefact.
...
KNOWN_RULE_IDS = set(['pronounceable-in-locales', 'trademark-checked', 'apex-domain-available', 'handles-checked', 'ranked-rationale', 'skip-this-methodology'])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["pronounceable-in-locales"],
        "evidence": [
            {
                "rule_id": "pronounceable-in-locales",
