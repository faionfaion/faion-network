#!/usr/bin/env python3
"""validate-insight-evidence-card-template.py — stdlib-only validator for the Insight Evidence Card Template artefact.
...
KNOWN_RULE_IDS = set(['one-claim-per-card', 'verbatim-quote', 'evidence-count-tracked', 'segment-tag', 'confidence-band', 'skip-this-methodology'])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["one-claim-per-card"],
        "evidence": [
            {
                "rule_id": "one-claim-per-card",
