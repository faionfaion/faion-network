#!/usr/bin/env python3
"""validate-idea-generation.py — stdlib-only validator for the Idea Generation (Researcher) artefact.
...
KNOWN_RULE_IDS = set(['research-priors-first', 'diverge-before-converge', 'evidence-links-top-five', 'fit-override', 'dedupe-by-job', 'skip-this-methodology'])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "trigger": "Idea Generation (Researcher) engagement",
        "rules_applied": ["research-priors-first"],
        "evidence": [
            {
                "rule_id": "research-priors-first",
