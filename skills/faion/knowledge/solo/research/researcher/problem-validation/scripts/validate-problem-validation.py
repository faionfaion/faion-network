#!/usr/bin/env python3
"""validate-problem-validation.py — stdlib-only validator for the Problem Validation artefact.
...
KNOWN_RULE_IDS = set(['mom-test-questions', 'seven-interview-min', 'workaround-documented', 'verdict-single', 'no-vanity-validation', 'skip-this-methodology'])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["mom-test-questions"],
        "evidence": [
            {
                "rule_id": "mom-test-questions",
