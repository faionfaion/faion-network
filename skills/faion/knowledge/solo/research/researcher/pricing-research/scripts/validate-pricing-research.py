#!/usr/bin/env python3
"""validate-pricing-research.py — stdlib-only validator for the Pricing Research (Researcher) artefact.
...
KNOWN_RULE_IDS = set(['value-anchor-from-interviews', 'vw-min-30', 'tier-feature-distribution', 'validation-five-paying', 'confidence-band-tied-to-evidence', 'skip-this-methodology'])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["value-anchor-from-interviews"],
        "evidence": [
            {
                "rule_id": "value-anchor-from-interviews",
