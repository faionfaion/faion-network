#!/usr/bin/env python3
"""validate-pain-point-research.py — stdlib-only validator for the Pain-Point Research artefact.
...
KNOWN_RULE_IDS = set(['source-link-per-pain', 'frequency-proxy', 'workaround-described', 'scored-five-criteria', 'segment-tagged', 'skip-this-methodology'])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["source-link-per-pain"],
        "evidence": [
            {
                "rule_id": "source-link-per-pain",
