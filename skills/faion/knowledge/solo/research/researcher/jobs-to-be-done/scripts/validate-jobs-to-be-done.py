#!/usr/bin/env python3
"""validate-jobs-to-be-done.py — stdlib-only validator for the Jobs To Be Done (Researcher) artefact.
...
KNOWN_RULE_IDS = set(['recent-switchers-only', 'four-forces-tagged', 'observable-switch-event', 'force-aggregation-rubric', 'hire-fire-criteria-explicit', 'skip-this-methodology'])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["recent-switchers-only"],
        "evidence": [
            {
                "rule_id": "recent-switchers-only",
