#!/usr/bin/env python3
"""validate-competitor-tracker-template.py — stdlib-only validator for the Competitor Tracker Template (Solo) artefact.
...
KNOWN_RULE_IDS = set(['channel-named-per-comp', 'delta-not-state', 'triage-rule-applied', 'monthly-matrix-refresh', 'action-link-per-queue', 'skip-this-methodology'])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["channel-named-per-comp"],
        "evidence": [
            {
                "rule_id": "channel-named-per-comp",
