#!/usr/bin/env python3
"""validate-feature-discovery.py — stdlib-only validator for the Feature Discovery artefact.
...
KNOWN_RULE_IDS = set(['rice-scored', 'evidence-three-sources', 'named-owner-top-5', 'parked-revisit-trigger', 'capacity-aware-top-five', 'skip-this-methodology'])
