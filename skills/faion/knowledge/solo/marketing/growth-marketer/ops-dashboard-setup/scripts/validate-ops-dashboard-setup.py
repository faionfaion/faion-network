#!/usr/bin/env python3
"""validate-ops-dashboard-setup.py — validate a ops-dashboard-setup output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'widgets', 'hosting', 'owner', 'next_review']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed', 'next_review']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['widgets']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'hosting', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "ops-dashboard-setup-2026-q2", "version": "1.1.0", "last_reviewed": "2026-05-23", "widgets": [], "hosting": "<hosting>", "owner": "@ruslan", "next_review": "2026-05-23"}')
INVALID_FIXTURE = json.loads('{"widgets": [], "hosting": "<hosting>", "owner": "team", "next_review": "2026-05-23"}')
