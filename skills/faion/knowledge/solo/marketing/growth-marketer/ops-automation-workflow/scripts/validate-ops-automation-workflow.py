#!/usr/bin/env python3
"""validate-ops-automation-workflow.py — validate a ops-automation-workflow output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'inventory', 'backlog', 'hour_cost_usd', 'owner', 'next_review']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed', 'next_review']
INT_FIELDS = []
NUM_FIELDS = ['hour_cost_usd']
ARRAY_FIELDS = ['inventory', 'backlog']
OBJECT_FIELDS = []
BOOL_FIELDS = []
...
VALID_FIXTURE = json.loads('{"artefact_id": "ops-automation-workflow-2026-q2", "version": "1.1.0", "last_reviewed": "2026-05-23", "inventory": [], "backlog": [], "hour_cost_usd": 1.0, "owner": "@ruslan", "next_review": "2026-05-23"}')
INVALID_FIXTURE = json.loads('{"inventory": [], "backlog": [], "hour_cost_usd": 1.0, "owner": "team", "next_review": "2026-05-23"}')
