#!/usr/bin/env python3
"""validate-ai-slop-detector-checklist.py — validate a ai-slop-detector-checklist output JSON against the methodology schema.
...
REQUIRED = ["artefact_id", "version", "last_reviewed", "draft_path", "scores", "total_score", "verdict", "owner"]
ENUMS = {"verdict": ["ship", "rework"]}
SEMVER_FIELDS = ["version"]
DATE_FIELDS = ["last_reviewed"]
INT_FIELDS = ["total_score", "hedging_count"]
ARRAY_FIELDS = []
OBJECT_FIELDS = ["scores"]
BOOL_FIELDS = []
STRING_FIELDS = ["artefact_id", "draft_path", "owner"]
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"slop-2026-05-23-post-1\", \"version\": \"1.1.0\", \"last_reviewed\": \"2026-05-23\", \"draft_path\": \"content/blog/2026-05-23-shipping-fast.md\", \"scores\": {\"originality\": 18, \"specificity\": 17, \"grounding\": 16, \"voice\": 16, \"tics\": 18}, \"total_score\": 85, \"verdict\": \"ship\", \"hedging_count\": 1, \"owner\": \"@ruslan\"}")
INVALID_FIXTURE = json.loads("{\"draft_path\": \"content/blog/post.md\", \"scores\": {\"originality\": 5, \"specificity\": 6, \"grounding\": 4, \"voice\": 5, \"tics\": 8}, \"total_score\": 28, \"verdict\": \"ship\", \"owner\": \"team\"}")
