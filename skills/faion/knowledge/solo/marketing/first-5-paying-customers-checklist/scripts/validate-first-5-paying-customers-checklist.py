#!/usr/bin/env python3
"""validate-first-5-paying-customers-checklist.py — validate a first-5-paying-customers-checklist output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'icp', 'price_usd_month', 'channels', 'weekly_quota', 'paid_customers', 'status', 'owner']
ENUMS = {'status': ['active', 'paused', 'graduated', 'abandoned']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['price_usd_month', 'paid_customers']
NUM_FIELDS = []
ARRAY_FIELDS = ['channels']
OBJECT_FIELDS = ['weekly_quota']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'icp', 'status', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "first-5-paying-customers-checklist-2026-q2", "version": "1.1.0", "last_reviewed": "2026-05-23", "icp": "<icp>", "price_usd_month": 1, "channels": [], "weekly_quota": {}, "paid_customers": 1, "status": "active", "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"icp": "<icp>", "price_usd_month": 1, "channels": [], "weekly_quota": {}, "paid_customers": 1, "status": "active", "owner": "team"}')
