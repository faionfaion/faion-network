<!-- purpose: Markdown skeleton for EEAT Signal Pass Template eeat-pass artefact. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a eeat-pass artefact validating against scripts/validate-eeat-signal-pass-template.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# EEAT Signal Pass Template — Artefact Skeleton
...
Run `python scripts/validate-eeat-signal-pass-template.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
