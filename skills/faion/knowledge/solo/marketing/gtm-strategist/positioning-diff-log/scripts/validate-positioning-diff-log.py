#!/usr/bin/env python3
"""validate-positioning-diff-log.py — validate a positioning-diff-log output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'trigger', 'old_wording', 'new_wording', 'expected_effect', 'check_30d', 'check_90d', 'owner']
ENUMS = {}
...
NUM_FIELDS = []
ARRAY_FIELDS = []
OBJECT_FIELDS = ['expected_effect', 'check_30d', 'check_90d']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'trigger', 'old_wording', 'new_wording', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "positioning-diff-log-2026-q2", "version": "1.1.0", "last_reviewed": "2026-05-23", "trigger": "<trigger>", "old_wording": "<old_wording>", "new_wording": "<new_wording>", "expected_effect": {}, "check_30d": {}, "check_90d": {}, "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"trigger": "<trigger>", "old_wording": "<old_wording>", "new_wording": "<new_wording>", "expected_effect": {}, "check_30d": {}, "check_90d": {}, "owner": "team"}')
