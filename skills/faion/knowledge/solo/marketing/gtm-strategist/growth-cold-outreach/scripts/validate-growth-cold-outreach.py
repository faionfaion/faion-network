#!/usr/bin/env python3
"""validate-growth-cold-outreach.py — validate a growth-cold-outreach output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'campaign_name', 'prospect_count', 'sequence_steps', 'body_max_sentences', 'daily_throttle', 'stop_conditions', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['prospect_count', 'sequence_steps', 'body_max_sentences', 'daily_throttle']
NUM_FIELDS = []
ARRAY_FIELDS = ['stop_conditions']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'campaign_name', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "growth-cold-outreach-2026-q2", "version": "1.1.0", "last_reviewed": "2026-05-23", "campaign_name": "<campaign_name>", "prospect_count": 1, "sequence_steps": 1, "body_max_sentences": 1, "daily_throttle": 1, "stop_conditions": [], "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"campaign_name": "<campaign_name>", "prospect_count": 1, "sequence_steps": 1, "body_max_sentences": 1, "daily_throttle": 1, "stop_conditions": [], "owner": "team"}')
