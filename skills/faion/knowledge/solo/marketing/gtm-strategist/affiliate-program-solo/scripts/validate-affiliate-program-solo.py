#!/usr/bin/env python3
"""validate-affiliate-program-solo.py — validate a affiliate-program-solo output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'platform', 'commission_pct', 'cookie_days', 'payout_cap_usd_month', 'refund_clawback_days', 'fraud_rules', 'owner']
ENUMS = {'platform': ['lemonsqueezy', 'gumroad', 'rewardful', 'stripe']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['cookie_days', 'payout_cap_usd_month', 'refund_clawback_days']
NUM_FIELDS = ['commission_pct']
ARRAY_FIELDS = ['fraud_rules']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'platform', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "affiliate-program-solo-2026-q2", "version": "1.1.0", "last_reviewed": "2026-05-23", "platform": "lemonsqueezy", "commission_pct": 1.0, "cookie_days": 1, "payout_cap_usd_month": 1, "refund_clawback_days": 1, "fraud_rules": [], "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"platform": "lemonsqueezy", "commission_pct": 1.0, "cookie_days": 1, "payout_cap_usd_month": 1, "refund_clawback_days": 1, "fraud_rules": [], "owner": "team"}')
