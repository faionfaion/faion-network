#!/usr/bin/env python3
"""validate-growth-app-store-optimization.py — validate a growth-app-store-optimization output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'app_id', 'store', 'keywords', 'title', 'subtitle', 'screenshots_order', 'review_prompt_trigger', 'next_review', 'owner']
ENUMS = {'store': ['apple', 'google']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed', 'next_review']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['keywords', 'screenshots_order']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'app_id', 'store', 'title', 'subtitle', 'review_prompt_trigger', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "growth-app-store-optimization-2026-q2", "version": "1.1.0", "last_reviewed": "2026-05-23", "app_id": "<app_id>", "store": "apple", "keywords": [], "title": "<title>", "subtitle": "<subtitle>", "screenshots_order": [], "review_prompt_trigger": "<review_prompt_trigger>", "next_review": "2026-05-23", "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"app_id": "<app_id>", "store": "apple", "keywords": [], "title": "<title>", "subtitle": "<subtitle>", "screenshots_order": [], "review_prompt_trigger": "<review_prompt_trigger>", "next_review": "2026-05-23", "owner": "team"}')
