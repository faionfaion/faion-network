#!/usr/bin/env python3
"""validate-growth-landing-page-design.py — stdlib-only validator for the AIDA-Structured Landing Page artefact.
...
OK_JSON = '{"artefact_id": "growth-landing-page-design-acme-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "inputs_used": [{"name": "engagement charter", "source": "docs/charters/acme.md"}], "findings": [{"id": "f1", "summary": "pattern", "severity": "high"}], "decision": "ship the artefact.", "rationale": "Finding f1 supports the decision by triangulating three inputs."}'
