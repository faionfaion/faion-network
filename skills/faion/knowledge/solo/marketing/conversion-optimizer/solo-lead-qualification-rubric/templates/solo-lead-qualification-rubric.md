<!-- purpose: Markdown skeleton for Solo Lead Qualification Rubric lead-qualification-score artefact. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a lead-qualification-score artefact validating against scripts/validate-solo-lead-qualification-rubric.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# Solo Lead Qualification Rubric — Artefact Skeleton
...
Run `python scripts/validate-solo-lead-qualification-rubric.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
