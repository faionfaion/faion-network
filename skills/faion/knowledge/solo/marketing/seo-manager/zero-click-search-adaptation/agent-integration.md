...
- `faion` (seo-manager/topical-authority) — builds topic cluster maps to identify citation-worthy content gaps
- `faion` (seo-manager/google-ai-overviews-optimization) — paired methodology for schema and AIO-specific optimizations
