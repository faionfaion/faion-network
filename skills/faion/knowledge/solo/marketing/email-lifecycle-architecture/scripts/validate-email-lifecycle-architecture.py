#!/usr/bin/env python3
"""validate-email-lifecycle-architecture.py — validate a email-lifecycle-architecture output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'lifecycle_map', 'frequency_cap', 'suppression_list_id', 'consent_records', 'compliance_basis', 'audit_date', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed', 'audit_date']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['lifecycle_map', 'compliance_basis']
OBJECT_FIELDS = ['frequency_cap', 'consent_records']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'suppression_list_id', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "email-lifecycle-architecture-2026-q2", "version": "1.1.0", "last_reviewed": "2026-05-23", "lifecycle_map": [], "frequency_cap": {}, "suppression_list_id": "<suppression_list_id>", "consent_records": {}, "compliance_basis": [], "audit_date": "2026-05-23", "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"lifecycle_map": [], "frequency_cap": {}, "suppression_list_id": "<suppression_list_id>", "consent_records": {}, "compliance_basis": [], "audit_date": "2026-05-23", "owner": "team"}')
