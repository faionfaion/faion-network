#!/usr/bin/env python3
"""validate-brand-voice-consistency-system.py — validate a brand-voice-consistency-system output JSON against the methodology schema.
...
REQUIRED = ["artefact_id", "version", "last_reviewed", "attributes", "do_dont_pairs", "channels", "last_drift_audit", "owner"]
ENUMS = {}
SEMVER_FIELDS = ["version"]
DATE_FIELDS = ["last_reviewed", "last_drift_audit"]
INT_FIELDS = []
ARRAY_FIELDS = ["attributes", "do_dont_pairs", "channels"]
OBJECT_FIELDS = []
BOOL_FIELDS = []
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"voice-faion-2026-q2\", \"version\": \"1.1.0\", \"last_reviewed\": \"2026-05-23\", \"attributes\": [\"direct\", \"dry-humored\", \"evidence-led\", \"opinionated\", \"brief\"], \"do_dont_pairs\": [{\"do\": \"Faion is a CLI tool\", \"dont\": \"Faion can be thought of as a CLI tool\"}], \"channels\": [{\"name\": \"twitter\", \"length\": \"\\u2264280\", \"emoji\": \"rare\"}, {\"name\": \"blog\", \"length\": \"800-1200\", \"emoji\": \"none\"}, {\"name\": \"email\", \"length\": \"\\u2264500\", \"emoji\": \"rare\"}], \"last_drift_audit\": \"2026-05-23\", \"owner\": \"@ruslan\"}")
INVALID_FIXTURE = json.loads("{\"attributes\": [\"friendly\", \"professional\"], \"do_dont_pairs\": [], \"channels\": [], \"owner\": \"team\"}")
