#!/usr/bin/env python3
"""validate-churn-save-email-pack-indie.py — validate a churn-save-email-pack-indie output JSON against the methodology schema.
...
VALID_FIXTURE = {
    "artefact_id": "churn-save-email-pack-indie-2026-q2",
    "version": "1.1.0",
