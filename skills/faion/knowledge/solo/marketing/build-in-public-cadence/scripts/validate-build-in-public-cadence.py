#!/usr/bin/env python3
"""validate-build-in-public-cadence.py — validate a build-in-public-cadence output JSON against the methodology schema.
...
VALID_FIXTURE = {
    "artefact_id": "build-in-public-cadence-2026-q2",
    "version": "1.1.0",
