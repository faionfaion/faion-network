#!/usr/bin/env python3
"""validate-audience-to-customer-funnel.py — validate a audience-to-customer-funnel output JSON against the methodology schema.
...
REQUIRED = ["artefact_id", "version", "last_reviewed", "stages", "data_window_days", "owner"]
ENUMS = {}
SEMVER_FIELDS = ["version"]
DATE_FIELDS = ["last_reviewed"]
INT_FIELDS = ["data_window_days"]
ARRAY_FIELDS = ["stages"]
OBJECT_FIELDS = []
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"funnel-faion-2026-q2\", \"version\": \"1.1.0\", \"last_reviewed\": \"2026-05-23\", \"stages\": [{\"name\": \"Awareness\", \"kpi\": \"unique_visitors\", \"owner\": \"@ruslan\", \"drop_off_threshold_pct\": 90}, {\"name\": \"Interest\", \"kpi\": \"newsletter_signups\", \"owner\": \"@ruslan\", \"drop_off_threshold_pct\": 80}, {\"name\": \"Consideration\", \"kpi\": \"trial_starts\", \"owner\": \"@ruslan\", \"drop_off_threshold_pct\": 50}, {\"name\": \"Conversion\", \"kpi\": \"paid_subscribers\", \"owner\": \"@ruslan\", \"drop_off_threshold_pct\": 30}], \"data_window_days\": 30, \"provisional\": false, \"owner\": \"@ruslan\"}")
INVALID_FIXTURE = json.loads("{\"stages\": [{\"name\": \"Awareness\", \"kpi\": \"visits\"}], \"data_window_days\": 7, \"owner\": \"team\"}")
