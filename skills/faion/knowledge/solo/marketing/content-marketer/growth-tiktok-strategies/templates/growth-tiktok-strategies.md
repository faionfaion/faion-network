<!-- purpose: Markdown skeleton for Advanced TikTok Strategies tiktok-strategy artefact. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a tiktok-strategy artefact validating against scripts/validate-growth-tiktok-strategies.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# Advanced TikTok Strategies — Artefact Skeleton
...
Run `python scripts/validate-growth-tiktok-strategies.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
