#!/usr/bin/env python3
"""validate-growth-content-marketing.py — validate a growth-content-marketing output JSON against the methodology schema.
...
VALID_FIXTURE = {
    "artefact_id": "growth-content-marketing-2026-q2",
    "version": "1.1.0",
