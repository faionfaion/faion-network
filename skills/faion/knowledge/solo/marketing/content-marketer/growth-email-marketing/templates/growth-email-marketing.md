<!-- purpose: Markdown skeleton for Email Marketing for Solo Operators email-program artefact. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a email-program artefact validating against scripts/validate-growth-email-marketing.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# Email Marketing for Solo Operators — Artefact Skeleton
...
Run `python scripts/validate-growth-email-marketing.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
