<!-- purpose: Markdown skeleton for TikTok Basics for B2B/SaaS tiktok-foundation artefact. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a tiktok-foundation artefact validating against scripts/validate-growth-tiktok-basics.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# TikTok Basics for B2B/SaaS — Artefact Skeleton
...
Run `python scripts/validate-growth-tiktok-basics.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
