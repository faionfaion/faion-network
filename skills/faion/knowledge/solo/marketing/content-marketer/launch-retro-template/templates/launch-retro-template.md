<!-- purpose: Markdown skeleton for Launch Retro Template launch-retro artefact. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a launch-retro artefact validating against scripts/validate-launch-retro-template.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# Launch Retro Template — Artefact Skeleton
...
Run `python scripts/validate-launch-retro-template.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
