<!-- purpose: Markdown skeleton for Webinar Delivery webinar-runbook artefact. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a webinar-runbook artefact validating against scripts/validate-growth-webinar-delivery.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# Webinar Delivery — Artefact Skeleton
...
Run `python scripts/validate-growth-webinar-delivery.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
