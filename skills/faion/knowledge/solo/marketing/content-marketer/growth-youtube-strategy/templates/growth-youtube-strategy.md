<!-- purpose: Markdown skeleton for YouTube Strategy youtube-plan artefact. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a youtube-plan artefact validating against scripts/validate-growth-youtube-strategy.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# YouTube Strategy — Artefact Skeleton
...
Run `python scripts/validate-growth-youtube-strategy.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
