<!-- purpose: Markdown skeleton for Search Everywhere Optimization search-everywhere-plan artefact. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a search-everywhere-plan artefact validating against scripts/validate-search-everywhere-optimization.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# Search Everywhere Optimization — Artefact Skeleton
...
Run `python scripts/validate-search-everywhere-optimization.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
