<!-- purpose: Markdown skeleton for Two-Track Podcast Strategy podcast-plan artefact. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a podcast-plan artefact validating against scripts/validate-growth-podcast-strategy.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# Two-Track Podcast Strategy — Artefact Skeleton
...
Run `python scripts/validate-growth-podcast-strategy.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
