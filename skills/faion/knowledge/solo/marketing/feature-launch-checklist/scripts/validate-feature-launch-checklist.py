#!/usr/bin/env python3
"""validate-feature-launch-checklist.py — validate a feature-launch-checklist output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'feature_name', 'launch_date', 'items', 'channels', 'success_metric', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed', 'launch_date']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['items', 'channels']
OBJECT_FIELDS = ['success_metric']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'feature_name', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "feature-launch-checklist-2026-q2", "version": "1.1.0", "last_reviewed": "2026-05-23", "feature_name": "<feature_name>", "launch_date": "2026-05-23", "items": [], "channels": [], "success_metric": {}, "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"feature_name": "<feature_name>", "launch_date": "2026-05-23", "items": [], "channels": [], "success_metric": {}, "owner": "team"}')
