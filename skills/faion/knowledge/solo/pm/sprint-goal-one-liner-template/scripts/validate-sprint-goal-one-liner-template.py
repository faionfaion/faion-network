#!/usr/bin/env python3
"""validate-sprint-goal-one-liner-template.py — stdlib-only validator for the Sprint Goal One Liner Template artefact.
...
KNOWN_RULE_IDS = set(["five-slots-filled", "verb-must-be-outcome", "benefit-is-measurable", "recitable-at-standup", "explicit-out-of-scope", "skip-this-methodology"])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["five-slots-filled"],
        "evidence": [
            {
                "rule_id": "five-slots-filled",
