#!/usr/bin/env python3
"""validate-tiny-bets-quarterly-cadence.py — stdlib-only validator for the Tiny Bets Quarterly Cadence artefact.
...
KNOWN_RULE_IDS = set(["max-four-bets", "kill-criterion-pre-commit", "mid-quarter-cull", "named-owner-required", "end-of-quarter-rollup", "skip-this-methodology"])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["max-four-bets"],
        "evidence": [
            {
                "rule_id": "max-four-bets",
