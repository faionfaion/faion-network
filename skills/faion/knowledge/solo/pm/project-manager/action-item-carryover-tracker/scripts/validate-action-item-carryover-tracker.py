#!/usr/bin/env python3
"""validate-action-item-carryover-tracker.py — validate a action-item-carryover-tracker output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'log_url', 'stale_threshold', 'weekly_report_day', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['stale_threshold']
NUM_FIELDS = []
ARRAY_FIELDS = []
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'log_url', 'weekly_report_day', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "action-item-tracker-2026-q2", "version": "1.0.0", "last_reviewed": "2026-05-23", "log_url": "notion://workspace/action-items", "stale_threshold": 3, "weekly_report_day": "Friday", "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"log_url": "", "stale_threshold": 0, "weekly_report_day": "", "owner": "team"}')
