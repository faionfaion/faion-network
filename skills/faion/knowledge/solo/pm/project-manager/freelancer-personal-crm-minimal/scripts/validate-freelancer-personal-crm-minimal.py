#!/usr/bin/env python3
"""validate-freelancer-personal-crm-minimal.py — validate a freelancer-personal-crm-minimal output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'table_url', 'field_count', 'stages', 'review_day', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['field_count']
NUM_FIELDS = []
ARRAY_FIELDS = ['stages']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'table_url', 'review_day', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "crm-minimal-2026-q2", "version": "1.0.0", "last_reviewed": "2026-05-23", "table_url": "notion://workspace/crm", "field_count": 11, "stages": ["lead", "qualified", "proposal", "signed", "active", "churned"], "review_day": "Friday", "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"table_url": "", "field_count": 22, "stages": ["lead", "qualified", "proposal", "signed", "active"], "review_day": "", "owner": "team"}')
