#!/usr/bin/env python3
"""validate-1-1-question-bank-by-tenure.py — validate a 1-1-question-bank-by-tenure output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'buckets', 'owner']
ENUMS = {}
...
VALID_FIXTURE = json.loads('{"artefact_id": "1on1-question-bank-2026-q2", "version": "1.0.0", "last_reviewed": "2026-05-23", "buckets": {"0-30d": ["What\'s missing that I haven\'t realised yet?", "What surprised you about onboarding?", "Where do you feel most stuck right now?", "What\'s one thing that\'s better than expected?", "Which doc was the most useful?", "Which doc made no sense?", "Who haven\'t you met yet?", "What\'s your biggest question I haven\'t answered?", "What pace feels sustainable for you?", "What\'s slowing you down?"], "31-60d": ["Q1", "Q2", "Q3", "Q4", "Q5", "Q6", "Q7", "Q8", "Q9", "Q10"], "61-90d": ["Q1", "Q2", "Q3", "Q4", "Q5", "Q6", "Q7", "Q8", "Q9", "Q10"], "4-6mo": ["Q1", "Q2", "Q3", "Q4", "Q5", "Q6", "Q7", "Q8", "Q9", "Q10"], "6mo+": ["Q1", "Q2", "Q3", "Q4", "Q5", "Q6", "Q7", "Q8", "Q9", "Q10"]}, "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"buckets": {"0-30d": ["are you blocked?"]}, "owner": "team"}')
