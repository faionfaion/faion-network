...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'workspace_url', 'triage_cadence', 'ceremonies', 'status_template_url', 'velocity_review_date', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed', 'velocity_review_date']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['ceremonies']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'workspace_url', 'triage_cadence', 'status_template_url', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "linear-pm-ops-2026-q2", "version": "1.0.0", "last_reviewed": "2026-05-23", "workspace_url": "https://linear.app/faion", "triage_cadence": "daily", "ceremonies": ["planning", "mid-cycle-check-in", "retro"], "status_template_url": "templates/status-update.md", "velocity_review_date": "2026-08-15", "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"workspace_url": "https://linear.app/x", "triage_cadence": "weekly", "ceremonies": ["planning"], "status_template_url": "", "owner": "team"}')
