#!/usr/bin/env python3
"""validate-notion-pm.py — validate a notion-pm output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'workspace_url', 'tasks_db_id', 'projects_db_id', 'sprints_db_id', 'property_count', 'integrations', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['property_count']
NUM_FIELDS = []
ARRAY_FIELDS = []
OBJECT_FIELDS = ['integrations']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'workspace_url', 'tasks_db_id', 'projects_db_id', 'sprints_db_id', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "notion-pm-2026-q2", "version": "1.0.0", "last_reviewed": "2026-05-23", "workspace_url": "https://notion.so/faion", "tasks_db_id": "<tasks_db_id>", "projects_db_id": "<projects_db_id>", "sprints_db_id": "<sprints_db_id>", "property_count": 14, "integrations": {"status_type": "status", "pagination_enabled": true, "rate_limit_delay_ms": 350, "n8n_workflows": ["standup-digest", "sprint-closure"]}, "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"workspace_url": "", "tasks_db_id": "", "projects_db_id": "", "sprints_db_id": "", "property_count": 35, "integrations": {"status_type": "select"}, "owner": "team"}')
