#!/usr/bin/env python3
"""validate-trello-kanban.py — validate a trello-kanban output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'board_url', 'columns', 'wip_limits', 'labels', 'powerups', 'butler_rules', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['columns', 'labels', 'powerups', 'butler_rules']
OBJECT_FIELDS = ['wip_limits']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'board_url', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "trello-kanban-ops-2026-q2", "version": "1.0.0", "last_reviewed": "2026-05-23", "board_url": "https://trello.com/b/abc/ops", "columns": ["Backlog", "Ready", "In Progress", "Review", "Done"], "wip_limits": {"Ready": 8, "In Progress": 6, "Review": 5}, "labels": ["bug", "feat", "ops", "sales", "onboarding", "billing"], "powerups": ["calendar", "github"], "butler_rules": [{"name": "auto-archive-done-30d", "trigger": "card in Done >30d", "action": "archive"}], "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"board_url": "https://trello.com/b/x/y", "columns": ["A", "B", "C", "D", "E", "F", "G", "H"], "wip_limits": {}, "labels": ["x", "x", "x", "x", "x", "x", "x", "x", "x", "x", "x", "x", "x", "x", "x"], "powerups": ["a", "b", "c", "d", "e"], "butler_rules": [], "owner": "team"}')
