#!/usr/bin/env python3
"""validate-pm-1on1-template-engineering-design.py — validate a pm-1on1-template-engineering-design output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'teammate', 'meeting_date', 'career', 'project', 'craft', 'blockers', 'feedback', 'notes_log_url', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed', 'meeting_date']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['blockers']
OBJECT_FIELDS = ['feedback']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'teammate', 'career', 'project', 'craft', 'notes_log_url', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "1on1-designer-x-2026-w22", "version": "1.0.0", "last_reviewed": "2026-05-23", "teammate": "@designer-x", "meeting_date": "2026-05-23", "career": "interested in expanding to design-systems work; will pair on storybook 30 min/wk", "project": "/pricing v1 shipped; /home hero blocked on copy", "craft": "exploring Figma variables; share token strategy doc", "blockers": [{"id": "b1", "what": "waiting on /home hero copy"}], "feedback": {"from_pm": "great pace on /pricing", "to_pm": "earlier copy briefs help"}, "notes_log_url": "notion://workspace/1on1/designer-x", "owner": "@ruslan"}')
INVALID_FIXTURE = json.loads('{"teammate": "designer-x", "meeting_date": "2026-05-23", "career": "", "project": "stuff", "feedback": {}, "notes_log_url": "", "owner": "team"}')
