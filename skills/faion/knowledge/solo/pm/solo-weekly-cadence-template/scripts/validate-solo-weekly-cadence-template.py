#!/usr/bin/env python3
"""validate-solo-weekly-cadence-template.py — stdlib-only validator for the Solo Weekly Cadence Template artefact.
...
KNOWN_RULE_IDS = set(["two-artifacts-only", "four-mandatory-inputs", "memory-hook-required", "sixty-minute-timebox", "no-catchup-restart", "skip-this-methodology"])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["two-artifacts-only"],
        "evidence": [
            {
                "rule_id": "two-artifacts-only",
