#!/usr/bin/env python3
"""validate-coverage-rebuild-playbook.py — validate a coverage-rebuild-playbook output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'owner', 'step_id', 'objective', 'actions', 'exit_criteria']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['actions', 'exit_criteria']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'step_id', 'objective']
...
VALID_FIXTURE = json.loads('{"artefact_id": "coverage-rebuild-playbook-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "owner": "@solo-founder", "step_id": "step-1", "objective": "what this step achieves", "actions": ["action-1", "action-2", "action-3"], "exit_criteria": ["criterion-1"]}')
