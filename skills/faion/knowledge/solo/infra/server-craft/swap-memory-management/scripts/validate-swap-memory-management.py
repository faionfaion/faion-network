#!/usr/bin/env python3
"""validate-swap-memory-management.py — validate a swap-memory-management output JSON against the methodology schema.
...
REQUIRED = ["artefact_id", "version", "last_reviewed", "ram_gb", "swap_gb", "swappiness", "units", "owner"]
ENUMS = {}
SEMVER_FIELDS = ["version"]
DATE_FIELDS = ["last_reviewed"]
INT_FIELDS = ["ram_gb", "swap_gb", "swappiness"]
ARRAY_FIELDS = ["units"]
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ["artefact_id", "alert_path", "owner"]
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"memory-nero-prod\", \"version\": \"1.1.0\", \"last_reviewed\": \"2026-05-23\", \"ram_gb\": 32, \"swap_gb\": 16, \"swappiness\": 10, \"units\": [{\"unit\": \"claude@.service\", \"MemoryHigh\": \"8G\", \"MemoryMax\": \"12G\"}], \"alert_path\": \"tg-send admin\", \"owner\": \"@ruslan\"}")
INVALID_FIXTURE = json.loads("{\"ram_gb\": 8, \"swap_gb\": 0, \"swappiness\": 60, \"units\": [], \"owner\": \"team\"}")
