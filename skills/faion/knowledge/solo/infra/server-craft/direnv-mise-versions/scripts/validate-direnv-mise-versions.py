#!/usr/bin/env python3
"""validate-direnv-mise-versions.py

Validate the output artefact for the `direnv-mise-versions` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/direnv-mise-versions.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'direnv-mise-versions',
    'title': 'Direnv + Mise for Per-Project Environments',
