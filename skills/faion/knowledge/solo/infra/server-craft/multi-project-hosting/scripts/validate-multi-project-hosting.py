#!/usr/bin/env python3
"""validate-multi-project-hosting.py

Validate the output artefact for the `multi-project-hosting` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/multi-project-hosting.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'multi-project-hosting',
    'title': 'Multi-Project Hosting on One VPS',
