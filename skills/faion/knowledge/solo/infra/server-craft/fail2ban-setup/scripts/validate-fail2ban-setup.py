#!/usr/bin/env python3
"""validate-fail2ban-setup.py

Validate the output artefact for the `fail2ban-setup` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/fail2ban-setup.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'fail2ban-setup',
    'title': 'Fail2ban Setup for Ubuntu 24',
