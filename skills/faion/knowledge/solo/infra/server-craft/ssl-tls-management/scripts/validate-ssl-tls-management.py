#!/usr/bin/env python3
"""validate-ssl-tls-management.py — validate a ssl-tls-management output JSON against the methodology schema.
...
REQUIRED = ["artefact_id", "version", "last_reviewed", "domain", "mode", "cert_path", "key_path", "owner"]
ENUMS = {"mode": ["cloudflare-origin", "letsencrypt", "self-signed"]}
...
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ["artefact_id", "domain", "cert_path", "key_path", "expiry_monitor_cron", "renewal_hook", "owner"]
