#!/usr/bin/env python3
"""validate-deploy-scripts.py

Validate the output artefact for the `deploy-scripts` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/deploy-scripts.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'deploy-scripts',
    'title': 'Deploy Scripts for Solo VPS',
