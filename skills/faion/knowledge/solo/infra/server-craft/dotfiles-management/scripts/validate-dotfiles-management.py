#!/usr/bin/env python3
"""validate-dotfiles-management.py

Validate the output artefact for the `dotfiles-management` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/dotfiles-management.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
