#!/usr/bin/env python3
"""validate-docker-compose-patterns.py

Validate the output artefact for the `docker-compose-patterns` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/docker-compose-patterns.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'docker-compose-patterns',
    'title': 'Docker Compose Patterns for Solo VPS',
