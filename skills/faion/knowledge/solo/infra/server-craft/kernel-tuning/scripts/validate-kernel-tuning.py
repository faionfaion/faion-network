#!/usr/bin/env python3
"""validate-kernel-tuning.py

Validate the output artefact for the `kernel-tuning` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/kernel-tuning.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'kernel-tuning',
    'title': 'Kernel Tuning (sysctl) for VPS',
