#!/usr/bin/env python3
"""validate-health-checks-autoheal.py

Validate the output artefact for the `health-checks-autoheal` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/health-checks-autoheal.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'health-checks-autoheal',
    'title': 'Health Checks + Auto-Heal',
