#!/usr/bin/env python3
"""validate-vercel-deployment-discipline.py — validate a vercel-deployment-discipline output JSON against the methodology schema.
...
REQUIRED = ["artefact_id", "version", "last_reviewed", "project_id", "commit_sha", "target_env", "env_audit_pass", "edge_violations", "go_no_go", "owner"]
ENUMS = {"target_env": ["production", "preview-staging", "preview-pr"], "go_no_go": ["go", "hold-fix", "abort"]}
SEMVER_FIELDS = ["version"]
DATE_FIELDS = ["last_reviewed"]
INT_FIELDS = []
ARRAY_FIELDS = ["edge_violations", "isr_paths"]
OBJECT_FIELDS = ["rollback_plan"]
BOOL_FIELDS = ["env_audit_pass"]
STRING_FIELDS = ["artefact_id", "project_id", "commit_sha", "owner"]
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"deploy-faion-net-2026-05-23\", \"version\": \"1.1.0\", \"last_reviewed\": \"2026-05-23\", \"project_id\": \"prj_abc123\", \"commit_sha\": \"9f1c2a4\", \"target_env\": \"production\", \"env_audit_pass\": true, \"edge_violations\": [], \"isr_paths\": [], \"rollback_plan\": {\"prior_deployment_id\": \"dpl_xyz\", \"verify_url\": \"/_vercel/info\"}, \"go_no_go\": \"go\", \"owner\": \"@ruslan\"}")
INVALID_FIXTURE = json.loads("{\"project_id\": \"prj_abc123\", \"target_env\": \"production\", \"env_audit_pass\": false, \"edge_violations\": [\"app/api/upload/route.ts uses fs\"], \"go_no_go\": \"go\", \"owner\": \"team\"}")
