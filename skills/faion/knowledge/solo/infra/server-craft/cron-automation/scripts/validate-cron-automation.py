#!/usr/bin/env python3
"""validate-cron-automation.py

Validate the output artefact for the `cron-automation` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/cron-automation.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'cron-automation',
    'title': 'Cron Automation for VPS',
