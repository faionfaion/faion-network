#!/usr/bin/env python3
"""validate-secrets-management.py — validate a secrets-management output JSON against the methodology schema.
...
REQUIRED = ["artefact_id", "version", "last_reviewed", "secrets", "consumers", "owner"]
ENUMS = {}
SEMVER_FIELDS = ["version"]
DATE_FIELDS = ["last_reviewed"]
INT_FIELDS = ["rotation_cadence_days"]
ARRAY_FIELDS = ["secrets", "consumers"]
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ["artefact_id", "owner", "leak_response_plan"]
