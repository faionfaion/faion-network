#!/usr/bin/env python3
"""validate-cloudflare-domain-dns.py

Validate the output artefact for the `cloudflare-domain-dns` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/cloudflare-domain-dns.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'cloudflare-domain-dns',
    'title': 'Cloudflare Domain + DNS',
