#!/usr/bin/env python3
"""validate-server-init-bootstrap.py — validate a server-init-bootstrap output JSON against the methodology schema.
...
REQUIRED = ["artefact_id", "version", "last_reviewed", "hostname", "operator", "phases", "owner"]
ENUMS = {}
SEMVER_FIELDS = ["version"]
DATE_FIELDS = ["last_reviewed"]
INT_FIELDS = []
ARRAY_FIELDS = ["phases", "verifications"]
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ["artefact_id", "hostname", "operator", "owner"]
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"bootstrap-faion-net-01\", \"version\": \"1.1.0\", \"last_reviewed\": \"2026-05-23\", \"hostname\": \"faion-net-01\", \"operator\": \"faion\", \"phases\": [\"access-users\", \"system-identity\", \"packages-tools\", \"security-hardening\", \"services-foundation\"], \"verifications\": [\"ssh-as-operator\", \"loginctl-linger-enabled\", \"ufw-active\", \"fail2ban-active\"], \"owner\": \"@ruslan\"}")
INVALID_FIXTURE = json.loads("{\"hostname\": \"localhost\", \"phases\": [], \"owner\": \"team\"}")
