#!/usr/bin/env python3
"""validate-monitoring-logging.py

Validate the output artefact for the `monitoring-logging` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/monitoring-logging.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'monitoring-logging',
    'title': 'Lightweight Monitoring + Logging',
