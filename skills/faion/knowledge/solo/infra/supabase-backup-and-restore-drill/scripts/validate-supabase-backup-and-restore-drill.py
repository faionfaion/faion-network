#!/usr/bin/env python3
"""validate-supabase-backup-and-restore-drill.py — validate a supabase-backup-and-restore-drill output JSON against the methodology schema.
...
REQUIRED = ["artefact_id", "version", "last_reviewed", "drill_date", "source_snapshot_id", "target_project", "restore_seconds", "row_count_delta", "owner"]
ENUMS = {}
SEMVER_FIELDS = ["version"]
DATE_FIELDS = ["last_reviewed", "drill_date"]
INT_FIELDS = ["restore_seconds", "row_count_delta"]
ARRAY_FIELDS = []
OBJECT_FIELDS = []
BOOL_FIELDS = ["checksum_match"]
STRING_FIELDS = ["artefact_id", "source_snapshot_id", "target_project", "owner"]
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"drill-2026-05-23\", \"version\": \"1.1.0\", \"last_reviewed\": \"2026-05-23\", \"drill_date\": \"2026-05-23\", \"source_snapshot_id\": \"snap_xyz\", \"target_project\": \"faion-restore-clone\", \"restore_seconds\": 412, \"row_count_delta\": 0, \"checksum_match\": true, \"owner\": \"@ruslan\"}")
INVALID_FIXTURE = json.loads("{\"drill_date\": \"2026-05-23\", \"source_snapshot_id\": \"snap_xyz\", \"target_project\": \"faion-prod\", \"row_count_delta\": 7, \"owner\": \"team\"}")
