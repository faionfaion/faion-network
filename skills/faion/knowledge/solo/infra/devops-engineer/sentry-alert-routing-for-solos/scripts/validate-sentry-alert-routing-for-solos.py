#!/usr/bin/env python3
"""validate-sentry-alert-routing-for-solos.py — validate a sentry-alert-routing-for-solos output JSON against the methodology schema.
...
VALID_FIXTURE = {
    "artefact_id": "sentry-alert-routing-for-solos-2026-q2",
    "version": "1.1.0",
