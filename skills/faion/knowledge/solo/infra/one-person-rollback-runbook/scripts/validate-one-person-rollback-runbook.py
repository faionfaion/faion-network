#!/usr/bin/env python3
"""validate-one-person-rollback-runbook.py

Validate the output artefact for the `one-person-rollback-runbook` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/one-person-rollback-runbook.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'one-person-rollback-runbook',
    'title': 'One Person Rollback Runbook',
