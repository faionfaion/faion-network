#!/usr/bin/env python3
"""validate-supabase-rls-audit-checklist.py — validate a supabase-rls-audit-checklist output JSON against the methodology schema.
...
REQUIRED = ["artefact_id", "version", "last_reviewed", "audit_date", "tables", "tenant_isolation_test_pass", "owner"]
ENUMS = {}
...
ARRAY_FIELDS = ["tables"]
OBJECT_FIELDS = []
BOOL_FIELDS = ["tenant_isolation_test_pass"]
STRING_FIELDS = ["artefact_id", "fixture_path", "owner"]
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"rls-audit-2026-05-23\", \"version\": \"1.1.0\", \"last_reviewed\": \"2026-05-23\", \"audit_date\": \"2026-05-23\", \"tables\": [{\"name\": \"orders\", \"rls_enabled\": true, \"policies\": {\"select\": true, \"insert\": true, \"update\": true, \"delete\": true}}], \"tenant_isolation_test_pass\": true, \"fixture_path\": \"tests/fixtures/two-tenants.sql\", \"owner\": \"@ruslan\"}")
INVALID_FIXTURE = json.loads("{\"audit_date\": \"2026-05-23\", \"tables\": [{\"name\": \"orders\", \"rls_enabled\": false}], \"tenant_isolation_test_pass\": false, \"owner\": \"team\"}")
