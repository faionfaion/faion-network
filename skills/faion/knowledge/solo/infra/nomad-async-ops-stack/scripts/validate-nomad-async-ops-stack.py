#!/usr/bin/env python3
"""validate-nomad-async-ops-stack.py — validate a nomad-async-ops-stack output JSON against the methodology schema.
...
VALID_FIXTURE = {
    "artefact_id": "nomad-async-ops-stack-2026-q2",
    "version": "1.1.0",
