#!/usr/bin/env python3
"""validate-sentry-supabase-vercel-wiring.py

Validate the output artefact for the `sentry-supabase-vercel-wiring` methodology against the JSON Schema
...
SCHEMA = {   '$schema': 'http://json-schema.org/draft-07/schema#',
    '$id': 'https://faion.net/schemas/sentry-supabase-vercel-wiring.json',
    'type': 'object',
    'required': [   'slug',
                    'title',
                    'owner',
...
OK = {   'slug': 'sentry-supabase-vercel-wiring',
    'title': 'Sentry Supabase Vercel Wiring',
