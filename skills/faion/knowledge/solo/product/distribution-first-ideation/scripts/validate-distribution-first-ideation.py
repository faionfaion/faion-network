#!/usr/bin/env python3
"""validate-distribution-first-ideation.py — stdlib-only validator for the Distribution First Ideation artefact.
...
KNOWN_RULE_IDS = set(["named-channel-required", "smoke-page-traffic-target", "waitlist-conversion-floor", "kill-on-negative-signal", "decision-record-go-no-go", "skip-this-methodology"])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["named-channel-required"],
        "evidence": [
            {
                "rule_id": "named-channel-required",
