#!/usr/bin/env python3
"""validate-design-debt-vs-design-bet.py — stdlib-only validator for the Design Debt Vs Design Bet artefact.
...
KNOWN_RULE_IDS = set(["explicit-class-tag", "debt-needs-friction-source", "bet-needs-falsifiable-hypothesis", "budget-envelope-per-class", "kill-criterion-on-bet", "skip-this-methodology"])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "trigger": "Design Debt Vs Design Bet engagement",
        "rules_applied": ["explicit-class-tag"],
        "evidence": [
            {
                "rule_id": "explicit-class-tag",
