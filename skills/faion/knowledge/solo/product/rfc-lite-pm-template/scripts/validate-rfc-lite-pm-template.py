#!/usr/bin/env python3
"""validate-rfc-lite-pm-template.py — validate a rfc-lite-pm-template output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'problem', 'evidence', 'scope_in', 'scope_out', 'open_questions', 'outcome_id', 'owner', 'reviewer', 'review_date']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed', 'review_date']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['evidence', 'scope_in', 'scope_out', 'open_questions']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'problem', 'outcome_id', 'owner', 'reviewer']
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"rfc-lite-pm-template-example\", \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"problem\": \"problem value\", \"evidence\": [\"item-1\", \"item-2\", \"item-3\"], \"scope_in\": [\"item-1\", \"item-2\", \"item-3\"], \"scope_out\": [\"item-1\", \"item-2\", \"item-3\"], \"open_questions\": [\"item-1\", \"item-2\", \"item-3\"], \"outcome_id\": \"outcome_id value\", \"owner\": \"@solo-founder\", \"reviewer\": \"@reviewer\", \"review_date\": \"2026-05-23\"}")
