#!/usr/bin/env python3
"""validate-beta-charter-template.py — stdlib-only validator for the Beta Charter Template artefact.
...
KNOWN_RULE_IDS = set(["cohort-size-cap", "duration-bounded", "single-success-metric", "weekly-broadcast", "explicit-exit-criteria", "skip-this-methodology"])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["cohort-size-cap"],
        "evidence": [
            {
                "rule_id": "cohort-size-cap",
