#!/usr/bin/env python3
"""validate-technical-debt-management.py — validate a technical-debt-management output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'register', 'debt_budget_pct', 'interest_rate_rubric', 'sprint_review_cadence', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = ['debt_budget_pct']
ARRAY_FIELDS = ['register']
OBJECT_FIELDS = ['interest_rate_rubric']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'sprint_review_cadence', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "technical-debt-management-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "register": ["item-1", "item-2", "item-3"], "debt_budget_pct": 1.0, "interest_rate_rubric": {"key": "value"}, "sprint_review_cadence": "sprint_review_cadence value", "owner": "@solo-founder"}')
