#!/usr/bin/env python3
"""validate-feedback-management.py — validate a feedback-management output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'inbound_channels', 'triage_cadence', 'theme_taxonomy', 'close_loop_sla_days', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['close_loop_sla_days']
NUM_FIELDS = []
ARRAY_FIELDS = ['inbound_channels', 'theme_taxonomy']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'triage_cadence', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "feedback-management-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "inbound_channels": ["item-1", "item-2", "item-3"], "triage_cadence": "triage_cadence value", "theme_taxonomy": ["item-1", "item-2", "item-3"], "close_loop_sla_days": 3, "owner": "@solo-founder"}')
