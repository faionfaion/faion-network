#!/usr/bin/env python3
"""validate-product-lifecycle.py — validate a product-lifecycle output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'current_stage', 'signals', 'confidence', 'recommended_playbook', 'owner']
ENUMS = {'current_stage': ['idea', 'launch', 'growth', 'maturity', 'decline'], 'confidence': ['low', 'medium', 'high']}
...
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'recommended_playbook', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "product-lifecycle-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "current_stage": "idea", "signals": ["item-1", "item-2", "item-3"], "confidence": "low", "recommended_playbook": "recommended_playbook value", "owner": "@solo-founder"}')
