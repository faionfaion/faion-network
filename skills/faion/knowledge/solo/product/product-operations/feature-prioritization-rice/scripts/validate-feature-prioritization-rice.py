#!/usr/bin/env python3
"""validate-feature-prioritization-rice.py — validate a feature-prioritization-rice output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'scoring_items', 'reach_unit', 'effort_unit', 'confidence_floor', 'effort_ceiling', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = ['confidence_floor', 'effort_ceiling']
ARRAY_FIELDS = ['scoring_items']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'reach_unit', 'effort_unit', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "feature-prioritization-rice-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "scoring_items": ["item-1", "item-2", "item-3"], "reach_unit": "reach_unit value", "effort_unit": "effort_unit value", "confidence_floor": 1.0, "effort_ceiling": 1.0, "owner": "@solo-founder"}')
