#!/usr/bin/env python3
"""validate-product-analytics.py — validate a product-analytics output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'nsm', 'leading_metrics', 'health_metric', 'tracking_plan_url', 'dashboard_url', 'review_cadence', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['leading_metrics']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'nsm', 'health_metric', 'tracking_plan_url', 'dashboard_url', 'review_cadence', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "product-analytics-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "nsm": "nsm value", "leading_metrics": ["item-1", "item-2", "item-3"], "health_metric": "health_metric value", "tracking_plan_url": "notion://workspace/tracking_plan_url", "dashboard_url": "notion://workspace/dashboard_url", "review_cadence": "review_cadence value", "owner": "@solo-founder"}')
