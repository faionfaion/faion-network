#!/usr/bin/env python3
"""validate-rice-for-one-person-cheatsheet.py — validate a rice-for-one-person-cheatsheet output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'week_of', 'bets', 'committed_bet_id', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed', 'week_of']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['bets']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'committed_bet_id', 'owner']
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"rice-for-one-person-cheatsheet-example\", \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"week_of\": \"2026-05-23\", \"bets\": [\"item-1\", \"item-2\", \"item-3\"], \"committed_bet_id\": \"committed_bet_id value\", \"owner\": \"@solo-founder\"}")
