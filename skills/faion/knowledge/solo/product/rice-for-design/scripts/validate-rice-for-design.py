#!/usr/bin/env python3
"""validate-rice-for-design.py — validate a rice-for-design output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'backlog_item_id', 'reach', 'impact', 'confidence', 'effort_design_days', 'effort_dev_days', 'rice_score', 'friction_ref', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['reach']
NUM_FIELDS = ['impact', 'confidence', 'effort_design_days', 'effort_dev_days', 'rice_score']
ARRAY_FIELDS = []
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'backlog_item_id', 'friction_ref', 'owner']
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"rice-for-design-example\", \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"backlog_item_id\": \"backlog_item_id value\", \"reach\": 1, \"impact\": 1.0, \"confidence\": 1.0, \"effort_design_days\": 1.0, \"effort_dev_days\": 1.0, \"rice_score\": 1.0, \"friction_ref\": \"friction_ref value\", \"owner\": \"@solo-founder\"}")
