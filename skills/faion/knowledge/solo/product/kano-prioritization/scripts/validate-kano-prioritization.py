#!/usr/bin/env python3
"""validate-kano-prioritization.py — stdlib-only validator for the Kano Prioritization artefact.
...
KNOWN_RULE_IDS = set(["two-question-survey-form", "category-assignment-table", "minimum-sample-thirty", "revisit-cadence-90d", "reverse-features-flagged", "skip-this-methodology"])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "trigger": "Kano Prioritization engagement",
        "rules_applied": ["two-question-survey-form"],
        "evidence": [
            {
                "rule_id": "two-question-survey-form",
