#!/usr/bin/env python3
"""validate-product-discovery.py — validate a product-discovery output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'idea_brief', 'risk_value', 'risk_usability', 'risk_feasibility', 'risk_viability', 'verdict', 'evidence', 'owner']
ENUMS = {'verdict': ['go', 'hold', 'no-op']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['evidence']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'idea_brief', 'risk_value', 'risk_usability', 'risk_feasibility', 'risk_viability', 'owner']
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"product-discovery-example\", \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"idea_brief\": \"idea_brief value\", \"risk_value\": \"risk_value value\", \"risk_usability\": \"risk_usability value\", \"risk_feasibility\": \"risk_feasibility value\", \"risk_viability\": \"risk_viability value\", \"verdict\": \"go\", \"evidence\": [\"item-1\", \"item-2\", \"item-3\"], \"owner\": \"@solo-founder\"}")
