...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'product_name', 'segment', 'positioning', 'channels', 'success_metric', 'launch_date', 'owner']
ENUMS = {}
...
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'product_name', 'segment', 'positioning', 'success_metric', 'owner']
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"product-launch-example\", \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"product_name\": \"product_name value\", \"segment\": \"segment value\", \"positioning\": \"positioning value\", \"channels\": [\"item-1\", \"item-2\", \"item-3\"], \"success_metric\": \"success_metric value\", \"launch_date\": \"2026-05-23\", \"owner\": \"@solo-founder\"}")
