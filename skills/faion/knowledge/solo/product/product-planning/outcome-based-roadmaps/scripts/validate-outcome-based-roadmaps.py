#!/usr/bin/env python3
"""validate-outcome-based-roadmaps.py — validate a outcome-based-roadmaps output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'quarter', 'outcomes', 'not_doing', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['outcomes', 'not_doing']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'quarter', 'owner']
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"outcome-based-roadmaps-example\", \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"quarter\": \"quarter value\", \"outcomes\": [\"item-1\", \"item-2\", \"item-3\"], \"not_doing\": [\"item-1\", \"item-2\", \"item-3\"], \"owner\": \"@solo-founder\"}")
