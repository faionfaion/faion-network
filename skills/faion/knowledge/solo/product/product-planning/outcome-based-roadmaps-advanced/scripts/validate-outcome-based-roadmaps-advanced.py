#!/usr/bin/env python3
"""validate-outcome-based-roadmaps-advanced.py — validate a outcome-based-roadmaps-advanced output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'business_goal', 'product_outcomes', 'leading_indicators', 'experiments', 'confidence_labels', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['product_outcomes', 'leading_indicators', 'experiments', 'confidence_labels']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'business_goal', 'owner']
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"outcome-based-roadmaps-advanced-example\", \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"business_goal\": \"business_goal value\", \"product_outcomes\": [\"item-1\", \"item-2\", \"item-3\"], \"leading_indicators\": [\"item-1\", \"item-2\", \"item-3\"], \"experiments\": [\"item-1\", \"item-2\", \"item-3\"], \"confidence_labels\": [\"item-1\", \"item-2\", \"item-3\"], \"owner\": \"@solo-founder\"}")
