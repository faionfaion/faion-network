#!/usr/bin/env python3
"""validate-okr-setting.py — validate a okr-setting output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'objectives', 'checkin_cadence', 'confidence_band', 'quarter', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['objectives']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'checkin_cadence', 'confidence_band', 'quarter', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "okr-setting-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "objectives": ["item-1", "item-2", "item-3"], "checkin_cadence": "checkin_cadence value", "confidence_band": "confidence_band value", "quarter": "quarter value", "owner": "@solo-founder"}')
