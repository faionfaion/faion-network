#!/usr/bin/env python3
"""validate-ac-quality-rubric.py — validate a ac-quality-rubric output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'acceptance_criteria', 'scores', 'rejected_count', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['rejected_count']
NUM_FIELDS = []
ARRAY_FIELDS = ['acceptance_criteria', 'scores']
OBJECT_FIELDS = []
BOOL_FIELDS = []
...
VALID_FIXTURE = json.loads('{"artefact_id": "ac-quality-rubric-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "acceptance_criteria": ["item-1", "item-2", "item-3"], "scores": ["item-1", "item-2", "item-3"], "rejected_count": 3, "owner": "@solo-founder"}')
