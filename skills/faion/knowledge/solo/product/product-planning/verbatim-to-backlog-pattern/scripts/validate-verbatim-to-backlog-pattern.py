#!/usr/bin/env python3
"""validate-verbatim-to-backlog-pattern.py — validate a verbatim-to-backlog-pattern output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'card_id', 'job_story', 'verbatim_quotes', 'rice_score', 'source_cluster_id', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = ['rice_score']
ARRAY_FIELDS = ['verbatim_quotes']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'card_id', 'job_story', 'source_cluster_id', 'owner']
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"verbatim-to-backlog-pattern-example\", \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"card_id\": \"card_id value\", \"job_story\": \"job_story value\", \"verbatim_quotes\": [\"item-1\", \"item-2\", \"item-3\"], \"rice_score\": 1.0, \"source_cluster_id\": \"source_cluster_id value\", \"owner\": \"@solo-founder\"}")
