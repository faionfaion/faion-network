#!/usr/bin/env python3
"""validate-continuous-discovery.py — validate a continuous-discovery output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'weekly_touch_count', 'assumption_tree_url', 'touch_types', 'cadence_slot', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['weekly_touch_count']
NUM_FIELDS = []
ARRAY_FIELDS = ['touch_types']
OBJECT_FIELDS = ['cadence_slot']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'assumption_tree_url', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "continuous-discovery-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "weekly_touch_count": 3, "assumption_tree_url": "notion://workspace/assumption_tree_url", "touch_types": ["item-1", "item-2", "item-3"], "cadence_slot": {"key": "value"}, "owner": "@solo-founder"}')
