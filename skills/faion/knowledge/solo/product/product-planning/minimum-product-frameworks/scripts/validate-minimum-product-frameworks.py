#!/usr/bin/env python3
"""validate-minimum-product-frameworks.py — validate a minimum-product-frameworks output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'goal_statement', 'frame_chosen', 'rationale', 'downstream_methodology', 'owner']
ENUMS = {'frame_chosen': ['MVP', 'MLP', 'MMP', 'MMR']}
...
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'goal_statement', 'rationale', 'downstream_methodology', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "minimum-product-frameworks-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "goal_statement": "goal_statement value", "frame_chosen": "MVP", "rationale": "rationale value", "downstream_methodology": "downstream_methodology value", "owner": "@solo-founder"}')
