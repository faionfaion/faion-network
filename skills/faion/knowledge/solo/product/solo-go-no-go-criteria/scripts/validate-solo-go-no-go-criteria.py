#!/usr/bin/env python3
"""validate-solo-go-no-go-criteria.py — validate a solo-go-no-go-criteria output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'release_id', 'build_quality', 'scope_vs_promise', 'comms_ready', 'rollback_tested', 'metric_instrumented', 'verdict', 'owner']
...
ARRAY_FIELDS = []
OBJECT_FIELDS = []
BOOL_FIELDS = ['build_quality', 'scope_vs_promise', 'comms_ready', 'rollback_tested', 'metric_instrumented']
STRING_FIELDS = ['artefact_id', 'release_id', 'owner']
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"solo-go-no-go-criteria-example\", \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"release_id\": \"release_id value\", \"build_quality\": true, \"scope_vs_promise\": true, \"comms_ready\": true, \"rollback_tested\": true, \"metric_instrumented\": true, \"verdict\": \"go\", \"owner\": \"@solo-founder\"}")
