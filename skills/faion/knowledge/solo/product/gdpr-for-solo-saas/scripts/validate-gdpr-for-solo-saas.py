#!/usr/bin/env python3
"""validate-gdpr-for-solo-saas.py — stdlib-only validator for the Gdpr For Solo Saas artefact.
...
KNOWN_RULE_IDS = set(["data-inventory-required", "lawful-basis-per-category", "processor-dpa-tracked", "breach-response-72h", "lawyer-up-triggers-named", "skip-this-methodology", "skip-this-methodology"])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["data-inventory-required"],
        "evidence": [
            {
                "rule_id": "data-inventory-required",
