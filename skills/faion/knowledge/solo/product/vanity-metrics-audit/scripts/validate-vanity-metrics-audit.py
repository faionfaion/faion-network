#!/usr/bin/env python3
"""validate-vanity-metrics-audit.py — validate a vanity-metrics-audit output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'dashboard_name', 'vanity_metrics', 'replacements', 'stakeholder_scripts', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['vanity_metrics', 'replacements', 'stakeholder_scripts']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'dashboard_name', 'owner']
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"vanity-metrics-audit-example\", \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"dashboard_name\": \"dashboard_name value\", \"vanity_metrics\": [\"item-1\", \"item-2\", \"item-3\"], \"replacements\": [\"item-1\", \"item-2\", \"item-3\"], \"stakeholder_scripts\": [\"item-1\", \"item-2\", \"item-3\"], \"owner\": \"@solo-founder\"}")
