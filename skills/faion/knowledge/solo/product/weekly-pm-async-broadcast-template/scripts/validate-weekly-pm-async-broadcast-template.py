#!/usr/bin/env python3
"""validate-weekly-pm-async-broadcast-template.py — stdlib-only validator for the Weekly PM Async Broadcast Template artefact.
...
KNOWN_RULE_IDS = set(['single-owner', 'typed-inputs', 'version-and-reviewed', 'rationale-cites-input', 'next-step-block', 'skip-this-methodology'])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["single-owner"],
        "evidence": [
            {
                "rule_id": "single-owner",
