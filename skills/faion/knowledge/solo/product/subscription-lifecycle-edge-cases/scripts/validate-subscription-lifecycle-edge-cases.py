#!/usr/bin/env python3
"""validate-subscription-lifecycle-edge-cases.py — validate a subscription-lifecycle-edge-cases output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'cases_covered', 'dunning_policy', 'refund_policy', 'stripe_tax_enabled', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['cases_covered']
OBJECT_FIELDS = []
BOOL_FIELDS = ['stripe_tax_enabled']
STRING_FIELDS = ['artefact_id', 'dunning_policy', 'refund_policy', 'owner']
...
VALID_FIXTURE = json.loads("{\"artefact_id\": \"subscription-lifecycle-edge-cases-example\", \"version\": \"1.0.0\", \"last_reviewed\": \"2026-05-23\", \"cases_covered\": [\"item-1\", \"item-2\", \"item-3\"], \"dunning_policy\": \"dunning_policy value\", \"refund_policy\": \"refund_policy value\", \"stripe_tax_enabled\": true, \"owner\": \"@solo-founder\"}")
