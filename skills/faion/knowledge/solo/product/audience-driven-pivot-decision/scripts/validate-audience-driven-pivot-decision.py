#!/usr/bin/env python3
"""validate-audience-driven-pivot-decision.py — stdlib-only validator for the Audience Driven Pivot Decision artefact.
...
KNOWN_RULE_IDS = set(["audience-asset-required", "evidence-of-unsolved-jobs", "explicit-kill-criterion-old-product", "validation-before-build", "named-surviving-cohort", "skip-this-methodology"])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["audience-asset-required"],
        "evidence": [
            {
                "rule_id": "audience-asset-required",
