#!/usr/bin/env python3
"""validate-beta-cohort-communication.py — stdlib-only validator for the Beta Cohort Communication artefact.
...
KNOWN_RULE_IDS = set(["one-ask-per-send", "three-message-types", "named-segment-tags", "reply-sla-72h", "graduation-message-required", "skip-this-methodology"])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["one-ask-per-send"],
        "evidence": [
            {
                "rule_id": "one-ask-per-send",
