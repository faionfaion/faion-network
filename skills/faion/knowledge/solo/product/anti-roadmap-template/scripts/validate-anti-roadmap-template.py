#!/usr/bin/env python3
"""validate-anti-roadmap-template.py — stdlib-only validator for the Anti Roadmap Template artefact.
...
KNOWN_RULE_IDS = set(["rationale-per-entry", "revisit-trigger-required", "sponsor-sign-off", "expiration-date", "paired-with-roadmap", "skip-this-methodology"])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["rationale-per-entry"],
        "evidence": [
            {
                "rule_id": "rationale-per-entry",
