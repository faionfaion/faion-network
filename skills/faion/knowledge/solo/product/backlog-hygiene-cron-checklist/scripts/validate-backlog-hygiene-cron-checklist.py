#!/usr/bin/env python3
"""validate-backlog-hygiene-cron-checklist.py — stdlib-only validator for the Backlog Hygiene Cron Checklist artefact.
...
KNOWN_RULE_IDS = set(["weekly-cadence", "stale-sweep-90d", "dup-merge-mandatory", "top-10-published", "anti-roadmap-refresh", "skip-this-methodology"])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "trigger": "Backlog Hygiene Cron Checklist engagement",
        "rules_applied": ["weekly-cadence"],
        "evidence": [
            {
                "rule_id": "weekly-cadence",
