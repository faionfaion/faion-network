...
summary: An outcome-based roadmap replaces feature commitments with measurable metric movements — each row states a problem, an outcome ("metric from baseline to target by horizon"), and 2-3 candidate solutions rather than a single committed feature.
content_id: "7b806f2f25577504"
tags: [roadmap, outcome-orientation, product-strategy, metrics, solution-flexibility]
---
# Outcome-Based Roadmaps

## Summary

**One-sentence:** An outcome-based roadmap replaces feature commitments with measurable metric movements — each row states a problem, an outcome ("metric from baseline to target by horizon"), and 2-3 candidate solutions rather than a single committed feature.
