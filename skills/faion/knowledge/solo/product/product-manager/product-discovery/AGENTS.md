...
summary: Systematically de-risk ideas before committing engineering capacity by testing four risk types: Value (will customers use it?), Usability (can they figure it out?), Feasibility (can we build it?), and Business Viability (does it work for the business?).
content_id: "54103633f8df5e44"
tags: [discovery, validation, experimentation, risk-management, assumptions]
---
# Product Discovery

## Summary

**One-sentence:** Systematically de-risk ideas before committing engineering capacity by testing four risk types: Value (will customers use it?), Usability (can they figure it out?), Feasibility (can we build it?), and Business Viability (does it work for the business?).

**One-paragraph:** Systematically de-risk ideas before committing engineering capacity by testing four risk types: Value (will customers use it?), Usability (can they figure it out?), Feasibility (can we build it?), and Business Viability (does it work for the business?). Map all assumptions, tag each by risk type and severity, then design the cheapest experiment that could falsify the highest-severity assumption first. Every experiment requires a hypothesis, a success threshold, and an explicit kill threshold. Timebox each discovery cycle to 1-4 weeks.
