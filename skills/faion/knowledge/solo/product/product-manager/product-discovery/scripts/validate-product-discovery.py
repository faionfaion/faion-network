...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'cycle_id', 'risks', 'experiments', 'decision', 'kill_threshold', 'owner']
ENUMS = {'decision': ['proceed', 'pivot', 'kill', 'more-discovery']}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['risks', 'experiments']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'cycle_id', 'kill_threshold', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "product-discovery-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "cycle_id": "cycle_id value", "risks": ["item-1", "item-2", "item-3"], "experiments": ["item-1", "item-2", "item-3"], "decision": "proceed", "kill_threshold": "kill_threshold value", "owner": "@solo-founder"}')
