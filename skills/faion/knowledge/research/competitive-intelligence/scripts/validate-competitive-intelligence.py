...
Validate an artefact produced by the competitive-intelligence methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/competitive-intelligence.json", "type": "object", "required": ["artifact", "generated_at", "events", "claims", "fact_checker_passed"], "properties": {"artifact": {"enum": ["weekly_digest", "monthly_threat_assessment", "battlecard", "quarterly_strategic_report"]}, "generated_at": {"type": "string"}, "ttl_days": {"type": "integer", "maximum": 14}, "events": {"type": "array", "minItems": 1}, "claims": {"type": "array"}, "fact_checker_passed": {"type": "boolean"}}}')
