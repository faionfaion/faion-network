#!/usr/bin/env python3
"""validate-interview-hot-take-template.py — stdlib-only validator for the Interview Hot-Take Template artefact.
...
KNOWN_RULE_IDS = set(['thirty-minute-window', 'five-bullet-shape', 'verbatim-strongest-quote', 'named-next-step', 'linked-to-transcript', 'skip-this-methodology'])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["thirty-minute-window"],
        "evidence": [
            {
                "rule_id": "thirty-minute-window",
