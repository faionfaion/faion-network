...
Validate an artefact produced by the product-development-trends methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/product-development-trends.json", "type": "object", "required": ["quarter", "bets", "monitor", "ignored", "source_map"], "properties": {"quarter": {"type": "string"}, "bets": {"type": "array", "items": {"type": "object", "required": ["trend", "scores", "verdict", "kill_criteria"]}}, "monitor": {"type": "array"}, "ignored": {"type": "array"}, "source_map": {"type": "object", "required": ["academic", "practitioner", "market_signal"]}}}')
