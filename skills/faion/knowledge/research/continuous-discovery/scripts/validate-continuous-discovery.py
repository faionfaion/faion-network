...
Validate an artefact produced by the continuous-discovery methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/continuous-discovery.json", "type": "object", "required": ["cadence", "observations", "ost_delta", "assumptions_tested"], "properties": {"cadence": {"enum": ["daily", "weekly", "bi-weekly", "monthly"]}, "observations": {"type": "array", "minItems": 5}, "ost_delta": {"type": "object"}, "assumptions_tested": {"type": "array"}, "kill_list": {"type": "array"}}}')
