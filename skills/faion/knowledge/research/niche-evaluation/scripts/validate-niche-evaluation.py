#!/usr/bin/env python3
"""validate-niche-evaluation.py — stdlib-only validator for the Niche Evaluation (Researcher) artefact.
...
KNOWN_RULE_IDS = set(['evidence-link-per-row', 'interview-anchored-sizing', 'verdict-single', 'competitor-matrix-three-min', 'accessibility-named-channels', 'skip-this-methodology'])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["evidence-link-per-row"],
        "evidence": [
            {
                "rule_id": "evidence-link-per-row",
