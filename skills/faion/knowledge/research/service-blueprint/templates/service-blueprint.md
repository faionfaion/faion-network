<!-- purpose: Markdown skeleton: 5-swimlane table + moments-of-truth scoring section + backlog item slots. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a spec artefact validating against scripts/validate-service-blueprint.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# Service Blueprint — Artefact Skeleton
...
Run `python scripts/validate-service-blueprint.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
