<!-- purpose: minimal Market Research TAM SAM SOM artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: report artefact validated by scripts/validate-market-research-tam-sam-som.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Market Research TAM SAM SOM — Artefact

| Field | Value |
|-------|-------|
| artefact_id | market-research-tam-sam-som-YYYY-MM-DD |
