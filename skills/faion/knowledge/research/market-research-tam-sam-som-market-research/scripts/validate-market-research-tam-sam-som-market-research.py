...
Validate a Market Research TAM SAM SOM artefact against the JSON Schema (draft-07) defined in
...
OK = {'owner': 'ruslan@faion.net', 'last_touched': '2026-05-23T12:00:00Z', 'template_version': '1.1.0', 'artefact_id': 'market-research-tam-sam-som-2026-05-23', 'tam': {'key': 'value'}, 'sam': {'key': 'value'}, 'som': {'key': 'value'}, 'top_down_vs_bottom_up': {'key': 'value'}, 'evidence': [{'source': 'https://example.com/transcript/1', 'citation': 'verbatim user quote'}]}
