<!-- purpose: minimal Continuous Discovery artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: playbook-step artefact validated by scripts/validate-continuous-discovery.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Continuous Discovery — Artefact

| Field | Value |
|-------|-------|
| artefact_id | continuous-discovery-YYYY-MM-DD |
