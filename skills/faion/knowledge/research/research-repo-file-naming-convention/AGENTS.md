...
| `templates/research-repo-file-naming-convention.md.j2` | Markdown skeleton with the required fields. |
| `templates/research-repo-file-naming-convention.md` | Markdown skeleton with the required fields. Generated from `templates/research-repo-file-naming-convention.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
