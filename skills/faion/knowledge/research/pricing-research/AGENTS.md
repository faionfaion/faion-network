...
| `templates/quick-pricing-check.md.j2` | Quick competitor-benchmark and value-based pricing estimate with a confidence rating. |
| `templates/quick-pricing-check.md` | Quick competitor-benchmark and value-based pricing estimate with a confidence rating. Generated from `templates/quick-pricing-check.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
```json
{
  ...
  "trigger": "Pricing Research (Researcher) engagement",
  "rules_applied": [
