...
- Lowest: $X/mo
- Median: $X/mo
- Highest: $X/mo (excluding "contact us" tiers)
- Source: [list of 3-5 competitors checked]

## Value-based estimate
- Monthly value delivered: ~$X/mo
- Category capture rate: [N]% ([devtools|productivity|vertical SaaS])
- Value ceiling: $X/mo

## Customer feedback
- "Would pay": $X average (N=[N] responses; only use if N >= 10)
- Notable quote: "[...]"
