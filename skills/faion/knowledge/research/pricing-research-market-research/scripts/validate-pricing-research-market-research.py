#!/usr/bin/env python3
"""validate-pricing-research.py — stdlib-only validator for the Pricing Research (Market Researcher) artefact.
...
KNOWN_RULE_IDS = set(['value-anchored', 'vw-min-30', 'tier-feature-distribution', 'validation-five-paying', 'billing-model-named', 'skip-this-methodology'])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["value-anchored"],
        "evidence": [
            {
                "rule_id": "value-anchored",
