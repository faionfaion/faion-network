#!/usr/bin/env python3
"""validate-interview-insight-tagging-schema.py — stdlib-only validator for the Interview Insight Tagging Schema artefact.
...
KNOWN_RULE_IDS = set(['six-category-axes', 'controlled-values', 'one-tag-per-category-min', 'versioned-schema', 'segment-pinned', 'skip-this-methodology'])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["six-category-axes"],
        "evidence": [
            {
                "rule_id": "six-category-axes",
