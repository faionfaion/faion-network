...
| File | Purpose |
|------|---------|
| `templates/beta-cohort-recruitment.md.j2` | Markdown skeleton for the playbook-step artefact, matching content/02-output-contract.xml |
| `templates/beta-cohort-recruitment.md` | Markdown skeleton for the playbook-step artefact, matching content/02-output-contract.xml Generated from `templates/beta-cohort-recruitment.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/beta-cohort-recruitment.schema.json`

```json
{
  "artefact_id": "REPLACE-WITH-ULID",
  "trigger": "Private-Beta / Design-Partner Cohort Recruitment engagement",
  "rules_applied": [
