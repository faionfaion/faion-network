#!/usr/bin/env python3
"""validate-beta-cohort-recruitment.py — stdlib-only validator for the Private-Beta / Design-Partner Cohort Recruitment artefact.
...
KNOWN_RULE_IDS = set(['vetted-entry', 'signed-expectations', 'cadence-tracked', 'value-exchange-named', 'exit-ramp', 'skip-this-methodology'])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["vetted-entry"],
        "evidence": [
            {
                "rule_id": "vetted-entry",
