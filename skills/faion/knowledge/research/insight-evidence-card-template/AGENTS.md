...
| File | Purpose |
|------|---------|
| `templates/insight-evidence-card-template.md.j2` | Markdown skeleton for the spec artefact, matching content/02-output-contract.xml |
| `templates/insight-evidence-card-template.md` | Markdown skeleton for the spec artefact, matching content/02-output-contract.xml Generated from `templates/insight-evidence-card-template.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/insight-evidence-card-template.schema.json`

```json
{
  "artefact_id": "REPLACE-WITH-ULID",
  "trigger": "Insight Evidence Card Template engagement",
  "rules_applied": [
