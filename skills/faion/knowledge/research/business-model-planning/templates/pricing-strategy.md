<!-- purpose: pricing-strategy.md skeleton for Business Model Planning -->
...
### Competitor Pricing (from competitor-analysis output)
...
### Value Analysis
- Cost of problem eliminated: $X/month (source: [customer interview or case study])
- Time saved: X hours/month × $Y/hour = $Z/month value
- Value capture rate target: 10-20% of savings
