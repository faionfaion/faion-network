#!/usr/bin/env python3
"""validate-affinity-diagramming.py — stdlib-only validator for the Affinity Diagramming artefact.
...
KNOWN_RULE_IDS = set(['silent-first-pass', 'label-after-cluster', 'orphan-bucket', 'size-confidence-per-cluster', 'segment-tag-preserved', 'skip-this-methodology'])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["silent-first-pass"],
        "evidence": [
            {
                "rule_id": "silent-first-pass",
