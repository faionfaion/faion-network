...
| `templates/trend-report.md.j2` | Platform/consumer trend brief with a kill-list of retired GTM assumptions and regional notes. |
| `templates/trend-report.md` | Platform/consumer trend brief with a kill-list of retired GTM assumptions and regional notes. Generated from `templates/trend-report.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
```json
{
  ...
  "artefact_id": "product-development-trends-2026-05-23",
  "trends": [
    {
