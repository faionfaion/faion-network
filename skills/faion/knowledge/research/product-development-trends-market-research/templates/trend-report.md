...
### Platform Trends (fast-moving, technology-driven)

| Score | Trend | State | Confidence | Market implication | Source | Date |
|-------|-------|-------|------------|-------------------|--------|------|
| X | [trend] | accepted/contested/declining/emerging | 0.X | [TAM shift / pricing / positioning] | [URL] | YYYY-MM-DD |

### Consumer Trends (slow-moving, demographic)
...
For every adopted trend: name one current GTM/pricing assumption to retire.
...
| Region | Key variance | Source |
|--------|-------------|--------|
| EU | [how EU market differs] | [URL] |
| APAC | [how APAC market differs] | [URL] |

---

**Human checkpoint required** before writing into .aidocs/product_docs/.
Signal audit trail: .aidocs/research/raw/signals.jsonl
