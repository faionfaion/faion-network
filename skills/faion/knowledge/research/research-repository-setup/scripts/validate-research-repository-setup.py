#!/usr/bin/env python3
"""validate-research-repository-setup.py

Validate an artefact produced by the research-repository-setup methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/research-repository-setup.json", "type": "object", "required": ["platform", "taxonomy", "access_matrix", "ingestion_sources", "backfill"], "properties": {"platform": {"type": "object", "required": ["picked", "scorecard"]}, "taxonomy": {"type": "object", "required": ["classes", "tag_count"], "properties": {"tag_count": {"type": "integer", "minimum": 30, "maximum": 80}}}, "access_matrix": {"type": "object"}, "ingestion_sources": {"type": "array", "minItems": 1}, "backfill": {"type": "object", "required": ["window_days", "completed"]}}}')
