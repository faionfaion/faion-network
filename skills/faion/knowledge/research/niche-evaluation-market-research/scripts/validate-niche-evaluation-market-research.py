#!/usr/bin/env python3
"""validate-niche-evaluation.py — stdlib-only validator for the Niche Evaluation (Market Researcher) artefact.
...
KNOWN_RULE_IDS = set(['niche-formula', 'cited-sizing', 'competitor-matrix-three-min', 'accessibility-named-channels', 'verdict-single', 'skip-this-methodology'])
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["niche-formula"],
        "evidence": [
            {
                "rule_id": "niche-formula",
