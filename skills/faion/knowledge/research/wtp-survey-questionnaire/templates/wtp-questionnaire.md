<!-- purpose: Four Van Westendorp questions + five-point Gabor-Granger ladder + segment screener. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a report artefact validating against scripts/validate-wtp-survey-questionnaire.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# WTP Survey Questionnaire — Artefact Skeleton
...
Run `python scripts/validate-wtp-survey-questionnaire.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
