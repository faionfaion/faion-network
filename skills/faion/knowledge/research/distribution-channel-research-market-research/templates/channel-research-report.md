...
| Channel | Audience (25%) | Cost (20%) | Time (15%) | Scale (15%) | Fit (15%) | Team (10%) | Score |
|---------|---------------|------------|------------|-------------|-----------|------------|-------|
...
| Channel | CAC Est. | LTV:CAC | Time to ROI | Source | Capture date |
|---------|----------|---------|-------------|--------|--------------|
| [Ch 1] | $X | X:1 | X weeks | [URL] | YYYY-MM-DD |
| [Ch 2] | $X | X:1 | X months | [URL] | YYYY-MM-DD |
