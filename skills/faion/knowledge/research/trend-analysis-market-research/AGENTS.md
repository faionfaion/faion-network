...
| `templates/trend-analysis-report.md.j2` | Full trend-analysis report -- STEEP analysis, counter-signals, competitive landscape and a scored opportunity assessment. |
| `templates/trend-analysis-report.md` | Full trend-analysis report -- STEEP analysis, counter-signals, competitive landscape and a scored opportunity assessment. Generated from `templates/trend-analysis-report.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
| `templates/trend-monitoring-dashboard.md.j2` | Monthly recurring trend-watch dashboard tracking monitored trends, new signals and counter-signals. |
| `templates/trend-monitoring-dashboard.md` | Monthly recurring trend-watch dashboard tracking monitored trends, new signals and counter-signals. Generated from `templates/trend-monitoring-dashboard.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
```json
{
  ...
  "artefact_id": "trend-analysis-2026-05-23",
  "horizon_months": 1,
  "trends": [
    {
