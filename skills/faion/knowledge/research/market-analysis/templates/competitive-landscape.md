...
Same solution, same problem, same customer.

| # | Name | URL | Pricing (from page) | Key differentiator | Snapshot |
|---|------|-----|---------------------|--------------------|---------|
| 1 | | | | | `snapshots/YYYY-MM-DD/01-name.md` |
| 2 | | | | | |
| 3 | | | | | |
| 4 | | | | | |
| 5 | | | | | |

*Cap: 10 direct. Each entry requires a working URL and snapshot.*
...
| # | Name | URL | How they solve the problem | Why buyers choose them |
|---|------|-----|---------------------------|------------------------|
| 1 | | | | |
| 2 | | | | |
| 3 | | | | |
...
Alternative approach that bypasses the category entirely.
...
Companies that could enter using their existing capabilities and distribution.

| # | Company | Current product | Entry vector | Probability | Trigger to watch |
|---|---------|-----------------|--------------|-------------|-----------------|
| 1 | | | | [High/Med/Low] | |
| 2 | | | | | |
...
Gaps confirmed by the feature-matrix pass. Each gap must be falsifiable.
...
| Competitor | Type | Price range | Strengths | Weaknesses | Threat level |
|------------|------|-------------|-----------|------------|-------------|
| | Direct | | | | [High/Med/Low] |
| | Indirect | | | | |
| | Substitute | | | | |
...
## Sources and Snapshot Log

| Competitor | URL fetched | Snapshot file | Date |
|------------|-------------|---------------|------|
| | | | |
