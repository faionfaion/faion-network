...
Validate an artefact produced by the risk-assessment methodology against the JSON
...
SCHEMA = json.loads('{"$schema": "http://json-schema.org/draft-07/schema#", "$id": "https://faion.net/schemas/risk-assessment.json", "type": "object", "required": ["date", "risks", "parked"], "properties": {"date": {"type": "string"}, "risks": {"type": "array", "minItems": 1, "maxItems": 7, "items": {"type": "object", "required": ["id", "title", "likelihood", "severity", "owner", "trigger", "decision"]}}, "parked": {"type": "array"}}}')
