<!-- purpose: minimal Mixed-Methods Triangulation artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: report artefact validated by scripts/validate-mixed-methods-triangulation.py -->
<!-- depends-on: content/01-core-rules.xml + content/02-output-contract.xml -->
<!-- token-budget-impact: ~500-1500 tokens when filled -->

# Mixed-Methods Triangulation — Artefact

| Field | Value |
|-------|-------|
| artefact_id | mixed-methods-triangulation-YYYY-MM-DD |
