<!-- purpose: minimal Competitor Analysis artefact skeleton conforming to content/02-output-contract.xml -->
<!-- consumes: input brief + source-of-truth refs declared in AGENTS.md prerequisites -->
<!-- produces: report artefact validated by scripts/validate-competitor-analysis.py -->
...
| Field | Value |
|-------|-------|
| artefact_id | competitor-analysis-YYYY-MM-DD |
