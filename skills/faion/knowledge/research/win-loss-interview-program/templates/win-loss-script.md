<!-- purpose: Interview script: 7 evidence-anchored questions + neutral-interviewer notes. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a report artefact validating against scripts/validate-win-loss-interview-program.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# Win-Loss Interview Program — Artefact Skeleton
...
Run `python scripts/validate-win-loss-interview-program.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
