#!/usr/bin/env python3
"""validate-ecommerce-checkout-ba-pack.py

Validate the artefact for ecommerce-checkout-ba-pack against the schema in content/02-output-contract.xml.
...
OK_FIXTURE = json.dumps(
    {
        ...
        "trigger": "ecommerce-checkout-ba-pack engagement",
        "rules_applied": ["flow-states-enumerated"],
        "evidence": [
            {
                "rule_id": "flow-states-enumerated",
