#!/usr/bin/env python3
"""validate-demo-recap-email-template.py

Validate the artefact for demo-recap-email-template against the schema in content/02-output-contract.xml.
...
OK_FIXTURE = json.dumps(
    {
        ...
        "trigger": "demo-recap-email-template engagement",
        "rules_applied": ["six-block-shape"],
        "evidence": [
            {
                "rule_id": "six-block-shape",
