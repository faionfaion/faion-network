#!/usr/bin/env python3
"""validate-freelance-proposal-template.py

Validate the artefact for freelance-proposal-template against the schema in content/02-output-contract.xml.
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["scope-envelope-explicit"],
        "evidence": [
            {
                "rule_id": "scope-envelope-explicit",
