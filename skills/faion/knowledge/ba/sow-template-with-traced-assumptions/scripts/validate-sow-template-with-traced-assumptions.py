#!/usr/bin/env python3
"""validate-sow-template-with-traced-assumptions.py — stdlib-only validator for the SoW Template with Traced Assumptions spec artefact.
