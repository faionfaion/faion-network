...
| File | Purpose |
|------|---------|
| `templates/sow-template-with-traced-assumptions.md.j2` | Working spec skeleton with 5-line header |
| `templates/sow-template-with-traced-assumptions.md` | Working spec skeleton with 5-line header Generated from `templates/sow-template-with-traced-assumptions.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
