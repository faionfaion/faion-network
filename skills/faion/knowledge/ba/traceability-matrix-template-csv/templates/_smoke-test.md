...
<!-- produces: artefact instance that MUST validate via scripts/validate-traceability-matrix-template-csv.py -->
<!-- depends-on: templates/traceability-matrix-template-csv.md, content/02-output-contract.xml -->
<!-- token-budget-impact: ~200 tokens -->

# Traceability Matrix Template (CSV) — Smoke Test Fixture

```json
{
  "artefact_id": "traceability-matrix-template-csv-acme-2026-05-23",
