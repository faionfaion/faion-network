...
| File | Purpose |
|------|---------|
| `templates/traceability-matrix-template-csv.md.j2` | Working spec skeleton with 5-line header |
| `templates/traceability-matrix-template-csv.md` | Working spec skeleton with 5-line header Generated from `templates/traceability-matrix-template-csv.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
