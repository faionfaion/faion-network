#!/usr/bin/env python3
"""validate-traceability-matrix-template-csv.py — stdlib-only validator for the Traceability Matrix Template (CSV) spec artefact.
