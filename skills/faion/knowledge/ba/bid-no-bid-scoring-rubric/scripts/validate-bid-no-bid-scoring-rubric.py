#!/usr/bin/env python3
"""validate-bid-no-bid-scoring-rubric.py

Validate a Bid / No-Bid Scoring Rubric artefact against 02-output-contract.xml.
...
ANON = {"team", "we", "us", "ops", "?", ""}
REQUIRED = ('opportunity_id', 'version', 'dimensions', 'scores', 'weighted_total', 'threshold', 'approver',)
...
OK_FIXTURE = {'version': 'v1.0.0', 'opportunity_id': 'opp-acme', 'dimensions': [{'name': 'fit', 'weight': 0.3}], 'scores': [{'dim': 'fit', 'score': 4}], 'weighted_total': 78, 'threshold': 70, 'approver': {'name': 'Pedro Silva', 'role': 'CFO', 'ts': '2026-05-23T17:00:00Z'}}
BAD_FIXTURE = {}
