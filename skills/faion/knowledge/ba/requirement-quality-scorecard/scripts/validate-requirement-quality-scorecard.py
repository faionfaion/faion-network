#!/usr/bin/env python3
"""validate-requirement-quality-scorecard.py

Validate the artefact for requirement-quality-scorecard against the schema in content/02-output-contract.xml.
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["six-axis-shape"],
        "evidence": [
            {
                "rule_id": "six-axis-shape",
