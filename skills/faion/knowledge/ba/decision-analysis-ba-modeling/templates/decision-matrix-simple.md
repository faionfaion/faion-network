<!-- purpose: lightweight 3-option × 3-criteria decision matrix -->
<!-- consumes: brief + option list + initial criteria -->
<!-- produces: condensed scoring snapshot, not a full record -->
