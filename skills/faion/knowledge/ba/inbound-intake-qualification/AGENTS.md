...
| File | Purpose |
|------|---------|
| `templates/inbound-intake-qualification.md.j2` | Markdown rubric template with scoring axes + thresholds |
| `templates/inbound-intake-qualification.md` | Markdown rubric template with scoring axes + thresholds Generated from `templates/inbound-intake-qualification.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/inbound-intake-qualification.schema.json`
