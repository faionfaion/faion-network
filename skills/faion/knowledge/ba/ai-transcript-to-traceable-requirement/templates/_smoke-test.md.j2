<!--
purpose: Filled-in minimum viable example of a AI Transcript to Traceable Requirement artefact.
consumes: nothing — fixture.
produces: a worked Markdown example for tests / docs.
depends-on: content/02-output-contract.xml + templates/ai-transcript-to-traceable-requirement.md.
token-budget-impact: ~150 tokens.
-->

# AI Transcript to Traceable Requirement — att-smoke-001

- **artefact_id**: att-smoke-001
...
Apply the ai-transcript-to-traceable-requirement procedure to the pilot engagement; emit artefact bound to the scope doc.
