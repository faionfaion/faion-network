<!--
purpose: Filled-in minimum viable example of a Fixed-Price vs T&M Change-Request Pricing Playbook artefact.
consumes: nothing — fixture.
produces: a worked Markdown example for tests / docs.
depends-on: content/02-output-contract.xml + templates/fixed-price-vs-tm-cr-pricing-playbook.md.
token-budget-impact: ~150 tokens.
-->

# Fixed-Price vs T&M Change-Request Pricing Playbook — fpcr-smoke-001

- **artefact_id**: fpcr-smoke-001
...
Apply the fixed-price-vs-tm-cr-pricing-playbook procedure to the pilot engagement; emit artefact bound to the scope doc.
