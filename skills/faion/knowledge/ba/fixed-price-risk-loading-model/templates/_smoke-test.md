<!--
purpose: Filled-in minimum viable example of a Fixed-Price Risk Loading Model artefact.
consumes: nothing — fixture.
produces: a worked Markdown example for tests / docs.
depends-on: content/02-output-contract.xml + templates/fixed-price-risk-loading-model.md.
token-budget-impact: ~150 tokens.
-->

# Fixed-Price Risk Loading Model — fprl-smoke-001

- **artefact_id**: fprl-smoke-001
...
Apply the fixed-price-risk-loading-model procedure to the pilot engagement; emit artefact bound to the scope doc.
