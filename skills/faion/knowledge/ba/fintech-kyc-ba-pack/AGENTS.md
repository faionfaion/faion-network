...
| `templates/fintech-kyc-ba-pack.md.j2` | Markdown skeleton with the required fields |
| `templates/fintech-kyc-ba-pack.md` | Markdown skeleton with the required fields Generated from `templates/fintech-kyc-ba-pack.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
| `templates/_smoke-test.md.j2` | Filled-in minimum viable example of a fintech-kyc-ba-pack record |
| `templates/_smoke-test.md` | Filled-in minimum viable example of a fintech-kyc-ba-pack record Generated from `templates/_smoke-test.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/fintech-kyc-ba-pack.json`

```json
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://faion.network/schema/fintech-kyc-ba-pack.json",
  "type": "object",
  "required": [
    "artefact_id",
    "owner",
