#!/usr/bin/env python3
"""validate-process-mining-tool-shortlist.py

Validate the artefact for process-mining-tool-shortlist against the schema in content/02-output-contract.xml.
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["weighted-criteria"],
        "evidence": [
            {
                "rule_id": "weighted-criteria",
