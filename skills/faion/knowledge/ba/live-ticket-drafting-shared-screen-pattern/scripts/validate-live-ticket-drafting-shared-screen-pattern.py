#!/usr/bin/env python3
"""validate-live-ticket-drafting-shared-screen-pattern.py

Validate the artefact for live-ticket-drafting-shared-screen-pattern against the schema in content/02-output-contract.xml.
...
OK_FIXTURE = json.dumps(
    {
        ...
        "trigger": "live-ticket-drafting-shared-screen-pattern engagement",
        "rules_applied": ["draft-in-session"],
        "evidence": [
            {
                "rule_id": "draft-in-session",
