#!/usr/bin/env python3
"""validate-facilitation-anti-patterns.py

Validate the artefact for facilitation-anti-patterns against the schema in content/02-output-contract.xml.
...
OK_FIXTURE = json.dumps(
    {
        ...
        "trigger": "facilitation-anti-patterns engagement",
        "rules_applied": ["break-sponsor-monologue-at-5min"],
        "evidence": [
            {
                "rule_id": "break-sponsor-monologue-at-5min",
