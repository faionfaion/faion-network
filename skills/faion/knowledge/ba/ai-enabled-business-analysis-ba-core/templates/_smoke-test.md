<!--
purpose: Filled-in minimum viable example of a AI-Enabled Business Analysis artefact.
...
# AI-Enabled Business Analysis — aiba-smoke-001

- **artefact_id**: aiba-smoke-001
