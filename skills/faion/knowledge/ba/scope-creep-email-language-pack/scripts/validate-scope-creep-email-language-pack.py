#!/usr/bin/env python3
"""validate-scope-creep-email-language-pack.py — stdlib-only validator for the Scope-Creep Email Language Pack checklist artefact.
