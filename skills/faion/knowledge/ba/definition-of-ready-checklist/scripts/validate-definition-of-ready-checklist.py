#!/usr/bin/env python3
"""validate-definition-of-ready-checklist.py

Validate the artefact for definition-of-ready-checklist against the schema in content/02-output-contract.xml.
...
OK_FIXTURE = json.dumps(
    {
        ...
        "rules_applied": ["eight-item-gate"],
        "evidence": [
            {
                "rule_id": "eight-item-gate",
