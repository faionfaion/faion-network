...
_Skeleton for the `ai-feature-build-buy-finetune-decision` methodology output. Fill each section; do not leave headings empty._
...
- Timestamp
- Validator run: `python scripts/validate-ai-feature-build-buy-finetune-decision.py --file out.json`
