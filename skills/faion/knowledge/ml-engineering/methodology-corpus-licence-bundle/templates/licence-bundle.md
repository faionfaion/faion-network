<!--
purpose: Per-customer licence bundle skeleton with all 5 sections
consumes: Inputs declared in `AGENTS.md` Prerequisites.
produces: Filled artefact for `methodology-corpus-licence-bundle` matching `content/02-output-contract.xml`.
depends-on: `content/01-core-rules.xml`, `scripts/validate-methodology-corpus-licence-bundle.py`.
