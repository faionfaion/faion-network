#!/usr/bin/env python3
# purpose: validate fine-tuning-openai-production JSON artefact against 02-output-contract schema
...
"""validate-fine-tuning-openai-production.py — validate a fine-tuning-openai-production JSON artefact.
...
REQUIRED = ['registry_id', 'model_id', 'base_model', 'dataset_hash', 'eval_score', 'status']
