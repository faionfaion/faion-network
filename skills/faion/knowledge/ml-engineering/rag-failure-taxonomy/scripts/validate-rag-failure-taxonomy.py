#!/usr/bin/env python3
"""validate-rag-failure-taxonomy.

Validates a rag-failure-taxonomy output JSON against the 02-output-contract schema.
...
REQUIRED = {"incident_id", "query", "primary_label", "evidence", "reviewer_id"}
