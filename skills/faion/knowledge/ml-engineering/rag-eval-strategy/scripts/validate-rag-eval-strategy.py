#!/usr/bin/env python3
"""validate-rag-eval-strategy.

Validates a rag-eval-strategy output JSON against the 02-output-contract schema.
...
REQUIRED = {"gates", "tiers", "sampling", "rollback", "owner", "revisit_date"}
