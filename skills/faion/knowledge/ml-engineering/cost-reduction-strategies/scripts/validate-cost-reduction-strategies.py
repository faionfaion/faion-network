#!/usr/bin/env python3
# purpose: validate cost-reduction-strategies JSON artefact against 02-output-contract schema
...
"""validate-cost-reduction-strategies.py — validate a cost-reduction-strategies JSON artefact.
...
REQUIRED = ['report_id', 'baseline_usd_month', 'post_usd_month', 'quality_delta', 'latency_delta_ms']

TYPE_MAP = {
    'report_id': 'string',
    'baseline_usd_month': 'number',
    'post_usd_month': 'number',
    'levers': 'object',
