#!/usr/bin/env python3
# purpose: validate vision-provider-selection JSON artefact against 02-output-contract schema
...
"""validate-vision-provider-selection.py — validate a vision-provider-selection JSON artefact.
...
REQUIRED = ['decision_id', 'selected_vlm', 'budget_usd_month', 'fallback_vlm', 'expected_volume']
