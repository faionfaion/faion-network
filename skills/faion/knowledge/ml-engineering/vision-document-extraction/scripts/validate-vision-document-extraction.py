#!/usr/bin/env python3
# purpose: validate vision-document-extraction JSON artefact against 02-output-contract schema
...
"""validate-vision-document-extraction.py — validate a vision-document-extraction JSON artefact.
...
REQUIRED = ['doc_id', 'doc_type', 'validation_status', 'review_queue_id']
