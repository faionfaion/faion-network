#!/usr/bin/env python3
"""validate-rag.py — validate an output artefact against the rag contract.
...
SMOKE = {'slug': 'rag', 'version': '1.0.0', 'date': '2026-05-22', 'produces': 'spec', 'signature': '16c058db94cba3bd', 'payload': {'title': 'Worked spec', 'sections': ['Intro', 'Requirements', 'Acceptance']}, 'forbidden_seen': []}
