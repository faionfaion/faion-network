...
| Lighting | <natural_light_direction> |
...
- Sora: "starting with <first_state>, gradually transitioning to <second_state> over the clip"
- Veo: "ambient <audio_cue>; subtle <sound>; 4K resolution"

## Concatenated prompt
<subject>, <action>, in <setting>. Style: <style>. Camera: <camera>. Lighting: <lighting>. <provider_overlay>
