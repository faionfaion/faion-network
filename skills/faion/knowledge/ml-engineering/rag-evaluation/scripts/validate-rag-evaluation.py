#!/usr/bin/env python3
"""validate-rag-evaluation.py — validate an output artefact against the rag-evaluation contract.
...
SMOKE = {'slug': 'rag-evaluation', 'version': '1.0.0', 'date': '2026-05-22', 'produces': 'report', 'signature': 'e0dd7566a01ba1dd', 'payload': {'metrics': {'accuracy': 0.91}, 'narrative': 'Accuracy improved 3.6 pp on the frozen eval suite.', 'caveats': ['LLM-as-judge variance ±3%.']}, 'forbidden_seen': []}
