<!-- purpose: Rollout playbook-step skeleton -->
...
_Skeleton for the `ai-feature-progressive-rollout` methodology output. Fill each section; do not leave headings empty._
...
- Timestamp
- Validator run: `python scripts/validate-ai-feature-progressive-rollout.py --file out.json`
