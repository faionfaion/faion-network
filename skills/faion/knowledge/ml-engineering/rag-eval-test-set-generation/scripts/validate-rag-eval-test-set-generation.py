#!/usr/bin/env python3
"""validate-rag-eval-test-set-generation.

Validates a rag-eval-test-set-generation output JSON against the 02-output-contract schema.
...
REQUIRED = {"query_id", "query", "query_type", "relevant_chunk_ids", "source", "human_checked"}
