#!/usr/bin/env python3
"""validate-prompt-engineering-reasoning.py — validate an output artefact against the prompt-engineering-reasoning contract.
...
SMOKE = {'slug': 'prompt-engineering-reasoning', 'version': '1.0.0', 'date': '2026-05-22', 'produces': 'playbook-step', 'signature': '6600177b05dad9b9', 'payload': {'trigger': 'deploy event', 'action': 'rollout 5% canary', 'verification': 'eval delta within ±2 pp', 'rollback': 'gateway rollback to prev hash'}, 'forbidden_seen': []}
