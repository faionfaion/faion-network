#!/usr/bin/env python3
# purpose: validate evaluation-benchmarks JSON artefact against 02-output-contract schema
...
"""validate-evaluation-benchmarks.py — validate a evaluation-benchmarks JSON artefact.
...
REQUIRED = ['benchmark_id', 'baseline_model_id', 'contender_model_id', 'win_rate', 'drift_alert']

TYPE_MAP = {
    'benchmark_id': 'string',
    'baseline_model_id': 'string',
    'contender_model_id': 'string',
    'win_rate': 'number',
    'ci_95': 'object',
    'drift_alert': 'boolean',
}
