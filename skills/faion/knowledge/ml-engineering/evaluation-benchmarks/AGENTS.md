...
| File | Purpose |
|------|---------|
| `templates/leaderboard.md.j2` | Multi-model leaderboard skeleton |
| `templates/leaderboard.md` | Multi-model leaderboard skeleton Generated from `templates/leaderboard.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
