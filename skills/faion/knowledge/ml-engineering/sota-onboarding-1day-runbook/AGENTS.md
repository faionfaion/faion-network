...
| `templates/decision-record.md.j2` | 1-page decision record skeleton. |
| `templates/decision-record.md` | 1-page decision record skeleton. Generated from `templates/decision-record.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
