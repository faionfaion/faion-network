#!/usr/bin/env python3
"""validate-fine-tuning-openai-dpo.py — Validate output artifact for `fine-tuning-openai-dpo` methodology.
...
REQUIRED = ['sft_base_model_id', 'pair_count', 'beta', 'epochs', 'inter_rater_agreement', 'preference_eval_gate_passed']
ENUMS = json.loads('{}')
