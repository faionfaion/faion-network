#!/usr/bin/env python3
"""validate-rag-eval-production-monitoring.

Validates a rag-eval-production-monitoring output JSON against the 02-output-contract schema.
...
REQUIRED = {"window", "n_queries", "latency", "hit_rate", "feedback", "thresholds", "anomalies"}
