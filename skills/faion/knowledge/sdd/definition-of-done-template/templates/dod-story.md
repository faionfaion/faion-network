<!-- purpose: Story DoD checklist with binary gates + per-gate signoff. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a checklist artefact validating against scripts/validate-definition-of-done-template.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# Definition of Done Template — Artefact Skeleton
...
Run `python scripts/validate-definition-of-done-template.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
