#!/usr/bin/env python3
"""validate-agents-md-for-receiving-team.py — stdlib-only validator for the AGENTS.md for Receiving Team spec artefact.
...
OK_JSON = """{"artefact_id": "agents-md-for-receiving-team-acme-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "inputs_used": [{"name": "engagement charter", "source": "docs/charters/acme.md"}], "sections": [{"heading": "Context", "body": "bounded scope"}, {"heading": "Decision", "body": "adopt"}], "decision": "Adopt the methodology"}"""
