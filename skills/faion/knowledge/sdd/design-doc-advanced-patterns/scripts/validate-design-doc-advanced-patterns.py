#!/usr/bin/env python3
"""validate-design-doc-advanced-patterns.py — validate a design-doc-advanced-patterns output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'base_doc_path', 'triggers_fired', 'blocks_included', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = ['rollback_budget_minutes']
NUM_FIELDS = []
ARRAY_FIELDS = ['triggers_fired', 'blocks_included', 'capacity_sources']
OBJECT_FIELDS = ['mttr_minutes']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'base_doc_path', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "design-doc-advanced-patterns-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "base_doc_path": "base_doc_path value", "triggers_fired": ["item-1", "item-2", "item-3"], "blocks_included": ["item-1", "item-2", "item-3"], "capacity_sources": ["item-1", "item-2", "item-3"], "mttr_minutes": {"key": "value"}, "rollback_budget_minutes": 1, "owner": "@solo-founder"}')
