#!/usr/bin/env python3
"""validate-design-doc-structure.py — validate a design-doc-structure output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'spec_path', 'context', 'design', 'alternatives', 'risks', 'rollout', 'adrs_cited', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['alternatives', 'risks', 'adrs_cited']
OBJECT_FIELDS = ['rollout']
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'spec_path', 'context', 'design', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "design-doc-structure-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "spec_path": "spec_path value", "context": "context value", "design": "design value", "alternatives": ["item-1", "item-2", "item-3"], "risks": ["item-1", "item-2", "item-3"], "rollout": {"key": "value"}, "adrs_cited": ["item-1", "item-2", "item-3"], "owner": "@solo-founder"}')
