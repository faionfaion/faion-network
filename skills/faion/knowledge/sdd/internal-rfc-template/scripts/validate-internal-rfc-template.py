#!/usr/bin/env python3
"""validate-internal-rfc-template.py

Validate the artefact produced by the `internal-rfc-template` methodology against the schema
...
EXPECTED_SLUG = "internal-rfc-template"
