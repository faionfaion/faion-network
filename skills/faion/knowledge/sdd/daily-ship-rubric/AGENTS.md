...
| `templates/daily-ship-rubric.md.j2` | Markdown skeleton with the required fields. |
| `templates/daily-ship-rubric.md` | Markdown skeleton with the required fields. Generated from `templates/daily-ship-rubric.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
