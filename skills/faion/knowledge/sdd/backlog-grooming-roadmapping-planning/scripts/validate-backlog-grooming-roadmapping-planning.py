#!/usr/bin/env python3
"""validate-backlog-grooming-roadmapping.py — validate a backlog-grooming-roadmapping output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'grooming_date', 'items_total', 'items_promoted', 'items_culled', 'horizons', 'theme_orphans', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed', 'grooming_date']
INT_FIELDS = ['items_total', 'items_promoted', 'items_culled']
NUM_FIELDS = []
ARRAY_FIELDS = ['theme_orphans']
OBJECT_FIELDS = ['horizons']
BOOL_FIELDS = []
...
VALID_FIXTURE = json.loads('{"artefact_id": "backlog-grooming-roadmapping-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "grooming_date": "2026-05-23", "items_total": 1, "items_promoted": 1, "items_culled": 1, "horizons": {"key": "value"}, "theme_orphans": ["item-1", "item-2", "item-3"], "owner": "@solo-founder"}')
