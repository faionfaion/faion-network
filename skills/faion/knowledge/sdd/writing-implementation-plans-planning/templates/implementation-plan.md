...
|----|-------|-------|------------|------------|-----------|
| TASK_001 | <first_task_title> | [path, path] | [int ≤100000] | — | AD-<task_001>, FR-<task_001> |
| TASK_002 | <imperative_title> | [path, path] | [int ≤100000] | TASK_001 | AD-<task_002> |
...
- <risk_statement> (mitigation: <action>).

## Testing Strategy

- AD-<ad> covered by [unit|integration|e2e|contract] tests at TASK_[NNN].
