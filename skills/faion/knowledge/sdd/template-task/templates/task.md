...
Covered by this task: <which_part>
...
- [ ] AC-<ac>.1: Given <precondition> / When <action> / Then <verifiable_result>
- [ ] AC-<ac>.2: Given <precondition> / When <action> / Then <verifiable_result>

---

## Technical Approach

1. Read <existing_file> to understand <pattern>
