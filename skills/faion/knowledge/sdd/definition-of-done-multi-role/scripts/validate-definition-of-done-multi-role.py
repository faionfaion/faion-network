#!/usr/bin/env python3
"""validate-definition-of-done-multi-role.py

Validate the artefact produced by the `definition-of-done-multi-role` methodology against the schema
...
EXPECTED_SLUG = "definition-of-done-multi-role"
