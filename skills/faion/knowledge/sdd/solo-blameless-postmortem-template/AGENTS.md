...
| `templates/solo-blameless-postmortem-template.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/solo-blameless-postmortem-template.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/solo-blameless-postmortem-template.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
