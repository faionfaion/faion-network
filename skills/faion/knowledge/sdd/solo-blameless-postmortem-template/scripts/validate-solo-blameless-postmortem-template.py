#!/usr/bin/env python3
"""validate-solo-blameless-postmortem-template.py — validate a solo-blameless-postmortem-template output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'owner', 'subject', 'findings', 'score', 'verdict']
ENUMS = {}
...
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'subject', 'verdict']
...
VALID_FIXTURE = json.loads('{"artefact_id": "solo-blameless-postmortem-template-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "owner": "@solo-founder", "subject": "subject of the report", "findings": ["finding-1", "finding-2", "finding-3"], "score": 0.82, "verdict": "pass"}')
