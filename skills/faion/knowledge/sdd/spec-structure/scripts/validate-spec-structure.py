#!/usr/bin/env python3
"""validate-spec-structure.py — validate a spec-structure output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'problem', 'users', 'goals', 'non_goals', 'requirements', 'acceptance_criteria', 'open_questions', 'owner']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['users', 'goals', 'non_goals', 'requirements', 'acceptance_criteria', 'open_questions']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'problem', 'owner']
...
VALID_FIXTURE = json.loads('{"artefact_id": "spec-structure-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "problem": "problem value", "users": ["item-1", "item-2", "item-3"], "goals": ["item-1", "item-2", "item-3"], "non_goals": ["item-1", "item-2", "item-3"], "requirements": ["item-1", "item-2", "item-3"], "acceptance_criteria": ["item-1", "item-2", "item-3"], "open_questions": ["item-1", "item-2", "item-3"], "owner": "@solo-founder"}')
