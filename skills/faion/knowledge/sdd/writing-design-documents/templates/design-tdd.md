<!--
purpose: Technical Design Document — background, requirements, detailed design, APIs, data storage, error handling, security, trade-offs, testing strategy, rollout plan.
consumes: Approved spec.md, constitution.md per Prerequisites
produces: artefact conforming to content/02-output-contract.xml (design, TDD variant)
