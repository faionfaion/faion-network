#!/usr/bin/env python3
"""validate-task-creation-principles.py — validate a task-creation-principles output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'task_id', 'atomic_pass', 'testable_pass', 'owned_pass', 'estimated_pass', 'rubric_score', 'owner']
ENUMS = {}
...
ARRAY_FIELDS = []
OBJECT_FIELDS = []
BOOL_FIELDS = ['atomic_pass', 'testable_pass', 'owned_pass', 'estimated_pass']
...
VALID_FIXTURE = json.loads('{"artefact_id": "task-creation-principles-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "task_id": "task_id value", "atomic_pass": true, "testable_pass": true, "owned_pass": true, "estimated_pass": true, "rubric_score": 1, "owner": "@solo-founder"}')
