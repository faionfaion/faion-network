...
| `templates/api-first-development.md.j2` | Markdown skeleton with the required fields. |
| `templates/api-first-development.md` | Markdown skeleton with the required fields. Generated from `templates/api-first-development.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
