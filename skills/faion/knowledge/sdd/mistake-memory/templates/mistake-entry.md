...
1. Why <symptom>? → <answer_1>
2. Why <answer_1>? → <answer_2>
3. Why <answer_2>? → {root cause — systemic gap}

**Prevention:**
{One concrete, actionable step with a trigger condition. Example: "When task keywords include 'migration', run COUNT(*) before planning. If >100k rows, use batched approach."}
