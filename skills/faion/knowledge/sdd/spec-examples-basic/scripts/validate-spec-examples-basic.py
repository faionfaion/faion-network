#!/usr/bin/env python3
"""validate-spec-examples-basic.py — validate a spec-examples-basic output JSON against the methodology schema.
...
ENUMS = {'archetype': ['crud', 'integration', 'internal-tool', 'polish', 'none']}
...
VALID_FIXTURE = json.loads('{"artefact_id": "spec-examples-basic-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "archetype": "crud", "example_path": "example_path value", "fields_adapted": 1, "fields_kept": 1, "draft_spec_path": "draft_spec_path value", "owner": "@solo-founder"}')
