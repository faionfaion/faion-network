...
| File | Purpose |
|------|---------|
| `templates/impl-plan-100k-rule.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/impl-plan-100k-rule.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/impl-plan-100k-rule.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
