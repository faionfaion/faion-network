<!--
purpose: Canonical design.md skeleton this methodology owns — architectural decisions, components, data flow/models, API endpoints, files, testing strategy, risks, FR coverage.
consumes: design-doc-structure spec per Prerequisites
