<!-- purpose: Per-ADR skeleton: context / options considered / decision / consequences / commit links / signoff. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a report artefact validating against scripts/validate-decision-log-reconstruction-from-git.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# Decision Log Reconstruction From Git — Artefact Skeleton
...
Run `python scripts/validate-decision-log-reconstruction-from-git.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
