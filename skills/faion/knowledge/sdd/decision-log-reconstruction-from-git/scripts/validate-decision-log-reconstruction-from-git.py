#!/usr/bin/env python3
"""validate-decision-log-reconstruction-from-git.py — stdlib-only validator for the Decision Log Reconstruction From Git report artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'inputs_used'] + ["findings", "decision", "rationale"]
...
OK_JSON = """{"artefact_id": "decision-log-reconstruction-from-git-acme-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "inputs_used": [{"name": "engagement charter", "source": "docs/charters/acme.md"}], "findings": [{"id": "f1", "summary": "pattern", "severity": "high"}], "decision": "ship a patch.", "rationale": "Finding f1 supports the decision by triangulating three inputs."}"""
