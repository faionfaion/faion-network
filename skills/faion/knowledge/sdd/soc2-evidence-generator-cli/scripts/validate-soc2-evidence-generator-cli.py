#!/usr/bin/env python3
"""validate-soc2-evidence-generator-cli.py — stdlib-only validator for the SOC 2 Evidence Generator CLI config artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'inputs_used'] + ["entries"]
...
OK_JSON = """{"artefact_id": "soc2-evidence-generator-cli-acme-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "inputs_used": [{"name": "engagement charter", "source": "docs/charters/acme.md"}], "entries": [{"key": "k1", "value": "v1", "source": "docs/style.md"}]}"""
