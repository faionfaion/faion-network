#!/usr/bin/env python3
"""validate-team-methodology-overlay-mechanism.py

Validate the artefact produced by the `team-methodology-overlay-mechanism` methodology against the schema
...
EXPECTED_SLUG = "team-methodology-overlay-mechanism"
