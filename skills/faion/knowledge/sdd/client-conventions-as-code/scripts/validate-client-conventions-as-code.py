#!/usr/bin/env python3
"""validate-client-conventions-as-code.py — stdlib-only validator for the Client Conventions As Code config artefact.
...
OK_JSON = """{"artefact_id": "client-conventions-as-code-acme-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "inputs_used": [{"name": "engagement charter", "source": "docs/charters/acme.md"}], "entries": [{"key": "k1", "value": "v1", "source": "docs/style.md"}]}"""
