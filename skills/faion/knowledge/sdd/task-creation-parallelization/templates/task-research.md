<!--
purpose: Research-task skeleton producing an ADR and updated execution tasks instead of production code.
consumes: design.md, open architectural question per Prerequisites
produces: artefact conforming to content/02-output-contract.xml (items entry, research type) plus an inline ADR skeleton
