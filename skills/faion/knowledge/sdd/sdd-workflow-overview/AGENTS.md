...
| `templates/sdd-workflow-overview.md.j2` | Markdown skeleton for human-readable artefact rendering. |
...
### `templates/sdd-workflow-overview.json`

```json
{
  "artefact_id": "sdd-workflow-overview-example",
  "version": "1.0.0",
