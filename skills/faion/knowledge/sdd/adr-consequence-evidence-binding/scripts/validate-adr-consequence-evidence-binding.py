#!/usr/bin/env python3
"""validate-adr-consequence-evidence-binding.py

Validate the artefact produced by the `adr-consequence-evidence-binding` methodology against the schema
...
EXPECTED_SLUG = "adr-consequence-evidence-binding"
