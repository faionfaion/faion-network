#!/usr/bin/env python3
"""validate-ts-strict-isolated.py

Validate the config artefact for the ts-strict-isolated methodology against the schema
...
REQUIRED = ['base_path', 'strict', 'no_unchecked_indexed_access', 'exact_optional_property_types', 'libraries']
SCHEMA_PROPS = {'strict': {'const': True}, 'no_unchecked_indexed_access': {'const': True}, 'exact_optional_property_types': {'const': True}}
...
OK = {'base_path': 'tsconfig.base.json', 'strict': True, 'no_unchecked_indexed_access': True, 'exact_optional_property_types': True, 'libraries': [{'path': 'packages/core/tsconfig.json', 'isolated_declarations': True, 'composite': True, 'references': []}, {'path': 'packages/web/tsconfig.json', 'isolated_declarations': True, 'composite': True, 'references': ['../core']}]}
BAD = {'base_path': 'tsconfig.json', 'strict': False, 'no_unchecked_indexed_access': False, 'exact_optional_property_types': False, 'libraries': [{'path': 'packages/web/tsconfig.json', 'isolated_declarations': False, 'composite': False}]}
