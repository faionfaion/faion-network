#!/usr/bin/env python3
"""validate-ai-coding-agent-handoff-protocol.py — validate a ai-coding-agent-handoff-protocol output JSON against the methodology schema.
...
REQUIRED = ['artefact_id', 'version', 'last_reviewed', 'owner', 'feature_id', 'summary', 'items', 'out_of_scope']
ENUMS = {}
SEMVER_FIELDS = ['version']
DATE_FIELDS = ['last_reviewed']
INT_FIELDS = []
NUM_FIELDS = []
ARRAY_FIELDS = ['items', 'out_of_scope']
OBJECT_FIELDS = []
BOOL_FIELDS = []
STRING_FIELDS = ['artefact_id', 'owner', 'feature_id', 'summary']
...
VALID_FIXTURE = json.loads('{"artefact_id": "ai-coding-agent-handoff-protocol-example", "version": "1.0.0", "last_reviewed": "2026-05-23", "owner": "@solo-founder", "feature_id": "F-example", "summary": "One-paragraph problem + outcome statement.", "items": ["item-1", "item-2", "item-3"], "out_of_scope": ["item-x", "item-y"]}')
