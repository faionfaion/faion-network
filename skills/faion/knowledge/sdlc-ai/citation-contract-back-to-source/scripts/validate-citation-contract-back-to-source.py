#!/usr/bin/env python3
"""validate-citation-contract-back-to-source.py — stdlib-only validator for the Citation Contract Back to Source spec artefact.
...
REQUIRED = ['artefact_id', 'owner', 'version', 'last_reviewed', 'inputs_used'] + ["sections", "decision"]
...
OK_JSON = """{"artefact_id": "citation-contract-back-to-source-acme-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "inputs_used": [{"name": "engagement charter", "source": "docs/charters/acme.md"}], "sections": [{"heading": "Context", "body": "bounded scope"}, {"heading": "Decision", "body": "adopt"}], "decision": "Adopt the methodology"}"""
