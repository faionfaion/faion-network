<!-- purpose: Citation format specification + verifier recipe + 3 adapter snippets. -->
<!-- consumes: inputs declared in AGENTS.md Prerequisites; schema in content/02-output-contract.xml -->
<!-- produces: a spec artefact validating against scripts/validate-citation-contract-back-to-source.py -->
<!-- depends-on: content/01-core-rules.xml, content/02-output-contract.xml -->
<!-- token-budget-impact: ~400-1500 tokens once filled -->

# Citation Contract Back to Source — Artefact Skeleton
...
Run `python scripts/validate-citation-contract-back-to-source.py --file <path-to-filled-json>`. Exit 0 = valid, exit 1 = violations listed on stderr.
