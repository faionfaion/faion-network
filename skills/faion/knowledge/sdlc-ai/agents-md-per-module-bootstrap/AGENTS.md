...
| `templates/agents-md-per-module-bootstrap.md.j2` | Markdown skeleton for human-readable artefact rendering. |
| `templates/agents-md-per-module-bootstrap.md` | Markdown skeleton for human-readable artefact rendering. Generated from `templates/agents-md-per-module-bootstrap.md.j2` by `tpl-jinja --migrate`; do not hand-edit. |
...
### `templates/agents-md-per-module-bootstrap.json`

```json
{
  "artefact_id": "agents-md-per-module-bootstrap-example",
  "version": "1.0.0",
