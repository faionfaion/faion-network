#!/usr/bin/env python3
"""validate-ai-agent-guardrails-pack.py — stdlib-only validator for the AI Agent Guardrails Pack config artefact.
...
OK_JSON = """{"artefact_id": "ai-agent-guardrails-pack-acme-2026-05-23", "owner": "Ruslan Faion <ruslan@faion.net>", "version": "1.0.0", "last_reviewed": "2026-05-23", "inputs_used": [{"name": "engagement charter", "source": "docs/charters/acme.md"}], "entries": [{"key": "k1", "value": "v1", "source": "docs/style.md"}]}"""
