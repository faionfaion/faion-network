#!/usr/bin/env python3
"""validate-adr-supersession-detection.py

Validate the artefact produced by the `adr-supersession-detection` methodology against the schema
...
EXPECTED_SLUG = "adr-supersession-detection"
