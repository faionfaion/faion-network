...
Used by the RECAPTURE phase of the sdd-batch-orchestrator workflow.

Inputs:
    target_url         absolute URL or `file://...` path to the rendered page
...
def screenshot_focused(target_url, find_text_regex, container_selector,
