...
Enriches every methodology under `skills/faion/knowledge/` with an `agent-integration.md` file covering: when to use / when NOT to use / failure modes / agentic workflow / CLI tools / services / templates / best practices.
...
1. Cron fires every 5 minutes with prompt `Follow skills/faion/.research/TICK.md ...`
