---
slug: weekly-competitor-serp-scan-45-min
tier: solo
...
maintainers:
  - faion-network
summary: "Every Wednesday: top 3 competitors' new content, ads, pricing, SERP gainers in our cluster. Output is 0-3 'react now' items + a slowly-growing intel doc."
content_id: b8ede030ba181706
methodology_refs:
...
# Weekly competitor + SERP scan (45 min)

A 7-stage playbook for the atomic angle. Tier: **solo**. Complexity: **medium**.

## Context

Every Wednesday: top 3 competitors' new content, ads, pricing, SERP gainers in our cluster. Output is 0-3 'react now' items + a slowly-growing intel doc.
...
- `knowledge/pro/marketing/ppc-manager/ads-google-creative`
- `knowledge/pro/marketing/ppc-manager/ads-meta-creative`
