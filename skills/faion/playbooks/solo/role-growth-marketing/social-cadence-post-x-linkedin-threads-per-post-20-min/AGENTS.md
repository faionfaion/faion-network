---
slug: social-cadence-post-x-linkedin-threads-per-post-20-min
tier: solo
...
maintainers:
  - faion-network
summary: One platform-native post that is not cross-poster slop. Hook tested, format suits the platform, CTA appropriate to stage, reply window scheduled.
content_id: 70d892c64e104638
methodology_refs:
...
# Social cadence post: X / LinkedIn / threads (per-post, 20 min)

A 5-stage playbook for the atomic angle. Tier: **solo**. Complexity: **light**.

## Context

One platform-native post that is not cross-poster slop. Hook tested, format suits the platform, CTA appropriate to stage, reply window scheduled.
...
- `solo/marketing/smm-manager/instagram-growth`
...
- `solo/marketing/smm-manager/threads-growth`
...
- `knowledge/solo/marketing/content-marketer/growth-tiktok-strategies`
- `knowledge/solo/marketing/smm-manager/growth-community-building`
- `knowledge/solo/marketing/smm-manager/growth-linkedin-strategy`
- `knowledge/solo/marketing/smm-manager/growth-social-media-strategy`
- `knowledge/solo/marketing/smm-manager/growth-twitter-x-growth`
