---
slug: pr-review-for-test-coverage-of-new-feature
tier: solo
...
maintainers:
  - faion-network
summary: PR review for test coverage of new feature. Review a PR not for code style but for whether the tests actually cover the AC, including the non-happy paths the author skipped.
content_id: bcb0b2be6b9d7601
methodology_refs:
  - code-review-process
  - mocking-strategies
  - test-fixtures
  ...
  - qa-ai-generated-test-audit-checklist
---

# PR review for test coverage of new feature

## Context

Review a PR not for code style but for whether the tests actually cover the AC, including the non-happy paths the author skipped.

## Outcome

By the time this playbook closes:

- Done-state achieved as described in the scope: Review a PR not for code style but for whether the tests actually cover the AC, including the non-happy paths the author skipped.
...
Get an honest map of where things stand today for: PR review for test coverage of new feature.
