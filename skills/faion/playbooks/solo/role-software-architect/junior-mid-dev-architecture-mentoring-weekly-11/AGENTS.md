---
slug: junior-mid-dev-architecture-mentoring-weekly-11
tier: solo
...
maintainers:
  - faion-network
summary: "Done = mentee leaves the 1:1 with one concrete architectural exercise (read this ADR, refactor this seam, write this design doc) and one piece of feedback tied to a quality attribute or trade-off t..."
content_id: 1707fabaa8ebc20d
methodology_refs:
...
# Junior / mid dev architecture mentoring (weekly 1:1)

**Slug:** `junior-mid-dev-architecture-mentoring-weekly-11` · **Tier:** solo · **Complexity:** light

## Context

Done = mentee leaves the 1:1 with one concrete architectural exercise (read this ADR, refactor this seam, write this design doc) and one piece of feedback tied to a quality attribute or trade-off they missed in their recent PRs.
...
- `knowledge/solo/dev/software-architect/patterns-overview`
- `knowledge/solo/dev/software-architect/trade-off-quality-attributes`
- `knowledge/solo/sdd/sdd/living-documentation`
- `knowledge/solo/sdd/sdd/pattern-memory`
- `knowledge/solo/sdd/sdd/reflexion-learning`
