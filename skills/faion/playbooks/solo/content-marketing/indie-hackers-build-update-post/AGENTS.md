---
slug: indie-hackers-build-update-post
tier: solo
...
maintainers:
  - faion
summary: Two weeks of work → long-form IH post that drives qualified clicks back.
content_id: a3c3b580b0776592
methodology_refs:
...
# Indie Hackers build-update post

## Why this playbook exists
Indie hackers run the entire pipeline alone — research, build, ship, market, support, and decide — under tight calendar constraints and often from a nomad schedule. Two weeks of work → long-form IH post that drives qualified clicks back. This playbook turns that ambition into a sequenced set of stages with explicit decision gates so the founder doesn't confuse motion for progress and doesn't keep paying for products that quietly stopped working.

## What changes after running it
Bi-weekly long-form post on Indie Hackers: progress, numbers, lessons, and an explicit ask — driving qualified clicks back to the product, newsletter, or audience handle.

## Stage flow
### Mine
Pick the most genuine story from the last 2 weeks.

**Tasks**
- List the 5 most consequential moments
- Pick the one with a clear lesson
- Note numbers that prove the story

**Decision gate**
> Advance once the lesson is one sentence.

### Draft
Long-form post that mixes story, numbers, and ask.

**Tasks**
- Open with a confession or contrarian hook
- Mid-section: chronological story with numbers
- Close with one specific ask

**Decision gate**
> Advance only once another indie hacker would skim and react.

### Ship
Post and engage to convert comments to clicks.

**Tasks**
- Post during peak weekday hours
- Reply to every comment in the first 12 hours
- Track click-throughs to landing or newsletter

**Decision gate**
> Done once comments are handled and clicks logged.
