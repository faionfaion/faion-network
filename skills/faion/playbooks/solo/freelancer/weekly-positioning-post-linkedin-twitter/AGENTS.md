---
slug: weekly-positioning-post-linkedin-twitter
tier: solo
group: freelancer
persona: P3
goal: TBD
...
maintainers:
  - faion-network
summary: One post per week that reinforces specialization niche. Done = post published, engagement triaged, follow-up DMs handled within 48h.
content_id: 1536f22be410cc77
methodology_refs:
  - storytelling
...
Methodologies:
- `solo/comms/communicator/storytelling`
...
- `solo/comms/communicator/storytelling` — methodology cited inside the stages above.
- `solo/marketing/content-marketer/growth-copywriting-fundamentals` — methodology cited inside the stages above.
- `solo/marketing/smm-manager/growth-community-building` — methodology cited inside the stages above.
- `solo/marketing/smm-manager/growth-linkedin-strategy` — methodology cited inside the stages above.
- `solo/marketing/smm-manager/growth-twitter-x-growth` — methodology cited inside the stages above.
