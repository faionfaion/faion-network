---
slug: cold-lead-reply-linkedin-email-inbound
tier: solo
group: freelancer
persona: P3
goal: TBD
...
- `pro/research/researcher/audience-segmentation` — methodology cited inside the stages above.
- `solo/comms/communicator/mom-test` — methodology cited inside the stages above.
