---
slug: monday-client-check-in-cycle-one-per-active-client
tier: solo
group: freelancer
persona: P3
goal: operate-ritual
...
maintainers:
  - faion-network
summary: "Monday client check-in cycle (one per active client) — Each active client receives a 5-10 min status note before noon Monday: what shipped last week, what's next, blockers, expected hours. Done = a..."
content_id: 1470f0ba316245f3
methodology_refs:
  - change-control
...
- `solo/comms/communicator/stakeholder-communication`
...
- `pro/pm/project-manager/raci-matrix` — methodology cited inside the stages above.
...
- `solo/comms/communicator/stakeholder-communication` — methodology cited inside the stages above.
