---
slug: weekly-twitter-x-analytics-review
tier: solo
group: product-ops
persona: P2
goal: TBD
...
maintainers:
  - faion
summary: Last 7 days of X data → next-week content slate rooted in evidence.
content_id: b96b0bf61373e176
methodology_refs:
  - ops-dashboard-setup
  - plausible-analytics
...
# Weekly Twitter / X analytics review

## Why this playbook exists
Indie hackers run the entire pipeline alone — research, build, ship, market, support, and decide — under tight calendar constraints and often from a nomad schedule. Last 7 days of X data → next-week content slate rooted in evidence. This playbook turns that ambition into a sequenced set of stages with explicit decision gates so the founder doesn't confuse motion for progress and doesn't keep paying for products that quietly stopped working.

## What changes after running it
30-minute Sunday review: identify which three posts moved followers, clicks, or replies and feed the insights into next week's content slate so growth compounds.

## Stage flow
### Pull
Raw 7-day metrics in one place.

**Tasks**
- Export native analytics CSV or screenshot
- Capture impressions, clicks, follows by post
- Tag posts by hypothesis bucket (build, lesson, signal)

**Decision gate**
> Advance once each post has a numeric line entry.

### Rank
Top-3 and bottom-3 named with cause-of-success hypotheses.

**Tasks**
- Sort by goal-aligned metric (followers OR clicks OR replies)
- Pick top-3 and bottom-3
- Write a 1-line cause-of-success or failure

**Decision gate**
> Advance only when each highlighted post has a written hypothesis.

### Brief
A simple content brief for the next 7 days.

**Tasks**
- Pick 3 angles to remix top performers
- Cut formats that fall in bottom-3 two weeks in a row
- Add updated hooks to the swipe file

**Decision gate**
> Done when next-week content is scheduled or queued.
