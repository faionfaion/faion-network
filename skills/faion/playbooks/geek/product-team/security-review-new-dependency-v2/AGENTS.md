...
maintainers:
  - faion-network
summary: "Engineer wants to add a new lib / SDK. Before merge: AI runs SBOM diff, supply-chain scan, license check; security-conscious engineer reviews the diff + alternatives. Decision recorded as a lightwe..."
