---
slug: cross-role-handoff-pm-architect-dev-qa-devops-v2
tier: geek
group: product-team
...
maintainers:
  - faion-network
summary: A feature moves through 5 roles with a single living artifact (spec + design + test-plan + runbook). Each role inherits prior context and emits a delta. Handoffs blocked if Definition-of-Ready not met
content_id: c2e5282950cea577
methodology_refs:
  - code-review
