---
slug: ai-assisted-user-story-sanity-pass
tier: geek
...
maintainers:
  - faion-network
summary: Run any AI-generated batch of user stories through a structured truth check before they touch the backlog. One batch in, validated subset out.
content_id: 5eec8c6e0eca446c
methodology_refs:
...
# AI-assisted user-story sanity pass

**Persona:** role-ba - **Tier:** geek - **Complexity:** medium - **Angle:** atomic

## Context

Run any AI-generated batch of user stories through a structured truth check before they touch the backlog. One batch in, validated subset out.
...
- `ba-ai-quality-metrics-dashboard`
- `requirements-management`

BLOCK policy: this playbook cannot move to `published` until `gaps[]` is empty.

Run `faion get-content ai-assisted-user-story-sanity-pass --format context` to pull the full chain into an agent-readable payload.
