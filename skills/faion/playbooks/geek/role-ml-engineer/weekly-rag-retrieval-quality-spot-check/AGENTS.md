---
slug: weekly-rag-retrieval-quality-spot-check
tier: geek
...
maintainers:
  - faion-network
summary: "Engineer samples N production queries from last week, labels retrieval quality (hit@k, MRR, faithfulness), files tickets for the worst clusters."
content_id: 33b121d9d75085db
methodology_refs:
  - chunking-strategies
...
# Weekly RAG retrieval quality spot-check

A 7-stage playbook for the atomic angle. Tier: **geek**. Complexity: **medium**.

## Context

Engineer samples N production queries from last week, labels retrieval quality (hit@k, MRR, faithfulness), files tickets for the worst clusters.
...
Methodologies:
- `geek/ai/ml-engineer/chunking-strategies`
...
- `knowledge/geek/ai/ml-engineer/chunking-strategies`
- `knowledge/geek/ai/ml-engineer/llm-observability-stack`
- `knowledge/geek/ai/ml-engineer/reranking`
- `knowledge/geek/ai/rag-engineer/chunking-document-structure`
- `knowledge/geek/ai/rag-engineer/rag-eval-generation-metrics`
