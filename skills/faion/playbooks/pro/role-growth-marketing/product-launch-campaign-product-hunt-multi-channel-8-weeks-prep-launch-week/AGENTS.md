---
slug: product-launch-campaign-product-hunt-multi-channel-8-weeks-prep-launch-week
tier: pro
...
maintainers:
  - faion-network
summary: "End-to-end launch campaign anchored on Product Hunt, with founder community presence (IH, HN, Reddit), email + SMM coordination, paid teaser layer, and post-launch retention follow-through. 'Done'..."
content_id: bd98d94ca2d669ed
methodology_refs:
  - onboarding-flows
...
# Product Launch Campaign — Product Hunt + Multi-Channel (8 weeks prep + launch week)

A 9-stage playbook for the global angle. Tier: **pro**. Complexity: **deep**.

## Context

End-to-end launch campaign anchored on Product Hunt, with founder community presence (IH, HN, Reddit), email + SMM coordination, paid teaser layer, and post-launch retention follow-through. 'Done' = launch day executed without missed cues, top-5 of the day or clear documented reason why not, paid signups and activation tracked vs targets, and post-launch retention email sequence is live.
...
Methodologies:
- `pro/marketing/conversion-optimizer/onboarding-flows`
...
- `pro/marketing/ppc-manager/ads-twitter-ads`
...
Methodologies:
- `pro/marketing/growth-marketer/retention-basics`
...
Methodologies:
- `pro/marketing/growth-marketer/retention-strategies`
...
Methodologies:
- `pro/marketing/gtm-strategist/growth-press-coverage`
...
- `knowledge/pro/marketing/conversion-optimizer/onboarding-flows`
- `knowledge/pro/marketing/growth-marketer/activation-framework`
- `knowledge/pro/marketing/growth-marketer/cohort-basics`
- `knowledge/pro/marketing/growth-marketer/retention-basics`
- `knowledge/pro/marketing/growth-marketer/retention-strategies`
