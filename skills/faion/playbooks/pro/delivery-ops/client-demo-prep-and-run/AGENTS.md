...
maintainers:
  - faion
summary: End-of-sprint demo to client stakeholders (often non-technical) → explicit acceptance per AC, action items captured, senior dev runs it solo (not the PM).
content_id: 5a8f205ed295fa3d
methodology_refs:
