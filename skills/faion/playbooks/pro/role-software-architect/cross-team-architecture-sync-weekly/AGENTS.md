---
slug: cross-team-architecture-sync-weekly
tier: pro
...
maintainers:
  - faion-network
summary: "Done = the architects / leads of dependent teams have aligned on this week's interface changes, queue contract changes, capacity needs, and shared infra moves; risks are owned; no surprise integrat..."
content_id: 37b3e56aa471910f
methodology_refs:
...
# Cross-team architecture sync (weekly)

**Slug:** `cross-team-architecture-sync-weekly` · **Tier:** pro · **Complexity:** light

## Context

Done = the architects / leads of dependent teams have aligned on this week's interface changes, queue contract changes, capacity needs, and shared infra moves; risks are owned; no surprise integration breakages this sprint.
...
- `knowledge/solo/dev/software-architect/api-gateway-patterns`
...
- `knowledge/solo/sdd/sdd/api-first-development`
