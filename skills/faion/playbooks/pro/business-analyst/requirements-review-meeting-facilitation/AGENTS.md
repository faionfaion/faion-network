---
slug: requirements-review-meeting-facilitation
tier: pro
...
maintainers:
  - faion-network
summary: One review meeting with mixed stakeholders ends with explicit approvals per requirement, parked items routed, and minutes published within an hour.
content_id: bb9dff2b4b86161e
methodology_refs:
...
# Requirements review meeting facilitation

**Persona:** role-ba - **Tier:** pro - **Complexity:** medium - **Angle:** atomic

## Context

One review meeting with mixed stakeholders ends with explicit approvals per requirement, parked items routed, and minutes published within an hour.
...
- `review-meeting-facilitation-script`
- `stakeholder-conflict-mediation`

BLOCK policy: this playbook cannot move to `published` until `gaps[]` is empty.

Run `faion get-content requirements-review-meeting-facilitation --format context` to pull the full chain into an agent-readable payload.
