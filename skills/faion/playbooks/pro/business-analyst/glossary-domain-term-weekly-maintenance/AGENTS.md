---
slug: glossary-domain-term-weekly-maintenance
tier: pro
...
maintainers:
  - faion-network
summary: "Project glossary stays canonical: new terms from this week's tickets and transcripts are defined; conflicting definitions are reconciled in one page."
content_id: 3b3021acd111c851
methodology_refs:
  - requirements-documentation
  - requirements-management
---

# Glossary / domain-term weekly maintenance

**Persona:** role-ba - **Tier:** pro - **Complexity:** light - **Angle:** atomic

## Context

Project glossary stays canonical: new terms from this week's tickets and transcripts are defined; conflicting definitions are reconciled in one page.
...
- `glossary-template-confluence`
- `requirements-management`
- `term-conflict-resolution-protocol`

BLOCK policy: this playbook cannot move to `published` until `gaps[]` is empty.

Run `faion get-content glossary-domain-term-weekly-maintenance --format context` to pull the full chain into an agent-readable payload.
