---
slug: stakeholder-conflict-facilitation-and-decision-rationale-capture
tier: pro
...
maintainers:
  - faion-network
summary: "Mid-engagement: two stakeholder groups disagree on scope. BA facilitates, captures positions, runs structured decision, records rationale for audit. Output: decision record + updated baseline + imp..."
content_id: 921dd08cdae9def7
methodology_refs:
...
# Stakeholder-conflict facilitation and decision rationale capture

**Persona:** role-ba - **Tier:** pro - **Complexity:** medium - **Angle:** synthesis

## Context

Mid-engagement: two stakeholder groups disagree on scope. BA facilitates, captures positions, runs structured decision, records rationale for audit. Output: decision record + updated baseline + impact assessment.
...
- `change-request-impact-rubric` *(gap)*
- `pro/ba/ba-core/ba-requirements-mgmt`
- `pro/ba/ba-core/requirements-traceability`
- `pro/ba/ba-core/stakeholder-analysis`
- `pro/ba/ba-modeling/decision-analysis`
- `stakeholder-conflict-facilitation-script` *(gap)*
...
Run `faion get-content stakeholder-conflict-facilitation-and-decision-rationale-capture --format context` to pull the full chain into an agent-readable payload.
