---
slug: tm-to-fixed-price-contract-conversion-6-weeks
tier: pro
group: outsource
persona: P4
...
maintainers:
  - faion-network
summary: "T&M to fixed-price contract conversion (6 weeks) — Engagement is running on time-and-materials. Client requests conversion to fixed-price for the next phase. By end of week 6 Daria has: requirement..."
content_id: 2d2b62178231280d
methodology_refs:
...
Engagement is running on time-and-materials. Client requests conversion to fixed-price for the next phase. By end of week 6 Daria has: requirements baseline frozen for phase 2, three-point estimate with risk reserves, defensible commercial proposal, and a signed contract amendment without the team taking a margin haircut.
...
- `pro/ba/ba-core/requirements-prioritization` — methodology cited inside the stages above.
