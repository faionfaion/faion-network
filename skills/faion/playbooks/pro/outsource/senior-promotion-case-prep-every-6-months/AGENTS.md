---
slug: senior-promotion-case-prep-every-6-months
tier: pro
group: outsource
persona: P4
goal: operate-ritual
...
maintainers:
  - faion-network
summary: Senior promotion case prep (every 6 months) — Half-day reflective task done before promotion review cycle. Produces a written case that maps your last 6 months at the outsource shop to the senior/l...
content_id: 359b5373128c1331
methodology_refs:
  - 30-60-90-day-plan
  - feedback
...
Half-day reflective task done before promotion review cycle. Produces a written case that maps your last 6 months at the outsource shop to the senior/lead competency rubric, with evidence the reviewer can verify without you in the room.
...
- `solo/comms/communicator/feedback`
...
Methodologies:
- `pro/comms/hr-recruiter/star-interview-examples`
...
Methodologies:
- `pro/comms/hr-recruiter/star-interview-framework`
...
Methodologies:
- `pro/comms/hr-recruiter/star-interview-method`
...
- `pro/comms/hr-recruiter/star-interview-examples` — methodology cited inside the stages above.
- `pro/comms/hr-recruiter/star-interview-framework` — methodology cited inside the stages above.
- `pro/comms/hr-recruiter/star-interview-method` — methodology cited inside the stages above.
- `pro/pm/pm-traditional/lessons-learned` — methodology cited inside the stages above.
