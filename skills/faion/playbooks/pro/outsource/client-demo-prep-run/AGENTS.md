...
maintainers:
  - faion-network
summary: "End-of-sprint demo to client stakeholders (often non-technical, often executive). Senior dev runs it solo or as tech lead, not the PM. Outcome: explicit acceptance per AC, captured action items."
content_id: def9a6ee896d05ca
methodology_refs:
...
End-of-sprint demo to client stakeholders (often non-technical, often executive). Senior dev runs it solo or as tech lead, not the PM. Outcome: explicit acceptance per AC, captured action items.
...
Methodologies:
- `pro/pm/project-manager/stakeholder-engagement`
...
Methodologies:
- `solo/comms/communicator/active-listening`
...
- `pro/pm/pm-agile/scrum-ceremonies` — methodology cited inside the stages above.
- `pro/pm/pm-traditional/communications-management` — methodology cited inside the stages above.
- `pro/pm/pm-traditional/stakeholder-engagement` — methodology cited inside the stages above.
- `pro/pm/project-manager/stakeholder-engagement` — methodology cited inside the stages above.
- `solo/comms/communicator/active-listening` — methodology cited inside the stages above.
