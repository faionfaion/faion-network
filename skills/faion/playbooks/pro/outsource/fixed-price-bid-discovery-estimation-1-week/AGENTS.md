---
slug: fixed-price-bid-discovery-estimation-1-week
tier: pro
group: outsource
persona: P4
goal: plan-design
...
maintainers:
  - faion-network
summary: "Fixed-price bid discovery + estimation (1 week) — Daria leads pre-sales discovery for a fixed-price proposal. By end of week 1 she has: a discovery report, a sized estimate with assumptions + risk ..."
content_id: 65d9284da57b9348
methodology_refs:
...
Daria leads pre-sales discovery for a fixed-price proposal. By end of week 1 she has: a discovery report, a sized estimate with assumptions + risk reserves, a defensible margin, and a proposal Bid/No-bid recommendation that the delivery manager will not regret six months later.
...
- `pro/research/researcher/risk-assessment`
...
- `pro/dev/software-architect/cloud-architecture` — methodology cited inside the stages above.
