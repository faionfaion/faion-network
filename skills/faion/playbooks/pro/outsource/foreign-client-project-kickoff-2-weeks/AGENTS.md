---
slug: foreign-client-project-kickoff-2-weeks
tier: pro
group: outsource
persona: P4
goal: build-ship
...
maintainers:
  - faion-network
summary: "Foreign-client project kickoff (2 weeks) — Daria joins a brand-new engagement for a US/EU/UK/AU client. By end of week 2 she has: signed SoW, validated requirements baseline, ratified architecture ..."
content_id: 8b391475ecb86d9b
methodology_refs:
...
- `pro/dev/software-architect/cloud-architecture`
...
- `solo/sdd/sdd-planning/design-doc-structure`
...
- `pro/infra/devops-engineer/docker-image-optimization`
...
- `pro/infra/devops-engineer/github-actions-cicd`
...
- `pro/pm/pm-agile/hybrid-delivery`
...
- `pro/ba/ba-core/requirements-documentation` — methodology cited inside the stages above.
- `pro/ba/ba-core/requirements-traceability` — methodology cited inside the stages above.
- `pro/ba/ba-core/requirements-validation` — methodology cited inside the stages above.
- `pro/ba/ba-core/stakeholder-analysis` — methodology cited inside the stages above.
- `pro/ba/ba-modeling/acceptance-criteria` — methodology cited inside the stages above.
