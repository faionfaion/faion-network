---
slug: weekly-client-status-report
tier: pro
group: outsource
persona: P4
goal: operate-ritual
...
maintainers:
  - faion-network
summary: "End-of-week RAG report that the offshore senior owns: progress vs sprint goal, risks, asks. Client PM forwards it upstream without rewriting. Pre-empts Monday-morning interrogation."
content_id: ce5a24d53e04d841
methodology_refs:
...
End-of-week RAG report that the offshore senior owns: progress vs sprint goal, risks, asks. Client PM forwards it upstream without rewriting. Pre-empts Monday-morning interrogation.
...
- `pro/pm/pm-traditional/risk-register` — methodology cited inside the stages above.
