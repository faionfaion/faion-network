---
slug: new-project-machine-setup-laptop-desktop
tier: pro
group: outsource
persona: P4
goal: TBD
...
maintainers:
  - faion-network
summary: New-project machine setup (laptop + desktop) — Multi-machine senior (work laptop, home desktop, occasionally a client-issued VDI) gets a new outsource engagement and needs both machines productive ...
content_id: 15d7215f042a8db3
methodology_refs:
...
Multi-machine senior (work laptop, home desktop, occasionally a client-issued VDI) gets a new outsource engagement and needs both machines productive on client stack within a half-day, with no credential leakage between engagements.
...
Methodologies:
- `free/dev/software-developer/language-framework-guide`
...
Methodologies:
- `free/dev/software-developer/python-poetry-setup`
...
Methodologies:
- `solo/dev/automation-tooling/trunk-based-branch-by-abstraction`
...
Methodologies:
- `solo/infra/server-craft/dotfiles-management`
...
- `free/dev/software-developer/language-framework-guide` — methodology cited inside the stages above.
- `free/dev/software-developer/python-poetry-setup` — methodology cited inside the stages above.
- `pro/comms/hr-recruiter/onboarding-30-day` — methodology cited inside the stages above.
- `solo/dev/automation-tooling/trunk-based-branch-by-abstraction` — methodology cited inside the stages above.
- `solo/infra/server-craft/dotfiles-management` — methodology cited inside the stages above.
- `solo/sdd/sdd/living-documentation` — methodology cited inside the stages above.
