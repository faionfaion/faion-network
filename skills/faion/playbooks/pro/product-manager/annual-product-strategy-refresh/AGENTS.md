---
slug: annual-product-strategy-refresh
tier: pro
...
maintainers:
  - faion-network
summary: "A reset of product strategy: market view, competitor landscape, portfolio bets, multi-year roadmap, and updated north-star. Published artefact replaces the prior strategy memo."
content_id: 22d5434bb7eae8bb
methodology_refs:
...
# Annual product strategy refresh

**Persona:** role-pm - **Tier:** pro - **Complexity:** deep - **Angle:** global

## Context

A reset of product strategy: market view, competitor landscape, portfolio bets, multi-year roadmap, and updated north-star. Published artefact replaces the prior strategy memo.
...
- `pro/research/market-researcher/distribution-channel-research`
...
Methodologies in scope:
- `pro/product/product-operations/product-led-growth`
- `pro/research/market-researcher/market-research-tam-sam-som`
...
Methodologies in scope:
- `pro/product/product-operations/product-lifecycle`
- `pro/research/market-researcher/product-development-trends-2026`
...
- `pro/research/market-researcher/risk-assessment`
...
Methodologies in scope:
- `pro/research/market-researcher/business-model-research`
- `pro/research/market-researcher/trend-analysis`
...
Methodologies in scope:
- `pro/research/market-researcher/competitive-intelligence`
...
- `pro/product/product-manager/portfolio-strategy`
- `pro/product/product-operations/product-led-growth`
- `pro/product/product-operations/product-lifecycle` *(gap)*
- `pro/product/product-operations/stakeholder-management`
- `pro/research/market-researcher/business-model-research`
- `pro/research/market-researcher/competitive-intelligence`
- `pro/research/market-researcher/competitor-analysis`
...
Run `faion get-content annual-product-strategy-refresh --format context` to pull the full chain into an agent-readable payload.
