---
slug: portfolio-site-update-with-new-case-study
tier: pro
group: freelancer
persona: P3
goal: build-ship
...
maintainers:
  - faion-network
summary: Portfolio site update with new case study — A project closes successfully → add a case study to portfolio site within 2 weeks while context is fresh. Done = published case study with metrics, clien...
content_id: 3fad0494f5acaef9
methodology_refs:
...
- `solo/marketing/content-marketer/growth-content-marketing` — methodology cited inside the stages above.
- `solo/marketing/content-marketer/growth-customer-testimonials` — methodology cited inside the stages above.
- `solo/marketing/smm-manager/growth-linkedin-strategy` — methodology cited inside the stages above.
