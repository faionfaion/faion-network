---
slug: freelance-to-saas-transition-6-month-side-build
tier: pro
group: freelancer
persona: P3
...
maintainers:
  - faion-network
summary: "Freelance-to-SaaS transition (6-month side build) — Across two quarters, parallel to delivery work: pick one client-pain pattern, validate it as a productized SaaS, ship a paid v1 to 5-10 customers..."
content_id: b35fd5279d2637ae
methodology_refs:
...
- `pro/marketing/growth-marketer/retention-metrics`
...
- `solo/research/market-researcher`
...
Methodologies:
- `pro/marketing/growth-marketer/activation-metrics`
...
- `solo/comms/communicator/mom-test`
...
- `pro/ba/business-analyst/business-process-analysis` — methodology cited inside the stages above.
...
- `pro/marketing/conversion-optimizer/onboarding-flows` — methodology cited inside the stages above.
- `pro/marketing/growth-marketer/activation-framework` — methodology cited inside the stages above.
- `pro/marketing/growth-marketer/activation-metrics` — methodology cited inside the stages above.
