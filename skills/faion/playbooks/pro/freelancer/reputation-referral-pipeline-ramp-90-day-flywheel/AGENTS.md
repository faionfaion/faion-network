---
slug: reputation-referral-pipeline-ramp-90-day-flywheel
tier: pro
group: freelancer
persona: P3
goal: acquire-grow
...
maintainers:
  - faion-network
summary: "Build a system that compounds: every closed engagement produces a testimonial + a referral + a public artefact, so by day 90 inbound covers >=50% of new pipeline and outbound effort drops."
content_id: 50a5e0fc5d3de452
methodology_refs:
...
- `pro/marketing/gtm-strategist/ops-partnership-strategy`
...
Methodologies:
- `pro/marketing/growth-marketer/growth-referral-programs`
...
Methodologies:
- `pro/marketing/growth-marketer/growth-viral-loops`
- `solo/marketing/content-marketer/growth-customer-testimonials`
...
- `pro/marketing/conversion-optimizer/funnel-basics-framework` — methodology cited inside the stages above.
- `pro/marketing/conversion-optimizer/funnel-tactics-advanced` — methodology cited inside the stages above.
- `pro/marketing/growth-marketer/aarrr-pirate-metrics` — methodology cited inside the stages above.
- `pro/marketing/growth-marketer/growth-referral-programs` — methodology cited inside the stages above.
- `pro/marketing/growth-marketer/growth-viral-loops` — methodology cited inside the stages above.
