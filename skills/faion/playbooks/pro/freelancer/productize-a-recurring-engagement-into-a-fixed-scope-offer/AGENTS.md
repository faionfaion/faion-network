---
slug: productize-a-recurring-engagement-into-a-fixed-scope-offer
tier: pro
group: freelancer
persona: P3
goal: build-ship
...
maintainers:
  - faion-network
summary: "Productize a recurring engagement into a fixed-scope offer — Take one repeatedly-sold engagement (e.g. 'Stripe integration audit', 'Next.js perf pass', 'CI pipeline setup') and convert it into a na..."
content_id: cdd1752d04e0d62c
methodology_refs:
...
This playbook covers the synthesis flow for the persona `p3-technical-freelancer`. It applies whenever the trigger described in the scope below appears in the operator's workflow. The output is a written, auditable artefact pack, not a verbal hand-wave.
...
Methodologies:
- `pro/product/product-manager/minimum-product-frameworks`
...
- `pro/marketing/conversion-optimizer/growth-conversion-optimization` — methodology cited inside the stages above.
- `pro/marketing/gtm-strategist/growth-brand-positioning` — methodology cited inside the stages above.
- `pro/product/product-manager/minimum-product-frameworks` — methodology cited inside the stages above.
