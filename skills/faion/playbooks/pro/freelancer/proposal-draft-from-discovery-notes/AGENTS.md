---
slug: proposal-draft-from-discovery-notes
tier: pro
group: freelancer
persona: P3
goal: TBD
...
maintainers:
  - faion-network
summary: From a qualified-yes discovery, produce a short proposal (1-3 pages) the client can sign within a week. Done = proposal sent, follow-up cadence scheduled, win/loss reason recorded.
content_id: a09ec78a8df8ebc2
methodology_refs:
  - acceptance-criteria
  - selling-ideas
  - ops-legal-basics
...
Methodologies:
- `pro/pm/project-manager/wbs-creation`
...
- `pro/pm/project-manager/wbs-creation` — methodology cited inside the stages above.
