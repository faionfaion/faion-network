---
slug: quarterly-portfolio-rebalance-cash-clients-capacity
tier: pro
group: freelancer
persona: P3
goal: TBD
...
maintainers:
  - faion-network
summary: "End of every quarter: drop the worst client, raise rates on the rest, fill the freed slot with a higher-rate engagement, and lock the next quarter's revenue target and capacity allocation."
content_id: c1a799f517b83021
methodology_refs:
  - decision-analysis
...
This playbook covers the global flow for the persona `p3-technical-freelancer`. It applies whenever the trigger described in the scope below appears in the operator's workflow. The output is a written, auditable artefact pack, not a verbal hand-wave.
...
Methodologies:
- `pro/ba/business-analyst/decision-analysis`
- `pro/marketing/gtm-strategist/ops-customer-success-metrics`
...
- `pro/marketing/gtm-strategist/ops-financial-basics`
...
- `pro/marketing/gtm-strategist/ops-legal-basics`
...
Methodologies:
- `pro/marketing/gtm-strategist/ops-contractor-basics`
- `pro/marketing/gtm-strategist/ops-tax-basics`
...
Methodologies:
- `pro/marketing/gtm-strategist/ops-contractor-management`
- `pro/marketing/gtm-strategist/ops-tax-compliance`
...
Methodologies:
- `pro/marketing/gtm-strategist/ops-customer-success-basics`
- `pro/marketing/gtm-strategist/ops-upselling-cross-selling`
...
- `pro/ba/business-analyst/decision-analysis` — methodology cited inside the stages above.
- `pro/marketing/conversion-optimizer/funnel-tactics-basics` — methodology cited inside the stages above.
- `pro/marketing/gtm-strategist/ops-annual-planning-process` — methodology cited inside the stages above.
- `pro/marketing/gtm-strategist/ops-contractor-basics` — methodology cited inside the stages above.
- `pro/marketing/gtm-strategist/ops-contractor-management` — methodology cited inside the stages above.
- `pro/marketing/gtm-strategist/ops-customer-success-basics` — methodology cited inside the stages above.
