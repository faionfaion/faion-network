...
Complete catalog of all 502 methodologies available in the faion-network framework.
...
| Name | Description |
|------|-------------|
| xp-extreme-programming | Extreme Programming (XP) |
...
See [faion-hr-recruiter SKILL.md](../../faion-hr-recruiter/SKILL.md) for complete list.
