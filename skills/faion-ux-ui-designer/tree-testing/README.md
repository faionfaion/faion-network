...
- [Optimal Workshop Tree Testing](https://www.optimalworkshop.com/learn/101s/tree-testing/) - Tool guide and best practices
- [How to Conduct Tree Testing](https://www.interaction-design.org/literature/article/tree-testing-fast-cheap-and-effective-evaluation-of-menu-labels-and-categories) - IDF detailed guide
- [Tree Testing for IA](https://boxesandarrows.com/tree-testing/) - Boxes and Arrows
- [Validating Navigation with Tree Testing](https://www.usability.gov/how-to-and-tools/methods/tree-testing.html) - Usability.gov
