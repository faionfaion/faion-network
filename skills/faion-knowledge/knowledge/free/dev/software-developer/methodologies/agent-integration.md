...
# Usage: stub-detect.sh skills/faion-knowledge/knowledge/free/dev/software-developer
set -euo pipefail
...
## References
- Sibling skill folder: `skills/faion-knowledge/knowledge/free/dev/software-developer/` (one dir per methodology — that's where the real content lives).
- Cross-reference: `skills/faion-knowledge/knowledge/free/dev/software-developer/best-practices-2026/README.md` for current (2025/2026) practice.
- Skill manifest: `skills/faion-knowledge/SKILL.md` and `skills/tier-manifest.json`.
