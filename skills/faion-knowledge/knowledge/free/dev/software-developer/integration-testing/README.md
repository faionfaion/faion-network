...
Integration testing verifies that multiple components work correctly together. Tests use real dependencies (databases, APIs, message queues, external services) or realistic test doubles.
...
- **Real integrations** - use actual databases, not mocks
- **Isolated test data** - each test controls its own data
- **Proper cleanup** - restore system to known state after tests
...
- **Slow tests** - integration tests should complete in seconds, not minutes
...
- [Supertest Documentation](https://github.com/ladjs/supertest) - HTTP assertions for Node.js
- [WireMock Documentation](https://wiremock.org/docs/) - HTTP mocking server
- [Martin Fowler - Integration Test](https://martinfowler.com/bliki/IntegrationTest.html) - integration testing principles
