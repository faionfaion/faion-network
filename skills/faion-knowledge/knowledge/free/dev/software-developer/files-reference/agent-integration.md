...
set -euo pipefail
ref="skills/faion-knowledge/knowledge/free/dev/software-developer/files-reference/README.md"
base="$(dirname "$ref")"
missing=0
...
## References
- Worktree path: `skills/faion-knowledge/knowledge/free/dev/software-developer/files-reference/README.md`
- Parent skill: `skills/faion-knowledge/knowledge/free/dev/software-developer/CLAUDE.md`
- Tier manifest: `skills/faion-knowledge/tier-manifest.json`
