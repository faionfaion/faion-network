...
### Design Pattern
```
Prompt: Design a db-weaviate system that:
1. Handles {use_case}
...
### Code Generation
```
Prompt: Generate Python code for {specific_task} using db-weaviate.
...
Using db-weaviate, what's the issue and how to fix it?
```
...
### Test Generation
```
Prompt: Generate comprehensive tests for {function_name} that handles db-weaviate.
...
### Tutorial Generation
```
Prompt: Create a tutorial for implementing db-weaviate from scratch.
...
### Performance
```
Prompt: How can I improve the performance of {metric} in {language} for db-weaviate?
...
### Cost Optimization
```
Prompt: How to reduce API costs while maintaining quality for db-weaviate?
