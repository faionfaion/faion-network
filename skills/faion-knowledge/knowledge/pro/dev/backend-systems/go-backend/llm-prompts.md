# LLM Prompts for Go Backend Development

Effective prompts for AI-assisted development with go backend development.
...
```
I need to implement go backend development for my project.
...
2. Technology choices from: Gin, Echo, Chi, Standard library
...
```
Help me choose the best tool for go backend development.
...
```
Generate go backend development implementation for [language].

**Requirements:**
- Focus: Project structure, handlers, routers, middleware
- Features:
  - [ ] [Feature 1]
  - [ ] [Feature 2]
  - [ ] [Feature 3]
...
```
Add [feature] to my existing go backend development code.
...
```
Analyze my go backend development implementation for performance issues.
...
```
Refactor this go backend development code for better maintainability.
...
```
I'm experiencing [issue] with go backend development.
...
```
Review my go backend development implementation for best practices.
...
```
Generate comprehensive tests for go backend development.
...
```
What test scenarios should I cover for go backend development?
...
```
Generate documentation for this go backend development implementation.
...
```
Create step-by-step tutorial for implementing go backend development.
...
```
Migrate go backend development from [old tool] to [new tool].
...
```
1. "Design go backend development for [project]"
   -> Get architecture
...
```
Generate go backend development in [language]:
- Feature: [description]
- Tool: Gin
...
```
Review this go backend development code:
[paste code]
...
```
Debug go backend development issue:
Error: [message]
Code: [paste]
Context: [details]
