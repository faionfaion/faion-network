# LLM Prompts for SQL Optimization

Effective prompts for AI-assisted development with sql optimization.
...
```
I need to implement sql optimization for my project.
...
2. Technology choices from: PostgreSQL, MySQL, EXPLAIN, pg_stat_statements
...
```
Help me choose the best tool for sql optimization.
...
```
Generate sql optimization implementation for [language].

**Requirements:**
- Focus: Query optimization, indexing, EXPLAIN
- Features:
  - [ ] [Feature 1]
  - [ ] [Feature 2]
  - [ ] [Feature 3]
...
```
Add [feature] to my existing sql optimization code.
...
```
Analyze my sql optimization implementation for performance issues.
...
```
Refactor this sql optimization code for better maintainability.
...
```
I'm experiencing [issue] with sql optimization.
...
```
Review my sql optimization implementation for best practices.
...
```
Generate comprehensive tests for sql optimization.
...
```
What test scenarios should I cover for sql optimization?
...
```
Generate documentation for this sql optimization implementation.
...
```
Create step-by-step tutorial for implementing sql optimization.
...
```
Migrate sql optimization from [old tool] to [new tool].
...
```
1. "Design sql optimization for [project]"
   -> Get architecture
...
```
Generate sql optimization in [language]:
- Feature: [description]
- Tool: PostgreSQL
...
```
Review this sql optimization code:
[paste code]
