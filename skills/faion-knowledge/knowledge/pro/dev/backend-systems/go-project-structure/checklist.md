# Go Project Structure Checklist

Step-by-step checklist for implementing go project structure in backend systems.
...
- [ ] Evaluate tool options: Go modules, cmd/internal pattern
...
|------|---------|-------------|
| Go modules | Tool | Usage |
| cmd/internal pattern | Tool | Usage |
