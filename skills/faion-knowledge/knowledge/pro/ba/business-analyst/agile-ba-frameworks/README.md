---
id: agile-ba-frameworks
name: "Agile Business Analysis in Scrum and scaled agile frameworks"
domain: BA
skill: faion-business-analyst
category: "best-practices-2026"
---

## Agile Business Analysis in Scrum and scaled agile frameworks

### Problem

Business analysts struggle to find their role in agile frameworks. scaled agile frameworks does not explicitly define a BA role. Traditional BA activities do not map cleanly to agile ceremonies. Organizations need guidance on integrating BA competencies into agile delivery.

### Solution

Map BA competencies to agile roles and ceremonies. Understand where BA skills add value in Scrum and scaled agile frameworks.
...
### BA in scaled agile frameworks Levels

| scaled agile frameworks Level | BA Role Mapping | Key Activities |
|------------|-----------------|----------------|
...
### Key BA Responsibilities in scaled agile frameworks
...
|---------------|----------|-------|
| Agile Analysis Certification | BA industry | Agile Analysis (71% of BAs practice agile, 16% salary premium) |
| scaled agile frameworks Agilist | Scaled Agile | Enterprise agile scaling |
| scaled agile frameworks POPM | Scaled Agile | Product Owner / Product Manager |
| CPOA | BA industry | Product Ownership Analysis |
