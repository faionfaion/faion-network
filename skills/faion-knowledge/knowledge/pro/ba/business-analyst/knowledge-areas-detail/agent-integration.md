...
set -euo pipefail
REQ="$(cat)"
KB="skills/faion-knowledge/knowledge/pro/ba"
...
- `skills/faion-knowledge/knowledge/pro/ba/business-analyst/` — per-methodology agent integrations.
- `skills/faion-knowledge/knowledge/pro/ba/ba-core/` — 21 core BA methodologies.
- `skills/faion-knowledge/knowledge/pro/ba/ba-modeling/` — 7 modelling methodologies.
