...
- `faion-research-agent` (`skills/faion-knowledge/knowledge/pro/research/researcher/`) — runs `market` + `competitors` modes to populate the `Threats` and `Opportunities` cells of the SWOT with cited evidence instead of opinion.
