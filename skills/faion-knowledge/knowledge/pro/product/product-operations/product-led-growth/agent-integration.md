...
- Repo-local `agents/` (none PLG-specific yet) — use `faion-knowledge` to load `pro/product/product-manager`, `pro/marketing/growth-marketer`, `pro/marketing/conversion-optimizer` content as context for whichever agent runs.
