...
30-60-90 draft:
```
You are drafting a 30-60-90 plan per skills/faion-knowledge/knowledge/pro/comms/hr-recruiter/onboarding/README.md.
...
- Internal: `skills/faion-knowledge/knowledge/pro/comms/hr-recruiter/recruitment-funnel-optimization/agent-integration.md` (90-day retention as funnel terminal).
