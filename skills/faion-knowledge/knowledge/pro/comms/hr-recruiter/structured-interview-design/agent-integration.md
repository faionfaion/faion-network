...
Competency + weights:
```
You are designing a structured interview kit per skills/faion-knowledge/knowledge/pro/comms/hr-recruiter/structured-interview-design/README.md.
...
- Internal: `skills/faion-knowledge/knowledge/pro/comms/hr-recruiter/interview-methods/agent-integration.md`.
