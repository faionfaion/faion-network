...
### Design Pattern
```
Prompt: Design a rag-architecture system that:
1. Handles {use_case}
...
### Code Generation
```
Prompt: Generate Python code for {specific_task} using rag-architecture.
...
Using rag-architecture, what's the issue and how to fix it?
```
...
### Test Generation
```
Prompt: Generate comprehensive tests for {function_name} that handles rag-architecture.
...
### Tutorial Generation
```
Prompt: Create a tutorial for implementing rag-architecture from scratch.
...
### Performance
```
Prompt: How can I improve the performance of {metric} in {language} for rag-architecture?
...
### Cost Optimization
```
Prompt: How to reduce API costs while maintaining quality for rag-architecture?
