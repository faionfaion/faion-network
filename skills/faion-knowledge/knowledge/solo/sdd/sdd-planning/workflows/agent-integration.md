...
## References
- `skills/faion-knowledge/knowledge/solo/sdd/sdd-planning/workflow-spec-phase.md` — specification phase detail
- `skills/faion-knowledge/knowledge/solo/sdd/sdd-planning/workflow-design-phase.md` — design phase detail
- `skills/faion-knowledge/knowledge/solo/sdd/sdd/sdd-workflow-overview/README.md` — high-level SDD overview
