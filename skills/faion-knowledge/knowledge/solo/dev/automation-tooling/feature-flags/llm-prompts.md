# Feature Flags - LLM-Assisted Prompts
...
```
I need to set up feature flags for my project.
...
```
Review my feature flags configuration and suggest improvements.
...
```
Generate a feature flags implementation with these requirements:
...
```
Refactor this code to follow feature flags best practices.

Current code:
[PASTE YOUR CODE]

Focus on:
- flag systems, rollout strategies
- Maintainability
- Performance
- Error handling
...
```
Generate comprehensive tests for this feature flags implementation.
...
```
Create a testing strategy for feature flags.
...
```
I'm having an issue with my feature flags implementation.
...
```
Analyze the performance of my feature flags implementation.
...
```
Generate comprehensive documentation for this feature flags implementation.
...
```
Explain feature flags to my team who are unfamiliar with it.
...
```
Create a migration plan to adopt feature flags.
...
```
Design a gradual adoption strategy for feature flags.
...
```
Audit my feature flags implementation against best practices.
...
```
Assess production readiness of my feature flags implementation.
...
```
Create a tutorial teaching feature flags from basics to advanced.
...
```
# Quick help
"Explain feature flags in simple terms"

# Quick example
"Show me a minimal feature flags example"

# Quick fix
"Fix this feature flags error: [ERROR]"

# Quick comparison
"Compare feature flags with [ALTERNATIVE]"

# Quick recommendation
"Should I use feature flags for [USE CASE]?"
```
