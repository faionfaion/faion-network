...
- `faion-research-agent` (`skills/faion-knowledge/knowledge/pro/research/researcher/`) — sources comparable industry SLOs (e.g., what Stripe/Shopify publish for similar services) so targets are not invented from scratch.
