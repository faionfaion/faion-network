...
**Methods:**
- RICE scoring (feature-prioritization-rice)
- MoSCoW (feature-prioritization-moscow)
- Weighted scoring
- Stack ranking
...
- **jira-workflow-management:** Jira Workflow Management
...
**faion-task-creator-agent** helps with backlogs. Invoke with:
