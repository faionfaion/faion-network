...
| **Related** | google-campaign-setup, conversion-tracking, attribution-models |
...
- [Google Ads API Reporting Guide](https://developers.google.com/google-ads/api/docs/reporting/overview)
- [Custom Reports in Google Ads](https://support.google.com/google-ads/answer/2375418)


---

*Methodology: google-reporting | Ads API | faion-ads-agent*
