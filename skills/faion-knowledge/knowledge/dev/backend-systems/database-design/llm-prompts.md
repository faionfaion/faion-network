# LLM Prompts for Database Design

Effective prompts for AI-assisted development with database design.
...
```
I need to implement database design for my project.
...
2. Technology choices from: PostgreSQL, MySQL, Alembic, Flyway
...
```
Help me choose the best tool for database design.
...
```
Generate database design implementation for [language].

**Requirements:**
- Focus: Schema design, normalization, indexing, migrations
- Features:
  - [ ] [Feature 1]
  - [ ] [Feature 2]
  - [ ] [Feature 3]
...
```
Add [feature] to my existing database design code.
...
```
Analyze my database design implementation for performance issues.
...
```
Refactor this database design code for better maintainability.
...
```
I'm experiencing [issue] with database design.
...
```
Review my database design implementation for best practices.
...
```
Generate comprehensive tests for database design.
...
```
What test scenarios should I cover for database design?
...
```
Generate documentation for this database design implementation.
...
```
Create step-by-step tutorial for implementing database design.
...
```
Migrate database design from [old tool] to [new tool].
...
```
1. "Design database design for [project]"
   -> Get architecture
...
```
Generate database design in [language]:
- Feature: [description]
- Tool: PostgreSQL
...
```
Review this database design code:
[paste code]
