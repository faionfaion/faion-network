...
Intra-domain tier reclassification for faion-knowledge methodologies.
...
```bash
bash skills/faion-knowledge/.reclass/heuristic.sh  # regenerate candidates.tsv
bash skills/faion-knowledge/.reclass/filter.sh     # regenerate safe/skip/ambiguous
bash skills/faion-knowledge/.reclass/move.sh       # apply candidates.safe.tsv
```
