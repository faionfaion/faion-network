...
| **Related** | M-OPS-010, M-OPS-012, M-MKT-030 |
...
- **M-OPS-010:** Hiring Contractors (delegate what can't automate)
- **M-OPS-012:** Customer Success (automated touchpoints)
- **M-MKT-030:** Onboarding Emails (email automation)
- **M-OPS-003:** Customer Support (support automation)

---

*Methodology M-OPS-011 | Operations & Business | faion-growth-agent*
