...
- [Production Best Practices](https://kubernetes.io/docs/setup/best-practices/cluster-large/)
- [Application Deployment](https://kubernetes.io/docs/tasks/run-application/)
