...
| **references/skills.md** | SKILL.md creation, frontmatter fields, token economy, locations, troubleshooting | ~346 lines |
| **references/agents.md** | Agent files, tools whitelist, prompt writing, parallel execution patterns | ~361 lines |
| **references/commands.md** | Slash commands, argument syntax ($1, $ARGUMENTS), special syntax (!, @) | ~288 lines |
| **references/hooks.md** | Lifecycle events, input/output schemas, templates (Python/Bash), common patterns | ~484 lines |
| **references/mcp.md** | MCP server development (TS/Python), catalog of 40+ servers, configuration | ~706 lines |
...
| agent, subagent | references/agents.md |
| command, /cmd, slash | references/commands.md |
| hook, PreToolUse, PostToolUse | references/hooks.md |
| MCP, server, install mcp | references/mcp.md |
