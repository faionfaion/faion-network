...
Break scope into manageable pieces (see M-PMBOK-003).
...
Manage changes through change control (see M-PMBOK-008).
...
5. Connect to M-PMBOK-020 (Performance Domains Overview)
...
- PMI Practice Standard for Project Scope Management
