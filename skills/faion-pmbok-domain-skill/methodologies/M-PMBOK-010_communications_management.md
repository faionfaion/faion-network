# M-PMBOK-010: Communications Management
...
For each stakeholder (from M-PMBOK-001), determine:
...
5. Connect to M-PMBOK-011 (Resource Management)
...
- PMI Practice Standard for Communications
