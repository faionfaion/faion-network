---
name: faion-pmbok-domain-skill
user-invocable: false
description: "PMBOK Domain Skill: Project Management Body of Knowledge orchestrator. Implements PMBOK 7/8 Performance Domains, Principles, and 20 PM methodologies for professional project management."
...
Call faion-pm-agent with:
  methodology: "M-PMBOK-001" (Stakeholder Register)
  methodology: "M-PMBOK-002" (Stakeholder Analysis Matrix)
```
...
```
Call faion-pm-agent with:
  methodology: "M-PMBOK-003" (RACI Matrix)
  methodology: "M-PMBOK-004" (Team Charter)
```
...
```
Call faion-pm-agent with:
  methodology: "M-PMBOK-005" (Development Approach Selection)
  methodology: "M-PMBOK-006" (Project Life Cycle Design)
```
...
```
Call faion-pm-agent with:
  methodology: "M-PMBOK-007" (WBS Creation)
  methodology: "M-PMBOK-008" (Schedule Development)
  methodology: "M-PMBOK-009" (Cost Estimation)
```
...
```
Call faion-pm-agent with:
  methodology: "M-PMBOK-010" (Communication Management Plan)
  methodology: "M-PMBOK-011" (Change Management Process)
```
...
```
Call faion-pm-agent with:
  methodology: "M-PMBOK-012" (Quality Management Plan)
  methodology: "M-PMBOK-013" (Acceptance Criteria Definition)
```
...
```
Call faion-pm-agent with:
  methodology: "M-PMBOK-014" (Earned Value Management)
  methodology: "M-PMBOK-015" (Project Dashboard Design)
```
...
```
Call faion-pm-agent with:
  methodology: "M-PMBOK-016" (Risk Register)
  methodology: "M-PMBOK-017" (Risk Response Planning)
```
...
## M-PMBOK-002: Stakeholder Analysis Matrix
...
## M-PMBOK-005: Development Approach Selection
...
## M-PMBOK-006: Project Life Cycle Design
...
## M-PMBOK-008: Schedule Development
...
## M-PMBOK-010: Communication Management Plan
...
## M-PMBOK-011: Change Management Process
...
## M-PMBOK-012: Quality Management Plan
...
## M-PMBOK-013: Acceptance Criteria Definition
...
## M-PMBOK-014: Earned Value Management
...
## M-PMBOK-015: Project Dashboard Design
...
## M-PMBOK-017: Risk Response Planning
...
## M-PMBOK-019: Project Closure Checklist
...
## M-PMBOK-020: Project Status Report
...
| Agent | Purpose |
|-------|---------|
| faion-pm-agent | Executes PMBOK methodologies (M-PMBOK-001 to M-PMBOK-020) |
...
| faion-babok-domain-skill | Requirements feed into PMBOK scope |
