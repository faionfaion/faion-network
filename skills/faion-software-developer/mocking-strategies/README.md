...
Test doubles (stubs, mocks, spies, fakes) isolate code under test from dependencies. Each type serves different testing purposes.
...
- Speeding up tests (avoiding slow I/O operations)
- Testing time-dependent, random, or network-based code

## Key Principles

- **Mock at boundaries** - external systems, not internal classes
- **State over interaction** - test results, not method calls
- **Right double for the job** - stub for state, mock for behavior
- **Simple mocks** - complex mocks indicate design problems
...
- [pytest-mock](https://pytest-mock.readthedocs.io/) - pytest mocking plugin
- [Jest Mock Functions](https://jestjs.io/docs/mock-functions) - Jest official mocking guide
- [Mocks Aren't Stubs - Martin Fowler](https://martinfowler.com/articles/mocksArentStubs.html) - test doubles philosophy
