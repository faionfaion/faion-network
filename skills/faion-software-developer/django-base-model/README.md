...
- [Django Model Meta Options](https://docs.djangoproject.com/en/5.0/ref/models/options/) - Model metadata configuration
- [Django 5.0 Release Notes](https://docs.djangoproject.com/en/5.0/releases/5.0/) - GeneratedField, db_default
- [UUID Performance Considerations](https://www.percona.com/blog/uuids-are-popular-but-bad-for-performance/) - Database performance with UUIDs
- [Django Indexes](https://docs.djangoproject.com/en/5.0/ref/models/indexes/) - Index optimization
