...
- [Google Search Generative Experience](https://developers.google.com/search/blog/2023/05/generative-ai-search)
- [Schema.org for AI](https://schema.org/)
- [Perplexity Publisher Guide](https://www.perplexity.ai/publishers)
