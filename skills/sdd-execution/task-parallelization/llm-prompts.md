# Task Parallelization LLM Prompts

## Prompt 1: Apply Methodology

```
You are applying the Task Parallelization methodology.
...
TASK:
Apply the Task Parallelization methodology to analyze the given context and requirements.
...
```
You are validating the application of Task Parallelization methodology.
...
```
You are creating an implementation plan using Task Parallelization methodology.
...
METHODOLOGY: Task Parallelization
      ...
      "tasks": [
        {
          ...
          "methodology_application": "How Task Parallelization applies",
  ...
  "risks": [
    {
      ...
      "mitigation": "Mitigation strategy using Task Parallelization"
    }
  ],
...
```
You are troubleshooting issues with Task Parallelization methodology application.
...
TASK:
Identify what went wrong and how to fix it using Task Parallelization principles.
...
```
You are optimizing the application of Task Parallelization methodology.
  ...
  "optimization_opportunities": [
    {
      ...
      "optimized_approach": "Better way using Task Parallelization",
...
```
You are generating a report on Task Parallelization methodology application.
...
TASK:
Create a comprehensive report on how Task Parallelization was applied and outcomes achieved.
