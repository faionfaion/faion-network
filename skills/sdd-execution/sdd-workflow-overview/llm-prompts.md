# Sdd Workflow Overview LLM Prompts

## Prompt 1: Apply Methodology

```
You are applying the Sdd Workflow Overview methodology.
...
TASK:
Apply the Sdd Workflow Overview methodology to analyze the given context and requirements.
...
```
You are validating the application of Sdd Workflow Overview methodology.
...
```
You are creating an implementation plan using Sdd Workflow Overview methodology.
...
METHODOLOGY: Sdd Workflow Overview
      ...
      "tasks": [
        {
          ...
          "methodology_application": "How Sdd Workflow Overview applies",
  ...
  "risks": [
    {
      ...
      "mitigation": "Mitigation strategy using Sdd Workflow Overview"
    }
  ],
...
```
You are troubleshooting issues with Sdd Workflow Overview methodology application.
...
TASK:
Identify what went wrong and how to fix it using Sdd Workflow Overview principles.
...
```
You are optimizing the application of Sdd Workflow Overview methodology.
  ...
  "optimization_opportunities": [
    {
      ...
      "optimized_approach": "Better way using Sdd Workflow Overview",
...
```
You are generating a report on Sdd Workflow Overview methodology application.
...
TASK:
Create a comprehensive report on how Sdd Workflow Overview was applied and outcomes achieved.
