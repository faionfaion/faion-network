# Context Strategies LLM Prompts

## Prompt 1: Apply Methodology

```
You are applying the Context Strategies methodology.
...
TASK:
Apply the Context Strategies methodology to analyze the given context and requirements.
...
```
You are validating the application of Context Strategies methodology.
...
```
You are creating an implementation plan using Context Strategies methodology.
...
METHODOLOGY: Context Strategies
      ...
      "tasks": [
        {
          ...
          "methodology_application": "How Context Strategies applies",
  ...
  "risks": [
    {
      ...
      "mitigation": "Mitigation strategy using Context Strategies"
    }
  ],
...
```
You are troubleshooting issues with Context Strategies methodology application.
...
TASK:
Identify what went wrong and how to fix it using Context Strategies principles.
...
```
You are optimizing the application of Context Strategies methodology.
  ...
  "optimization_opportunities": [
    {
      ...
      "optimized_approach": "Better way using Context Strategies",
...
```
You are generating a report on Context Strategies methodology application.
...
TASK:
Create a comprehensive report on how Context Strategies was applied and outcomes achieved.
