# Pattern Memory LLM Prompts

## Prompt 1: Apply Methodology

```
You are applying the Pattern Memory methodology.
...
TASK:
Apply the Pattern Memory methodology to analyze the given context and requirements.
...
```
You are validating the application of Pattern Memory methodology.
...
```
You are creating an implementation plan using Pattern Memory methodology.
      ...
      "tasks": [
        {
          ...
          "methodology_application": "How Pattern Memory applies",
  ...
  "risks": [
    {
      ...
      "mitigation": "Mitigation strategy using Pattern Memory"
    }
  ],
...
```
You are troubleshooting issues with Pattern Memory methodology application.
...
TASK:
Identify what went wrong and how to fix it using Pattern Memory principles.
...
```
You are optimizing the application of Pattern Memory methodology.
  ...
  "optimization_opportunities": [
    {
      ...
      "optimized_approach": "Better way using Pattern Memory",
...
```
You are generating a report on Pattern Memory methodology application.
...
TASK:
Create a comprehensive report on how Pattern Memory was applied and outcomes achieved.
