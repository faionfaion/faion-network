# Quick Reference LLM Prompts

## Prompt 1: Apply Methodology

```
You are applying the Quick Reference methodology.
...
TASK:
Apply the Quick Reference methodology to analyze the given context and requirements.
...
```
You are validating the application of Quick Reference methodology.
...
```
You are creating an implementation plan using Quick Reference methodology.
      ...
      "tasks": [
        {
          ...
          "methodology_application": "How Quick Reference applies",
  ...
  "risks": [
    {
      ...
      "mitigation": "Mitigation strategy using Quick Reference"
    }
  ],
...
```
You are troubleshooting issues with Quick Reference methodology application.
...
TASK:
Identify what went wrong and how to fix it using Quick Reference principles.
...
```
You are optimizing the application of Quick Reference methodology.
  ...
  "optimization_opportunities": [
    {
      ...
      "optimized_approach": "Better way using Quick Reference",
...
```
You are generating a report on Quick Reference methodology application.
...
TASK:
Create a comprehensive report on how Quick Reference was applied and outcomes achieved.
