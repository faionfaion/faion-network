# Mistake Prevention LLM Prompts

## Prompt 1: Apply Methodology

```
You are applying the Mistake Prevention methodology.
...
TASK:
Apply the Mistake Prevention methodology to analyze the given context and requirements.
...
```
You are validating the application of Mistake Prevention methodology.
...
```
You are creating an implementation plan using Mistake Prevention methodology.
...
METHODOLOGY: Mistake Prevention
      ...
      "tasks": [
        {
          ...
          "methodology_application": "How Mistake Prevention applies",
  ...
  "risks": [
    {
      ...
      "mitigation": "Mitigation strategy using Mistake Prevention"
    }
  ],
...
```
You are troubleshooting issues with Mistake Prevention methodology application.
...
TASK:
Identify what went wrong and how to fix it using Mistake Prevention principles.
...
```
You are optimizing the application of Mistake Prevention methodology.
  ...
  "optimization_opportunities": [
    {
      ...
      "optimized_approach": "Better way using Mistake Prevention",
...
```
You are generating a report on Mistake Prevention methodology application.
...
TASK:
Create a comprehensive report on how Mistake Prevention was applied and outcomes achieved.
