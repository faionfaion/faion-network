# Reflexion Learning LLM Prompts

## Prompt 1: Apply Methodology

```
You are applying the Reflexion Learning methodology.
...
TASK:
Apply the Reflexion Learning methodology to analyze the given context and requirements.
...
```
You are validating the application of Reflexion Learning methodology.
...
```
You are creating an implementation plan using Reflexion Learning methodology.
...
METHODOLOGY: Reflexion Learning
      ...
      "tasks": [
        {
          ...
          "methodology_application": "How Reflexion Learning applies",
  ...
  "risks": [
    {
      ...
      "mitigation": "Mitigation strategy using Reflexion Learning"
    }
  ],
...
```
You are troubleshooting issues with Reflexion Learning methodology application.
...
TASK:
Identify what went wrong and how to fix it using Reflexion Learning principles.
...
```
You are optimizing the application of Reflexion Learning methodology.
  ...
  "optimization_opportunities": [
    {
      ...
      "optimized_approach": "Better way using Reflexion Learning",
...
```
You are generating a report on Reflexion Learning methodology application.
...
TASK:
Create a comprehensive report on how Reflexion Learning was applied and outcomes achieved.
