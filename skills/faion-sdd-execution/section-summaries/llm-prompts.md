# Section Summaries LLM Prompts

## Prompt 1: Apply Methodology

```
You are applying the Section Summaries methodology.
...
TASK:
Apply the Section Summaries methodology to analyze the given context and requirements.
...
```
You are validating the application of Section Summaries methodology.
...
```
You are creating an implementation plan using Section Summaries methodology.
      ...
      "tasks": [
        {
          ...
          "methodology_application": "How Section Summaries applies",
  ...
  "risks": [
    {
      ...
      "mitigation": "Mitigation strategy using Section Summaries"
    }
  ],
...
```
You are troubleshooting issues with Section Summaries methodology application.
...
TASK:
Identify what went wrong and how to fix it using Section Summaries principles.
...
```
You are optimizing the application of Section Summaries methodology.
  ...
  "optimization_opportunities": [
    {
      ...
      "optimized_approach": "Better way using Section Summaries",
...
```
You are generating a report on Section Summaries methodology application.
...
TASK:
Create a comprehensive report on how Section Summaries was applied and outcomes achieved.
