# Mistake Tracking LLM Prompts

## Prompt 1: Apply Methodology

```
You are applying the Mistake Tracking methodology.
...
TASK:
Apply the Mistake Tracking methodology to analyze the given context and requirements.
...
```
You are validating the application of Mistake Tracking methodology.
...
```
You are creating an implementation plan using Mistake Tracking methodology.
      ...
      "tasks": [
        {
          ...
          "methodology_application": "How Mistake Tracking applies",
  ...
  "risks": [
    {
      ...
      "mitigation": "Mitigation strategy using Mistake Tracking"
    }
  ],
...
```
You are troubleshooting issues with Mistake Tracking methodology application.
...
TASK:
Identify what went wrong and how to fix it using Mistake Tracking principles.
...
```
You are optimizing the application of Mistake Tracking methodology.
  ...
  "optimization_opportunities": [
    {
      ...
      "optimized_approach": "Better way using Mistake Tracking",
...
```
You are generating a report on Mistake Tracking methodology application.
...
TASK:
Create a comprehensive report on how Mistake Tracking was applied and outcomes achieved.
