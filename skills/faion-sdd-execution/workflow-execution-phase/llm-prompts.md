# Workflow Execution Phase LLM Prompts

## Prompt 1: Apply Methodology

```
You are applying the Workflow Execution Phase methodology.
...
TASK:
Apply the Workflow Execution Phase methodology to analyze the given context and requirements.
...
```
You are validating the application of Workflow Execution Phase methodology.
...
```
You are creating an implementation plan using Workflow Execution Phase methodology.
...
METHODOLOGY: Workflow Execution Phase
      ...
      "tasks": [
        {
          ...
          "methodology_application": "How Workflow Execution Phase applies",
  ...
  "risks": [
    {
      ...
      "mitigation": "Mitigation strategy using Workflow Execution Phase"
    }
  ],
...
```
You are troubleshooting issues with Workflow Execution Phase methodology application.
...
TASK:
Identify what went wrong and how to fix it using Workflow Execution Phase principles.
...
```
You are optimizing the application of Workflow Execution Phase methodology.
  ...
  "optimization_opportunities": [
    {
      ...
      "optimized_approach": "Better way using Workflow Execution Phase",
...
```
You are generating a report on Workflow Execution Phase methodology application.
...
TASK:
Create a comprehensive report on how Workflow Execution Phase was applied and outcomes achieved.
