# Task Dependencies LLM Prompts

## Prompt 1: Apply Methodology

```
You are applying the Task Dependencies methodology.
...
TASK:
Apply the Task Dependencies methodology to analyze the given context and requirements.
...
```
You are validating the application of Task Dependencies methodology.
...
```
You are creating an implementation plan using Task Dependencies methodology.
      ...
      "tasks": [
        {
          ...
          "methodology_application": "How Task Dependencies applies",
  ...
  "risks": [
    {
      ...
      "mitigation": "Mitigation strategy using Task Dependencies"
    }
  ],
...
```
You are troubleshooting issues with Task Dependencies methodology application.
...
TASK:
Identify what went wrong and how to fix it using Task Dependencies principles.
...
```
You are optimizing the application of Task Dependencies methodology.
  ...
  "optimization_opportunities": [
    {
      ...
      "optimized_approach": "Better way using Task Dependencies",
...
```
You are generating a report on Task Dependencies methodology application.
...
TASK:
Create a comprehensive report on how Task Dependencies was applied and outcomes achieved.
