# Confidence Checks LLM Prompts

## Prompt 1: Apply Methodology

```
You are applying the Confidence Checks methodology.
...
TASK:
Apply the Confidence Checks methodology to analyze the given context and requirements.
...
```
You are validating the application of Confidence Checks methodology.
...
```
You are creating an implementation plan using Confidence Checks methodology.
      ...
      "tasks": [
        {
          ...
          "methodology_application": "How Confidence Checks applies",
  ...
  "risks": [
    {
      ...
      "mitigation": "Mitigation strategy using Confidence Checks"
    }
  ],
...
```
You are troubleshooting issues with Confidence Checks methodology application.
...
TASK:
Identify what went wrong and how to fix it using Confidence Checks principles.
...
```
You are optimizing the application of Confidence Checks methodology.
  ...
  "optimization_opportunities": [
    {
      ...
      "optimized_approach": "Better way using Confidence Checks",
...
```
You are generating a report on Confidence Checks methodology application.
...
TASK:
Create a comprehensive report on how Confidence Checks was applied and outcomes achieved.
