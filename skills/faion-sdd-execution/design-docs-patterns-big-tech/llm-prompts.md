# Design Docs Patterns Big Tech LLM Prompts

## Prompt 1: Apply Methodology

```
You are applying the Design Docs Patterns Big Tech methodology.
...
TASK:
Apply the Design Docs Patterns Big Tech methodology to analyze the given context and requirements.
...
```
You are validating the application of Design Docs Patterns Big Tech methodology.
...
```
You are creating an implementation plan using Design Docs Patterns Big Tech methodology.
...
METHODOLOGY: Design Docs Patterns Big Tech
      ...
      "tasks": [
        {
          ...
          "methodology_application": "How Design Docs Patterns Big Tech applies",
  ...
  "risks": [
    {
      ...
      "mitigation": "Mitigation strategy using Design Docs Patterns Big Tech"
    }
  ],
...
```
You are troubleshooting issues with Design Docs Patterns Big Tech methodology application.
...
TASK:
Identify what went wrong and how to fix it using Design Docs Patterns Big Tech principles.
...
```
You are optimizing the application of Design Docs Patterns Big Tech methodology.
  ...
  "optimization_opportunities": [
    {
      ...
      "optimized_approach": "Better way using Design Docs Patterns Big Tech",
...
```
You are generating a report on Design Docs Patterns Big Tech methodology application.
...
TASK:
Create a comprehensive report on how Design Docs Patterns Big Tech was applied and outcomes achieved.
