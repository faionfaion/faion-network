# Key Trends Summary LLM Prompts

## Prompt 1: Apply Methodology

```
You are applying the Key Trends Summary methodology.
...
TASK:
Apply the Key Trends Summary methodology to analyze the given context and requirements.
...
```
You are validating the application of Key Trends Summary methodology.
...
```
You are creating an implementation plan using Key Trends Summary methodology.
...
METHODOLOGY: Key Trends Summary
      ...
      "tasks": [
        {
          ...
          "methodology_application": "How Key Trends Summary applies",
  ...
  "risks": [
    {
      ...
      "mitigation": "Mitigation strategy using Key Trends Summary"
    }
  ],
...
```
You are troubleshooting issues with Key Trends Summary methodology application.
...
TASK:
Identify what went wrong and how to fix it using Key Trends Summary principles.
...
```
You are optimizing the application of Key Trends Summary methodology.
  ...
  "optimization_opportunities": [
    {
      ...
      "optimized_approach": "Better way using Key Trends Summary",
...
```
You are generating a report on Key Trends Summary methodology application.
...
TASK:
Create a comprehensive report on how Key Trends Summary was applied and outcomes achieved.
