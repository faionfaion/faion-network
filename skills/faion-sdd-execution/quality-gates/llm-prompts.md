...
```
You are applying the Quality Gates methodology.
...
TASK:
Apply the Quality Gates methodology to analyze the given context and requirements.
...
```
You are validating the application of Quality Gates methodology.
...
```
You are creating an implementation plan using Quality Gates methodology.
      ...
      "tasks": [
        {
          ...
          "methodology_application": "How Quality Gates applies",
  ...
  "risks": [
    {
      ...
      "mitigation": "Mitigation strategy using Quality Gates"
    }
  ],
...
```
You are troubleshooting issues with Quality Gates methodology application.
...
TASK:
Identify what went wrong and how to fix it using Quality Gates principles.
...
```
You are optimizing the application of Quality Gates methodology.
  ...
  "optimization_opportunities": [
    {
      ...
      "optimized_approach": "Better way using Quality Gates",
...
```
You are generating a report on Quality Gates methodology application.
...
TASK:
Create a comprehensive report on how Quality Gates was applied and outcomes achieved.
