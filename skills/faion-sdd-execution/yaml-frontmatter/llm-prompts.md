# Yaml Frontmatter LLM Prompts

## Prompt 1: Apply Methodology

```
You are applying the Yaml Frontmatter methodology.
...
TASK:
Apply the Yaml Frontmatter methodology to analyze the given context and requirements.
...
```
You are validating the application of Yaml Frontmatter methodology.
...
```
You are creating an implementation plan using Yaml Frontmatter methodology.
      ...
      "tasks": [
        {
          ...
          "methodology_application": "How Yaml Frontmatter applies",
  ...
  "risks": [
    {
      ...
      "mitigation": "Mitigation strategy using Yaml Frontmatter"
    }
  ],
...
```
You are troubleshooting issues with Yaml Frontmatter methodology application.
...
TASK:
Identify what went wrong and how to fix it using Yaml Frontmatter principles.
...
```
You are optimizing the application of Yaml Frontmatter methodology.
  ...
  "optimization_opportunities": [
    {
      ...
      "optimized_approach": "Better way using Yaml Frontmatter",
...
```
You are generating a report on Yaml Frontmatter methodology application.
...
TASK:
Create a comprehensive report on how Yaml Frontmatter was applied and outcomes achieved.
