# Context Basics LLM Prompts

## Prompt 1: Apply Methodology

```
You are applying the Context Basics methodology.
...
TASK:
Apply the Context Basics methodology to analyze the given context and requirements.
...
```
You are validating the application of Context Basics methodology.
...
```
You are creating an implementation plan using Context Basics methodology.
      ...
      "tasks": [
        {
          ...
          "methodology_application": "How Context Basics applies",
  ...
  "risks": [
    {
      ...
      "mitigation": "Mitigation strategy using Context Basics"
    }
  ],
...
```
You are troubleshooting issues with Context Basics methodology application.
...
TASK:
Identify what went wrong and how to fix it using Context Basics principles.
...
```
You are optimizing the application of Context Basics methodology.
  ...
  "optimization_opportunities": [
    {
      ...
      "optimized_approach": "Better way using Context Basics",
...
```
You are generating a report on Context Basics methodology application.
...
TASK:
Create a comprehensive report on how Context Basics was applied and outcomes achieved.
