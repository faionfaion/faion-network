# Living Documentation Docs As Code LLM Prompts

## Prompt 1: Apply Methodology

```
You are applying the Living Documentation Docs As Code methodology.
...
TASK:
Apply the Living Documentation Docs As Code methodology to analyze the given context and requirements.
...
```
You are validating the application of Living Documentation Docs As Code methodology.
...
```
You are creating an implementation plan using Living Documentation Docs As Code methodology.
...
METHODOLOGY: Living Documentation Docs As Code
      ...
      "tasks": [
        {
          ...
          "methodology_application": "How Living Documentation Docs As Code applies",
  ...
  "risks": [
    {
      ...
      "mitigation": "Mitigation strategy using Living Documentation Docs As Code"
    }
  ],
...
```
You are troubleshooting issues with Living Documentation Docs As Code methodology application.
...
TASK:
Identify what went wrong and how to fix it using Living Documentation Docs As Code principles.
...
```
You are optimizing the application of Living Documentation Docs As Code methodology.
  ...
  "optimization_opportunities": [
    {
      ...
      "optimized_approach": "Better way using Living Documentation Docs As Code",
...
```
You are generating a report on Living Documentation Docs As Code methodology application.
...
TASK:
Create a comprehensive report on how Living Documentation Docs As Code was applied and outcomes achieved.
