...
| **Related** | aarrr-pirate-metrics, growth-loops, activation-rate |
...
- **aarrr-pirate-metrics:** AARRR Pirate Metrics (retention is 3rd stage)
- **growth-loops:** Growth Loops (retention is a loop type)
- **activation-rate:** Activation Rate (activation feeds retention)
- **viral-coefficient:** Viral Coefficient (retained users drive referral)

---

*Methodology: retention-loops | Growth | faion-growth-agent*
