...
| **Related** | M-ADS-011, M-ADS-013, M-MKT-023 |
...
- **M-ADS-013:** Attribution Models (understanding attribution)
- **M-ADS-004:** Meta Reporting (using conversion data)
- **M-ADS-008:** Google Reporting (using conversion data)

---

*Methodology M-ADS-012 | Ads API | faion-ads-agent*
