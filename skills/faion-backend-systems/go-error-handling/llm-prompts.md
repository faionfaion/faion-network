# LLM Prompts for Go Error Handling

Effective prompts for AI-assisted development with go error handling.
...
```
I need to implement go error handling for my project.
...
2. Technology choices from: errors package, fmt.Errorf, Custom types
...
```
Help me choose the best tool for go error handling.
...
```
Generate go error handling implementation for [language].

**Requirements:**
- Focus: Error wrapping, custom errors, sentinel errors
- Features:
  - [ ] [Feature 1]
  - [ ] [Feature 2]
  - [ ] [Feature 3]
...
```
Add [feature] to my existing go error handling code.
...
```
Analyze my go error handling implementation for performance issues.
...
```
Refactor this go error handling code for better maintainability.
...
```
I'm experiencing [issue] with go error handling.
...
```
Review my go error handling implementation for best practices.
...
```
Generate comprehensive tests for go error handling.
...
```
What test scenarios should I cover for go error handling?
...
```
Generate documentation for this go error handling implementation.
...
```
Create step-by-step tutorial for implementing go error handling.
...
```
Migrate go error handling from [old tool] to [new tool].
...
```
1. "Design go error handling for [project]"
   -> Get architecture
...
```
Generate go error handling in [language]:
- Feature: [description]
- Tool: errors package
...
```
Review this go error handling code:
[paste code]
