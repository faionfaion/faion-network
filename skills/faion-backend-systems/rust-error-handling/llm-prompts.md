# LLM Prompts for Rust Error Handling

Effective prompts for AI-assisted development with rust error handling.
...
```
I need to implement rust error handling for my project.
...
2. Technology choices from: anyhow, thiserror, std::error
...
```
Help me choose the best tool for rust error handling.
...
```
Generate rust error handling implementation for [language].

**Requirements:**
- Focus: Result type, error propagation, custom errors
- Features:
  - [ ] [Feature 1]
  - [ ] [Feature 2]
  - [ ] [Feature 3]
...
```
Add [feature] to my existing rust error handling code.
...
```
Analyze my rust error handling implementation for performance issues.
...
```
Refactor this rust error handling code for better maintainability.
...
```
I'm experiencing [issue] with rust error handling.
...
```
Review my rust error handling implementation for best practices.
...
```
Generate comprehensive tests for rust error handling.
...
```
What test scenarios should I cover for rust error handling?
...
```
Generate documentation for this rust error handling implementation.
...
```
Create step-by-step tutorial for implementing rust error handling.
...
```
Migrate rust error handling from [old tool] to [new tool].
...
```
1. "Design rust error handling for [project]"
   -> Get architecture
...
```
Generate rust error handling in [language]:
- Feature: [description]
- Tool: anyhow
...
```
Review this rust error handling code:
[paste code]
...
```
Debug rust error handling issue:
Error: [message]
Code: [paste]
Context: [details]
