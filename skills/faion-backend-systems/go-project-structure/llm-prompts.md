# LLM Prompts for Go Project Structure

Effective prompts for AI-assisted development with go project structure.
...
```
I need to implement go project structure for my project.
...
2. Technology choices from: Go modules, cmd/internal pattern
...
```
Help me choose the best tool for go project structure.
...
```
Generate go project structure implementation for [language].

**Requirements:**
- Focus: Directory layout, package organization
- Features:
  - [ ] [Feature 1]
  - [ ] [Feature 2]
  - [ ] [Feature 3]
...
```
Add [feature] to my existing go project structure code.
...
```
Analyze my go project structure implementation for performance issues.
...
```
Refactor this go project structure code for better maintainability.
...
```
I'm experiencing [issue] with go project structure.
...
```
Review my go project structure implementation for best practices.
...
```
Generate comprehensive tests for go project structure.
...
```
What test scenarios should I cover for go project structure?
...
```
Generate documentation for this go project structure implementation.
...
```
Create step-by-step tutorial for implementing go project structure.
...
```
Migrate go project structure from [old tool] to [new tool].
...
```
1. "Design go project structure for [project]"
   -> Get architecture
...
```
Generate go project structure in [language]:
- Feature: [description]
- Tool: Go modules
...
```
Review this go project structure code:
[paste code]
...
```
Debug go project structure issue:
Error: [message]
Code: [paste]
Context: [details]
