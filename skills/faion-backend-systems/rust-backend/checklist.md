# Rust Backend Development Checklist

Step-by-step checklist for implementing rust backend development in backend systems.
...
- [ ] Evaluate tool options: Axum, Actix-web, Tokio, SQLx
...
|------|---------|-------------|
| Axum | Web framework | Type-safe APIs |
| Actix-web | Tool | Usage |
