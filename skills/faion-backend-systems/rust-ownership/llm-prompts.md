# LLM Prompts for Rust Ownership

Effective prompts for AI-assisted development with rust ownership.
...
```
I need to implement rust ownership for my project.
...
2. Technology choices from: Rust compiler, Clippy
...
```
Help me choose the best tool for rust ownership.
...
```
Generate rust ownership implementation for [language].

**Requirements:**
- Focus: Ownership rules, borrowing, lifetimes
- Features:
  - [ ] [Feature 1]
  - [ ] [Feature 2]
  - [ ] [Feature 3]
...
```
Add [feature] to my existing rust ownership code.
...
```
Analyze my rust ownership implementation for performance issues.
...
```
Refactor this rust ownership code for better maintainability.
...
```
I'm experiencing [issue] with rust ownership.
...
```
Review my rust ownership implementation for best practices.
...
```
Generate comprehensive tests for rust ownership.
...
```
What test scenarios should I cover for rust ownership?
...
```
Generate documentation for this rust ownership implementation.
...
```
Create step-by-step tutorial for implementing rust ownership.
...
```
Migrate rust ownership from [old tool] to [new tool].
...
```
1. "Design rust ownership for [project]"
   -> Get architecture
...
```
Generate rust ownership in [language]:
- Feature: [description]
- Tool: Rust compiler
...
```
Review this rust ownership code:
[paste code]
