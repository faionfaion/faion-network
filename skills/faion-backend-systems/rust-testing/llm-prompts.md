# LLM Prompts for Rust Testing

Effective prompts for AI-assisted development with rust testing.
...
```
I need to implement rust testing for my project.
...
2. Technology choices from: cargo test, mockall, proptest
...
```
Help me choose the best tool for rust testing.
...
```
Generate rust testing implementation for [language].
...
```
Add [feature] to my existing rust testing code.
...
```
Analyze my rust testing implementation for performance issues.
...
```
Refactor this rust testing code for better maintainability.
...
```
I'm experiencing [issue] with rust testing.
...
```
Review my rust testing implementation for best practices.
...
```
Generate comprehensive tests for rust testing.
...
```
What test scenarios should I cover for rust testing?
...
```
Generate documentation for this rust testing implementation.
...
```
Create step-by-step tutorial for implementing rust testing.
...
```
Migrate rust testing from [old tool] to [new tool].
...
```
1. "Design rust testing for [project]"
   -> Get architecture
...
```
Generate rust testing in [language]:
- Feature: [description]
- Tool: cargo test
