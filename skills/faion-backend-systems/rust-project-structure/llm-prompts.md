# LLM Prompts for Rust Project Structure

Effective prompts for AI-assisted development with rust project structure.
...
```
I need to implement rust project structure for my project.
...
2. Technology choices from: Cargo, Workspaces
...
```
Help me choose the best tool for rust project structure.
...
```
Generate rust project structure implementation for [language].

**Requirements:**
- Focus: Module organization, workspace layout
- Features:
  - [ ] [Feature 1]
  - [ ] [Feature 2]
  - [ ] [Feature 3]
...
```
Add [feature] to my existing rust project structure code.
...
```
Analyze my rust project structure implementation for performance issues.
...
```
Refactor this rust project structure code for better maintainability.
...
```
I'm experiencing [issue] with rust project structure.
...
```
Review my rust project structure implementation for best practices.
...
```
Generate comprehensive tests for rust project structure.
...
```
What test scenarios should I cover for rust project structure?
...
```
Generate documentation for this rust project structure implementation.
...
```
Create step-by-step tutorial for implementing rust project structure.
...
```
Migrate rust project structure from [old tool] to [new tool].
...
```
1. "Design rust project structure for [project]"
   -> Get architecture
...
```
Generate rust project structure in [language]:
- Feature: [description]
- Tool: Cargo
...
```
Review this rust project structure code:
[paste code]
...
```
Debug rust project structure issue:
Error: [message]
Code: [paste]
Context: [details]
