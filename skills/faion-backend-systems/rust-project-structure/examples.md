# Rust Project Structure Examples

Real-world implementations and use cases.

## Example 1: Library crate
...
|----------|----------|------------|-------------|-------------|
| Library crate | [approach] | Low | High | [scenario] |
| Binary crate | [approach] | Medium | Medium | [scenario] |
| Workspace | [approach] | High | High | [scenario] |
| Feature flags | [approach] | Medium | High | [scenario] |
...
```
Is it [condition]?
  Yes → Use Library crate
  No  → Is it [other condition]?
          Yes → Use Binary crate
          No  → Use Workspace
```
...
|-------|-----------|--------|
| Primary | Cargo | [Reason for choice] |
| Alternative | Workspaces | [Reason for choice] |
