# LLM Prompts for Rust Tokio Async

Effective prompts for AI-assisted development with rust tokio async.
...
```
I need to implement rust tokio async for my project.
...
2. Technology choices from: Tokio, futures, async-std
...
```
Help me choose the best tool for rust tokio async.
...
```
Generate rust tokio async implementation for [language].

**Requirements:**
- Focus: Async runtime, tokio patterns, futures
- Features:
  - [ ] [Feature 1]
  - [ ] [Feature 2]
  - [ ] [Feature 3]
...
```
Add [feature] to my existing rust tokio async code.
...
```
Analyze my rust tokio async implementation for performance issues.
...
```
Refactor this rust tokio async code for better maintainability.
...
```
I'm experiencing [issue] with rust tokio async.
...
```
Review my rust tokio async implementation for best practices.
...
```
Generate comprehensive tests for rust tokio async.
...
```
What test scenarios should I cover for rust tokio async?
...
```
Generate documentation for this rust tokio async implementation.
...
```
Create step-by-step tutorial for implementing rust tokio async.
...
```
Migrate rust tokio async from [old tool] to [new tool].
...
```
1. "Design rust tokio async for [project]"
   -> Get architecture
...
```
Generate rust tokio async in [language]:
- Feature: [description]
- Tool: Tokio
...
```
Review this rust tokio async code:
[paste code]
