# LLM Prompts for NoSQL Patterns

Effective prompts for AI-assisted development with nosql patterns.
...
```
I need to implement nosql patterns for my project.
...
2. Technology choices from: MongoDB, DynamoDB, Cassandra, Redis
...
```
Help me choose the best tool for nosql patterns.
...
```
Generate nosql patterns implementation for [language].

**Requirements:**
- Focus: Document, key-value, column-family patterns
- Features:
  - [ ] [Feature 1]
  - [ ] [Feature 2]
  - [ ] [Feature 3]
...
```
Add [feature] to my existing nosql patterns code.
...
```
Analyze my nosql patterns implementation for performance issues.
...
```
Refactor this nosql patterns code for better maintainability.
...
```
I'm experiencing [issue] with nosql patterns.
...
```
Review my nosql patterns implementation for best practices.
...
```
Generate comprehensive tests for nosql patterns.
...
```
What test scenarios should I cover for nosql patterns?
...
```
Generate documentation for this nosql patterns implementation.
...
```
Create step-by-step tutorial for implementing nosql patterns.
...
```
Migrate nosql patterns from [old tool] to [new tool].
...
```
1. "Design nosql patterns for [project]"
   -> Get architecture
...
```
Generate nosql patterns in [language]:
- Feature: [description]
- Tool: MongoDB
...
```
Review this nosql patterns code:
[paste code]
