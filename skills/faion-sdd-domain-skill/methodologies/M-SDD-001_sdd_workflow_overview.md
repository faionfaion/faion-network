...
#### Phase 1: Idea
- Generate ideas using proven frameworks (see M-RES-001)
...
**faion-task-executor** orchestrates the SDD workflow. Invoke with:
...
*Methodology M-SDD-001 | SDD Foundation | Version 1.0*
