---
name: faion-research-domain-skill
description: "Domain skill for research and discovery: idea generation (7 frameworks), market research, competitor analysis, persona building, pricing research, problem validation, niche evaluation, project naming. Orchestrates 8 research agents."
...
|-------|-------|---------|--------|
| faion-idea-generator | opus | Creative idea brainstorming | idea-validation.md |
| faion-pain-point-researcher | sonnet | Research pain points via Reddit/forums | pain-points.md |
| faion-niche-evaluator | sonnet | Evaluate niche viability | niche-evaluation.md |
| faion-market-researcher | sonnet | TAM/SAM/SOM, trends | market-research.md |
| faion-competitor-analyzer | sonnet | Features, pricing, gaps | competitive-analysis.md |
| faion-persona-builder | sonnet | Pain points, JTBD | user-personas.md |
| faion-problem-validator | sonnet | Problem evidence | problem-validation.md |
| faion-pricing-researcher | sonnet | Benchmarks, models | pricing-research.md |

**Additional Naming Agents:**

| Agent | Purpose |
|-------|---------|
| faion-name-generator | Creative name brainstorming (opus) |
| faion-domain-checker | Domain availability verification (sonnet) |
...
| # | Methodology | Description | Agent |
|---|-------------|-------------|-------|
| M-RES-001 | 7 Ps of Ideation | Pain, Passion, Profession, Process, Platform, People, Product | faion-idea-generator |
| M-RES-002 | Paul Graham Questions | Tedious tasks, surprisingly hard, build for self | faion-idea-generator |
| M-RES-003 | Personal Pain Points | Daily problems, complaints, workarounds | faion-idea-generator |
| M-RES-004 | Idea Scoring Matrix | Multi-criteria scoring (market, competition, fit) | faion-niche-evaluator |
| M-RES-005 | TAM/SAM/SOM Analysis | Total, Serviceable, Obtainable market sizing | faion-market-researcher |
| M-RES-006 | Market Trend Analysis | Industry trends, growth drivers, threats | faion-market-researcher |
| M-RES-007 | Competitive Landscape Mapping | Direct, indirect, substitute competitors | faion-competitor-analyzer |
| M-RES-008 | Feature Gap Analysis | Missing features in competitor products | faion-competitor-analyzer |
| M-RES-009 | Pricing Benchmarking | Competitor pricing models comparison | faion-pricing-researcher |
| M-RES-010 | Jobs To Be Done (JTBD) | Functional, emotional, social jobs | faion-persona-builder |
| M-RES-011 | User Persona Creation | Demographics, behaviors, pain points, goals | faion-persona-builder |
| M-RES-012 | Problem Validation | Evidence gathering for problem existence | faion-problem-validator |
| M-RES-013 | Pain Point Mining | Reddit, forums, reviews, social listening | faion-pain-point-researcher |
| M-RES-014 | Niche Viability Scoring | 5-criteria scoring (market, competition, barriers, profit, fit) | faion-niche-evaluator |
| M-RES-015 | Blue Ocean Strategy | Uncontested market space identification | faion-niche-evaluator |
| M-RES-016 | Value Proposition Canvas | Customer profile vs. value map | faion-persona-builder |
| M-RES-017 | Project Naming Strategies | Descriptive, invented, compound, metaphor, portmanteau | faion-name-generator |
| M-RES-018 | Domain Availability Check | .com, .io, .co, social handles | faion-domain-checker |
...
```python
Task(
    subagent_type="faion-market-researcher",
...
```python
Task(
    subagent_type="faion-competitor-analyzer",
...
```python
Task(
    subagent_type="faion-persona-builder",
...
```python
Task(
    subagent_type="faion-name-generator",
