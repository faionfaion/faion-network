---
id: customer-success-basics
name: "Customer Success Basics"
domain: BIZ
...
| **Related** | customer-success-metrics, customer-support, churn-prevention |
...
### Step 2: Create Success Touchpoints
...
- **customer-success-metrics:** Health Scoring & Metrics
- **customer-support:** Customer Support (reactive support)
- **churn-prevention:** Churn Prevention (at-risk intervention)
- **upselling-cross-selling:** Upselling & Cross-selling (expansion)
- **onboarding-emails:** Onboarding Emails (automated touchpoints)

---

*Methodology: customer-success-basics | Operations & Business | faion-growth-agent*
...
- [Gainsight Customer Success Resources](https://www.gainsight.com/resources/) - CS platform and methodology leader
- [ChurnZero CS Playbooks](https://churnzero.net/resources/) - Customer success automation and best practices
- [The Customer Success Professional's Handbook](https://www.amazon.com/Customer-Success-Professionals-Handbook/dp/1119624576) - Comprehensive CS guide
- [Customer Success by Nick Mehta](https://www.amazon.com/Customer-Success-Innovative-Companies-Churn/dp/1119167965) - CS methodology and frameworks
- [Intercom Customer Success Guide](https://www.intercom.com/resources/customer-success) - Modern CS strategies
