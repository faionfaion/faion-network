---
name: faion-development-domain-skill
...
|----------------|---------|
| faion-dev-django | Django coding standards, patterns |
| faion-dev-ui-design | UI brainstorming, Storybook, components |
| faion-dev-docs | CLAUDE.md documentation creation |
...
| faion-dev-design-brainstormer | Generate 3-5 design variants | - |
| faion-dev-storybook-manager | Setup/maintain Storybook | - |
| faion-dev-component-developer | Develop components with stories | - |
...
**Agent:** faion-dev-storybook-manager
...
**Agent:** faion-dev-component-developer
...
Task(subagent_type="faion-dev-design-brainstormer",
     prompt=f"Create 3-5 DISTINCT design variants for: {requirements}")

# Phase 2: Storybook
Task(subagent_type="faion-dev-storybook-manager",
     prompt=f"Setup Storybook for {project}")

# Phase 3: Components
Task(subagent_type="faion-dev-component-developer",
...
*Merged from: faion-dev-django, faion-dev-ui-design, faion-dev-docs*
