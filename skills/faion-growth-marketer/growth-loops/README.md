...
| **Related** | viral-metrics, viral-loops, viral-optimization, product-led-growth, retention-loops |
...
- **viral-metrics, viral-loops, viral-optimization:** Viral Coefficient (deep dive into viral loops)
- **product-led-growth:** Product-Led Growth (PLG as a loop)
- **retention-loops:** Retention Loops (engagement-based loops)

---

*Methodology: growth-loops | Growth | faion-growth-agent*
