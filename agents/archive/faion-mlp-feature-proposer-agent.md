---
name: faion-mlp-feature-proposer-agent
...
- feature_list: Existing features (from faion-mlp-spec-analyzer-agent)
- missing_capabilities: Gaps requiring new features (from faion-mlp-gap-finder-agent)
