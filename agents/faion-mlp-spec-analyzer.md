...
**Used by:** faion-mlp-gap-finder, faion-mlp-impl-planner
...
1. **faion-mlp-gap-finder** — to identify what's missing
2. **faion-mlp-impl-planner** — to understand dependencies
